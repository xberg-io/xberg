...
# alef:hash:b54fab2fcad9056b2462728bc769f808707d30b9208cf4b7f805021a69c669f3
...
RSpec.describe 'smoke' do
  ...
  it 'smoke_xlsx_basic: Smoke test: XLSX with basic spreadsheet data including tables' do
    ...
    expect(result.metadata.sheet_names.any? { |item| alef_e2e_item_texts(item).any? { |t| t.include?('Stanley Cups') } }).to be(true)
  end
end
