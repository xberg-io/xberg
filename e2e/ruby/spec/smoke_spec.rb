...
# alef:hash:5e071aa716977ce0389d60284001e1a198b343b432e0fa5713630625c593d9a1
...
RSpec.describe 'smoke' do
  ...
  it 'smoke_xlsx_basic: Smoke test: XLSX with basic spreadsheet data including tables' do
    ...
    expect(result.metadata.format.excel.sheet_names.to_s).to include('Stanley Cups')
  end
end
