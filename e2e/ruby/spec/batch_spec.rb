...
# alef:hash:da68254284ed7c7f0574392a50c661b11eca167e0104329a2bfc940719bb7258
...
RSpec.describe 'batch' do
  ...
  it 'batch_extract_bytes_happy: batch_extract_bytes: happy path with mixed inputs' do
    result = Kreuzberg.batch_extract_bytes_async([Kreuzberg::BatchBytesItem.new([72, 101, 108, 108, 111, 44, 32, 119, 111, 114, 108, 100, 33], "text/plain", nil), Kreuzberg::BatchBytesItem.new([60, 104, 116, 109, 108, 62, 60, 98, 111, 100, 121, 62, 84, 101, 115, 116, 60, 47, 98, 111, 100, 121, 62, 60, 47, 104, 116, 109, 108, 62], "text/html", nil)])
