...
# alef:hash:9ce6ad598132da96eea18573d0f58678085bcd5a3b7e13d0312f5270ffda2241
...
# 2. Standalone mode (direct `BUNDLE_PATH=vendor/bundle ruby -S bundle exec ruby -S rspec` /
#    `task ruby:smoke`): Build the
