...
# alef:hash:6104f6d9514189e5f9a2ce0111c193d739d997feecd67f27813714d03409f831
...
RSpec.describe 'contract' do
  ...
  it 'config_chunking_prepend_heading_context: Tests markdown chunker prepends heading hierarchy to chunk content' do
    ...
    expect(result.chunks_have_heading_context).to be true
    expect(result.first_chunk_starts_with_heading).to be true
