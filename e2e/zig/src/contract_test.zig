...
test "api_batch_bytes_async" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", null, "{}");
...
test "api_batch_bytes_with_configs_async" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", null, "{\"output_format\":\"markdown\"}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_document_structure_with_headings" {
    ...
    const _result_json = try xberg.extract_file_sync("docx/fake.docx", null, "{\"include_document_structure\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_element_types" {
    ...
    const _result_json = try xberg.extract_file_sync("docx/unit_test_headers.docx", null, "{\"result_format\":\"element_based\"}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_extraction_timeout" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", null, "{\"extraction_timeout_secs\":300}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_keywords" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", null, "{\"keywords\":{\"algorithm\":\"yake\",\"max_keywords\":10}}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_pages" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", null, "{\"pages\":{\"extract_pages\":true,\"insert_page_markers\":true}}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_quality_enabled" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", null, "{\"enable_quality_processing\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_security_limits" {
    ...
    const _result_json = try xberg.extract_file_sync("archives/documents.zip", null, "{\"security_limits\":{\"max_archive_size\":104857600,\"max_compression_ratio\":50,\"max_files_in_archive\":100}}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "config_tree_sitter" {
    ...
    const _result_json = try xberg.extract_file_sync("code/hello.py", null, "{\"tree_sitter\":{\"groups\":[\"web\"],\"languages\":[\"python\",\"rust\"],\"process\":{\"comments\":false,\"diagnostics\":false,\"docstrings\":false,\"exports\":true,\"imports\":true,\"structure\":true,\"symbols\":false}}}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "output_format_bytes_markdown" {
    ...
    const _result_json = try xberg.extract_bytes_sync(content_bytes, "application/pdf", "{\"output_format\":\"markdown\"}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
