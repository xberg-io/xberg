...
test "unregister_document_extractor_after_register" {
    ...
    suppress_abort();
    _ = kreuzberg.unregister_document_extractor("test-extractor");
}

test "unregister_embedding_backend_after_register" {
    // unregister_embedding_backend
    suppress_abort();
    _ = kreuzberg.unregister_embedding_backend("test-embedding-backend");
}

test "unregister_post_processor_after_register" {
    // unregister_post_processor
    suppress_abort();
    _ = kreuzberg.unregister_post_processor("test-processor");
}

test "unregister_renderer_after_register" {
    // unregister_renderer
    suppress_abort();
    _ = kreuzberg.unregister_renderer("test-renderer");
}
