...
test "ocr_image_png" {
    ...
    const _result_json = try xberg.extract_bytes_sync(content_bytes, "image/png", "{}");
...
test "smoke_docx_basic" {
    ...
    const _result_json = try xberg.extract_file_sync("docx/fake.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_html_basic" {
    ...
    const _result_json = try xberg.extract_file_sync("html/simple_table.html", "text/html", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_image_png" {
    ...
    const _result_json = try xberg.extract_file_sync("images/sample.png", null, "{\"disable_ocr\":true}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_json_basic" {
    ...
    const _result_json = try xberg.extract_file_sync("json/simple.json", "application/json", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_pdf_basic" {
    ...
    const _result_json = try xberg.extract_file_sync("pdf/fake_memo.pdf", "application/pdf", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_txt_basic" {
    ...
    const _result_json = try xberg.extract_file_sync("text/report.txt", "text/plain", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
...
test "smoke_xlsx_basic" {
    ...
    const _result_json = try xberg.extract_file_sync("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "{}");
    defer std.heap.c_allocator.free(_result_json);
    var _parsed = try std.json.parseFromSlice(std.json.Value, allocator, _result_json, .{});
    defer _parsed.deinit();
    const result = &_parsed.value;
