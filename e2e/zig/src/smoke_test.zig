...
// alef:hash:ca1b71ac8120c1aa25c4bfb268f27536b22a64f421d786f7ef331ad4aedfd25b
...
test "smoke_image_png" {
    ...
    const result = &_parsed.value;
    try testing.expectEqualStrings("image/png", std.mem.trim(u8, result.object.get("mime_type").?.string, " \n\r\t"));
    try testing.expectEqualStrings("PNG", std.mem.trim(u8, result.object.get("metadata").?.object.get("format").?.string, " \n\r\t"));
}
