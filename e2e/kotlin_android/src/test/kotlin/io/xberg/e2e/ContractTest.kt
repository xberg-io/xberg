...
class ContractTest {
    ...
    fun testApiBatchBytesAsync() = runBlocking {
        ...
        val result = Xberg.extractFile("pdf/fake_memo.pdf", null, ExtractionConfig())
    ...
    fun testApiBatchBytesWithConfigsAsync() = runBlocking {
        ...
        val result = Xberg.extractFile("pdf/fake_memo.pdf", null, config_Config)
        assertEquals("application/pdf", result.mimeType.trim())
        assertTrue(result.content.length >= 10, "expected length >= 10")
    ...
    fun testConfigDocumentStructureWithHeadings() = runBlocking {
        ...
        val result = Xberg.extractFileSync("docx/fake.docx", null, config)
    ...
    fun testConfigElementTypes() = runBlocking {
        ...
        val result = Xberg.extractFileSync("docx/unit_test_headers.docx", null, config)
    ...
    fun testConfigExtractionTimeout() = runBlocking {
        ...
        val result = Xberg.extractFileSync("pdf/fake_memo.pdf", null, config)
        assertEquals("application/pdf", result.mimeType.trim())
        assertTrue(result.content.length >= 10, "expected length >= 10")
    }
    ...
    fun testConfigSecurityLimits() = runBlocking {
        ...
        val result = Xberg.extractFileSync("archives/documents.zip", null, config)
    ...
    fun testConfigTreeSitter() = runBlocking {
        ...
        val result = Xberg.extractFileSync("code/hello.py", null, config)
    ...
    fun testOutputFormatBytesMarkdown() = runBlocking {
        ...
        val result = Xberg.extractBytesSync(java.nio.file.Files.readAllBytes(java.nio.file.Paths.get("pdf/fake_memo.pdf")), "application/pdf", config)
        assertEquals("application/pdf", result.mimeType.trim())
        assertTrue(result.content.length >= 10, "expected length >= 10")
        assertEquals("markdown", result.metadata.outputFormat.orEmpty().trim())
    }
