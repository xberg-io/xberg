...
class SmokeTest {
    ...
    fun testOcrImagePng() = runBlocking {
        ...
        val result = Xberg.extractBytes(java.nio.file.Files.readAllBytes(java.nio.file.Paths.get("images/test_hello_world.png")), "image/png", config)
    ...
    fun testSmokeDocxBasic() = runBlocking {
        ...
        val config = MAPPER.readValue("{}", ExtractionConfig::class.java)
        val result = Xberg.extractFile("docx/fake.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", config)
    ...
    fun testSmokeHtmlBasic() = runBlocking {
        ...
        val config = MAPPER.readValue("{}", ExtractionConfig::class.java)
        val result = Xberg.extractFile("html/simple_table.html", "text/html", config)
    ...
    fun testSmokeImagePng() = runBlocking {
        ...
        val result = Xberg.extractFile("images/sample.png", null, config)
        assertEquals("image/png", result.mimeType.trim())
    }
    ...
    fun testSmokeJsonBasic() = runBlocking {
        ...
        val config = MAPPER.readValue("{}", ExtractionConfig::class.java)
        val result = Xberg.extractFile("json/simple.json", "application/json", config)
    ...
    fun testSmokePdfBasic() = runBlocking {
        ...
        val config = MAPPER.readValue("{}", ExtractionConfig::class.java)
        val result = Xberg.extractFile("pdf/fake_memo.pdf", "application/pdf", config)
    ...
    fun testSmokeTxtBasic() = runBlocking {
        ...
        val config = MAPPER.readValue("{}", ExtractionConfig::class.java)
        val result = Xberg.extractFile("text/report.txt", "text/plain", config)
    ...
    fun testSmokeXlsxBasic() = runBlocking {
        ...
        val config = MAPPER.readValue("{}", ExtractionConfig::class.java)
        val result = Xberg.extractFile("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", config)
