...
// alef:hash:3d1543e35fb8d4fc63ffe35a0961e600bf7de1f9c18c9057eb34df7cb1a034a9
...
class EmbedAsyncPendingTest {
    ...
    fun testEmbedTextsAsyncPresetSwitch() = runBlocking {
        ...
        val config = MAPPER.readValue("{\"model\":{\"name\":\"default\",\"type\":\"preset\"}}", EmbeddingConfig::class.java)
