...
// alef:hash:e7adbf16d352d0314ee66321930b8a1efb73141644bb87a6dc4c1d777e5fd885
...
class CodeTest {
    ...
    fun testCodeShebangDetection() = runBlocking {
        ...
        val result = Kreuzberg.extractFileSync(java.nio.file.Path.of("code/script.sh"), "text/x-source-code", ExtractionConfig.builder().build())
