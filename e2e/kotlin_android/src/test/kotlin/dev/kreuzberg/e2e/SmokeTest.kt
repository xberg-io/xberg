...
// alef:hash:c3a11b1e1c7eddeb6c0f1afaac0f8925641c6f16213884fcefab4281ffbcd3fd
...
class SmokeTest {
    ...
    fun testSmokeImagePng() = runBlocking {
        ...
        val result = Kreuzberg.extractFile(java.nio.file.Path.of("images/sample.png"), null, config)
        assertEquals("image/png", result.mimeType.trim())
        assertEquals("PNG", result.metadata.format.orEmpty().trim())
    }
