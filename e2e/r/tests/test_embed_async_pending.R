...
# alef:hash:906aaebd55c8291f866669905d674615f6c54f246ecf7228c9480e13677b05d7
...
test_that("embed_texts_async_preset_switch: embed_texts_async: preset override", {
  result <- embed_texts_async(texts = c("Text"), config = EmbeddingConfig$from_json(jsonlite::toJSON(list("model" = list("name" = "default", "type" = "preset")), auto_unbox = TRUE)))
  expect_true(TRUE)
})
