...
# alef:hash:92e141c2a79549bd13b4647203b80a3ee4e0a9386da4740f830c5d6d88ddeea7
...
test_that("batch_extract_bytes_size_cap: batch_extract_bytes: archive size cap triggers error", {
  expect_error(batch_extract_bytes(items = "[{\"content\":[97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97],\"mime_type\":\"text/plain\"}]", config = ExtractionConfig$from_json(jsonlite::toJSON(list("security_limits" = list("max_content_size" = 1)), auto_unbox = TRUE))))
})
