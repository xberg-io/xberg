...
# alef:hash:e3e4aa5f3bd5b19cdce7a44adbb002924beec3adffd346a8248facc5ee2a7416
...
test_that("config_chunking_prepend_heading_context: Tests markdown chunker prepends heading hierarchy to chunk content", {
  ...
  expect_true(result$chunks_have_heading_context)
  expect_true(result$first_chunk_starts_with_heading)
})
