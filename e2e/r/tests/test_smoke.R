...
# alef:hash:f8938b2d28976f9f8eddcc39064e675a7543d12c0386ad7dca9f6d45afd5df73
...
test_that("smoke_xlsx_basic: Smoke test: XLSX with basic spreadsheet data including tables", {
  ...
  expect_true(grepl("Stanley Cups", result$metadata$format$excel$sheet_names, fixed = TRUE))
})
