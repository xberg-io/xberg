...
final class ErrorTests: XCTestCase {
    ...
    func testErrorEmptyBytes() throws {
        ...
        let result = try Xberg.extractBytesSync(contentBytes, "text/plain", "{}")
    }
    ...
    func testErrorEmptyMime() throws {
        ...
        do {
            ...
            let contentBytes = Array(contentData)
            _ = try Xberg.extractBytesSync(contentBytes, "", "{}")
    ...
    func testErrorExtractBytesConflictingOcr() throws {
        ...
        do {
            ...
            let contentBytes = Array(contentData)
            _ = try Xberg.extractBytesSync(contentBytes, "text/plain", "{\"disable_ocr\":true,\"force_ocr\":true}")
            XCTFail("expected to throw")
        } catch {
            // success
        }
    ...
    func testErrorInvalidMimeFormat() throws {
        ...
        do {
            let contentData = try Data(contentsOf: URL(fileURLWithPath: "text/plain.txt"))
            let contentBytes = Array(contentData)
            _ = try Xberg.extractBytesSync(contentBytes, "not-a-mime", "{}")
            XCTFail("expected to throw")
        } catch {
            // success
        }
    ...
    func testErrorUnsupportedMime() throws {
        ...
        do {
            let contentData = try Data(contentsOf: URL(fileURLWithPath: "text/plain.txt"))
            let contentBytes = Array(contentData)
            _ = try Xberg.extractBytesSync(contentBytes, "application/x-nonexistent", "{}")
            XCTFail("expected to throw")
        } catch {
            // success
        }
