...
final class BatchTests: XCTestCase {
  ...
  func testExtractBatchBytesHappy() async throws {
    ...
    let _item_inputsArray_0 = try Xberg.extractInputFromJson("{\"kind\":\"bytes\",\"bytes\":[72,101,108,108,111,44,32,119,111,114,108,100,33],\"mime_type\":\"text/plain\"}")
    let _item_inputsArray_1 = try Xberg.extractInputFromJson("{\"kind\":\"bytes\",\"bytes\":[60,104,116,109,108,62,60,98,111,100,121,62,84,101,115,116,60,47,98,111,100,121,62,60,47,104,116,109,108,62],\"mime_type\":\"text/html\"}")
  ...
  func testExtractBatchBytesInvalidMime() async throws {
    ...
    let _item_inputsArray_0 = try Xberg.extractInputFromJson("{\"kind\":\"bytes\",\"bytes\":[72,101,108,108,111],\"mime_type\":\"application/x-nonexistent\"}")
  ...
  func testExtractBatchBytesMixedFormat() async throws {
    ...
    let _item_inputsArray_0 = try Xberg.extractInputFromJson("{\"kind\":\"bytes\",\"bytes\":[80,68,70,32,112,108,97,99,101,104,111,108,100,101,114],\"mime_type\":\"application/x-unknown\"}")
    let inputsArray = [_item_inputsArray_0]
    let configObj = try Xberg.extractionConfigFromJson("{}")
    let result = try await Xberg.extractBatch(inputs: inputsArray, config: configObj)
  }
  ...
  func testExtractBatchBytesUnsupportedMime() async throws {
    ...
    let _item_inputsArray_0 = try Xberg.extractInputFromJson("{\"kind\":\"bytes\",\"bytes\":[100,97,116,97],\"mime_type\":\"application/x-unknown\"}")
    let inputsArray = [_item_inputsArray_0]
    let configObj = try Xberg.extractionConfigFromJson("{}")
    let result = try await Xberg.extractBatch(inputs: inputsArray, config: configObj)
  }
