...
// alef:hash:ccaa061ea4869a9ccfc032018a5231927a556c48355f1a216f624e37ae9b4267
...
final class FormatSpecificTests: XCTestCase {
    ...
    func testFormatDocxStandalone() throws {
        ...
        let result = try Kreuzberg.extractBytesSync(contentVec, "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "{}")
    ...
    func testFormatHwpxStandalone() throws {
        ...
        let contentVec = RustBridge.RustVec<UInt8>()
        for _byte in contentData { contentVec.push(value: _byte) }
        let result = try Kreuzberg.extractBytesSync(contentVec, "application/haansofthwpx", "{}")
        XCTAssertGreaterThanOrEqual(result.content.count, 20)
    ...
    func testFormatPdfText() throws {
        ...
        let contentVec = RustBridge.RustVec<UInt8>()
        for _byte in contentData { contentVec.push(value: _byte) }
        let result = try Kreuzberg.extractBytesSync(contentVec, "application/pdf", "{}")
