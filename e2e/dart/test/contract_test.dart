...
// alef:hash:5b66a61beb1ed64775ca31b931ba33d0fdbf23cfd2b2f98110e010a672aa5621
...
void main() {
  ...
  test('Tests markdown chunker prepends heading hierarchy to chunk content', () async {
    ...
    final result = await KreuzbergBridge.extractBytesSync(File('markdown/extraction_test.md').readAsBytesSync(), 'text/markdown', _config).toList();
    // skipped streaming assertion: 'min_length'
