...
// alef:hash:10219261bd44cc358e6b375203c1b79bd441dee025814c733a86fc2830a85980
...
void main() {
  ...
  test('Test language detection from shebang line via bytes input', () async {
    final result = await KreuzbergBridge.extractBytesSync(File('code/script.sh').readAsBytesSync(), mimeType: 'text/x-source-code');
