...
describe("pdf fixtures", () => {
  it("pdf_annotations", () => {
    ...
    try {
      ...
      if (shouldSkipFixture(error, "pdf_annotations", [], "PDFium ARM Linux binary does not support annotation extraction")) {
        return;
      }
      throw error;
    }
  ...
  it("pdf_layout_detection", () => {
    ...
    try {
      ...
      if (shouldSkipFixture(error, "pdf_layout_detection", ["layout-detection"], "Requires layout-detection feature with ONNX Runtime")) {
        return;
      }
      throw error;
    }
  ...
  it("pdf_technical_stat_learning", () => {
    const documentPath = resolveDocument("pdf/an_introduction_to_statistical_learning_with_applications_in_r_islr_sixth_printing.pdf");
    if (!existsSync(documentPath)) {
