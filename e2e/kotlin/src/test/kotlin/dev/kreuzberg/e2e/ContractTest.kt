...
// alef:hash:ddd29d7e87f41e74d2b865ab6b57882dd135d5ef7fc9ae00d0355ba968aa81cd
...
class ContractTest {
    ...
    fun testOutputFormatBytesMarkdown() {
        ...
        val result = Kreuzberg.extractBytesSync("pdf/fake_memo.pdf".toByteArray(), "application/pdf", config)
        assertEquals("application/pdf", result.mimeType().trim())
        assertTrue(result.content().length >= 10, "expected length >= 10")
