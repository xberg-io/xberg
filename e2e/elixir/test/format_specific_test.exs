...
defmodule E2e.FormatSpecificTest do
  ...
  describe "format_docx_standalone" do
    test "format_docx_standalone" do
      ...
      input_value = %Xberg.ExtractInput{kind: "uri", uri: String.replace("$mock_url/docx/fake.docx", "$mock_url", input_mock_base_url), mime_type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document", filename: "fake.docx"}
  ...
  describe "format_hwpx_standalone" do
    test "format_hwpx_standalone" do
      ...
      input_value = %Xberg.ExtractInput{kind: "uri", uri: String.replace("$mock_url/hwpx/simple.hwpx", "$mock_url", input_mock_base_url), mime_type: "application/haansofthwpx", filename: "simple.hwpx"}
      {:ok, result} = Xberg.extract(input: input_value)
      assert (is_binary(Enum.at(result.results, 0).content) && byte_size(Enum.at(result.results, 0).content) >= 20) || (is_list(Enum.at(result.results, 0).content) && length(Enum.at(result.results, 0).content) >= 20)
  ...
  describe "format_pdf_text" do
    test "format_pdf_text" do
      ...
      input_value = %Xberg.ExtractInput{kind: "uri", uri: String.replace("$mock_url/pdf/fake_memo.pdf", "$mock_url", input_mock_base_url), mime_type: "application/pdf", filename: "fake_memo.pdf"}
      {:ok, result} = Xberg.extract(input: input_value)
  ...
  describe "format_pptx" do
    test "format_pptx" do
      ...
      input_value = %Xberg.ExtractInput{kind: "uri", uri: String.replace("$mock_url/pptx/simple.pptx", "$mock_url", input_mock_base_url), mime_type: "application/vnd.openxmlformats-officedocument.presentationml.presentation"}
      {:ok, result} = Xberg.extract(input: input_value)
    end
  end
  ...
  describe "format_xlsx" do
    test "format_xlsx" do
      ...
      input_value = %Xberg.ExtractInput{kind: "uri", uri: String.replace("$mock_url/xlsx/stanley_cups.xlsx", "$mock_url", input_mock_base_url), mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"}
      {:ok, result} = Xberg.extract(input: input_value)
    end
  end
end
