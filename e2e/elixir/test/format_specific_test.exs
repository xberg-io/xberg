...
defmodule E2e.FormatSpecificTest do
  ...
  describe "format_docx_standalone" do
    test "format_docx_standalone" do
      ...
      {:ok, result} = Xberg.extract_bytes_sync(content, "application/vnd.openxmlformats-officedocument.wordprocessingml.document")
  ...
  describe "format_hwpx_standalone" do
    test "format_hwpx_standalone" do
      ...
      {:ok, result} = Xberg.extract_bytes_sync(content, "application/haansofthwpx")
      assert (is_binary(result.content) && byte_size(result.content) >= 20) || (is_list(result.content) && length(result.content) >= 20)
  ...
  describe "format_pdf_text" do
    test "format_pdf_text" do
      ...
      {:ok, result} = Xberg.extract_bytes_sync(content, "application/pdf")
  ...
  describe "format_pptx" do
    test "format_pptx" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/pptx/simple.pptx", mime_type: "application/vnd.openxmlformats-officedocument.presentationml.presentation")
    end
  end

  describe "format_xlsx" do
    test "format_xlsx" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/xlsx/stanley_cups.xlsx", mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
    end
  end
end
