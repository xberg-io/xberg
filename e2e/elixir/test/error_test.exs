...
# alef:hash:56b1956b09b8616abf0149be1cbb2a294d60e334adb6b79a6b509c5aaa5b6849
...
defmodule E2e.ErrorTest do
  ...
  describe "error_empty_bytes" do
    test "error_empty_bytes" do
      ...
      {:ok, result} = Kreuzberg.extract_bytes_sync(content, "text/plain", config: "{}")
    end
  end
  ...
  describe "error_empty_mime" do
    test "error_empty_mime" do
      ...
      assert {:error, _} = Kreuzberg.extract_bytes_sync(content, "", config: "{}")
    end
  end
  ...
  describe "error_extract_bytes_conflicting_ocr" do
    test "error_extract_bytes_conflicting_ocr" do
      ...
      assert {:error, _} = Kreuzberg.extract_bytes_sync(content, "text/plain", config: "{\"disable_ocr\":true,\"force_ocr\":true}")
    end
  end
  ...
  describe "error_invalid_mime_format" do
    test "error_invalid_mime_format" do
      content = File.read!("../../test_documents/text/plain.txt")
      assert {:error, _} = Kreuzberg.extract_bytes_sync(content, "not-a-mime", config: "{}")
    end
  end
  ...
  describe "error_unsupported_mime" do
    test "error_unsupported_mime" do
      content = File.read!("../../test_documents/text/plain.txt")
      assert {:error, _} = Kreuzberg.extract_bytes_sync(content, "application/x-nonexistent", config: "{}")
    end
  end
end
