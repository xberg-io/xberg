...
defmodule E2e.ContractTest do
  ...
  describe "api_batch_bytes_async" do
    test "api_batch_bytes_async" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/pdf/fake_memo.pdf")
  ...
  describe "api_batch_bytes_with_configs_async" do
    test "api_batch_bytes_with_configs_async" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/pdf/fake_memo.pdf", config: "{\"output_format\":\"markdown\"}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
  ...
  describe "config_document_structure_with_headings" do
    test "config_document_structure_with_headings" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/docx/fake.docx", config: "{\"include_document_structure\":true}")
  ...
  describe "config_element_types" do
    test "config_element_types" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/docx/unit_test_headers.docx", config: "{\"result_format\":\"element_based\"}")
  ...
  describe "config_extraction_timeout" do
    test "config_extraction_timeout" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", config: "{\"extraction_timeout_secs\":300}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
    end
  end
  ...
  describe "config_keywords" do
    test "config_keywords" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", config: "{\"keywords\":{\"algorithm\":\"yake\",\"max_keywords\":10}}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
  ...
  describe "config_pages" do
    test "config_pages" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", config: "{\"pages\":{\"extract_pages\":true,\"insert_page_markers\":true}}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
  ...
  describe "config_quality_enabled" do
    test "config_quality_enabled" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", config: "{\"enable_quality_processing\":true}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
  ...
  describe "config_security_limits" do
    test "config_security_limits" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/archives/documents.zip", config: "{\"security_limits\":{\"max_archive_size\":104857600,\"max_compression_ratio\":50,\"max_files_in_archive\":100}}")
  ...
  describe "config_tree_sitter" do
    test "config_tree_sitter" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/code/hello.py", config: "{\"tree_sitter\":{\"groups\":[\"web\"],\"languages\":[\"python\",\"rust\"],\"process\":{\"comments\":false,\"diagnostics\":false,\"docstrings\":false,\"exports\":true,\"imports\":true,\"structure\":true,\"symbols\":false}}}")
  ...
  describe "output_format_bytes_markdown" do
    test "output_format_bytes_markdown" do
      ...
      {:ok, result} = Xberg.extract_bytes_sync(content, "application/pdf", "{\"output_format\":\"markdown\"}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
      assert String.trim(result.metadata.output_format) == "markdown"
    end
  ...
  describe "output_format_markdown" do
    test "output_format_markdown" do
      {:ok, result} = Xberg.extract_file_sync("../../test_documents/pdf/fake_memo.pdf", config: "{\"output_format\":\"markdown\"}")
      assert String.trim(result.mime_type) == "application/pdf"
      assert (is_binary(result.content) && byte_size(result.content) >= 10) || (is_list(result.content) && length(result.content) >= 10)
      assert String.trim(result.metadata.output_format) == "markdown"
    end
