...
# alef:hash:12cb13310a4bb9f9228026cfe2e2786f54fc0ae4b747693e855b73f6c6ba7ad1
...
defmodule E2e.SmokeTest do
  ...
  describe "ocr_image_png" do
    test "ocr_image_png" do
      data = File.read!("../../test_documents/images/test_hello_world.png")
      {:ok, result} = Kreuzberg.extract_bytes_async(data, "image/png", "{}")
