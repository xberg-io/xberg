...
defmodule E2e.SmokeTest do
  ...
  describe "ocr_image_png" do
    test "ocr_image_png" do
      ...
      {:ok, result} = Xberg.extract_bytes_async(content, "image/png", "{}")
  ...
  describe "smoke_docx_basic" do
    test "smoke_docx_basic" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/docx/fake.docx", mime_type: "application/vnd.openxmlformats-officedocument.wordprocessingml.document", config: "{}")
  ...
  describe "smoke_html_basic" do
    test "smoke_html_basic" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/html/simple_table.html", mime_type: "text/html", config: "{}")
  ...
  describe "smoke_image_png" do
    test "smoke_image_png" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/images/sample.png", config: "{\"disable_ocr\":true}")
      assert String.trim(result.mime_type) == "image/png"
    end
  end
  ...
  describe "smoke_json_basic" do
    test "smoke_json_basic" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/json/simple.json", mime_type: "application/json", config: "{}")
  ...
  describe "smoke_pdf_basic" do
    test "smoke_pdf_basic" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/pdf/fake_memo.pdf", mime_type: "application/pdf", config: "{}")
  ...
  describe "smoke_txt_basic" do
    test "smoke_txt_basic" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/text/report.txt", mime_type: "text/plain", config: "{}")
  ...
  describe "smoke_xlsx_basic" do
    test "smoke_xlsx_basic" do
      {:ok, result} = Xberg.extract_file_async("../../test_documents/xlsx/stanley_cups.xlsx", mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", config: "{}")
