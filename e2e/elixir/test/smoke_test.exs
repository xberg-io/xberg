...
# alef:hash:f62b15a8885aa42f725795e9261e853ca9f5cc6e3434bc50c4e771f3fa51b4ca
...
defmodule E2e.SmokeTest do
  ...
  describe "smoke_xlsx_basic" do
    test "smoke_xlsx_basic" do
      ...
      assert String.contains?(to_string(result.metadata.format.excel.sheet_names), "Stanley Cups")
    end
  end
end
