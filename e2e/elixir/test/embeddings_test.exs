...
# alef:hash:4a4cd858117d786b08fff86b1492d4743025a4259776d33785d74fe21c3e4665
...
defmodule E2e.EmbeddingsTest do
  ...
  describe "embed_texts_different_preset" do
    test "embed_texts_different_preset" do
      {:ok, result} = Kreuzberg.embed_texts(["Hello world", "Test"], config: "{\"model\":{\"name\":\"multilingual\",\"type\":\"preset\"}}")
