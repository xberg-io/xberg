...
public class OfficeTest {
    ...
    public void officeCommonmarkBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("text/markdown", "text/plain", "text/x-commonmark"));
    ...
    @Test
    public void officeKeynoteBasic() throws Exception {
        JsonNode config = null;
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/x-iwork-keynote-sffkey"));
                E2EHelpers.Assertions.assertMinContentLength(result, 5);
            }
        );
    }
    ...
    @Test
    public void officeNumbersBasic() throws Exception {
        JsonNode config = null;
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/x-iwork-numbers-sffnumbers"));
                E2EHelpers.Assertions.assertMinContentLength(result, 10);
            }
        );
    }
    ...
    @Test
    public void officePagesBasic() throws Exception {
        JsonNode config = null;
        E2EHelpers.runFixture(
            "office_pages_basic",
            "iwork/test.pages",
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/x-iwork-pages-sffpages"));
                E2EHelpers.Assertions.assertMinContentLength(result, 5);
            }
        );
    }
    ...
    public void officePptmBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/vnd.ms-powerpoint.presentation.macroEnabled.12", "application/vnd.openxmlformats-officedocument.presentationml.presentation"));
    ...
    public void officeXlsbBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/vnd.ms-excel.sheet.binary.macroEnabled.12", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"));
                E2EHelpers.Assertions.assertContentNotEmpty(result);
            }
        );
    }
    ...
    public void officeXlsmBasic() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/vnd.ms-excel.sheet.macroEnabled.12", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"));
                E2EHelpers.Assertions.assertContentNotEmpty(result);
            }
        );
    }
