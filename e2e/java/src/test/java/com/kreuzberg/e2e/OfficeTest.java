...
public class OfficeTest {
  ...
  public void officeKeynoteBasic() throws Exception {
    ...
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertExpectedMime(
              result, Arrays.asList("application/x-iwork-keynote-sffkey"));
          E2EHelpers.Assertions.assertMinContentLength(result, 5);
        });
  }
  ...
  public void officeNumbersBasic() throws Exception {
    ...
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertExpectedMime(
              result, Arrays.asList("application/x-iwork-numbers-sffnumbers"));
          E2EHelpers.Assertions.assertMinContentLength(result, 10);
        });
  }
  ...
  public void officePagesBasic() throws Exception {
    ...
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertExpectedMime(
              result, Arrays.asList("application/x-iwork-pages-sffpages"));
          E2EHelpers.Assertions.assertMinContentLength(result, 5);
        });
  }
