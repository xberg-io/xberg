...
public class ContractTest {
  ...
  public void configHtmlStyledCustomCss() throws Exception {
    JsonNode config =
        MAPPER.readTree(
            "{\"output_format\":\"html\",\"html_output\":{\"theme\":\"unstyled\",\"css\":\".kb-p {"
                + " color: red; }\",\"embed_css\":true}}");
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertContentContainsAll(
              result, Arrays.asList(".kb-p { color: red; }", "kb-doc"));
        });
  }
  ...
  public void configHtmlStyledDefault() throws Exception {
    ...
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/pdf"));
          E2EHelpers.Assertions.assertContentContainsAll(
              result, Arrays.asList("kb-doc", "kb-content", "kb-p", "<style>"));
        });
  }
  ...
  public void configHtmlStyledNoEmbed() throws Exception {
    ...
    E2EHelpers.runFixture(
        ...
        result -> {
          E2EHelpers.Assertions.assertContentContainsAll(
              result, Arrays.asList("kb-doc", "kb-content"));
        });
  }
