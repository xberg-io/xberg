...
public class ContractTest {
    ...
    public void configChunkingSemanticSmall() throws Exception {
        JsonNode config = MAPPER.readTree("{\"chunking\":{\"chunker_type\":\"semantic\",\"max_chars\":200}}");
        E2EHelpers.skipIfFeatureUnavailable("chunking");
        E2EHelpers.runFixture(
    ...
    public void configChunkingSemanticThreshold() throws Exception {
        JsonNode config = MAPPER.readTree("{\"chunking\":{\"chunker_type\":\"semantic\",\"topic_threshold\":0.5}}");
        E2EHelpers.skipIfFeatureUnavailable("chunking");
        E2EHelpers.runFixture(
    ...
    public void configChunkingTokenizer() throws Exception {
        JsonNode config = MAPPER.readTree("{\"chunking\":{\"max_chars\":200,\"max_overlap\":40,\"sizing\":{\"type\":\"tokenizer\",\"model\":\"Xenova/gpt-4o\"}}}");
    ...
    @Test
    public void configHtmlStyledCustomCss() throws Exception {
        JsonNode config = MAPPER.readTree("{\"output_format\":\"html\",\"html_output\":{\"theme\":\"unstyled\",\"css\":\".kb-p { color: red; }\",\"embed_css\":true}}");
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertContentContainsAll(result, Arrays.asList(".kb-p { color: red; }", "kb-doc"));
            }
        );
    }

    @Test
    public void configHtmlStyledDefault() throws Exception {
        JsonNode config = MAPPER.readTree("{\"output_format\":\"html\",\"html_output\":{\"theme\":\"default\",\"embed_css\":true}}");
        E2EHelpers.runFixture(
            ...
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/pdf"));
                E2EHelpers.Assertions.assertContentContainsAll(result, Arrays.asList("kb-doc", "kb-content", "kb-p", "<style>"));
            }
        );
    }

    @Test
    public void configHtmlStyledNoEmbed() throws Exception {
        JsonNode config = MAPPER.readTree("{\"output_format\":\"html\",\"html_output\":{\"theme\":\"default\",\"embed_css\":false}}");
        E2EHelpers.runFixture(
            ...
            true,
            result -> {
                E2EHelpers.Assertions.assertContentContainsAll(result, Arrays.asList("kb-doc", "kb-content"));
            }
        );
    }
    ...
    public void configLanguageDetectionMulti() throws Exception {
        JsonNode config = MAPPER.readTree("{\"language_detection\":{\"enabled\":true,\"detect_multiple\":true,\"min_confidence\":0.3}}");
        E2EHelpers.runFixture(
    ...
    public void configLanguageMulti() throws Exception {
        JsonNode config = MAPPER.readTree("{\"language_detection\":{\"enabled\":true,\"detect_multiple\":true}}");
    ...
    public void configLlmEmbeddings() throws Exception {
        JsonNode config = MAPPER.readTree("{\"chunking\":{\"max_chars\":500,\"max_overlap\":50,\"embedding\":{\"model\":{\"type\":\"llm\",\"llm\":{\"model\":\"openai/text-embedding-3-small\"}},\"normalize\":true}}}");
    ...
    public void configLlmStructuredExtraction() throws Exception {
        JsonNode config = MAPPER.readTree("{\"structured_extraction\":{\"schema\":{\"type\":\"object\",\"properties\":{\"title\":{\"type\":\"string\"},\"date\":{\"type\":\"string\"},\"summary\":{\"type\":\"string\"}},\"required\":[\"title\"]},\"schema_name\":\"memo_data\",\"llm\":{\"model\":\"openai/gpt-4o\"}}}");
        E2EHelpers.skipIfFeatureUnavailable("liter-llm");
        E2EHelpers.runFixture(
    ...
    public void configLlmStructuredExtractionWithPrompt() throws Exception {
        ...
        E2EHelpers.runFixture(
            ...
            result -> {
                E2EHelpers.Assertions.assertExpectedMime(result, Arrays.asList("application/pdf"));
                E2EHelpers.Assertions.assertMinContentLength(result, 10);
                E2EHelpers.assertStructuredOutput(result, true, null, new String[]{"sender", "recipient"});
            }
        );
    }
    ...
    public void configLlmVlmOcr() throws Exception {
        JsonNode config = MAPPER.readTree("{\"ocr\":{\"backend\":\"vlm\",\"language\":\"eng\",\"vlm_config\":{\"model\":\"openai/gpt-4o\"}}}");
        E2EHelpers.skipIfFeatureUnavailable("liter-llm");
        E2EHelpers.runFixture(
            "config_llm_vlm_ocr",
            "images/test_hello_world.png",
    ...
    public void configPdfHierarchy() throws Exception {
        JsonNode config = MAPPER.readTree("{\"pdf_options\":{\"hierarchy\":{\"enabled\":true,\"include_bbox\":true}},\"pages\":{\"extract_pages\":true}}");
        E2EHelpers.skipIfFeatureUnavailable("pdf");
        E2EHelpers.runFixture(
    ...
    public void configPdfMargins() throws Exception {
        JsonNode config = MAPPER.readTree("{\"pdf_options\":{\"top_margin_fraction\":0.1,\"bottom_margin_fraction\":0.1}}");
        E2EHelpers.skipIfFeatureUnavailable("pdf");
        E2EHelpers.runFixture(
            "config_pdf_margins",
            "pdf/fake_memo.pdf",
    ...
    public void configTreeSitter() throws Exception {
        JsonNode config = MAPPER.readTree("{\"tree_sitter\":{\"languages\":[\"python\",\"rust\"],\"groups\":[\"web\"],\"process\":{\"structure\":true,\"imports\":true,\"exports\":true,\"comments\":false,\"docstrings\":false,\"symbols\":false,\"diagnostics\":false}}}");
    ...
    public void configTreeSitterProcess() throws Exception {
        JsonNode config = MAPPER.readTree("{\"tree_sitter\":{\"process\":{\"structure\":true,\"imports\":true,\"exports\":true,\"comments\":true,\"docstrings\":true,\"symbols\":true,\"diagnostics\":true,\"chunk_max_size\":2000}}}");
        E2EHelpers.skipIfFeatureUnavailable("tree-sitter");
        E2EHelpers.runFixture(
