...
// alef:hash:bc9ebffadf39a830e6a0808717b92cc671596e306d4063e7c7827a6f338ec292
...
assertEquals("image/png", result.mimeType().trim());assertEquals("PNG", java.util.Optional.ofNullable(result.metadata().format()).orElse("").trim());
    }
