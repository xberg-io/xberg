...
// alef:hash:28a5da3aa368afd19d88d574eb89bc1acf1f5490f310e38471d880c1c922b51d
...
assertEquals("image/png", result.mimeType().trim());assertEquals("PNG", FormatMetadataDisplay.toDisplayString(java.util.Optional.ofNullable(result.metadata().format()).orElse(null)).trim());
    }
