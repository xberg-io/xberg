...
// alef:hash:687912de78d236cf712e1e7e4e3c48a28562591f15806c14fc86c02daecf83af
...
class SmokeTest {
    ...
    void testSmokeXlsxBasic() throws Exception {
        ...
        assertTrue(result.metadata().format().excel().sheetNames().contains("Stanley Cups"), "expected to contain: " + "Stanley Cups");
    }
