...
async def test_url_batch_mixed_inputs() -> None:
    ...
    inputs_json = '[{"kind":"uri","uri":"$mock_url"},{"kind":"bytes","bytes":[66,97,116,99,104,32,98,121,116,101,115,32,99,111,110,116,101,110,116],"mime_type":"text/plain","filename":"inline.txt"}]'.replace(
