...
# alef:hash:13a60edb9e0b536023e3622151f20cba8dd5437b6a331c1031058da7979e2854
...
async def test_ocr_image_png() -> None:
    ...
    data = Path("images/test_hello_world.png").read_bytes()
    mime_type = "image/png"
    config = ExtractionConfig()

    result = await extract_bytes(data, mime_type, config)
