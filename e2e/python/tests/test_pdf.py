...
# alef:hash:6340a0d0edd7e53e0b23f4830041645502f7bb0c20f33a0defd99efe3826d272
...
def test_render_pdf_page_first() -> None:
    ...
    page_number = 0
    result = render_pdf_page_to_png(pdf_bytes=pdf_bytes, page_number=page_number)
...
def test_render_pdf_page_missing_file() -> None:
    ...
    with pytest.raises(Exception):  # noqa: B017
        render_pdf_page_to_png(pdf_bytes=pdf_bytes, page_number=page_number)
