...
async def test_format_docx_standalone() -> None:
    ...
    input_json = '{"kind":"uri","uri":"$mock_url/docx/fake.docx","mime_type":"application/vnd.openxmlformats-officedocument.wordprocessingml.document","filename":"fake.docx"}'.replace(
...
async def test_format_hwpx_standalone() -> None:
    ...
    input_json = '{"kind":"uri","uri":"$mock_url/hwpx/simple.hwpx","mime_type":"application/haansofthwpx","filename":"simple.hwpx"}'.replace(
        "$mock_url", input_mock_base_url
    )
    input = ExtractInput(**json.loads(input_json))
...
async def test_format_pdf_text() -> None:
    ...
    input_json = '{"kind":"uri","uri":"$mock_url/pdf/fake_memo.pdf","mime_type":"application/pdf","filename":"fake_memo.pdf"}'.replace(
        "$mock_url", input_mock_base_url
    )
    input = ExtractInput(**json.loads(input_json))
...
async def test_format_pptx() -> None:
    ...
    input_json = '{"kind":"uri","uri":"$mock_url/pptx/simple.pptx","mime_type":"application/vnd.openxmlformats-officedocument.presentationml.presentation"}'.replace(
        "$mock_url", input_mock_base_url
    )
    input = ExtractInput(**json.loads(input_json))
