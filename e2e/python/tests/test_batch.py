...
async def test_extract_batch_bytes_invalid_mime() -> None:
    ...
    inputs = [ExtractInput(kind="bytes", bytes=[72, 101, 108, 108, 111], mime_type="application/x-nonexistent")]
...
async def test_extract_batch_bytes_unsupported_mime() -> None:
    ...
    inputs = [ExtractInput(kind="bytes", bytes=[100, 97, 116, 97], mime_type="application/x-unknown")]
