...
# alef:hash:3c980738339ab01402ffc5500b150e24ed592600e969296a38d77871dbc854a3
...
def test_batch_bytes_invalid_mime() -> None:
    ...
    items = [
        {"content": [72, 101, 108, 108, 111], "mime_type": "application/x-nonexistent"}
    ]
    _ = batch_extract_bytes_sync(items)
...
async def test_batch_extract_bytes_happy() -> None:
    ...
    result = await batch_extract_bytes(items)
...
async def test_batch_extract_bytes_mixed_format() -> None:
    ...
    _ = await batch_extract_bytes(items)
...
def test_batch_extract_bytes_sync_empty_list() -> None:
    ...
    items = []
    result = batch_extract_bytes_sync(items)
...
async def test_batch_file_async_basic() -> None:
    ...
    _ = await batch_extract_files(paths)
...
def test_batch_file_not_found() -> None:
    ...
    _ = batch_extract_files_sync(paths)
