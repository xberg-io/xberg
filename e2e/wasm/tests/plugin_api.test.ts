...
describe("plugin_api", () => {
	...
	it("register_document_extractor_trait_bridge: register_document_extractor: trait bridge", async () => {
		// /* test_backend unimplemented for wasm */
		await extract(null);
	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
	...
	it("unregister_document_extractor_after_register: unregister_document_extractor", async () => {
		await extract((() => { const _u0 = new ExtractInput(); _u0.name = "test-extractor"; return _u0; })(), undefined);
	}, 30000);
