...
func Test_OcrImagePng(t *testing.T) {
	...
	result, err := xberg.ExtractBytes(contentBytes, `image/png`, xberg.ExtractionConfig{})
	if err != nil {
...
func Test_SmokeDocxBasic(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`docx/fake.docx`, &mime_typeVal, xberg.ExtractionConfig{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_SmokeHtmlBasic(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`html/simple_table.html`, &mime_typeVal, xberg.ExtractionConfig{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_SmokeImagePng(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`images/sample.png`, nil, config)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(string(result.MimeType)) != `image/png` {
...
func Test_SmokeJsonBasic(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`json/simple.json`, &mime_typeVal, xberg.ExtractionConfig{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_SmokePdfBasic(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`pdf/fake_memo.pdf`, &mime_typeVal, xberg.ExtractionConfig{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_SmokeTxtBasic(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`text/report.txt`, &mime_typeVal, xberg.ExtractionConfig{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_SmokeXlsxBasic(t *testing.T) {
	...
	result, err := xberg.ExtractFile(`xlsx/stanley_cups.xlsx`, &mime_typeVal, xberg.ExtractionConfig{})
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
