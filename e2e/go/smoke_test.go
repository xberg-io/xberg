...
// alef:hash:76bcd41c4a2275b09c63abc127989a51a969a7b98f86e5e0266a33b58dda90bb
...
func Test_OcrImagePng(t *testing.T) {
	...
	dataBytes, dataBytesErr := os.ReadFile(`images/test_hello_world.png`)
	if dataBytesErr != nil {
		t.Fatalf("read fixture images/test_hello_world.png: %v", dataBytesErr)
	}
	result, err := kreuzberg.ExtractBytes(dataBytes, `image/png`, kreuzberg.ExtractionConfig{})
	if err != nil {
