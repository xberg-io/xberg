...
// alef:hash:9bf430f3764285cb789790cabe94581e93f3413dd54b63a8eea543d99fe824bb
...
func Test_SmokeXlsxBasic(t *testing.T) {
	...
	if result.Metadata.Format != nil {
		if !strings.Contains(fmt.Sprint(result.Metadata.Format.Excel.SheetNames), `Stanley Cups`) {
			t.Errorf("expected to contain %s", `Stanley Cups`)
		}
	}
}
