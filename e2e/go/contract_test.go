...
// alef:hash:f48be9443ce74e6aaa4c90193aae23b3e546ec152fd0f03ba59953f1e93b3e65
...
func Test_ConfigChunkingPrependHeadingContext(t *testing.T) {
	...
	stream, err := kreuzberg.ExtractFileSync(`markdown/extraction_test.md`, nil, config)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	var chunks []kreuzberg.ChatCompletionChunk
	...
	assert.True(t, result.ChunksHaveHeadingContext, "expected true")
	assert.True(t, result.FirstChunkStartsWithHeading, "expected true")
}
