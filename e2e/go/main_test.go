...
// alef:hash:4b3bbe7eb9eaee2f7ff28518a6554ab7a3d2dbe6302c306ff64cb5b785c057e1
...
func TestMain(m *testing.M) {
	...
	if _, ok := os.LookupEnv("RUST_MIN_STACK"); !ok {
		_ = os.Setenv("RUST_MIN_STACK", "16777216")
	}
	...
	mockBin := os.Getenv("ALEF_E2E_MOCK_SERVER")
	if mockBin == "" {
	...
	if v := os.Getenv("RUST_MIN_STACK"); v != "" {
		cmdEnv = append(cmdEnv, "RUST_MIN_STACK="+v)
	}
