...
// alef:hash:b69a1410f5e789a20c667458c5ecd87e68fe3981c7f1905cafdd098df24e7975
...
func Test_BatchExtractBytesSizeCap(t *testing.T) {
	...
	var items []BatchBytesItem
	if err := json.Unmarshal([]byte(`[{"content":[97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97],"mime_type":"text/plain"}]`), &items); err != nil {
		t.Fatalf("config parse failed: %v", err)
	}
	var config kreuzberg.ExtractionConfig
	if err := json.Unmarshal([]byte(`{"security_limits":{"max_content_size":1}}`), &config); err != nil {
		t.Fatalf("config parse failed: %v", err)
	}
	_, err := kreuzberg.BatchExtractBytes(items, config)
	if err == nil {
