...
final class SmokeTest extends TestCase
{
    ...
    public function test_ocr_image_png(): void
    {
        ...
        $result = Xberg::extractBytes($contentBytes, "image/png", $config);
    ...
    {
        $config = \Xberg\ExtractionConfig::from_json('{}');
        $result = Xberg::extractFile("docx/fake.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", $config);
    ...
    {
        $config = \Xberg\ExtractionConfig::from_json('{}');
        $result = Xberg::extractFile("html/simple_table.html", "text/html", $config);
    ...
    public function test_smoke_image_png(): void
    {
        ...
        $result = Xberg::extractFile("images/sample.png", null, $config);
    ...
    {
        $config = \Xberg\ExtractionConfig::from_json('{}');
        $result = Xberg::extractFile("json/simple.json", "application/json", $config);
    ...
    {
        $config = \Xberg\ExtractionConfig::from_json('{}');
        $result = Xberg::extractFile("pdf/fake_memo.pdf", "application/pdf", $config);
    ...
    {
        $config = \Xberg\ExtractionConfig::from_json('{}');
        $result = Xberg::extractFile("text/report.txt", "text/plain", $config);
    ...
    {
        $config = \Xberg\ExtractionConfig::from_json('{}');
        $result = Xberg::extractFile("xlsx/stanley_cups.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", $config);
