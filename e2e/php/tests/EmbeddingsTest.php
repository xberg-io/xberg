...
// alef:hash:b87679fba2580f189c64ef7898c977e0224898fe4a941d647d4a8d4277814c2d
...
final class EmbeddingsTest extends TestCase
{
    ...
    public function test_embed_texts_different_preset(): void
    {
        ...
        $config = ExtractionConfig::from_json(json_encode(["model" => "multilingual"]));
        $result = Kreuzberg::embedTexts($texts, $config);
