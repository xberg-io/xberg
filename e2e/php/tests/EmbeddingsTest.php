...
// alef:hash:55dd5426a253254708406264ba6542db74368d48ea14ab705676a6e153728dbe
...
final class EmbeddingsTest extends TestCase
{
    ...
    {
        $result = Kreuzberg\Kreuzberg::(["texts" => []]);
    ...
    {
        $result = Kreuzberg\Kreuzberg::(["texts" => ["First", "Second"]]);
    ...
    public function test_embed_texts_async_preset_switch(): void
    {
        ...
        $result = Kreuzberg\Kreuzberg::(["config" => ["embedding_model" => "default"], "texts" => ["Text"]]);
    }
