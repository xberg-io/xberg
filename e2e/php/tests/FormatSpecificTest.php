...
// alef:hash:3527d7f8087ebe484c7b55a8c5af7e4b6ce3afd1f61a0d6b7eff56299d694e43
...
final class FormatSpecificTest extends TestCase
{
    ...
    {
        $result = Kreuzberg::extractBytesSync(file_get_contents("docx/fake.docx"), "application/vnd.openxmlformats-officedocument.wordprocessingml.document", ExtractionConfig::from_json('{}'));
    ...
    {
        $result = Kreuzberg::extractBytesSync(file_get_contents("pdf/fake_memo.pdf"), "application/pdf", ExtractionConfig::from_json('{}'));
