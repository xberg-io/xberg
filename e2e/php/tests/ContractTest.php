...
// alef:hash:03bd61556858c7c31eecc03435533e67c1faf76a2ee7fa2fb6e1f73f72c30f34
...
final class ContractTest extends TestCase
{
    ...
    {
        $result = Kreuzberg\Kreuzberg::extract_bytes_sync("pdf/fake_memo.pdf", "application/pdf", ["output_format" => "markdown"]);
        $this->assertEquals("application/pdf", trim($result->mime_type));
        $this->assertGreaterThanOrEqual(10, strlen($result->content));
        $this->assertEquals("markdown", trim($result->metadata->output_format));
    }
