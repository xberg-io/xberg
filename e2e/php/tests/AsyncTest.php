...
// alef:hash:f504541b40d748ee11a59e952040845173b14b0deecf956c0735ed99aba5ef56
...
final class AsyncTest extends TestCase
{
    ...
    {        $contentBytes = file_get_contents("pdf/fake_memo.pdf");
        ...
        $result = Kreuzberg::extractBytes($contentBytes, "application/pdf", ExtractionConfig::from_json('{}'));
