...
// alef:hash:42781cc9072eed0a7d240aceffc4f4f384502456f01542b09e14f28cd6bd0510
...
final class DetectionTest extends TestCase
{
    ...
    {        $contentBytes = file_get_contents("html/html.html");
        if ($contentBytes === false) { $this->fail("failed to read fixture: html/html.html"); }        $this->expectNotToPerformAssertions();        $result = Kreuzberg::detectMimeTypeFromBytes($contentBytes);
    }
    ...
    {        $contentBytes = file_get_contents("pdf/fake_memo.pdf");
        if ($contentBytes === false) { $this->fail("failed to read fixture: pdf/fake_memo.pdf"); }        $this->expectNotToPerformAssertions();        $result = Kreuzberg::detectMimeTypeFromBytes($contentBytes);
    }
    ...
    {        $contentBytes = file_get_contents("images/test_hello_world.png");
        if ($contentBytes === false) { $this->fail("failed to read fixture: images/test_hello_world.png"); }        $this->expectNotToPerformAssertions();        $result = Kreuzberg::detectMimeTypeFromBytes($contentBytes);
    }
