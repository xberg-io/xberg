...
namespace Kreuzberg
{
    ...
    public class EmbedAsyncPendingTests
    {
        ...
        public async Task Test_EmbedTextsAsyncEmptyInput()
        {
            ...
            var result = await KreuzbergLib.EmbedTextsAsync(new List<String>() {  }, new EmbeddingConfig { Model = JsonSerializer.Deserialize<EmbeddingModelType>("{\"name\":\"balanced\",\"type\":\"preset\"}", ConfigOptions)! });
    Assert.True(result.Count == 0);
        ...
        public async Task Test_EmbedTextsAsyncHappy()
        {
            ...
            var result = await KreuzbergLib.EmbedTextsAsync(new List<String>() { JsonSerializer.Deserialize<String>("\"First\"", ConfigOptions)!, JsonSerializer.Deserialize<String>("\"Second\"", ConfigOptions)! }, new EmbeddingConfig { Model = JsonSerializer.Deserialize<EmbeddingModelType>("{\"name\":\"balanced\",\"type\":\"preset\"}", ConfigOptions)! });
