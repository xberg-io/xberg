...
namespace Kreuzberg
{
    ...
    public class FormatSpecificTests
    {
        ...
        public void Test_FormatDocxStandalone()
        {
            ...
            var result = KreuzbergLib.ExtractBytesSync(System.IO.File.ReadAllBytes("docx/fake.docx"), "application/vnd.openxmlformats-officedocument.wordprocessingml.document", new ExtractionConfig());
    Assert.True(result.Content.Length >= 20, "expected length >= 20");
        ...
        public void Test_FormatHwpxStandalone()
        {
            ...
            var result = KreuzbergLib.ExtractBytesSync(System.IO.File.ReadAllBytes("hwpx/simple.hwpx"), "application/haansofthwpx", new ExtractionConfig());
    Assert.True(result.Content.Length >= 20, "expected length >= 20");
    Assert.Contains("hello from hwpx", result.Content.ToString().ToLower());
        ...
        public void Test_FormatPdfText()
        {
            ...
            var result = KreuzbergLib.ExtractBytesSync(System.IO.File.ReadAllBytes("pdf/fake_memo.pdf"), "application/pdf", new ExtractionConfig());
