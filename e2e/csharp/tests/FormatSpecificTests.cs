...
// alef:hash:3d584970c2279d2c168ef21301e4c969b73147c5760df44faebacd37899831aa
...
public class FormatSpecificTests
{
    ...
    public void Test_FormatPptx()
    {
        ...
        var result = KreuzbergLib.ExtractBytesSync(System.Array.Empty<byte>(), "application/vnd.openxmlformats-officedocument.presentationml.presentation", null);
    }
    ...
    public void Test_FormatXlsx()
    {
        ...
        var result = KreuzbergLib.ExtractBytesSync(System.Array.Empty<byte>(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", null);
    }
}
