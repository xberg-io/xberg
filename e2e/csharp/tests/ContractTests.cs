...
namespace Xberg
{
    ...
    public class ContractTests
    {
        ...
        public async Task Test_ApiBatchBytesAsync()
        {
            ...
            var result = await XbergConverter.ExtractFileAsync("pdf/fake_memo.pdf", null, new ExtractionConfig());
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("Mallori"), "expected to contain at least one of the specified values");
        ...
        public async Task Test_ApiBatchBytesWithConfigsAsync()
        {
            ...
            var result = await XbergConverter.ExtractFileAsync("pdf/fake_memo.pdf", null, new ExtractionConfig { OutputFormat = OutputFormat.Markdown });
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    ...
    Assert.True(result.Content.ToString().Contains("May 5, 2023") || result.Content.ToString().Contains("Mallori"), "expected to contain at least one of the specified values");
        ...
        public void Test_ConfigDocumentStructureWithHeadings()
        {
            ...
            var result = XbergConverter.ExtractFileSync("docx/fake.docx", null, ExtractionConfig.FromJson("{\"include_document_structure\":true}"));
    ...
    Assert.True(result.Document!.Nodes.Count >= 1, "expected at least 1 elements");
        ...
        public void Test_ConfigElementTypes()
        {
            ...
            var result = XbergConverter.ExtractFileSync("docx/unit_test_headers.docx", null, ExtractionConfig.FromJson("{\"result_format\":\"element_based\"}"));
    ...
    Assert.True(result.Elements.Count >= 1, "expected at least 1 elements");
        ...
        public void Test_ConfigExtractionTimeout()
        {
            ...
            var result = XbergConverter.ExtractFileSync("pdf/fake_memo.pdf", null, ExtractionConfig.FromJson("{\"extraction_timeout_secs\":300}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigKeywords()
        {
            ...
            var result = XbergConverter.ExtractFileSync("pdf/fake_memo.pdf", null, ExtractionConfig.FromJson("{\"keywords\":{\"algorithm\":\"yake\",\"max_keywords\":10}}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigPages()
        {
            ...
            var result = XbergConverter.ExtractFileSync("pdf/fake_memo.pdf", null, ExtractionConfig.FromJson("{\"pages\":{\"extract_pages\":true,\"insert_page_markers\":true}}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    Assert.True(result.Content.ToString().Contains("PAGE"), "expected to contain at least one of the specified values");
        ...
        public void Test_ConfigQualityEnabled()
        {
            ...
            var result = XbergConverter.ExtractFileSync("pdf/fake_memo.pdf", null, ExtractionConfig.FromJson("{\"enable_quality_processing\":true}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    ...
    Assert.True(result.QualityScore <= 1.0d, "expected <= 1.0d");
        ...
        public void Test_ConfigSecurityLimits()
        {
            ...
            var result = XbergConverter.ExtractFileSync("archives/documents.zip", null, ExtractionConfig.FromJson("{\"security_limits\":{\"max_archive_size\":104857600,\"max_compression_ratio\":50,\"max_files_in_archive\":100}}"));
    ...
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
        ...
        public void Test_ConfigTreeSitter()
        {
            ...
            var result = XbergConverter.ExtractFileSync("code/hello.py", null, ExtractionConfig.FromJson("{\"tree_sitter\":{\"groups\":[\"web\"],\"languages\":[\"python\",\"rust\"],\"process\":{\"comments\":false,\"diagnostics\":false,\"docstrings\":false,\"exports\":true,\"imports\":true,\"structure\":true,\"symbols\":false}}}"));
    ...
    Assert.True(result.Content.Length >= 5, "expected length >= 5");
        ...
        public void Test_OutputFormatBytesMarkdown()
        {
            ...
            var result = XbergConverter.ExtractBytesSync(System.IO.File.ReadAllBytes("pdf/fake_memo.pdf"), "application/pdf", new ExtractionConfig { OutputFormat = OutputFormat.Markdown });
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    Assert.Equal("markdown", result.Metadata.OutputFormat!.Trim());
        ...
        public void Test_OutputFormatMarkdown()
        {
            ...
            var result = XbergConverter.ExtractFileSync("pdf/fake_memo.pdf", null, ExtractionConfig.FromJson("{\"output_format\":\"markdown\"}"));
    Assert.Equal("application/pdf", result.MimeType!.Trim());
    Assert.True(result.Content.Length >= 10, "expected length >= 10");
    Assert.Equal("markdown", result.Metadata.OutputFormat!.Trim());
