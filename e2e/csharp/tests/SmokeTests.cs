...
// alef:hash:50f3a9fd3fa379df236b4e8cbe064db2bb3ed745761a173ffbea43b29c533fcd
...
public class SmokeTests
{
    ...
    public async Task Test_SmokeCacheNamespace()
    {
        ...
        var result = await KreuzbergLib.ExtractFile("text/report.txt", null, new ExtractionConfig { CacheNamespace = "test_tenant", CacheTtlSecs = 3600, UseCache = true });
    ...
    public async Task Test_SmokeTxtBasic()
    {
        ...
        var result = await KreuzbergLib.ExtractFile("text/report.txt", null, null);
        Assert.Equal("text/plain", result.MimeType.Trim());
        Assert.True(result.Content.Length >= 5, "expected length >= 5");
    }
