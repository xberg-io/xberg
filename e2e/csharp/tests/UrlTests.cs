...
namespace Xberg
{
    ...
    public class UrlTests
    {
        ...
        public async Task Test_UrlBatchMixedInputs()
        {
            ...
            var Inputs_Json = "[{\"kind\":\"uri\",\"uri\":\"$mock_url\"},{\"kind\":\"bytes\",\"bytes\":[66,97,116,99,104,32,98,121,116,101,115,32,99,111,110,116,101,110,116],\"mime_type\":\"text/plain\",\"filename\":\"inline.txt\"}]".Replace("$mock_url", Inputs_MockBaseUrl);
        ...
        public async Task Test_UrlCrawlLinkedPages()
        {
            ...
            var result = await XbergConverter.ExtractAsync(ExtractInput.FromJson(Input_Json), ExtractionConfig.FromJson("{\"url\":{\"mode\":\"crawl\",\"crawl\":{\"max_depth\":1,\"max_pages\":4,\"respect_robots_txt\":false}}}"));
        ...
        public async Task Test_UrlRecursiveDocumentUrls()
        {
            ...
            var Input_Json = "{\"kind\":\"uri\",\"uri\":\"$mock_url\"}".Replace("$mock_url", Input_MockBaseUrl);
            var result = await XbergConverter.ExtractAsync(ExtractInput.FromJson(Input_Json), ExtractionConfig.FromJson("{\"url\":{\"mode\":\"document\",\"crawl\":{\"follow_document_urls\":true,\"document_url_depth\":1,\"respect_robots_txt\":false}}}"));
            Assert.True(result.Results.Count >= 2, "expected at least 2 elements");
