...
// alef:hash:4bc61dcab0b84627c7e19c34eac386ada6bcefb44bf8984118aaacb5a21497dc
...
namespace Xberg
{
    ...
    public class UrlTests
    {
        ...
        [Fact]
        public async Task Test_UrlGzipEncodedDocument()
        {
            // extract: remote document served gzip-encoded
            var Input_MockBaseUrl = Environment.GetEnvironmentVariable("MOCK_SERVER_URL_GZIP_ENCODED_DOCUMENT") ?? Environment.GetEnvironmentVariable("MOCK_SERVER_URL") + "/fixtures/url_gzip_encoded_document";
            var Input_Json = "{\"kind\":\"uri\",\"uri\":\"$mock_url\"}".Replace("$mock_url", Input_MockBaseUrl);
