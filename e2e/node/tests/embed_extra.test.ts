...
// alef:hash:a5f67a23890be32970735b6c420c10cbb2a43851f72a3b8c38be5c7cba64b6a0
...
describe("embed_extra", () => {
	it("embed_texts_batch: Batch embed texts", () => {
		embedTexts(["Hello", "World"], { model: { name: "balanced", type: "preset" } } as JsExtractionConfig);
	}, 600000);
});
