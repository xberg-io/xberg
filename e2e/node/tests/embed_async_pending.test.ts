...
// alef:hash:e4c421e08958cefd77c88a11418bbea42852163f802415162e460c62c6af67fc
...
describe("embed_async_pending", () => {
	...
	it("embed_texts_async_preset_switch: embed_texts_async: preset override", async () => {
		await embedTextsAsync(["Text"], { model: { name: "balanced", type: "preset" } } as JsExtractionConfig);
	}, 600000);
});
