...
import { extract, listEmbeddingBackends, listOcrBackends, listPostProcessors, listRenderers, listValidators, ExtractInput, type ExtractionConfig } from "@xberg-io/xberg";
...
describe("registry", () => {
	...
	it("list_document_extractors: List document extractors", async () => {
		await extract(undefined, undefined);
	}, 30000);
