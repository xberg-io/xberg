...
import { extract, registerEmbeddingBackend, registerOcrBackend, registerPostProcessor, registerRenderer, registerRerankerBackend, registerValidator, unregisterEmbeddingBackend, unregisterPostProcessor, unregisterRenderer, unregisterRerankerBackend, unregisterValidator, unregisterDocumentExtractor, unregisterOcrBackend, ExtractInput, type ExtractionConfig } from "@xberg-io/xberg";
...
describe("plugin_api", () => {
	...
	it("register_document_extractor_trait_bridge: register_document_extractor: trait bridge", async () => {
		// /* test_backend unimplemented for node */
		await extract(null);
	}, 30000);
  ...
  async dispose(): Promise<void> { return undefined; }
	...
	it("unregister_document_extractor_after_register: unregister_document_extractor", async () => {
		await extract({ name: "test-extractor" } as ExtractInput, undefined);
	}, 30000);
