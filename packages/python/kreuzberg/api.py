...
# alef:hash:33f2a2b3e809d49aab80c9a4692922283fd52d6ca62898eb76d2afa239c71999
...
def _coerce_dict_ocr_config(value: dict) -> OcrConfig:
...
def _coerce_dict_extraction_config(value: dict) -> ExtractionConfig:
