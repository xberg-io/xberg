...
# alef:hash:f0bf2fe004e41ddef6a7e6fac54c04966bc9172b5ecc81c83dc81a3db212a9e7
...
class AccelerationConfig:
    ...
    device_id: int
    def __init__(self, provider: ExecutionProviderType = ..., device_id: int = ...) -> None: ...
    @staticmethod
...
class CrawlConfig:
    ...
    def __init__(
        ...
        crawl_strategy: CrawlStrategyKind = ...,
        content_filter: ContentFilterKind | None = None,
        ...
        document_content_encoding: DocumentContentEncoding | None = None,
...
class CsvConfig:
    ...
    def __init__(self, delimiter: str | None = None, comment_prefixes: list[str] = ...) -> None: ...
    @staticmethod
...
class DeepseekOcrBackendOptions:
    ...
    version: int | None
    dtype: CandleDeepseekOcrDtype | None
    def __init__(
        self,
        ...
        device: CandleDevicePreference | None = None,
        version: int | None = None,
        dtype: CandleDeepseekOcrDtype | None = None,
    ) -> None: ...
    @staticmethod
...
class DjotAttributeGroup:
    ...
    def __init__(self, identifier: str = ..., attributes: Attributes | None = None) -> None: ...
    @staticmethod
...
class DoctorCheck:
    ...
    status: ProbeStatus
    message: str
    def __init__(self, name: str, status: ProbeStatus, message: str) -> None: ...
    @staticmethod
...
class DocumentCounts:
    ...
    tables: int
    images: int
    def __init__(self, pages: int = ..., tables: int = ..., images: int = ...) -> None: ...
    @staticmethod
...
class DocumentRelationship:
    ...
    def __init__(self, source: int, target: int, kind: RelationshipKind) -> None: ...
    @staticmethod
...
class ExtractionConfig:
    ...
    disable_ocr: bool
    ocr_near_empty_fallback: bool | None
    ocr_scanned_page_quality_gate: bool | None
    ocr_embedded_images: bool | None
    ...
    def runs_ocr_on_embedded_images(self) -> bool: ...
    def wants_own_bytes_in_result(self) -> bool: ...
...
class FileExtractionConfig:
    ...
    def __init__(
        self,
        mime_detection_policy: MimeDetectionPolicy | None = None,
...
class FootnoteConfig:
    ...
    def __init__(self, parse_citations: bool = ...) -> None: ...
...
class GeoJsonExtractionConfig:
    ...
    def __init__(self, include_full_coordinates: bool = ...) -> None: ...
    @staticmethod
...
class GlmOcrBackendOptions:
    ...
    def __init__(
        self,
        task: GlmOcrTaskKind | None = None,
        device: CandleDevicePreference | None = None,
        layout_mode: GlmOcrLayoutMode | None = None,
...
class LayoutDetection:
    ...
    confidence: float
    bbox: BBox
    def __init__(self, class_name: LayoutClass, confidence: float, bbox: BBox) -> None: ...
    @staticmethod
...
class LayoutDetectionConfig:
    ...
    def __init__(
        ...
        apply_heuristics: bool = ...,
        table_model: TableModel = ...,
        formula_model: FormulaModel | None = None,
        table_overlap_preference: TableOverlapPreference = ...,
        acceleration: AccelerationConfig | None = None,
        enable_chart_understanding: bool = ...,
    ) -> None: ...
...
class OcrConfidence:
    ...
    recognition: float
    def __init__(self, detection: float | None = None, recognition: float = ...) -> None: ...
    @staticmethod
...
class PaddleOcrConfig:
    ...
    def __init__(
        ...
        model_tier: str = ...,
        model_version: str = ...,
        inference_backend: PaddleInferenceBackend | None = None,
    ) -> None: ...
...
class PaddleOcrVlBackendOptions:
    ...
    def __init__(
        self,
        task: PaddleOcrVlTaskKind | None = None,
        model_path: str | None = None,
        model_id: str | None = None,
        hf_revision: str | None = None,
        cache_dir: str | None = None,
...
class PdfMetadata:
    ...
    fabricated_text_pages: list[int] | None
    implausible_text_pages: list[int] | None
...
class SvgOptions:
    sanitize: bool
    render_dpi: float
    def __init__(self, sanitize: bool = ..., render_dpi: float = ...) -> None: ...
    @staticmethod
...
class TrocrBackendOptions:
    ...
    def __init__(
        self,
        variant: CandleTrocrVariant | None = None,
        device: CandleDevicePreference | None = None,
        cache_dir: str | None = None,
        hf_revision: str | None = None,
    ) -> None: ...
...
class CandleDeepseekOcrDtype:
    AUTO: CandleDeepseekOcrDtype = ...
    F32: CandleDeepseekOcrDtype = ...
    F16: CandleDeepseekOcrDtype = ...
    BF16: CandleDeepseekOcrDtype = ...
    def __init__(self, value: int | str) -> None: ...
    def __hash__(self) -> int: ...
...
class DiffLine:
    kind: str
    @staticmethod
    def from_context(value: str) -> DiffLine: ...
    @staticmethod
    def from_added(value: str) -> DiffLine: ...
    @staticmethod
    def from_removed(value: str) -> DiffLine: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class EntityCategory:
    @staticmethod
    def from_custom(value: str) -> EntityCategory: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class FormatMetadata:
    ...
    @staticmethod
    def from_pdf(value: options.PdfMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_docx(value: options.DocxMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_excel(value: options.ExcelMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_email(value: options.EmailMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_pptx(value: options.PptxMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_archive(value: options.ArchiveMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_image(value: options.ImageMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_xml(value: options.XmlMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_text(value: options.TextMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_html(value: options.HtmlMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_ocr(value: options.OcrMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_csv(value: options.CsvMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_bibtex(value: options.BibtexMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_citation(value: options.CitationMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_fiction_book(value: options.FictionBookMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_dbf(value: options.DbfMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_jats(value: options.JatsMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_epub(value: options.EpubMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_pst(value: options.PstMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_audio(value: options.AudioMetadata | dict[str, Any]) -> FormatMetadata: ...
    @staticmethod
    def from_code(value: options.CodeMetadata | dict[str, Any]) -> FormatMetadata: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class OutputFormat:
    @staticmethod
    def from_custom(value: str) -> OutputFormat: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class PiiCategory:
    @staticmethod
    def from_custom(value: str) -> PiiCategory: ...
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
