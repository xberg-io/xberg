...
class NerConfig:
    ...
    hf_tokenizer_file: str | None
    hf_architecture: GlinerArchitecture | None
    llm: LlmConfig | None
    model_dir: str | None
...
class RedactionConfig:
    ...
    preserve_terms: list[RedactionTerm]
    def __init__(
        self,
        ...
        preserve_terms: list[RedactionTerm] | None = None,
    ) -> None: ...
...
class CitationOutput:
    ...
    structured_output_flat: dict[str, Any]
    def __init__(
        self,
        structured_output: dict[str, Any],
        structured_output_flat: dict[str, Any],
...
class BuiltPrompt:
    system: str
    user_text: str | None
    def __init__(self, system: str, user_text: str | None = None) -> None: ...
...
class ChunkerConfig:
    ...
    def __init__(
        ...
        avg_tokens_per_image: int | None = None,
        chars_per_token: int | None = None,
    ) -> None: ...
    @staticmethod
    def default() -> ChunkerConfig: ...

class Batch:
    pages: list[PageImage]
    user_text: str | None
    def __init__(self, pages: list[PageImage], user_text: str | None = None) -> None: ...

class PageImage:
    page_number: int
    png_bytes: bytes
    def __init__(self, page_number: int, png_bytes: bytes) -> None: ...

class MergedOutput:
    merged: dict[str, Any]
    outcome: Outcome
    error_message: str | None
    per_batch_errors: list[str]
...
class CustomGlinerSource:
    ...
    model_file: str
    tokenizer_file: str
    architecture: GlinerArchitecture
    def __init__(
        self,
        repo: str,
        model_file: str,
        tokenizer_file: str,
        architecture: GlinerArchitecture | str,
    ) -> None: ...
...
class TextRedactionOutcome:
    ...
    def __init__(
        self,
        map: RehydrationMap | None = None,  # noqa: A002
        rejection_counts: RejectionCounts | None = None,
    ) -> None: ...
...
class SubjectMatch:
    ...
    original: str
    category: str | None
    def __init__(self, token: str, original: str, category: str | None = None) -> None: ...
...
class NoopCache:
    ...
    async def put(self, _key: str, _value: bytes, _ttl: int | None = None) -> None: ...
class NoopProgressSink:
    def emit(self, _event: ProgressEvent) -> None: ...
class DefaultModelProvider:
    async def ensure_model(self, model: ModelId) -> str: ...
    @staticmethod
    def default() -> DefaultModelProvider: ...
class ParsedDocument:
    def mime_type(self) -> str: ...
    def page_count(self) -> int: ...
    def source(self) -> bytes: ...
    @staticmethod
    def from_bytes(source: bytes) -> ParsedDocument: ...
class Engine:
    async def extract(
        self,
    ...
    @staticmethod
    def new_default() -> Engine: ...
class EngineBuilder:
    def build(self) -> Engine: ...
class CandleBackend:
    async def detect(self, text: str, categories: list[EntityCategory]) -> list[Entity]: ...
    @staticmethod
    def from_local(model_dir: str, lora_adapter_dir: str | None = None) -> CandleBackend: ...
    @staticmethod
    def from_bytes(
        safetensors: bytes,
        tokenizer_json: bytes,
        encoder_config_json: bytes,
    ) -> CandleBackend: ...
...
class IbanChecksumValidator:
    def label(self) -> str: ...
    def validate(self, entity: PatternMatch, _ctx: str) -> ValidationResult: ...
class LuhnValidator:
    def label(self) -> str: ...
    def validate(self, entity: PatternMatch, _ctx: str) -> ValidationResult: ...
...
class NerBackendKind:
    ONNX: NerBackendKind = ...
    LLM: NerBackendKind = ...
    CANDLE: NerBackendKind = ...
    def __init__(self, value: int | str) -> None: ...

class GlinerArchitecture:
    GLINER1: GlinerArchitecture = ...
    GLINER2: GlinerArchitecture = ...
    def __init__(self, value: int | str) -> None: ...
...
class CitationSource:
    LLM: CitationSource = ...
    EXTRACTED: CitationSource = ...
    FUSED: CitationSource = ...
    NONE: CitationSource = ...
    def __init__(self, value: int | str) -> None: ...

class Outcome:
    SUCCESS: Outcome = ...
    PARTIAL_SUCCESS: Outcome = ...
    SCHEMA_INVALID: Outcome = ...
    ERROR: Outcome = ...
    def __init__(self, value: int | str) -> None: ...
...
class ValidationResultAcceptVariant(TypedDict):
    type: Literal["Accept"]

class ValidationResultRejectVariant(TypedDict):
    type: Literal["Reject"]
    reason: str
...
class PdfError(RasterizeError): ...
class ImageError(RasterizeError): ...
class UnsupportedMimeError(RasterizeError): ...
...
def decrypt_map(blob: bytes, passphrase: str) -> RehydrationMap: ...
def find_subject(
    map: RehydrationMap,  # noqa: A002
    query: str,
) -> list[SubjectMatch]: ...
