...
# alef:hash:cb7213e73e0f486c17788890e5e1144594e605b13fa3fdd3a29d3fca117d0d9d
...
class OcrBackendCapabilities:
    ...
    @staticmethod
    def from_json(json_str: str) -> OcrBackendCapabilities: ...
...
class FormatMetadata:
    ...
    csv: CsvMetadata | None
    bibtex: BibtexMetadata | None
    citation: CitationMetadata | None
    fiction_book: FictionBookMetadata | None
    dbf: DbfMetadata | None
    jats: JatsMetadata | None
    epub: EpubMetadata | None
    pst: PstMetadata | None
    audio: AudioMetadata | None
    code: CodeMetadata | None
    def __init__(self, value: dict[str, Any] | str | None = None, **kwargs: Any) -> None: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
