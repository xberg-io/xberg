...
// alef:hash:40a2c21ca0fc67b99cf0bbef871bb3ff484aad0749a5444aeb9d03404b1bb71c
...
pub fn clear_embedding_backends() -> Result<()> {
    kreuzberg::clear_embedding_backends().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn clear_document_extractors() -> Result<()> {
    kreuzberg::clear_document_extractors().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
pub fn clear_renderers() -> Result<()> {
    kreuzberg::clear_renderers().map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
