...
impl ImageExtractionConfig {
    ...
    pub fn new(
        ...
        Self { extract_images: extract_images.unwrap_or(true), target_dpi: target_dpi.unwrap_or(300), max_image_dimension: max_image_dimension.unwrap_or(4096), inject_placeholders: inject_placeholders.unwrap_or(true), auto_adjust_dpi: auto_adjust_dpi.unwrap_or(true), min_dpi: min_dpi.unwrap_or(72), max_dpi: max_dpi.unwrap_or(600), max_images_per_page: max_images_per_page }
    }
...
pub fn extract_email_content(data: Vec<u8>, mime_type: String, fallback_codepage: Option<i32>) -> Result<EmailExtractionResult> {
    kreuzberg::extraction::email::extract_email_content(&data, &mime_type, fallback_codepage).map(Into::into).map_err(|e| e.to_string())
}
