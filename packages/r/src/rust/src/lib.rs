...
// alef:hash:64fd844040f11e714bd1a0df343efd38cc0fd865082a17b574a8532057ed2c69
...
pub fn extract_file_sync(path: String, mime_type: Option<String>, config: Option<ExtractionConfig>) -> Result<ExtractionResult> {
    let config_json = serde_json::to_string(&config).map_err(|e| e.to_string())?;
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json).map_err(|e| e.to_string())?;
    kreuzberg::extract_file_sync(path, mime_type.as_deref(), &config_core).map(|val| ExtractionResult::from(val)).map_err(|e| e.to_string())
}
...
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: ExtractionConfig) -> Result<ExtractionResult> {
    let config_json = serde_json::to_string(&config).map_err(|e| e.to_string())?;
    let config_core: kreuzberg::ExtractionConfig = serde_json::from_str(&config_json).map_err(|e| e.to_string())?;
    kreuzberg::extract_bytes_sync(&content, &mime_type, &config_core).map(|val| ExtractionResult::from(val)).map_err(|e| e.to_string())
}
...
pub fn extract_email_content(data: Vec<u8>, mime_type: String, fallback_codepage: Option<i32>) -> Result<EmailExtractionResult> {
    kreuzberg::extraction::email::extract_email_content(&data, &mime_type, fallback_codepage).map(|val| val.into()).map_err(|e| e.to_string())
}
...
pub fn chunk_text(text: String, config: ChunkingConfig, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult> {
    ...
    kreuzberg::chunking::chunk_text(&text, &config_core, page_boundaries_core.as_deref()).map(|val| ChunkingResult::from(val)).map_err(|e| e.to_string())
}
...
pub fn chunk_text_with_heading_source(
    ...
    kreuzberg::chunking::core::chunk_text_with_heading_source(&text, &config_core, page_boundaries_core.as_deref(), heading_source.as_deref()).map(|val| ChunkingResult::from(val)).map_err(|e| e.to_string())
}
...
pub fn chunk_texts_batch(texts: Vec<String>, config: ChunkingConfig) -> Result<Vec<ChunkingResult>> {
    ...
    let config_json = serde_json::to_string(&config).map_err(|e| e.to_string())?;
    let config_core: kreuzberg::ChunkingConfig = serde_json::from_str(&config_json).map_err(|e| e.to_string())?;
    kreuzberg::chunking::core::chunk_texts_batch(&texts_refs, &config_core).map(|val| val.into_iter().map(Into::into).collect()).map_err(|e| e.to_string())
}
...
pub fn chunk_semantic(text: String, config: ChunkingConfig, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult> {
    ...
    kreuzberg::chunking::semantic::chunk_semantic(&text, &config_core, page_boundaries_core.as_deref()).map(|val| ChunkingResult::from(val)).map_err(|e| e.to_string())
}
...
pub fn render_pdf_page_to_png(pdf_bytes: Vec<u8>, page_index: f64, dpi: Option<i32>, password: Option<String>) -> Result<Vec<u8>> {
    kreuzberg::pdf::rendering::render_pdf_page_to_png(&pdf_bytes, page_index, dpi, password.as_deref()).map(|val| val.into()).map_err(|e| e.to_string())
}
