...
pub fn new_layoutdetectionconfig(
    ...
    table_overlap_preference: Option<String>,
    ...
    if let Some(v) = table_overlap_preference {
        if let Ok(parsed) = serde_json::from_str(&format!("\"{v}\"")) {
            __out.table_overlap_preference = parsed;
        }
    }
...
#[extendr]
impl NoopCache {
    pub fn put(&self, _key: String, _value: Vec<u8>, _ttl: Option<u64>) -> () {
        let _ = (_key, _value, _ttl);
        compile_error!(
            "alef cannot auto-delegate `NoopCache.put`; configure an adapter body or exclude this item from the backend"
        )
    }
}
...
pub struct CitationOutput {
    ...
    pub structured_output_flat: String,
}
...
#[extendr]
pub fn new_chunkerconfig(
    max_input_tokens: Option<i32>,
    avg_tokens_per_image: Option<i32>,
    chars_per_token: Option<f64>,
) -> ChunkerConfig {
    let mut __out = <ChunkerConfig>::default();
    if let Some(v) = max_input_tokens {
        __out.max_input_tokens = v;
    }
    if let Some(v) = avg_tokens_per_image {
        __out.avg_tokens_per_image = v;
    }
    if let Some(v) = chars_per_token {
        __out.chars_per_token = v;
    }
    __out
}
...
impl ParsedDocument {
    ...
    pub fn from_bytes(source: Vec<u8>) -> Result<ParsedDocument> {
...
impl CandleBackend {
    #[allow(clippy::missing_errors_doc)]
    pub fn from_local(model_dir: String, lora_adapter_dir: Option<String>) -> Result<CandleBackend> {
...
#[extendr]
pub fn new_proxyconfig(url: Option<String>, username: Option<String>, password: Option<String>) -> ProxyConfig {
    let mut __out = <ProxyConfig>::default();
    if let Some(v) = url {
        __out.url = v;
    }
    if let Some(v) = username {
        __out.username = Some(v);
    }
    if let Some(v) = password {
        __out.password = Some(v);
    }
    __out
}
...
pub fn new_contentconfig(
    ...
    let mut __out = <ContentConfig>::default();
    if let Some(v) = output_format {
        __out.output_format = v;
    }
    if let Some(v) = preprocessing_preset {
        __out.preprocessing_preset = v;
    }
...
pub fn new_browserconfig(
    ...
    block_url_patterns: Option<Vec<String>>,
    eval_script: Option<String>,
    robots_user_agent: Option<String>,
    capture_network_events: Option<bool>,
    session_affinity: Option<bool>,
) -> BrowserConfig {
    let mut __out = <BrowserConfig>::default();
    if let Some(v) = mode {
        if let Ok(parsed) = serde_json::from_str(&format!("\"{v}\"")) {
            __out.mode = parsed;
        }
    ...
    if let Some(v) = wait_selector {
        __out.wait_selector = Some(v);
    }
    if let Some(v) = extra_wait {
        __out.extra_wait = Some(v);
    }
    if let Some(v) = block_url_patterns {
        __out.block_url_patterns = v;
    }
    if let Some(v) = eval_script {
        __out.eval_script = Some(v);
    }
    if let Some(v) = robots_user_agent {
        __out.robots_user_agent = Some(v);
    }
    if let Some(v) = capture_network_events {
        __out.capture_network_events = v;
    }
    if let Some(v) = session_affinity {
        __out.session_affinity = v;
    }
    __out
}
...
pub struct CrawlConfig {
    ...
    pub rate_limit_ms: Option<f64>,
    /// Maximum number of redirects to follow.
    pub max_redirects: f64,
    ...
    pub document_url_depth: Option<i32>,
    ...
    pub document_max_size: Option<f64>,
...
#[extendr]
pub fn new_ssrfpolicy(deny_private: Option<bool>, max_redirects: Option<i32>) -> SsrfPolicy {
    let mut __out = <SsrfPolicy>::default();
    if let Some(v) = deny_private {
        __out.deny_private = v;
    }
    if let Some(v) = max_redirects {
        __out.max_redirects = v;
    }
    __out
}
...
#[extendr]
#[derive(Clone, Debug, Default, serde::Serialize, serde::Deserialize)]
#[serde(from = "crawlberg::AuthConfig", into = "crawlberg::AuthConfig")]
...
impl From<crawlberg::AuthConfig> for AuthConfig {
    fn from(value: crawlberg::AuthConfig) -> Self {
        Self {
            __inner: serde_json::to_string(&value).unwrap_or_else(|_| "null".to_string()),
        }
    }
...
impl From<AuthConfig> for crawlberg::AuthConfig {
    fn from(value: AuthConfig) -> Self {
        if value.__inner.is_empty() {
            return <crawlberg::AuthConfig>::default();
        }
        serde_json::from_str(&value.__inner).unwrap_or_default()
    }
}
...
impl AuthConfig {
    ...
    pub fn default() -> AuthConfig {
        <crawlberg::AuthConfig>::default().into()
    }
    pub fn from_json(json: String) -> extendr_api::Result<AuthConfig> {
        let core: crawlberg::AuthConfig =
            serde_json::from_str(&json).map_err(|e| extendr_api::Error::Other(e.to_string()))?;
        Ok(core.into())
    }
    pub fn _factory_basic(username: String, password: String) -> AuthConfig {
        crawlberg::AuthConfig::Basic { username, password }.into()
    }
    pub fn _factory_bearer(token: String) -> AuthConfig {
        crawlberg::AuthConfig::Bearer { token }.into()
    }
    pub fn _factory_header(name: String, value: String) -> AuthConfig {
...
impl From<CitationOutput> for xberg::engine::structured::citations::CitationOutput {
    fn from(val: CitationOutput) -> Self {
        Self {
            structured_output: serde_json::from_str(&val.structured_output).unwrap_or_default(),
            structured_output_flat: serde_json::from_str(&val.structured_output_flat).unwrap_or_default(),
        }
    }
}
...
impl From<xberg::engine::structured::citations::CitationOutput> for CitationOutput {
    fn from(val: xberg::engine::structured::citations::CitationOutput) -> Self {
        Self {
            ...
            structured_output_flat: val.structured_output_flat.to_string(),
        }
    }
}
...
impl From<ChunkerConfig> for xberg::engine::structured::chunk::ChunkerConfig {
    fn from(val: ChunkerConfig) -> Self {
        Self {
            max_input_tokens: val.max_input_tokens as u32,
            avg_tokens_per_image: val.avg_tokens_per_image as u32,
...
impl From<xberg::engine::structured::chunk::ChunkerConfig> for ChunkerConfig {
    fn from(val: xberg::engine::structured::chunk::ChunkerConfig) -> Self {
        Self {
            max_input_tokens: val.max_input_tokens as i32,
            avg_tokens_per_image: val.avg_tokens_per_image as i32,
            chars_per_token: val.chars_per_token as f64,
        }
    }
}
...
impl From<MergedOutput> for xberg::engine::structured::schema::MergedOutput {
    fn from(val: MergedOutput) -> Self {
        Self {
            merged: serde_json::from_str(&val.merged).unwrap_or_default(),
...
impl From<crawlberg::BrowserConfig> for BrowserConfig {
    fn from(val: crawlberg::BrowserConfig) -> Self {
        Self {
            ...
            timeout: val.timeout.as_millis() as f64,
            wait: val.wait.into(),
            wait_selector: val.wait_selector.map(|v| v.to_string()),
            extra_wait: val.extra_wait.map(|d| d.as_millis() as f64),
            proxy: val.proxy.map(Into::into),
            block_url_patterns: val.block_url_patterns.into_iter().collect(),
...
impl From<CrawlConfig> for crawlberg::CrawlConfig {
    fn from(val: CrawlConfig) -> Self {
        Self {
            ...
            retry_codes: val.retry_codes.into_iter().map(|v| v as u16).collect(),
            ...
            document_url_depth: val.document_url_depth.map(|v| v as u32),
...
impl From<crawlberg::CrawlConfig> for CrawlConfig {
    fn from(val: crawlberg::CrawlConfig) -> Self {
        Self {
            max_depth: val.max_depth.map(|v| v as f64),
            max_pages: val.max_pages.map(|v| v as f64),
            max_concurrent: val.max_concurrent.map(|v| v as f64),
            respect_robots_txt: val.respect_robots_txt,
            soft_http_errors: val.soft_http_errors,
            ...
            custom_headers: val
                ...
                .map(|(k, v)| (k.into(), v.into()))
                .collect(),
            request_timeout: val.request_timeout.as_millis() as f64,
            rate_limit_ms: val.rate_limit_ms.map(|v| v as f64),
            max_redirects: val.max_redirects as f64,
            retry_count: val.retry_count as f64,
            retry_codes: val.retry_codes.iter().map(|&v| v as i32).collect(),
            cookies_enabled: val.cookies_enabled,
            auth: val.auth.map(Into::into),
            max_body_size: val.max_body_size.map(|v| v as f64),
            remove_tags: val.remove_tags.into_iter().collect(),
            content: val.content.into(),
            map_limit: val.map_limit.map(|v| v as f64),
            map_search: val.map_search.map(|v| v.to_string()),
            download_assets: val.download_assets,
            asset_types: val.asset_types.into_iter().map(Into::into).collect(),
            max_asset_size: val.max_asset_size.map(|v| v as f64),
            browser: val.browser.into(),
            proxy: val.proxy.map(Into::into),
            user_agents: val.user_agents.into_iter().collect(),
            capture_screenshot: val.capture_screenshot,
            follow_document_urls: val.follow_document_urls,
            document_url_depth: val.document_url_depth.map(|v| v as i32),
            download_documents: val.download_documents,
            document_max_size: val.document_max_size.map(|v| v as f64),
            document_mime_types: val.document_mime_types.into_iter().collect(),
...
impl From<SsrfPolicy> for crawlberg::SsrfPolicy {
    fn from(val: SsrfPolicy) -> Self {
        Self {
            ...
            max_redirects: val.max_redirects as u8,
            ..Default::default()
        }
    }
}
...
impl From<crawlberg::SsrfPolicy> for SsrfPolicy {
    fn from(val: crawlberg::SsrfPolicy) -> Self {
        Self {
            deny_private: val.deny_private,
            max_redirects: val.max_redirects as i32,
        }
    }
}
...
impl From<NerBackendKind> for xberg::NerBackendKind {
    fn from(val: NerBackendKind) -> Self {
        match val {
            ...
            NerBackendKind::Candle => Self::Candle,
        }
    }
}
...
impl From<xberg::engine::structured::citations::CitationSource> for CitationSource {
...
impl From<Outcome> for xberg::engine::structured::schema::Outcome {
    fn from(val: Outcome) -> Self {
        match val {
            Outcome::Success => Self::Success,
            Outcome::PartialSuccess => Self::PartialSuccess,
            Outcome::SchemaInvalid => Self::SchemaInvalid,
            Outcome::Error => Self::Error,
        }
    }
}

impl From<xberg::engine::structured::schema::Outcome> for Outcome {
...
pub fn fuse(
    merged: String,
    ocr_elements: Vec<String>,
    element_metadata: Vec<String>,
    emit_citations: bool,
    match_threshold: f64,
    fused_confidence: f64,
) -> CitationOutput {
    xberg::engine::structured::citations::fuse(
        serde_json::from_str(&merged).unwrap_or_default(),
        &ocr_elements,
        &element_metadata,
        emit_citations,
        match_threshold,
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn validate_and_merge(raw_responses: Vec<String>, schema: String, merge_mode: String) -> String {
    match (|| -> Result<String> {
        let merge_mode_core: xberg::MergeMode = serde_json::from_str(&merge_mode).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
        ...
        let result = xberg::engine::structured::schema::validate_and_merge(
            raw_responses,
...
pub fn custom_source_from_parts(
    ...
    match (|| -> Result<Option<String>> {
        let architecture_core: Option<xberg::GlinerArchitecture> = architecture
            .as_deref()
            .map(|s| {
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn dedupe_overlaps(matches: String) -> String {
    match (|| -> Result<String> {
        let matches_core: Vec<xberg::PatternMatch> = serde_json::from_str(&matches).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
        ...
        let result = xberg::text::redaction::dedupe_overlaps(matches_core);
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn encrypt_map(map: RehydrationMap, passphrase: String) -> Result<Vec<u8>> {
    xberg::text::redaction::encrypt_map(&map.inner, &passphrase).map_err(|e| {
        extendr_api::Error::Other(
            e.to_string()
                .replace(":", "_")
                .replace("/", "_")
...
#[allow(clippy::missing_errors_doc)]
#[extendr]
pub fn decrypt_map(blob: Vec<u8>, passphrase: String) -> Result<RehydrationMap> {
    xberg::text::redaction::decrypt_map(&blob, &passphrase)
        .map(|val| RehydrationMap { inner: Arc::new(val) })
        .map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
...
impl xberg::DocumentExtractor for RDocumentExtractorBridge {
    async fn extract(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let args = extendr_api::Pairlist::from_pairs(&[
                ("input", extendr_api::Robj::from(input)),
                (
                    "config",
                    extendr_api::Robj::from(ExtractionConfig::from(config_owned.clone())),
                ),
