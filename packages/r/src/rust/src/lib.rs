...
impl MetaSchema {
    ...
    pub fn parse_preset(&self, path: String, raw: Vec<u8>) -> Result<Preset> {
        let result = self.inner.parse_preset(&path, &raw).map_err(|e| e.to_string())?;
        Ok(result.into())
    }
...
impl Registry {
    pub fn get(&self, id: String) -> Option<Preset> {
        let _ = id;
        compile_error!(
            "alef cannot auto-delegate `Registry.get`; configure an adapter body or exclude this item from the backend"
        )
    }
...
pub enum NoChunkingReason {
    ...
    FewPages = 1,
    TextLayerDetected = 2,
    FormatNotChunkable = 3,
    ChunkingDisabled = 4,
    FastTextExtraction = 5,
}
...
impl From<kreuzberg::EnrichStatus> for EnrichStatus {
    fn from(val: kreuzberg::EnrichStatus) -> Self {
        match val {
            kreuzberg::EnrichStatus::Pending => Self {
                status: "pending".to_string(),
                ..Default::default()
            },
            kreuzberg::EnrichStatus::Completed { .. } => Self {
                status: "completed".to_string(),
                ..Default::default()
            },
            kreuzberg::EnrichStatus::Failed { .. } => Self {
...
impl From<SchemaCompliance> for kreuzberg::heuristics::SchemaCompliance {
...
impl From<kreuzberg::heuristics::SchemaCompliance> for SchemaCompliance {
    ...
    fn from(val: kreuzberg::ChunkingDecision) -> Self {
        match val {
            kreuzberg::ChunkingDecision::NoChunking { .. } => Self {
                format_type: "NoChunking".to_string(),
                ..Default::default()
            },
            kreuzberg::ChunkingDecision::Chunk(_0) => Self {
                format_type: "Chunk".to_string(),
                chunk: Some(_0.into()),
                ..Default::default()
            },
            kreuzberg::ChunkingDecision::UseOverrides { .. } => Self {
                format_type: "UseOverrides".to_string(),
                ..Default::default()
            },
            #[allow(unreachable_patterns)]
            _ => Self::default(),
...
impl From<NoChunkingReason> for kreuzberg::NoChunkingReason {
    fn from(val: NoChunkingReason) -> Self {
        match val {
            NoChunkingReason::SmallFile => Self::SmallFile {
                size_bytes: Default::default(),
                threshold_bytes: Default::default(),
            },
            NoChunkingReason::FewPages => Self::FewPages {
                page_count: Default::default(),
                threshold: Default::default(),
            },
            NoChunkingReason::TextLayerDetected => Self::TextLayerDetected {
                text_coverage: Default::default(),
                avg_chars_per_page: Default::default(),
            },
            NoChunkingReason::FormatNotChunkable => Self::FormatNotChunkable {
...
impl From<ChunkingReason> for kreuzberg::ChunkingReason {
    fn from(val: ChunkingReason) -> Self {
        match val {
            ChunkingReason::LargeFile => Self::LargeFile {
                size_bytes: Default::default(),
                threshold_bytes: Default::default(),
            },
            ChunkingReason::ManyPages => Self::ManyPages {
                page_count: Default::default(),
                threshold: Default::default(),
            },
            ChunkingReason::OcrRequired => Self::OcrRequired {
                page_count: Default::default(),
                force_ocr: Default::default(),
            },
            ChunkingReason::LargeAndManyPages => Self::LargeAndManyPages {
                size_bytes: Default::default(),
                page_count: Default::default(),
            },
            _ => Self::default(),
...
pub fn check_format_limits(
    ...
    let config_core: kreuzberg::HeuristicsConfig = config.into_option().expect("'config' is required").clone().into();
...
#[cfg(feature = "heuristics")]
    fn analyze_document;
#[cfg(feature = "heuristics")]
    fn analyze_with_user_chunks;
#[cfg(feature = "heuristics")]
    fn score_confidence;
#[cfg(feature = "heuristics")]
    fn check_format_limits;
#[cfg(feature = "heuristics")]
    fn boundaries_from_extraction_result;
#[cfg(feature = "heuristics")]
    fn detect_boundaries;
#[cfg(feature = "heuristics")]
    fn choose_call_mode;
#[cfg(feature = "heuristics")]
    fn calculate_chunk_plan;
#[cfg(feature = "heuristics")]
    fn calculate_plan_from_overrides;
#[cfg(feature = "presets")]
    fn fingerprint;
#[cfg(feature = "presets")]
    fn resolve;
