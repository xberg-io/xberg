...
impl EmbeddingModelType {
    ...
    pub fn _factory_llm(llm: LlmConfig) -> EmbeddingModelType {
        xberg::EmbeddingModelType::Llm { llm: llm.into() }.into()
    }
...
impl RerankerModelType {
    ...
    pub fn _factory_llm(llm: LlmConfig) -> RerankerModelType {
        xberg::RerankerModelType::Llm { llm: llm.into() }.into()
    }
...
impl NodeContent {
    ...
    pub fn _factory_table(grid: TableGrid) -> NodeContent {
        xberg::NodeContent::Table { grid: grid.into() }.into()
    }
...
pub fn extract_bytes(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        ...
        let result = rt.block_on(async {
            xberg::extract_bytes(&content, &mime_type, &config_core)
                .await
                .map_err(|e| {
                    extendr_api::Error::Other(
                        e.to_string()
...
pub fn extract_file(path: String, mime_type: Option<String>, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        ...
        let result = rt.block_on(async {
            xberg::extract_file(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core)
                .await
                .map_err(|e| {
                    extendr_api::Error::Other(
                        e.to_string()
...
pub fn extract_file_sync(path: String, mime_type: Option<String>, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        let config_core: xberg::ExtractionConfig = (*config).clone().into();
        let result = xberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core)
            .map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
                        .replace(":", "_")
...
pub fn extract_bytes_sync(content: Vec<u8>, mime_type: String, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        let config_core: xberg::ExtractionConfig = (*config).clone().into();
        let result = xberg::extract_bytes_sync(&content, &mime_type, &config_core).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
pub fn batch_extract_files_sync(items: String, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        let items_core: Vec<xberg::BatchFileItem> = serde_json::from_str(&items).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
        ...
        let config_core: xberg::ExtractionConfig = (*config).clone().into();
        let result = xberg::batch_extract_files_sync(items_core, &config_core).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
pub fn batch_extract_bytes_sync(items: String, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        let items_core: Vec<xberg::BatchBytesItem> = serde_json::from_str(&items).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
        ...
        let config_core: xberg::ExtractionConfig = (*config).clone().into();
        let result = xberg::batch_extract_bytes_sync(items_core, &config_core).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
pub fn batch_extract_files(items: String, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        ...
        let result = rt.block_on(async {
            xberg::batch_extract_files(items_core, &config_core).await.map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
                        .replace(":", "_")
                        .replace("/", "_")
...
pub fn batch_extract_bytes(items: String, config: &ExtractionConfig) -> String {
    match (|| -> Result<String> {
        ...
        let result = rt.block_on(async {
            xberg::batch_extract_bytes(items_core, &config_core).await.map_err(|e| {
                extendr_api::Error::Other(
                    e.to_string()
                        .replace(":", "_")
                        .replace("/", "_")
