...
// alef:hash:1e011702d2714891f4e4141817a55505935f785d24b993c7d9576006abaee34b
...
impl HwpxExtractor {
    ...
    pub fn initialize(&self) -> Result<()> {
        Err(extendr_api::Error::Other(
            "Not implemented: HwpxExtractor.initialize".to_string(),
        ))
    }
    ...
    pub fn shutdown(&self) -> Result<()> {
        Err(extendr_api::Error::Other(
            "Not implemented: HwpxExtractor.shutdown".to_string(),
        ))
    }
...
impl kreuzberg::plugins::Plugin for ROcrBackendBridge {
    ...
    fn initialize(&self) -> std::result::Result<(), kreuzberg::KreuzbergError> {
        ...
        match result {
            Err(_) if true => Err(kreuzberg::KreuzbergError::Plugin {
    ...
    async fn process_image(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let fn_robj = match maybe_fn {
                ...
                _ => {
                    return Err(kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' missing method 'process_image'", cached_name_inner),
                        plugin_name: cached_name_inner.clone(),
                    });
                }
            };
            ...
            // the R side.
            match result {
                Err(_) => Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'process_image' failed", cached_name_inner),
                    plugin_name: cached_name_inner.clone(),
                }),
                Ok(val) => {
    ...
    async fn process(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let fn_robj = match maybe_fn {
                ...
                _ => {
                    return Err(kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' missing method 'process'", cached_name_inner),
                        plugin_name: cached_name_inner.clone(),
                    });
                }
            };
            ...
            match result {
                Err(_) => Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'process' failed", cached_name_inner),
                    plugin_name: cached_name_inner.clone(),
                }),
                Ok(_) => Ok(()),
            }
    ...
    async fn validate(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let fn_robj = match maybe_fn {
                ...
                _ => {
                    return Err(kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' missing method 'validate'", cached_name_inner),
                        plugin_name: cached_name_inner.clone(),
                    });
                }
            };
            ...
            match result {
                Err(_) => Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'validate' failed", cached_name_inner),
                    plugin_name: cached_name_inner.clone(),
                }),
                Ok(_) => Ok(()),
            }
    ...
    async fn embed(&self, texts: Vec<String>) -> std::result::Result<Vec<Vec<f32>>, kreuzberg::KreuzbergError> {
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let fn_robj = match maybe_fn {
                ...
                _ => {
                    return Err(kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' missing method 'embed'", cached_name_inner),
                        plugin_name: cached_name_inner.clone(),
                    });
                }
            };
            ...
            match result {
                Err(_) => Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'embed' failed", cached_name_inner),
                    plugin_name: cached_name_inner.clone(),
                }),
                Ok(val) => {
                    let payload = val.as_str().unwrap_or("");
                    serde_json::from_str::<Vec<Vec<f32>>>(payload).map_err(|_| kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' method 'embed' deserialization failed", cached_name_inner),
                        plugin_name: cached_name_inner.clone(),
                    })
                }
            }
    ...
    async fn extract_bytes(
        ...
        tokio::task::spawn_blocking(move || {
            ...
            let fn_robj = match maybe_fn {
                ...
                _ => {
                    return Err(kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' missing method 'extract_bytes'", cached_name_inner),
                        plugin_name: cached_name_inner.clone(),
                    });
                }
            };
            ...
            match result {
                Err(_) => Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' method 'extract_bytes' failed", cached_name_inner),
                    plugin_name: cached_name_inner.clone(),
                }),
                Ok(val) => {
                    let payload = val.as_str().unwrap_or("");
...
impl kreuzberg::plugins::Renderer for RRendererBridge {
    fn render(
        ...
        let fn_robj = match maybe_fn {
            ...
            _ => {
                return Err(kreuzberg::KreuzbergError::Plugin {
                    message: format!("Plugin '{}' missing method 'render'", self.cached_name),
                    plugin_name: self.cached_name.clone(),
                });
            }
        };
        ...
        match result {
            Err(_) => Err(kreuzberg::KreuzbergError::Plugin {
                message: format!("Plugin '{}' method 'render' failed", self.cached_name),
                plugin_name: self.cached_name.clone(),
            }),
            Ok(val) => {
                if let Some(s) = val.as_str() {
                    ...
                    Err(kreuzberg::KreuzbergError::Plugin {
                        message: format!("Plugin '{}' method 'render' returned invalid type", self.cached_name),
                        plugin_name: self.cached_name.clone(),
                    })
                }
            }
