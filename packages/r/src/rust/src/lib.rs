...
// alef:hash:67b9e6c421202689c322aa984a3d51c4ee5c55941785bc9de6f47bb3aa5edac1
...
#[extendr]
pub fn calculate_quality_score(text: String, metadata: Option<HashMap<String, String>>) -> f64 {
    kreuzberg::text::quality::calculate_quality_score(&text, metadata.as_deref())
}
