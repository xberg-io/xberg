...
#' @param match_threshold Minimum text-similarity score (`0.0`–`1.0`) for an OCR element to be accepted as the source of a field value.
#' @param fused_confidence Confidence recorded on a successfully fused field.
#' @return - `structured_output`: Citation-wrapped envelope if `emit_citations=true`, else original `merged`
...
#' @export
fuse <- function(merged, ocr_elements, element_metadata, emit_citations, match_threshold, fused_confidence) .Call("wrap__fuse", merged, ocr_elements, element_metadata, emit_citations, match_threshold, fused_confidence, PACKAGE = "xberg")
...
#' @return MergedOutput object (list with class attribute).
#' @export
validate_and_merge <- function(raw_responses, schema, merge_mode) .Call("wrap__validate_and_merge", raw_responses, schema, merge_mode, PACKAGE = "xberg")
...
#' @param model_file Character string.
#' @param tokenizer_file Character string.
#' @param architecture GlinerArchitecture object (list with class attribute).
#' @return Optional CustomGlinerSource object (list with class attribute). Defaults to NULL.
#' @export
custom_source_from_parts <- function(repo = NULL, model_file = NULL, tokenizer_file = NULL, architecture = NULL) .Call("wrap__custom_source_from_parts", repo, model_file, tokenizer_file, architecture, PACKAGE = "xberg")
...
#' @param matches List of patternmatch object (list with class attribute).
#' @return List of patternmatch object (list with class attribute).
#' @export
dedupe_overlaps <- function(matches) .Call("wrap__dedupe_overlaps", matches, PACKAGE = "xberg")
#' Encrypt `map` with `passphrase`. Returns `XPII\x01` + salt(16) + nonce(12) + tag(16) + ciphertext
#' @param map RehydrationMap object (list with class attribute).
#' @param passphrase Character string.
#' @return Raw vector of bytes.
#' @export
encrypt_map <- function(map, passphrase) .Call("wrap__encrypt_map", map, passphrase, PACKAGE = "xberg")
#' Decrypt a blob from [`encrypt_map`]
#' @param blob Raw vector of bytes.
#' @param passphrase Character string.
#' @return RehydrationMap object (list with class attribute).
#' @export
decrypt_map <- function(blob, passphrase) .Call("wrap__decrypt_map", blob, passphrase, PACKAGE = "xberg")
...
#' @return List of subjectmatch object (list with class attribute).
#' @export
find_subject <- function(map, query) .Call("wrap__find_subject", map, query, PACKAGE = "xberg")
...
#' @return List of subjectmatch object (list with class attribute).
#' @export
forget_subject <- function(map, query) .Call("wrap__forget_subject", map, query, PACKAGE = "xberg")
...
#' @field table_overlap_preference How to resolve overlapping native vs layout tables.
...
#' @export
NoopCache <- new.env(parent = emptyenv())
NoopCache$put <- function(self, key, value, ttl) .Call("wrap__NoopCache__put", self, key, value, ttl, PACKAGE = "xberg")
#' @export
`$.NoopCache` <- function(self, name) {
  func <- NoopCache[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
...
`[[.NoopCache` <- `$.NoopCache`
#' @export
put.NoopCache <- function(x, ...) x$put(...)
...
#' @field stage Short, stable identifier for the current stage (e.g. `"download"`).
#' @field message Optional human-readable detail for this event.
#' @field fraction Optional completion fraction in `0.0..=1.0`, when known.
#' @export
ProgressEvent <- new.env(parent = emptyenv())
#' @export
`$.ProgressEvent` <- function(self, name) {
  func <- ProgressEvent[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
NoopProgressSink <- new.env(parent = emptyenv())
#' @export
`$.NoopProgressSink` <- function(self, name) {
  func <- NoopProgressSink[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
`[[.NoopProgressSink` <- `$.NoopProgressSink`
...
#' @field kind Canonical model-type key.
#' @export
ModelId <- new.env(parent = emptyenv())
#' @export
`$.ModelId` <- function(self, name) {
  func <- ModelId[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
...
#' @export
DefaultModelProvider <- new.env(parent = emptyenv())
DefaultModelProvider$default <- function() .Call("wrap__DefaultModelProvider__default", PACKAGE = "xberg")
#' @export
`$.DefaultModelProvider` <- function(self, name) {
  func <- DefaultModelProvider[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field page 1-based page number where the value appears, when known.
#' @field confidence Confidence in the citation, when known.
#' @field source Provenance of the value.
#' @export
CitedField <- new.env(parent = emptyenv())
#' @export
`$.CitedField` <- function(self, name) {
  func <- CitedField[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field structured_output Citation-wrapped envelope (or the original `merged` when citations are off).
#' @field structured_output_flat Values only (`CitedField.value` extracted recursively).
#' @export
CitationOutput <- new.env(parent = emptyenv())
#' @export
`$.CitationOutput` <- function(self, name) {
  func <- CitationOutput[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field system System instruction primer.
#' @field user_text User content (text + images context). None for VisionOnly / Skip modes.
#' @export
BuiltPrompt <- new.env(parent = emptyenv())
#' @export
`$.BuiltPrompt` <- function(self, name) {
  func <- BuiltPrompt[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field max_input_tokens Maximum input tokens per batch.
#' @field avg_tokens_per_image Estimated tokens contributed by each image.
#' @field chars_per_token Characters-per-token divisor used to estimate text/image byte token counts.
#' @export
ChunkerConfig <- new.env(parent = emptyenv())
ChunkerConfig$default <- function() .Call("wrap__ChunkerConfig__default", PACKAGE = "xberg")
ChunkerConfig$from_json <- function(json) {
  .Call("wrap__ChunkerConfig__from_json", json, PACKAGE = "xberg")
}
#' @export
`$.ChunkerConfig` <- function(self, name) {
  func <- ChunkerConfig[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field page_number 1-based page number (matches the citation envelope convention).
#' @field png_bytes PNG-encoded page bytes.
#' @export
PageImage <- new.env(parent = emptyenv())
#' @export
`$.PageImage` <- function(self, name) {
  func <- PageImage[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
...
#' @field merged The merged JSON value.
#' @field outcome Aggregate outcome across all batches.
#' @field error_message Top-level error message, when the whole operation failed.
#' @field per_batch_errors Per-batch validation/parse errors, surfaced by the orchestrator event payload.
#' @field confidence Confidence score computed after merging (when available from the orchestrator). Set by the
#' @export
MergedOutput <- new.env(parent = emptyenv())
#' @export
`$.MergedOutput` <- function(self, name) {
  func <- MergedOutput[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' can take `&self`.
#' @export
ParsedDocument <- new.env(parent = emptyenv())
ParsedDocument$from_bytes <- function(source) .Call("wrap__ParsedDocument__from_bytes", source, PACKAGE = "xberg")
ParsedDocument$mime_type <- function(self) .Call("wrap__ParsedDocument__mime_type", self, PACKAGE = "xberg")
ParsedDocument$page_count <- function(self) .Call("wrap__ParsedDocument__page_count", self, PACKAGE = "xberg")
ParsedDocument$source <- function(self) .Call("wrap__ParsedDocument__source", self, PACKAGE = "xberg")
#' @export
`$.ParsedDocument` <- function(self, name) {
  func <- ParsedDocument[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
mime_type.ParsedDocument <- function(x, ...) x$mime_type(...)
#' @export
page_count.ParsedDocument <- function(x, ...) x$page_count(...)
#' @export
source.ParsedDocument <- function(x, ...) x$source(...)
...
Engine$builder <- function() .Call("wrap__Engine__builder", PACKAGE = "xberg")
Engine$new_default <- function() .Call("wrap__Engine__new_default", PACKAGE = "xberg")
#' @export
`$.Engine` <- function(self, name) {
  func <- Engine[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
...
#' @export
EngineBuilder <- new.env(parent = emptyenv())
EngineBuilder$build <- function(self) .Call("wrap__EngineBuilder__build", self, PACKAGE = "xberg")
#' @export
`$.EngineBuilder` <- function(self, name) {
  func <- EngineBuilder[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
build.EngineBuilder <- function(x, ...) x$build(...)
...
#' @export
CandleBackend <- new.env(parent = emptyenv())
CandleBackend$from_local <- function(model_dir, lora_adapter_dir) .Call("wrap__CandleBackend__from_local", model_dir, lora_adapter_dir, PACKAGE = "xberg")
CandleBackend$from_bytes <- function(safetensors, tokenizer_json, encoder_config_json) .Call("wrap__CandleBackend__from_bytes", safetensors, tokenizer_json, encoder_config_json, PACKAGE = "xberg")
#' @export
`$.CandleBackend` <- function(self, name) {
  func <- CandleBackend[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field repo Hugging Face repo id, e.g. `"gliner-community/gliner_small-v2.5"`.
#' @field model_file Path to the ONNX model file within `repo`.
#' @field tokenizer_file Path to the tokenizer file within `repo`.
#' @field architecture Which GLiNER tensor I/O contract `model_file` uses.
#' @export
CustomGlinerSource <- new.env(parent = emptyenv())
#' @export
`$.CustomGlinerSource` <- function(self, name) {
  func <- CustomGlinerSource[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
`[[.CustomGlinerSource` <- `$.CustomGlinerSource`
...
#' @field map Token → original PII text, populated for `TokenReplace` strategy hits.
#' @field rejection_counts Post-detection validator rejection counts, keyed by reason.
#' @export
TextRedactionOutcome <- new.env(parent = emptyenv())
#' @export
`$.TextRedactionOutcome` <- function(self, name) {
  func <- TextRedactionOutcome[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
`[[.TextRedactionOutcome` <- `$.TextRedactionOutcome`
...
#' @export
RehydrationMap <- new.env(parent = emptyenv())
#' @export
`$.RehydrationMap` <- function(self, name) {
  func <- RehydrationMap[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field category Category parsed from the token's bracket contents (e.g. `"EMAIL"` from `"[EMAIL_1]"`), or `None` if
#' @export
SubjectMatch <- new.env(parent = emptyenv())
#' @export
`$.SubjectMatch` <- function(self, name) {
  func <- SubjectMatch[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
IbanChecksumValidator <- new.env(parent = emptyenv())
IbanChecksumValidator$label <- function(self) .Call("wrap__IbanChecksumValidator__label", self, PACKAGE = "xberg")
#' @export
`$.IbanChecksumValidator` <- function(self, name) {
  func <- IbanChecksumValidator[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
`[[.IbanChecksumValidator` <- `$.IbanChecksumValidator`
#' @export
label.IbanChecksumValidator <- function(x, ...) x$label(...)
#' Validates credit-card-shaped candidates against the Luhn mod-10 checksum
#' @export
LuhnValidator <- new.env(parent = emptyenv())
LuhnValidator$label <- function(self) .Call("wrap__LuhnValidator__label", self, PACKAGE = "xberg")
#' @export
`$.LuhnValidator` <- function(self, name) {
  func <- LuhnValidator[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @export
label.LuhnValidator <- function(x, ...) x$label(...)
#' Counter for rejections, keyed by validator reason string
#' @export
RejectionCounts <- new.env(parent = emptyenv())
#' @export
`$.RejectionCounts` <- function(self, name) {
  func <- RejectionCounts[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' `EntityValidator`).
#' @field reason Static reason identifier reported by the validator (e.g. `"iban_checksum_failed"`). Never contains the
#' @field count Number of candidates rejected for this reason.
#' @export
RejectionCount <- new.env(parent = emptyenv())
#' @export
`$.RejectionCount` <- function(self, name) {
  func <- RejectionCount[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' @field Accept Pass-through, no change.
#' @field Reject Drop the candidate. `reason` is a static identifier used as a [`RejectionCounts`] key (e.g.
#' @export
ValidationResult <- new.env(parent = emptyenv())
#' @export
`$.ValidationResult` <- function(self, name) {
  func <- ValidationResult[[name]]
  if (identical(names(formals(func))[1], "self")) {
    function(...) func(self, ...)
  } else {
    func
...
#' Create a TableOverlapPreference enum value
#'
#' Returns the default TableOverlapPreference variant.
#'
#' @return A TableOverlapPreference enum value
#' @export
TableOverlapPreference  <- function() list() |> structure(class = "TableOverlapPreference")
...
#' Create a GlinerArchitecture enum value
#'
#' Returns the default GlinerArchitecture variant.
#'
#' @return A GlinerArchitecture enum value
#' @export
GlinerArchitecture  <- function() list() |> structure(class = "GlinerArchitecture")
...
#' Create a CitationSource enum value
#'
#' Returns the default CitationSource variant.
#'
#' @return A CitationSource enum value
#' @export
CitationSource  <- function() list() |> structure(class = "CitationSource")
#' Create a Outcome enum value
#'
#' Returns the default Outcome variant.
#'
#' @return A Outcome enum value
#' @export
Outcome  <- function() list() |> structure(class = "Outcome")
