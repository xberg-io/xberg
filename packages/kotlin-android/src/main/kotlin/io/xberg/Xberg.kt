...
object Xberg {
    ...
    fun extractBytes(content: ByteArray, mimeType: String, config: ExtractionConfig): ExtractionResult {
        val resultJson = XbergBridge.nativeExtractBytes(java.util.Base64.getEncoder().encodeToString(content), mimeType, mapper.writeValueAsString(config))
    ...
    fun extractFile(path: String, mimeType: String? = null, config: ExtractionConfig): ExtractionResult {
        val resultJson = XbergBridge.nativeExtractFile(path, mimeType ?: "", mapper.writeValueAsString(config))
        return mapper.readValue(resultJson, ExtractionResult::class.java)
    }
    /**
     * Extract content from a file.
    ...
    fun extractFileSync(path: String, mimeType: String? = null, config: ExtractionConfig): ExtractionResult {
        val resultJson = XbergBridge.nativeExtractFileSync(path, mimeType ?: "", mapper.writeValueAsString(config))
        return mapper.readValue(resultJson, ExtractionResult::class.java)
    }
    /**
     * Synchronous wrapper for `extract_file`.
    ...
    fun extractBytesSync(content: ByteArray, mimeType: String, config: ExtractionConfig): ExtractionResult {
        val resultJson = XbergBridge.nativeExtractBytesSync(java.util.Base64.getEncoder().encodeToString(content), mimeType, mapper.writeValueAsString(config))
        return mapper.readValue(resultJson, ExtractionResult::class.java)
    }
    /**
     * Synchronous wrapper for `extract_bytes`.
    ...
    fun batchExtractFilesSync(items: List<BatchFileItem>, config: ExtractionConfig): List<ExtractionResult> {
        val resultJson = XbergBridge.nativeBatchExtractFilesSync(mapper.writeValueAsString(items), mapper.writeValueAsString(config))
    ...
    fun batchExtractBytesSync(items: List<BatchBytesItem>, config: ExtractionConfig): List<ExtractionResult> {
        val resultJson = XbergBridge.nativeBatchExtractBytesSync(mapper.writeValueAsString(items), mapper.writeValueAsString(config))
        return mapper.readValue(resultJson, object : TypeReference<List<ExtractionResult>>() {})
    }
    /**
     * Synchronous wrapper for `batch_extract_bytes`.
    ...
    fun batchExtractFiles(items: List<BatchFileItem>, config: ExtractionConfig): List<ExtractionResult> {
        val resultJson = XbergBridge.nativeBatchExtractFiles(mapper.writeValueAsString(items), mapper.writeValueAsString(config))
        return mapper.readValue(resultJson, object : TypeReference<List<ExtractionResult>>() {})
    }
    /**
     * Extract content from multiple files concurrently.
    ...
    fun batchExtractBytes(items: List<BatchBytesItem>, config: ExtractionConfig): List<ExtractionResult> {
        val resultJson = XbergBridge.nativeBatchExtractBytes(mapper.writeValueAsString(items), mapper.writeValueAsString(config))
        return mapper.readValue(resultJson, object : TypeReference<List<ExtractionResult>>() {})
    }
    /**
     * Extract content from multiple byte arrays concurrently.
