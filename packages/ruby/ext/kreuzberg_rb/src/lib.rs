...
fn extract_email_content(
    ...
    let result =
        kreuzberg::extraction::email::extract_email_content(&data, &mime_type, fallback_codepage).map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                e.to_string(),
            )
...
fn reduce_tokens(text: String, config: String, language_hint: Option<String>) -> Result<String, Error> {
    ...
    let result = kreuzberg::text::reduce_tokens(&text, &config_core, language_hint.as_deref()).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn batch_reduce_tokens(
    ...
    let result =
        kreuzberg::text::batch_reduce_tokens(&texts_refs, &config_core, language_hint.as_deref()).map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                e.to_string(),
            )
...
fn chunk_text(
    ...
    let config_core: kreuzberg::ChunkingConfig = serde_json::from_str(&config).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
    ...
    let result =
        kreuzberg::chunking::chunk_text(&text, &config_core, page_boundaries_core.as_deref()).map_err(|e| {
            magnus::Error::new(
                unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
                e.to_string(),
            )
...
fn chunk_texts_batch(texts: Vec<String>, config: String) -> Result<Vec<ChunkingResult>, Error> {
    ...
    let result = kreuzberg::chunking::core::chunk_texts_batch(&texts_refs, &config_core).map_err(|e| {
        magnus::Error::new(
            unsafe { Ruby::get_unchecked() }.exception_runtime_error(),
            e.to_string(),
        )
...
fn init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_singleton_method("new", function!(ImageExtractionConfig::new, 8))?;
    ...
    class.define_singleton_method("new", function!(ExtractedImage::new, 13))?;
    ...
    module.define_module_function("batch_reduce_tokens", function!(batch_reduce_tokens, 3))?;
    ...
    module.define_module_function("chunk_semantic", function!(chunk_semantic, 3))?;
