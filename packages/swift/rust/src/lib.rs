...
pub struct BatchBytesItem(pub xberg::BatchBytesItem);
impl BatchBytesItem {
...
pub struct BatchFileItem(pub xberg::BatchFileItem);
impl BatchFileItem {
...
pub fn extract_bytes(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::extract_bytes(&content, &mime_type, &config.0)
            .await
            .map_err(|e| e.to_string())
...
pub fn extract_file(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::extract_file(std::path::PathBuf::from(path), mime_type.as_deref(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(ExtractionResult)
    })
...
pub fn extract_file_sync(
    ...
    xberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config.0)
        .map_err(|e| e.to_string())
        .map(ExtractionResult)
}
...
pub fn extract_bytes_sync(
    ...
    xberg::extract_bytes_sync(&content, &mime_type, &config.0)
        .map_err(|e| e.to_string())
        .map(ExtractionResult)
}
...
pub fn batch_extract_files_sync(
    ...
    xberg::batch_extract_files_sync(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
        .map_err(|e| e.to_string())
...
pub fn batch_extract_bytes_sync(
    ...
    xberg::batch_extract_bytes_sync(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
        .map_err(|e| e.to_string())
        .map(|v| v.into_iter().map(ExtractionResult).collect::<Vec<_>>())
}
...
pub fn batch_extract_files(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::batch_extract_files(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(|v| v.into_iter().map(ExtractionResult).collect::<Vec<_>>())
    })
...
pub fn batch_extract_bytes(
    ...
    crate::__alef_tokio_runtime().block_on(async {
        xberg::batch_extract_bytes(items.into_iter().map(|w| w.0).collect::<Vec<_>>(), &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(|v| v.into_iter().map(ExtractionResult).collect::<Vec<_>>())
    })
