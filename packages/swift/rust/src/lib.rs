...
mod ffi {
    ...
    extern "Rust" {
        ...
        fn new(
            ...
            hf_architecture: Option<GlinerArchitecture>,
            llm: Option<LlmConfig>,
            model_dir: Option<String>,
            lora_adapter_dir: Option<String>,
            custom_labels: Vec<String>,
        ) -> NerConfig;
        fn backend(&self) -> String;
        fn categories(&self) -> Vec<String>;
        fn model(&self) -> Option<String>;
        #[swift_bridge(swift_name = "hfRepo")]
        fn hf_repo(&self) -> Option<String>;
        #[swift_bridge(swift_name = "hfModelFile")]
        fn hf_model_file(&self) -> Option<String>;
        #[swift_bridge(swift_name = "hfTokenizerFile")]
        fn hf_tokenizer_file(&self) -> Option<String>;
        #[swift_bridge(swift_name = "hfArchitecture")]
        fn hf_architecture(&self) -> Option<String>;
        fn llm(&self) -> Option<LlmConfig>;
        #[swift_bridge(swift_name = "modelDir")]
        fn model_dir(&self) -> Option<String>;
        #[swift_bridge(swift_name = "loraAdapterDir")]
        fn lora_adapter_dir(&self) -> Option<String>;
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "noopCacheGet")]
        fn noop_cache_get(client: &NoopCache, key: String) -> String;
        #[swift_bridge(swift_name = "noopCachePut")]
        fn noop_cache_put(client: &NoopCache, key: String, value: Vec<u8>, ttl: Option<u64>) -> ();
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "noopProgressSinkEmit")]
        fn noop_progress_sink_emit(client: &NoopProgressSink, event: ProgressEvent) -> ();
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "defaultModelProviderEnsureModel")]
        fn default_model_provider_ensure_model(client: &DefaultModelProvider, model: ModelId)
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "structuredOutputFlat")]
        fn structured_output_flat(&self) -> String;
    }

    extern "Rust" {
        type BuiltPrompt;
        fn system(&self) -> String;
        #[swift_bridge(swift_name = "userText")]
    ...
    extern "Rust" {
        type ChunkerConfig;
        #[swift_bridge(init)]
        fn new(max_input_tokens: u32, avg_tokens_per_image: u32, chars_per_token: usize) -> ChunkerConfig;
        #[swift_bridge(swift_name = "maxInputTokens")]
        fn max_input_tokens(&self) -> u32;
        #[swift_bridge(swift_name = "avgTokensPerImage")]
        fn avg_tokens_per_image(&self) -> u32;
        #[swift_bridge(swift_name = "charsPerToken")]
    ...
    extern "Rust" {
        type PageImage;
        #[swift_bridge(init)]
        fn new(page_number: u32, png_bytes: Vec<u8>) -> PageImage;
        #[swift_bridge(swift_name = "pageNumber")]
        fn page_number(&self) -> u32;
        #[swift_bridge(swift_name = "pngBytes")]
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "errorMessage")]
        fn error_message(&self) -> Option<String>;
        fn confidence(&self) -> Option<ExtractionConfidence>;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "parsedDocumentMimeType")]
        fn parsed_document_mime_type(client: &ParsedDocument) -> String;
        #[swift_bridge(swift_name = "parsedDocumentPageCount")]
        fn parsed_document_page_count(client: &ParsedDocument) -> u32;
        #[swift_bridge(swift_name = "parsedDocumentSource")]
        fn parsed_document_source(client: &ParsedDocument) -> Vec<u8>;
    }
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "engineExtract")]
        fn engine_extract(
            client: &Engine,
            input: ExtractInput,
            config: ExtractionConfig,
        ) -> Result<ExtractionResult, String>;
        #[swift_bridge(swift_name = "engineExtractBatch")]
        fn engine_extract_batch(
            client: &Engine,
    ...
    extern "Rust" {
        #[swift_bridge(swift_name = "candleBackendDetect")]
        fn candle_backend_detect(
            client: &CandleBackend,
            text: String,
    ...
    extern "Rust" {
        type CustomGlinerSource;
        fn repo(&self) -> String;
        #[swift_bridge(swift_name = "modelFile")]
        fn model_file(&self) -> String;
        #[swift_bridge(swift_name = "tokenizerFile")]
        fn tokenizer_file(&self) -> String;
    ...
    extern "Rust" {
        ...
        fn page_ranges(&self) -> Option<Vec<PageRange>>;
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "validateAndMerge")]
        fn validate_and_merge(raw_responses: Vec<String>, schema: String, merge_mode: String) -> MergedOutput;
        ...
        #[swift_bridge(swift_name = "customSourceFromParts")]
        fn custom_source_from_parts(
            repo: Option<String>,
            model_file: Option<String>,
            tokenizer_file: Option<String>,
            architecture: Option<String>,
        ) -> Result<Option<CustomGlinerSource>, String>;
        #[swift_bridge(swift_name = "dedupeOverlaps")]
        fn dedupe_overlaps(matches: Vec<PatternMatch>) -> Vec<PatternMatch>;
        #[swift_bridge(swift_name = "encryptMap")]
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "citedFieldFromJson")]
        fn cited_field_from_json(json: String) -> Result<CitedField, String>;
    ...
    extern "Rust" {
        ...
        #[swift_bridge(swift_name = "glinerArchitectureFromJson")]
        fn gliner_architecture_from_json(json: String) -> Result<GlinerArchitecture, String>;
        ...
        #[swift_bridge(swift_name = "citationSourceFromJson")]
        fn citation_source_from_json(json: String) -> Result<CitationSource, String>;
        #[swift_bridge(swift_name = "outcomeFromJson")]
        fn outcome_from_json(json: String) -> Result<Outcome, String>;
    ...
    extern "Rust" {
        ...
        fn __alef_phantom_vec_noop_cache() -> Vec<NoopCache>;
        fn __alef_phantom_vec_progress_event() -> Vec<ProgressEvent>;
        fn __alef_phantom_vec_noop_progress_sink() -> Vec<NoopProgressSink>;
        fn __alef_phantom_vec_model_id() -> Vec<ModelId>;
        fn __alef_phantom_vec_default_model_provider() -> Vec<DefaultModelProvider>;
        fn __alef_phantom_vec_cited_field() -> Vec<CitedField>;
        fn __alef_phantom_vec_citation_output() -> Vec<CitationOutput>;
        fn __alef_phantom_vec_built_prompt() -> Vec<BuiltPrompt>;
        fn __alef_phantom_vec_chunker_config() -> Vec<ChunkerConfig>;
        fn __alef_phantom_vec_batch() -> Vec<Batch>;
        fn __alef_phantom_vec_page_image() -> Vec<PageImage>;
        fn __alef_phantom_vec_merged_output() -> Vec<MergedOutput>;
        fn __alef_phantom_vec_parsed_document() -> Vec<ParsedDocument>;
        fn __alef_phantom_vec_engine() -> Vec<Engine>;
        fn __alef_phantom_vec_engine_builder() -> Vec<EngineBuilder>;
        ...
        fn __alef_phantom_vec_candle_backend() -> Vec<CandleBackend>;
        ...
        fn __alef_phantom_vec_gliner_architecture() -> Vec<GlinerArchitecture>;
        ...
        fn __alef_phantom_vec_citation_source() -> Vec<CitationSource>;
        fn __alef_phantom_vec_outcome() -> Vec<Outcome>;
    ...
    extern "Rust" {
        ...
        //
        // These declarations are paired with phantom_impl functions below the bridge module.
        fn __alef_phantom_vec_text_redaction_outcome() -> Vec<TextRedactionOutcome>;
    }
...
#[doc(hidden)]
pub fn __alef_phantom_vec_noop_cache() -> Vec<NoopCache> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_progress_event() -> Vec<ProgressEvent> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_noop_progress_sink() -> Vec<NoopProgressSink> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_model_id() -> Vec<ModelId> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_default_model_provider() -> Vec<DefaultModelProvider> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_cited_field() -> Vec<CitedField> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_citation_output() -> Vec<CitationOutput> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_built_prompt() -> Vec<BuiltPrompt> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_chunker_config() -> Vec<ChunkerConfig> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_batch() -> Vec<Batch> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_page_image() -> Vec<PageImage> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_merged_output() -> Vec<MergedOutput> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_parsed_document() -> Vec<ParsedDocument> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_engine() -> Vec<Engine> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_engine_builder() -> Vec<EngineBuilder> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_candle_backend() -> Vec<CandleBackend> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_gliner_architecture() -> Vec<GlinerArchitecture> {
    Vec::new()
}
#[doc(hidden)]
...
#[doc(hidden)]
pub fn __alef_phantom_vec_citation_source() -> Vec<CitationSource> {
    Vec::new()
}
#[doc(hidden)]
pub fn __alef_phantom_vec_outcome() -> Vec<Outcome> {
    Vec::new()
}
#[doc(hidden)]
...
impl NerConfig {
    pub fn new(
        ...
        if let Some(s) = hf_repo {
            ...
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.hf_repo = Some(t);
            }
        }
        if let Some(s) = hf_model_file {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
            // valid JSON tokens (e.g. `tts-1`).
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.hf_model_file = Some(t);
            }
        }
        if let Some(s) = hf_tokenizer_file {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
            // valid JSON tokens (e.g. `tts-1`).
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.hf_tokenizer_file = Some(t);
            }
        }
        // alef: hf_architecture (GlinerArchitecture) is an enum; reverse From not generated — left at default
        if let Some(w) = llm {
            __target.llm = Some(w.0);
        }
        if let Some(s) = model_dir {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
            // valid JSON tokens (e.g. `tts-1`).
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.model_dir = Some(t);
            }
        }
        if let Some(s) = lora_adapter_dir {
            // Try JSON parse first (handles enum/object values); on parse failure
            // treat the raw input as a JSON string scalar so plain `String` /
            // string-like enum fields don't end up empty for inputs that aren't
            // valid JSON tokens (e.g. `tts-1`).
            let __v = ::serde_json::from_str::<::serde_json::Value>(&s).unwrap_or(::serde_json::Value::String(s));
            if let Ok(t) = ::serde_json::from_value(__v) {
                __target.lora_adapter_dir = Some(t);
            }
        }
...
pub struct NoopCache(pub xberg::engine::seams::NoopCache);

#[allow(unused_imports)]
use xberg::engine::seams::cache::CacheBackend;

pub fn noop_cache_get(client: &NoopCache, key: String) -> String {
    crate::__alef_tokio_runtime()
        .block_on(async { serde_json::to_string(&(client.0.get(&key).await)).expect("serializable return") })
}
pub fn noop_cache_put(client: &NoopCache, key: String, value: Vec<u8>, ttl: Option<u64>) {
    crate::__alef_tokio_runtime().block_on(async { client.0.put(&key, value, ttl).await })
}

pub struct ProgressEvent(pub xberg::engine::seams::ProgressEvent);
impl ProgressEvent {
    pub fn stage(&self) -> String {
        format!("{:?}", &self.0.stage)
    }
    pub fn message(&self) -> Option<String> {
        self.0.message.as_ref().map(|v| format!("{v:?}"))
    }
    pub fn fraction(&self) -> Option<f64> {
        self.0.fraction.clone()
    }
}

pub struct NoopProgressSink(pub xberg::engine::seams::NoopProgressSink);

#[allow(unused_imports)]
use xberg::engine::seams::progress::ProgressSink;

pub fn noop_progress_sink_emit(client: &NoopProgressSink, event: ProgressEvent) {
    client.0.emit(event.0)
}

pub struct ModelId(pub xberg::engine::seams::ModelId);
impl ModelId {
    pub fn kind(&self) -> String {
        format!("{:?}", &self.0.kind)
    }
...
pub struct DefaultModelProvider(pub xberg::engine::seams::DefaultModelProvider);

#[allow(unused_imports)]
use xberg::engine::seams::model_provider::ModelProvider;

pub fn default_model_provider_ensure_model(client: &DefaultModelProvider, model: ModelId) -> Result<String, String> {
    crate::__alef_tokio_runtime().block_on(async {
        client
            .0
            .ensure_model(&model.0)
            .await
...
pub struct CitedField(pub xberg::engine::structured::citations::CitedField);
impl CitedField {
    pub fn value(&self) -> String {
        serde_json::to_string(&self.0.value).unwrap_or_default()
    }
    ...
    pub fn source(&self) -> String {
        CitationSource::from(self.0.source.clone()).to_string()
    }
}

pub struct CitationOutput(pub xberg::engine::structured::citations::CitationOutput);
impl CitationOutput {
    pub fn structured_output(&self) -> String {
        format!("{:?}", &self.0.structured_output)
    }
    pub fn structured_output_flat(&self) -> String {
        format!("{:?}", &self.0.structured_output_flat)
    }
}

pub struct BuiltPrompt(pub xberg::engine::structured::prompts::BuiltPrompt);
impl BuiltPrompt {
    pub fn system(&self) -> String {
        format!("{:?}", &self.0.system)
    }
    pub fn user_text(&self) -> Option<String> {
        self.0.user_text.as_ref().map(|v| format!("{v:?}"))
    }
}

pub struct ChunkerConfig(pub xberg::engine::structured::chunk::ChunkerConfig);
impl ChunkerConfig {
    pub fn new(max_input_tokens: u32, avg_tokens_per_image: u32, chars_per_token: usize) -> ChunkerConfig {
        ChunkerConfig(xberg::engine::structured::chunk::ChunkerConfig {
            max_input_tokens,
    ...
    pub fn max_input_tokens(&self) -> u32 {
        self.0.max_input_tokens.clone()
    }
    pub fn avg_tokens_per_image(&self) -> u32 {
        self.0.avg_tokens_per_image.clone()
    }
    pub fn chars_per_token(&self) -> usize {
        self.0.chars_per_token.clone()
    }
}

pub struct Batch(pub xberg::engine::structured::chunk::Batch);
impl Batch {
    // alef: skipped getter `pages` — type cannot be bridged through swift-bridge
    pub fn user_text(&self) -> Option<String> {
        self.0.user_text.as_ref().map(|v| format!("{v:?}"))
    }
}

pub struct PageImage(pub xberg::engine::structured::rasterize::PageImage);
impl PageImage {
    pub fn new(page_number: u32, png_bytes: Vec<u8>) -> PageImage {
        PageImage(xberg::engine::structured::rasterize::PageImage {
            page_number,
    ...
    pub fn png_bytes(&self) -> Vec<u8> {
        self.0.png_bytes.to_vec()
    }
}

pub struct MergedOutput(pub xberg::engine::structured::schema::MergedOutput);
impl MergedOutput {
    pub fn merged(&self) -> String {
        format!("{:?}", &self.0.merged)
    }
    pub fn outcome(&self) -> String {
        Outcome::from(self.0.outcome.clone()).to_string()
    }
    pub fn error_message(&self) -> Option<String> {
        self.0.error_message.as_ref().map(|v| format!("{v:?}"))
    }
    // alef: skipped getter `per_batch_errors` — type cannot be bridged through swift-bridge
    pub fn confidence(&self) -> Option<ExtractionConfidence> {
        self.0.confidence.clone().map(ExtractionConfidence)
    }
}

pub struct ParsedDocument(pub xberg::engine::parsed::ParsedDocument);

pub fn parsed_document_mime_type(client: &ParsedDocument) -> String {
    client.0.mime_type().to_string()
}
pub fn parsed_document_page_count(client: &ParsedDocument) -> u32 {
    client.0.page_count()
}
pub fn parsed_document_source(client: &ParsedDocument) -> Vec<u8> {
    client.0.source()
}

pub struct Engine(pub xberg::engine::Engine);

#[allow(unused_imports)]
use xberg::DocumentExtractor;

pub fn engine_extract(
    client: &Engine,
    input: ExtractInput,
    config: ExtractionConfig,
) -> Result<ExtractionResult, String> {
    crate::__alef_tokio_runtime().block_on(async {
        client
            .0
            .extract(input.0, &config.0)
            .await
            .map_err(|e| e.to_string())
            .map(ExtractionResult)
    })
}
pub fn engine_extract_batch(
    client: &Engine,
    inputs: Vec<ExtractInput>,
    config: ExtractionConfig,
) -> Result<ExtractionResult, String> {
...
pub struct CandleBackend(pub xberg::text::ner::candle::CandleBackend);

#[allow(unused_imports)]
use xberg::text::ner::NerBackend;

pub fn candle_backend_detect(
    client: &CandleBackend,
    text: String,
    categories: Vec<String>,
) -> Result<Vec<Entity>, String> {
...
pub struct CustomGlinerSource(pub xberg::text::ner::gline::CustomGlinerSource);
impl CustomGlinerSource {
    pub fn repo(&self) -> String {
        format!("{:?}", &self.0.repo)
    }
    pub fn model_file(&self) -> String {
        format!("{:?}", &self.0.model_file)
    }
    pub fn tokenizer_file(&self) -> String {
        format!("{:?}", &self.0.tokenizer_file)
    }
    pub fn architecture(&self) -> String {
        GlinerArchitecture::from(self.0.architecture.clone()).to_string()
    }
}
...
impl UserChunkConfig {
    ...
    pub fn page_ranges(&self) -> Option<Vec<PageRange>> {
        self.0
            .page_ranges
            .as_ref()
            .map(|v| v.iter().map(|elem| PageRange(elem.clone())).collect())
    }
...
impl MultidocInput {
    ...
    pub fn pages(&self) -> Vec<PageSignals> {
        self.0.pages.iter().map(|elem| PageSignals(elem.clone())).collect()
    }
}
...
impl GlinerArchitecture {
    pub fn to_string(&self) -> String {
        match self {
            Self::Gliner1 => "gliner1".to_string(),
            Self::Gliner2 => "gliner2".to_string(),
        }
    }
}
...
impl CitationSource {
    pub fn to_string(&self) -> String {
        match self {
            Self::Llm => "llm".to_string(),
            Self::Extracted => "extracted".to_string(),
            Self::Fused => "fused".to_string(),
...
pub fn fuse(
    ...
    CitationOutput(xberg::engine::structured::citations::fuse(
        merged,
        &ocr_elements,
        &element_metadata,
        emit_citations,
...
pub fn validate_and_merge(raw_responses: Vec<String>, schema: String, merge_mode: String) -> MergedOutput {
    MergedOutput(xberg::engine::structured::schema::validate_and_merge(
        raw_responses,
        &schema,
        <xberg::MergeMode as ::std::convert::From<String>>::from(merge_mode),
    ))
}
...
pub fn custom_source_from_parts(
    ...
    xberg::text::ner::gline::custom_source_from_parts(
        ...
        architecture.map(|s| <xberg::GlinerArchitecture as ::std::convert::From<String>>::from(s)),
    )
    .map_err(|e| e.to_string())
    .map(|v| v.map(CustomGlinerSource))
}

pub fn dedupe_overlaps(matches: Vec<PatternMatch>) -> Vec<PatternMatch> {
    (xberg::text::redaction::dedupe_overlaps(matches.into_iter().map(|w| w.0).collect::<Vec<_>>()))
        .into_iter()
        .map(PatternMatch)
        .collect::<Vec<_>>()
}

pub fn encrypt_map(map: RehydrationMap, passphrase: String) -> Result<Vec<u8>, String> {
    xberg::text::redaction::encrypt_map(&map.0, &passphrase).map_err(|e| e.to_string())
}

pub fn decrypt_map(blob: Vec<u8>, passphrase: String) -> Result<RehydrationMap, String> {
...
pub fn cited_field_from_json(json: String) -> Result<CitedField, String> {
    serde_json::from_str::<xberg::engine::structured::citations::CitedField>(&json)
        .map(CitedField)
        .map_err(|e| e.to_string())
}
...
pub fn gliner_architecture_from_json(json: String) -> Result<GlinerArchitecture, String> {
    serde_json::from_str::<xberg::GlinerArchitecture>(&json)
        .map(GlinerArchitecture::from)
        .map_err(|e| e.to_string())
}
...
pub fn citation_source_from_json(json: String) -> Result<CitationSource, String> {
    serde_json::from_str::<xberg::engine::structured::citations::CitationSource>(&json)
        .map(CitationSource::from)
        .map_err(|e| e.to_string())
}
pub fn outcome_from_json(json: String) -> Result<Outcome, String> {
    serde_json::from_str::<xberg::engine::structured::schema::Outcome>(&json)
        .map(Outcome::from)
        .map_err(|e| e.to_string())
}
