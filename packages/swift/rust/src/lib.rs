...
mod ffi {
    ...
    extern "Rust" {
        ...
        fn inline_content(&self) -> Vec<String>;
        fn language(&self) -> Option<String>;
    ...
    extern "Rust" {
        ...
        fn form_fields(&self) -> Vec<String>;
    ...
    extern "Rust" {
        ...
        fn contributor_roles(&self) -> Vec<String>;
    }
    ...
    extern "Rust" {
        ...
        fn content_diff(&self) -> Vec<String>;
        #[swift_bridge(swift_name = "tablesAdded")]
        fn tables_added(&self) -> Vec<String>;
        #[swift_bridge(swift_name = "tablesRemoved")]
        fn tables_removed(&self) -> Vec<String>;
        #[swift_bridge(swift_name = "tablesChanged")]
        fn tables_changed(&self) -> Vec<String>;
...
impl FormattedBlock {
    ...
    pub fn inline_content(&self) -> Vec<String> {
        self.0
            .inline_content
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
...
impl ExtractedDocument {
    ...
    pub fn processing_warnings(&self) -> Vec<String> {
        self.0
            .processing_warnings
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
    ...
    pub fn form_fields(&self) -> Vec<String> {
        self.0
            .form_fields
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
...
impl JatsMetadata {
    ...
    pub fn contributor_roles(&self) -> Vec<String> {
        self.0
            .contributor_roles
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
...
impl ExtractionDiff {
    ...
    pub fn content_diff(&self) -> Vec<String> {
        self.0
            .content_diff
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
    ...
    pub fn tables_added(&self) -> Vec<String> {
        self.0
            .tables_added
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
    ...
    pub fn tables_removed(&self) -> Vec<String> {
        self.0
            .tables_removed
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
    ...
    pub fn tables_changed(&self) -> Vec<String> {
        self.0
            .tables_changed
            .iter()
            .map(|elem| serde_json::to_string(elem).unwrap_or_else(|_| "null".to_string()))
