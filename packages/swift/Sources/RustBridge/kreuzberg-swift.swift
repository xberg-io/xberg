  ...
  public func result_format() -> ResultFormat? {
    {
      ...
      if val != nil { return ResultFormat(ptr: val!) } else { return nil }
    }()
  }
  ...
  public func output_format() -> OutputFormat? {
    {
      ...
      if val != nil { return OutputFormat(ptr: val!) } else { return nil }
    }()
  }
...
extension PdfConfig {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ extract_images: Bool, _ passwords: RustVec<GenericIntoRustString>?, _ extract_metadata: Bool,
    _ hierarchy: HierarchyConfig?, _ extract_annotations: Bool, _ top_margin_fraction: Float?,
    _ bottom_margin_fraction: Float?, _ allow_single_column_tables: Bool
  ) {
    self.init(
...
extension CharShape: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: CharShape) {
    __swift_bridge__$Vec_CharShape$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> CharShapeRef? {
...
extension HwpImage {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ name: GenericIntoRustString, _ data: RustVec<UInt8>
  ) {
    self.init(
      ptr: __swift_bridge__$HwpImage$new(
        {
          let rustString = name.intoRustString()
          rustString.isOwned = false
          return rustString.ptr
...
extension HwpImage: Vectorizable {
  ...
  public static func vecOfSelfPush(vecPtr: UnsafeMutableRawPointer, value: HwpImage) {
    __swift_bridge__$Vec_HwpImage$push(
      vecPtr,
      {
        value.isOwned = false
        return value.ptr
  ...
  public static func vecOfSelfGet(vecPtr: UnsafeMutableRawPointer, index: UInt) -> HwpImageRef? {
...
extension ExtractionResultRef {
  ...
  public func extraction_method() -> ExtractionMethod? {
    {
      let val = __swift_bridge__$ExtractionResult$extraction_method(ptr)
      if val != nil { return ExtractionMethod(ptr: val!) } else { return nil }
    }()
  }
...
extension ExtractedImageRef {
  ...
  public func image_kind() -> ImageKind? {
    {
      let val = __swift_bridge__$ExtractedImage$image_kind(ptr)
      if val != nil { return ImageKind(ptr: val!) } else { return nil }
    }()
  }
...
extension TableCell {
  public convenience init<GenericIntoRustString: IntoRustString>(
    _ content: GenericIntoRustString, _ row_span: UInt, _ col_span: UInt, _ is_header: Bool
  ) {
    self.init(
...
extension PdfMetadata {
  public convenience init<GenericIntoRustString: IntoRustString>(
    ...
    _ is_encrypted: Bool?, _ width: Int64?, _ height: Int64?, _ page_count: UInt?
  ) {
    self.init(
