...
typedef struct HwpxExtractor HwpxExtractor;
void __swift_bridge__$HwpxExtractor$_free(void* self);

void* __swift_bridge__$Vec_HwpxExtractor$new(void);
void __swift_bridge__$Vec_HwpxExtractor$drop(void* vec_ptr);
void __swift_bridge__$Vec_HwpxExtractor$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_HwpxExtractor$pop(void* vec_ptr);
void* __swift_bridge__$Vec_HwpxExtractor$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_HwpxExtractor$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_HwpxExtractor$len(void* vec_ptr);
void* __swift_bridge__$Vec_HwpxExtractor$as_ptr(void* vec_ptr);
...
void* __swift_bridge__$OcrConfig$new(bool enabled, void* backend, void* language, void* tesseract_config, void* output_format, void* paddle_ocr_config, void* element_config, void* quality_thresholds, void* pipeline, bool auto_rotate, void* vlm_config, void* vlm_prompt, void* acceleration, void* tessdata_bytes);
...
void* __swift_bridge__$hwpx_extractor_name(void* client);
void* __swift_bridge__$hwpx_extractor_version(void* client);
void* __swift_bridge__$hwpx_extractor_initialize(void* client);
void* __swift_bridge__$hwpx_extractor_shutdown(void* client);
void* __swift_bridge__$hwpx_extractor_description(void* client);
void* __swift_bridge__$hwpx_extractor_author(void* client);
void* __swift_bridge__$hwpx_extractor_supported_mime_types(void* client);
int32_t __swift_bridge__$hwpx_extractor_priority(void* client);
...
void* __swift_bridge__$tessdata_manager_cache_dir(void* client);
bool __swift_bridge__$tessdata_manager_is_language_cached(void* client, void* lang);
struct __swift_bridge__$ResultUIntAndString __swift_bridge__$tessdata_manager_ensure_all_languages(void* client);
...
void* __swift_bridge__$PoolError$to_string(void* self);
