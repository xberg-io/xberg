...
typedef struct LlmBackend LlmBackend;
void __swift_bridge__$LlmBackend$_free(void* self);

void* __swift_bridge__$Vec_LlmBackend$new(void);
void __swift_bridge__$Vec_LlmBackend$drop(void* vec_ptr);
void __swift_bridge__$Vec_LlmBackend$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_LlmBackend$pop(void* vec_ptr);
void* __swift_bridge__$Vec_LlmBackend$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_LlmBackend$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_LlmBackend$len(void* vec_ptr);
void* __swift_bridge__$Vec_LlmBackend$as_ptr(void* vec_ptr);
...
typedef struct RerankerPreset RerankerPreset;
void __swift_bridge__$RerankerPreset$_free(void* self);

void* __swift_bridge__$Vec_RerankerPreset$new(void);
void __swift_bridge__$Vec_RerankerPreset$drop(void* vec_ptr);
void __swift_bridge__$Vec_RerankerPreset$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_RerankerPreset$pop(void* vec_ptr);
void* __swift_bridge__$Vec_RerankerPreset$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_RerankerPreset$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_RerankerPreset$len(void* vec_ptr);
void* __swift_bridge__$Vec_RerankerPreset$as_ptr(void* vec_ptr);
...
struct __private__ResultPtrAndPtr __swift_bridge__$llm_backend_detect(void* client, void* text, void* categories);
struct __private__ResultPtrAndPtr __swift_bridge__$llm_backend_detect_with_custom(void* client, void* text, void* categories, void* custom_labels);
...
void* __swift_bridge__$ExtractionResult$revisions(void* self);
...
void* __swift_bridge__$ExtractionResult$entities(void* self);
void* __swift_bridge__$ExtractionResult$summary(void* self);
void* __swift_bridge__$ExtractionResult$translation(void* self);
void* __swift_bridge__$ExtractionResult$page_classifications(void* self);
void* __swift_bridge__$ExtractionResult$redaction_report(void* self);
...
void* __swift_bridge__$RerankerPreset$name(void* self);
void* __swift_bridge__$RerankerPreset$model_repo(void* self);
void* __swift_bridge__$RerankerPreset$model_file(void* self);
void* __swift_bridge__$RerankerPreset$additional_files(void* self);
uintptr_t __swift_bridge__$RerankerPreset$max_length(void* self);
void* __swift_bridge__$RerankerPreset$description(void* self);
...
void* __swift_bridge__$classify_pages(void* result, void* config);
struct __private__ResultPtrAndPtr __swift_bridge__$classify_text(void* text, void* config);
void* __swift_bridge__$default_model_name(void);
void* __swift_bridge__$known_models(void);
void* __swift_bridge__$redact(void* result, void* config);
void* __swift_bridge__$summarize(void* text, void* language, struct __private__OptionU32 max_tokens);
uint32_t __swift_bridge__$token_count(void* text);
void* __swift_bridge__$translate_result(void* result, void* config);
void* __swift_bridge__$compare(void* a, void* b, void* opts);
struct __private__ResultPtrAndPtr __swift_bridge__$extract_region_with_vlm(void* image_bytes, void* image_mime, void* region_kind, void* llm_config, void* custom_prompt);
...
struct __private__ResultPtrAndPtr __swift_bridge__$rerank(void* query, void* documents, void* config);
struct __private__ResultPtrAndPtr __swift_bridge__$rerank_async(void* query, void* documents, void* config);
void* __swift_bridge__$get_reranker_preset(void* name);
void* __swift_bridge__$list_reranker_presets(void);
...
struct __private__ResultPtrAndPtr __swift_bridge__$reranker_preset_from_json(void* json);
...
void* __swift_bridge__$__alef_phantom_vec_batch_bytes_item(void);
void* __swift_bridge__$__alef_phantom_vec_batch_file_item(void);
...
void* __swift_bridge__$__alef_phantom_vec_llm_backend(void);
...
void* __swift_bridge__$__alef_phantom_vec_embedding_preset(void);
void* __swift_bridge__$__alef_phantom_vec_reranked_document(void);
void* __swift_bridge__$__alef_phantom_vec_reranker_preset(void);
