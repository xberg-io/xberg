...
internal extension AccelerationConfig {
    init(_ rb: RustBridge.AccelerationConfigRef) throws {
        self.provider = try { let rawValue = rb.provider().toString(); guard let value = ExecutionProviderType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown ExecutionProviderType variant", source: rawValue) }; return value }()
...
internal extension LayoutDetectionConfig {
    init(_ rb: RustBridge.LayoutDetectionConfigRef) throws {
        ...
        self.tableModel = try { let rawValue = rb.tableModel().toString(); guard let value = TableModel(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown TableModel variant", source: rawValue) }; return value }()
        self.tableOverlapPreference = try { let rawValue = rb.tableOverlapPreference().toString(); guard let value = TableOverlapPreference(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown TableOverlapPreference variant", source: rawValue) }; return value }()
...
internal extension SummarizationConfig {
    init(_ rb: RustBridge.SummarizationConfigRef) throws {
        self.strategy = try { let rawValue = rb.strategy().toString(); guard let value = SummaryStrategy(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown SummaryStrategy variant", source: rawValue) }; return value }()
        self.maxTokens = rb.maxTokens()
...
internal extension TreeSitterProcessConfig {
    init(_ rb: RustBridge.TreeSitterProcessConfigRef) throws {
        ...
        self.contentMode = try { let rawValue = rb.contentMode().toString(); guard let value = CodeContentMode(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown CodeContentMode variant", source: rawValue) }; return value }()
    }
...
public typealias ProgressEvent = RustBridge.ProgressEvent
...
public typealias ModelId = RustBridge.ModelId

/// A single field with its citation envelope.
public typealias CitedField = RustBridge.CitedField

/// Both views of the fused output: citation-wrapped and flattened.
public typealias CitationOutput = RustBridge.CitationOutput

/// Built prompt components ready to send to the vision model.
public typealias BuiltPrompt = RustBridge.BuiltPrompt

/// A batch of pages ready for a single vision-LLM call.
public typealias Batch = RustBridge.Batch

/// A rendered page ready for inline-base64 transport to the vision model.
public typealias PageImage = RustBridge.PageImage

/// Merged structured output plus validation bookkeeping.
public typealias MergedOutput = RustBridge.MergedOutput
...
internal extension PdfAnnotation {
    init(_ rb: RustBridge.PdfAnnotationRef) throws {
        self.annotationType = try { let rawValue = rb.annotationType().toString(); guard let value = PdfAnnotationType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown PdfAnnotationType variant", source: rawValue) }; return value }()
        self.content = rb.content()?.toString()
...
internal extension DocumentRelationship {
    init(_ rb: RustBridge.DocumentRelationshipRef) throws {
        ...
        self.kind = try { let rawValue = rb.kind().toString(); guard let value = RelationshipKind(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown RelationshipKind variant", source: rawValue) }; return value }()
    }
...
internal extension Chunk {
    init(_ rb: RustBridge.ChunkRef) throws {
        self.content = rb.content().toString()
        self.chunkType = try { let rawValue = rb.chunkType().toString(); guard let value = ChunkType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown ChunkType variant", source: rawValue) }; return value }()
...
internal extension PdfFormField {
    init(_ rb: RustBridge.PdfFormFieldRef) throws {
        ...
        self.fieldType = try { let rawValue = rb.fieldType().toString(); guard let value = FormFieldType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown FormFieldType variant", source: rawValue) }; return value }()
        self.value = rb.value()?.toString()
...
internal extension LinkMetadata {
    init(_ rb: RustBridge.LinkMetadataRef) throws {
        ...
        self.text = rb.text().toString()
        self.title = rb.title()?.toString()
        self.linkType = try { let rawValue = rb.linkType().toString(); guard let value = LinkType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown LinkType variant", source: rawValue) }; return value }()
...
internal extension ImageMetadataType {
    init(_ rb: RustBridge.ImageMetadataTypeRef) throws {
        ...
        self.alt = rb.alt()?.toString()
        self.title = rb.title()?.toString()
        self.imageType = try { let rawValue = rb.imageType().toString(); guard let value = ImageType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown ImageType variant", source: rawValue) }; return value }()
    }
...
internal extension StructuredData {
    init(_ rb: RustBridge.StructuredDataRef) throws {
        self.dataType = try { let rawValue = rb.dataType().toString(); guard let value = StructuredDataType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown StructuredDataType variant", source: rawValue) }; return value }()
...
internal extension OcrElementConfig {
    init(_ rb: RustBridge.OcrElementConfigRef) throws {
        ...
        self.minLevel = try { let rawValue = rb.minLevel().toString(); guard let value = OcrElementLevel(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown OcrElementLevel variant", source: rawValue) }; return value }()
        self.minConfidence = rb.minConfidence()
...
internal extension PageStructure {
    init(_ rb: RustBridge.PageStructureRef) throws {
        ...
        self.unitType = try { let rawValue = rb.unitType().toString(); guard let value = PageUnitType(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown PageUnitType variant", source: rawValue) }; return value }()
...
internal extension RedactionFinding {
    init(_ rb: RustBridge.RedactionFindingRef) throws {
        ...
        self.end = rb.end()
        self.category = try JSONDecoder().decode(PiiCategory.self, from: ((rb.category().toString()).data(using: .utf8) ?? Data("null".utf8)))
        self.strategy = try { let rawValue = rb.strategy().toString(); guard let value = RedactionStrategy(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown RedactionStrategy variant", source: rawValue) }; return value }()
...
internal extension DocumentRevision {
    init(_ rb: RustBridge.DocumentRevisionRef) throws {
        ...
        self.kind = try { let rawValue = rb.kind().toString(); guard let value = RevisionKind(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown RevisionKind variant", source: rawValue) }; return value }()
...
internal extension ExtractedUri {
    init(_ rb: RustBridge.ExtractedUriRef) throws {
        ...
        self.label = rb.label()?.toString()
        self.page = rb.page()
        self.kind = try { let rawValue = rb.kind().toString(); guard let value = UriKind(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown UriKind variant", source: rawValue) }; return value }()
    }
...
internal extension ExtractionConfidence {
    init(_ rb: RustBridge.ExtractionConfidenceRef) throws {
        ...
        self.schemaCompliance = try { let rawValue = rb.schemaCompliance().toString(); guard let value = SchemaCompliance(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown SchemaCompliance variant", source: rawValue) }; return value }()
...
internal extension DocumentBoundary {
    init(_ rb: RustBridge.DocumentBoundaryRef) throws {
        ...
        self.confidence = rb.confidence()
        self.reason = try { let rawValue = rb.reason().toString(); guard let value = BoundaryReason(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown BoundaryReason variant", source: rawValue) }; return value }()
    }
...
internal extension PresetSummary {
    init(_ rb: RustBridge.PresetSummaryRef) throws {
        ...
        self.description = rb.description().toString()
        self.category = try { let rawValue = rb.category().toString(); guard let value = PresetCategory(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown PresetCategory variant", source: rawValue) }; return value }()
        self.tags = rb.tags().map { $0.as_str().toString() }
        self.preferredCallMode = try { let rawValue = rb.preferredCallMode().toString(); guard let value = CallMode(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown CallMode variant", source: rawValue) }; return value }()
...
internal extension LayoutDetection {
    init(_ rb: RustBridge.LayoutDetectionRef) throws {
        self.className = try { let rawValue = rb.className().toString(); guard let value = LayoutClass(rawValue: rawValue) else { throw RasterizeError.validation(message: "Unknown LayoutClass variant", source: rawValue) }; return value }()
        self.confidence = rb.confidence()
...
public enum GlinerArchitecture: String, Codable, Sendable, Hashable {
...
extension GlinerArchitecture {
    func intoRust() throws -> RustBridge.GlinerArchitecture {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "null"
        return try RustBridge.glinerArchitectureFromJson(json)
    }
}
...
public enum CitationSource: String, Codable, Sendable, Hashable {
...
extension CitationSource {
    func intoRust() throws -> RustBridge.CitationSource {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "null"
        return try RustBridge.citationSourceFromJson(json)
    }
}
...
extension Outcome {
    func intoRust() throws -> RustBridge.Outcome {
        let data = try JSONEncoder().encode(self)
        let json = String(data: data, encoding: .utf8) ?? "null"
        return try RustBridge.outcomeFromJson(json)
    }
}
...
public enum RasterizeError: Swift.Error {
    /// PDF parsing or page rendering failed.
    case pdf(message: String, field0: String)
    /// Image decoding or PNG re-encoding failed.
    case image(message: String, field0: String)
    /// The supplied MIME type is neither `application/pdf` nor `image/*`.
    case unsupportedMime(message: String, field0: String)
...
public func citedFieldFromJson(_ json: String) throws -> CitedField {
    return try RustBridge.citedFieldFromJson(json)
}
...
public func glinerArchitectureFromJson(_ json: String) throws -> GlinerArchitecture {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(GlinerArchitecture.self, from: data)
}
...
public func citationSourceFromJson(_ json: String) throws -> CitationSource {
    let data = json.data(using: .utf8) ?? Data()
    return try JSONDecoder().decode(CitationSource.self, from: data)
}
public func outcomeFromJson(_ json: String) throws -> Outcome {
    let data = json.data(using: .utf8) ?? Data()
...
public func fuse(merged: String, ocrElements: [String], elementMetadata: [String], emitCitations: Bool, matchThreshold: Double, fusedConfidence: Double) -> CitationOutput {
    return RustBridge.fuse(merged, ocrElements, elementMetadata, emitCitations, matchThreshold, fusedConfidence)
}
...
public func validateAndMerge(rawResponses: [String], schema: String, mergeMode: MergeMode) throws -> MergedOutput {
        let _rb_mergeMode = try mergeMode.intoRust()
    return RustBridge.validateAndMerge(rawResponses, schema, _rb_mergeMode)
}
...
public func customSourceFromParts(repo: String? = nil, modelFile: String? = nil, tokenizerFile: String? = nil, architecture: GlinerArchitecture? = nil) throws -> CustomGlinerSource? {
        let _rb_repo = repo.map { RustString($0) }
        let _rb_modelFile = modelFile.map { RustString($0) }
        let _rb_tokenizerFile = tokenizerFile.map { RustString($0) }
        let _rb_architecture = try architecture?.intoRust()
    return try RustBridge.customSourceFromParts(_rb_repo, _rb_modelFile, _rb_tokenizerFile, _rb_architecture)
}
...
public func dedupeOverlaps(matches: [PatternMatch]) throws -> [PatternMatch] {
        let _rb_matches: RustVec<RustString> = try ({ () throws -> RustVec<RustString> in let v = RustVec<RustString>(); for item in matches { let data = try JSONEncoder().encode(item); let json = String(data: data, encoding: .utf8) ?? "null"; v.push(value: RustString(json)) }; return v }())
    return try RustBridge.dedupeOverlaps(_rb_matches).map { ref in try PatternMatch(ref) }
}
/// Encrypt `map` with `passphrase`. Returns `XPII\x01` + salt(16) + nonce(12) + tag(16) + ciphertext.
public func encryptMap(map: RehydrationMap, passphrase: String) throws -> [UInt8] {
        let _rb_passphrase = RustString(passphrase)
    return try RustBridge.encryptMap(map, _rb_passphrase).map { $0 }
}
/// Decrypt a blob from [`encrypt_map`].
public func decryptMap(blob: [UInt8], passphrase: String) throws -> RehydrationMap {
        let _rb_blob: RustVec<UInt8> = { let v = RustVec<UInt8>(); for b in blob { v.push(value: b) }; return v }()
        let _rb_passphrase = RustString(passphrase)
...
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.NoopCache: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.ProgressEvent: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.NoopProgressSink: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.ModelId: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.DefaultModelProvider: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.CitedField: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.CitationOutput: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.BuiltPrompt: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.ChunkerConfig: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.Batch: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.PageImage: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.MergedOutput: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.ParsedDocument: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.Engine: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.EngineBuilder: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
...
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.CandleBackend: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.CustomGlinerSource: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
extension RustBridge.TextRedactionOutcome: @unchecked Sendable {}
// swift-bridge opaque type used across Task.detached boundaries — Rust type is Send + Sync.
