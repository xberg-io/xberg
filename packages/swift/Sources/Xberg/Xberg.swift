...
// alef:hash:b04fae4d0648c3625bbcd731102e6daa944458f792c5f0de6ba0fd3e88ced725
...
public struct ConcurrencyConfig: Codable, Sendable, Hashable {
    ...
    public init(maxThreads: UInt? = nil) {
...
internal extension ConcurrencyConfig {
    ...
    func intoRust() throws -> RustBridge.ConcurrencyConfig {
        return RustBridge.ConcurrencyConfig(self.maxThreads)
    }
}
...
public struct DeepseekOcrBackendOptions: Codable, Sendable, Hashable {
    ...
    public init(modelPath: String? = nil, device: CandleDevicePreference? = nil, version: UInt32? = nil) {
...
public typealias LlmBudgetConfig = RustBridge.LlmBudgetConfig
...
public typealias LlmCacheConfig = RustBridge.LlmCacheConfig
...
public struct PdfMetadata: Codable, Sendable, Hashable {
    ...
    public init(pdfVersion: String? = nil, producer: String? = nil, isEncrypted: Bool? = nil, width: Int64? = nil, height: Int64? = nil, pageCount: UInt32? = nil, scannedConfidence: Float? = nil, scannedPages: [UInt32]? = nil, layoutGatedPages: [UInt32]? = nil, layoutGateReasons: [String]? = nil) {
...
public enum NodeContent: Codable, Sendable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case .comment(let text):
            try container.encode("comment", forKey: .node_type)
            try container.encode(text, forKey: .text)
