...
pub fn register_document_extractor(extractor: DocumentExtractor) -> Result<(), String> {
    xberg::register_document_extractor(unsafe {
        std::mem::transmute::<DocumentExtractor, xberg::DocumentExtractor>(extractor)
    })
    .map(|v| v)
    .map_err(|e| e.to_string())
}
...
pub fn register_renderer(renderer: Renderer) -> Result<(), String> {
    xberg::register_renderer(unsafe { std::mem::transmute::<Renderer, xberg::Renderer>(renderer) })
        .map(|v| v)
        .map_err(|e| e.to_string())
}
...
pub fn unregister_renderer(name: String) -> Result<(), String> {
    xberg::unregister_renderer(&name).map(|v| v).map_err(|e| e.to_string())
}
