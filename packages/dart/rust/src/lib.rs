...
// alef:hash:437431123af431ebe41f8fdec66632ea90da51c46f3fecd16429452decbcf592
...
impl From<xberg::TesseractConfig> for TesseractConfig {
    fn from(v: xberg::TesseractConfig) -> Self {
        TesseractConfig {
            ...
            thresholding_method: v.thresholding_method.into(),
        }
    }
}
