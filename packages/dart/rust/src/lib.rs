...
pub struct NoopCache {
    pub(crate) inner: xberg::engine::seams::NoopCache,
}

impl From<xberg::engine::seams::NoopCache> for NoopCache {
    fn from(inner: xberg::engine::seams::NoopCache) -> Self {
        Self { inner }
    }
}

impl From<NoopCache> for xberg::engine::seams::NoopCache {
    fn from(value: NoopCache) -> Self {
        value.inner
    }
}
...
pub struct NoopProgressSink {
    pub(crate) inner: xberg::engine::seams::NoopProgressSink,
}

impl From<xberg::engine::seams::NoopProgressSink> for NoopProgressSink {
    fn from(inner: xberg::engine::seams::NoopProgressSink) -> Self {
        Self { inner }
    }
}

impl From<NoopProgressSink> for xberg::engine::seams::NoopProgressSink {
    fn from(value: NoopProgressSink) -> Self {
        value.inner
    }
}
...
pub struct DefaultModelProvider {
    pub(crate) inner: xberg::engine::seams::DefaultModelProvider,
}

impl From<xberg::engine::seams::DefaultModelProvider> for DefaultModelProvider {
    fn from(inner: xberg::engine::seams::DefaultModelProvider) -> Self {
        Self { inner }
    }
}

impl From<DefaultModelProvider> for xberg::engine::seams::DefaultModelProvider {
    fn from(value: DefaultModelProvider) -> Self {
        value.inner
    }
}

/// A single field with its citation envelope.
#[frb(mirror(CitedField))]
...
pub struct ParsedDocument {
    pub(crate) inner: xberg::engine::parsed::ParsedDocument,
}

impl From<xberg::engine::parsed::ParsedDocument> for ParsedDocument {
    fn from(inner: xberg::engine::parsed::ParsedDocument) -> Self {
        Self { inner }
    }
}

impl From<ParsedDocument> for xberg::engine::parsed::ParsedDocument {
...
#[frb(opaque)]
pub struct Engine {
    pub(crate) inner: xberg::engine::Engine,
}

impl From<xberg::engine::Engine> for Engine {
    fn from(inner: xberg::engine::Engine) -> Self {
        Self { inner }
    }
}

impl From<Engine> for xberg::engine::Engine {
...
pub struct EngineBuilder {
    pub(crate) inner: xberg::engine::EngineBuilder,
}

impl From<xberg::engine::EngineBuilder> for EngineBuilder {
    fn from(inner: xberg::engine::EngineBuilder) -> Self {
        Self { inner }
    }
}

impl From<EngineBuilder> for xberg::engine::EngineBuilder {
...
pub struct CandleBackend {
    pub(crate) inner: xberg::text::ner::candle::CandleBackend,
}

impl From<xberg::text::ner::candle::CandleBackend> for CandleBackend {
    fn from(inner: xberg::text::ner::candle::CandleBackend) -> Self {
        Self { inner }
    }
}

impl From<CandleBackend> for xberg::text::ner::candle::CandleBackend {
    fn from(value: CandleBackend) -> Self {
        value.inner
    }
}
...
pub struct RehydrationMap {
    pub(crate) inner: xberg::text::redaction::RehydrationMap,
}

impl From<xberg::text::redaction::RehydrationMap> for RehydrationMap {
    fn from(inner: xberg::text::redaction::RehydrationMap) -> Self {
        Self { inner }
    }
}

impl From<RehydrationMap> for xberg::text::redaction::RehydrationMap {
    fn from(value: RehydrationMap) -> Self {
        value.inner
    }
}
...
impl NoopCache {
    ...
    pub async fn get(&self, _key: String) -> Option<Vec<u8>> {
        {
            let v = self.inner.get(&_key).await;
            v.map(|b| b.to_vec())
        }
    }
    #[frb]
    pub async fn put(&self, _key: String, _value: Vec<u8>, _ttl: Option<i64>) -> () {
        self.inner.put(&_key, ::bytes::Bytes::from(_value), _ttl).await
    }
}
...
impl NoopProgressSink {
    #[frb]
    pub fn emit(&self, _event: ProgressEvent) -> () {
        self.inner
            .emit(unsafe { ::std::mem::transmute::<ProgressEvent, xberg::ProgressEvent>(_event) })
    }
}
...
impl DefaultModelProvider {
    ...
    pub fn default() -> DefaultModelProvider {
        {
            let v = xberg::DefaultModelProvider::default();
            DefaultModelProvider::from(v)
        }
    }
    #[frb]
    pub async fn ensure_model(&self, model: ModelId) -> Result<String, String> {
        self.inner
            .ensure_model(unsafe { ::std::mem::transmute::<&ModelId, &xberg::ModelId>(&model) })
            .await
            .map(|v: ::std::path::PathBuf| v.to_string_lossy().to_string())
...
impl ParsedDocument {
    #[frb]
    pub fn from_bytes(source: Vec<u8>) -> Result<ParsedDocument, String> {
        xberg::ParsedDocument::from_bytes(::bytes::Bytes::from(source))
            .map(|v| ParsedDocument::from(v))
            .map_err(|e| e.to_string())
    }
    #[frb]
    pub fn mime_type(&self) -> String {
        {
            let v = self.inner.mime_type();
            v.to_string()
        }
    }
    #[frb]
...
impl Engine {
    ...
    pub fn new_default() -> Engine {
        {
            let v = xberg::Engine::new_default();
            Engine::from(v)
        }
    }
    #[frb]
    pub async fn extract(&self, input: ExtractInput, config: ExtractionConfig) -> Result<ExtractionResult, String> {
        self.inner
            .extract(xberg::ExtractInput::from(input), &xberg::ExtractionConfig::from(config))
            .await
...
impl CandleBackend {
    #[frb]
    pub fn from_local(model_dir: String, lora_adapter_dir: Option<String>) -> Result<CandleBackend, String> {
        xberg::CandleBackend::from_local(model_dir, lora_adapter_dir)
            .map(|v| CandleBackend::from(v))
            .map_err(|e| e.to_string())
    }
    #[frb]
    pub fn from_bytes(
    ...
    ) -> Result<CandleBackend, String> {
        xberg::CandleBackend::from_bytes(&safetensors, &tokenizer_json, &encoder_config_json)
            .map(|v| CandleBackend::from(v))
            .map_err(|e| e.to_string())
    }
    #[frb]
...
#[frb(mirror(GlinerArchitecture), unignore)]
...
#[frb(mirror(CitationSource), unignore)]
...
#[frb(mirror(RasterizeError), unignore)]
...
impl From<xberg::NerConfig> for NerConfig {
    fn from(v: xberg::NerConfig) -> Self {
        NerConfig {
            ...
            model_dir: v.model_dir.map(|p| p.to_string_lossy().into_owned()),
            lora_adapter_dir: v.lora_adapter_dir.map(|p| p.to_string_lossy().into_owned()),
...
impl From<xberg::engine::seams::ProgressEvent> for ProgressEvent {
    fn from(v: xberg::engine::seams::ProgressEvent) -> Self {
        ProgressEvent {
            stage: v.stage.into(),
            message: v.message.map(|s| s.into()),
            fraction: v.fraction.map(|x| x as _),
        }
    }
}

impl From<xberg::engine::seams::ModelId> for ModelId {
    fn from(v: xberg::engine::seams::ModelId) -> Self {
        ModelId { kind: v.kind.into() }
    }
}

impl From<xberg::engine::structured::citations::CitedField> for CitedField {
    fn from(v: xberg::engine::structured::citations::CitedField) -> Self {
        CitedField {
            value: serde_json::to_string(&v.value).unwrap_or_default(),
            page: v.page.map(|x| x as _),
            confidence: v.confidence.map(|x| x as _),
            source: CitationSource::from(v.source),
        }
    }
}

impl From<xberg::engine::structured::citations::CitationOutput> for CitationOutput {
    fn from(v: xberg::engine::structured::citations::CitationOutput) -> Self {
        CitationOutput {
            structured_output: serde_json::to_string(&v.structured_output).unwrap_or_default(),
            structured_output_flat: serde_json::to_string(&v.structured_output_flat).unwrap_or_default(),
        }
    }
}

impl From<xberg::engine::structured::prompts::BuiltPrompt> for BuiltPrompt {
    fn from(v: xberg::engine::structured::prompts::BuiltPrompt) -> Self {
        BuiltPrompt {
            system: v.system.into(),
            user_text: v.user_text.map(|s| s.into()),
        }
    }
}

impl From<xberg::engine::structured::chunk::ChunkerConfig> for ChunkerConfig {
    fn from(v: xberg::engine::structured::chunk::ChunkerConfig) -> Self {
        ChunkerConfig {
            max_input_tokens: v.max_input_tokens as _,
            avg_tokens_per_image: v.avg_tokens_per_image as _,
            chars_per_token: v.chars_per_token as _,
        }
    }
}

impl From<xberg::engine::structured::chunk::Batch> for Batch {
    fn from(v: xberg::engine::structured::chunk::Batch) -> Self {
        Batch {
            pages: v.pages.into_iter().map(PageImage::from).collect::<Vec<_>>(),
            user_text: v.user_text.map(|s| s.into()),
        }
    }
}
...
impl From<xberg::engine::structured::rasterize::PageImage> for PageImage {
    fn from(v: xberg::engine::structured::rasterize::PageImage) -> Self {
        PageImage {
            page_number: v.page_number as _,
            png_bytes: v.png_bytes.into(),
        }
    }
}

impl From<xberg::engine::structured::schema::MergedOutput> for MergedOutput {
    fn from(v: xberg::engine::structured::schema::MergedOutput) -> Self {
        MergedOutput {
            merged: serde_json::to_string(&v.merged).unwrap_or_default(),
            outcome: Outcome::from(v.outcome),
            error_message: v.error_message.map(|s| s.into()),
            per_batch_errors: v.per_batch_errors.into_iter().map(|s| s.into()).collect::<Vec<_>>(),
            confidence: v.confidence.map(ExtractionConfidence::from),
        }
    }
}
...
impl From<xberg::text::ner::gline::CustomGlinerSource> for CustomGlinerSource {
    fn from(v: xberg::text::ner::gline::CustomGlinerSource) -> Self {
        CustomGlinerSource {
            repo: v.repo.into(),
            model_file: v.model_file.into(),
            tokenizer_file: v.tokenizer_file.into(),
            architecture: GlinerArchitecture::from(v.architecture),
        }
    }
}
...
impl From<xberg::NerBackendKind> for NerBackendKind {
    fn from(v: xberg::NerBackendKind) -> Self {
        match v {
            ...
            xberg::NerBackendKind::Candle => NerBackendKind::Candle,
        }
    }
}
...
impl From<xberg::engine::structured::citations::CitationSource> for CitationSource {
    fn from(v: xberg::engine::structured::citations::CitationSource) -> Self {
        match v {
            xberg::engine::structured::citations::CitationSource::Llm => CitationSource::Llm,
            xberg::engine::structured::citations::CitationSource::Extracted => CitationSource::Extracted,
            xberg::engine::structured::citations::CitationSource::Fused => CitationSource::Fused,
            xberg::engine::structured::citations::CitationSource::None => CitationSource::None,
        }
    }
}

impl From<xberg::engine::structured::schema::Outcome> for Outcome {
    fn from(v: xberg::engine::structured::schema::Outcome) -> Self {
        match v {
            xberg::engine::structured::schema::Outcome::Success => Outcome::Success,
            xberg::engine::structured::schema::Outcome::PartialSuccess => Outcome::PartialSuccess,
            xberg::engine::structured::schema::Outcome::SchemaInvalid => Outcome::SchemaInvalid,
            xberg::engine::structured::schema::Outcome::Error => Outcome::Error,
        }
    }
}
...
impl From<NerConfig> for xberg::NerConfig {
    fn from(v: NerConfig) -> Self {
        xberg::NerConfig {
            ...
            model_dir: v.model_dir.map(std::path::PathBuf::from),
            lora_adapter_dir: v.lora_adapter_dir.map(std::path::PathBuf::from),
...
impl From<PatternMatch> for xberg::text::redaction::patterns::PatternMatch {
    fn from(v: PatternMatch) -> Self {
        xberg::text::redaction::patterns::PatternMatch {
            start: v.start as _,
            end: v.end as _,
...
impl From<NerBackendKind> for xberg::NerBackendKind {
    fn from(v: NerBackendKind) -> Self {
        match v {
            ...
            NerBackendKind::Candle => xberg::NerBackendKind::Candle,
        }
    }
}
...
pub fn fuse(
    ...
    CitationOutput::from(xberg::engine::structured::citations::fuse(
        serde_json::from_str(&merged).unwrap_or(serde_json::Value::Null),
        &ocr_elements,
        &element_metadata,
        emit_citations,
        match_threshold,
...
pub fn validate_and_merge(raw_responses: Vec<String>, schema: String, merge_mode: MergeMode) -> MergedOutput {
    MergedOutput::from(xberg::engine::structured::schema::validate_and_merge(
        raw_responses,
        serde_json::from_str(&schema).unwrap_or(serde_json::Value::Null),
        unsafe { std::mem::transmute::<MergeMode, xberg::MergeMode>(merge_mode) },
    ))
}
...
pub fn custom_source_from_parts(
    ...
    xberg::text::ner::gline::custom_source_from_parts(
        ...
        architecture.map(|v| unsafe { std::mem::transmute::<GlinerArchitecture, xberg::GlinerArchitecture>(v) }),
    )
    .map(|v| v.map(CustomGlinerSource::from))
    .map_err(|e| e.to_string())
}
...
pub fn dedupe_overlaps(matches: Vec<PatternMatch>) -> Vec<PatternMatch> {
    xberg::text::redaction::dedupe_overlaps(
        matches
            .into_iter()
            .map(xberg::text::redaction::patterns::PatternMatch::from)
            .collect::<Vec<_>>(),
    )
    .into_iter()
...
pub fn encrypt_map(map: RehydrationMap, passphrase: String) -> Result<Vec<u8>, String> {
    xberg::text::redaction::encrypt_map(&map.inner, &passphrase)
        .map(|v| v)
        .map_err(|e| e.to_string())
}
...
pub fn decrypt_map(blob: Vec<u8>, passphrase: String) -> Result<RehydrationMap, String> {
    xberg::text::redaction::decrypt_map(&blob, &passphrase)
        .map(|inner| RehydrationMap { inner })
        .map_err(|e| e.to_string())
}
...
#[frb]
pub fn create_cited_field_from_json(json: String) -> Result<CitedField, String> {
