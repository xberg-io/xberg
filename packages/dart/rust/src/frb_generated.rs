...
fn wire__crate__calculate_quality_score_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_metadata = <Option<std::collections::HashMap<String, String>>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::calculate_quality_score(api_text, api_metadata))?;
                    Ok(output_ok)
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__calculate_quality_score_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__clear_document_extractors_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__clear_embedding_backends_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__clear_ocr_backends_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__clear_post_processors_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__clear_renderers_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__clear_validators_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__create_acceleration_config_from_json_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__create_archive_entry_from_json_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__create_archive_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__create_b_box_from_json_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__create_batch_bytes_item_from_json_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__create_batch_file_item_from_json_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__create_bibtex_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__create_bounding_box_from_json_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__create_chunk_from_json_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__create_chunk_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__create_chunking_config_from_json_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__create_citation_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__create_content_filter_config_from_json_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__create_contributor_role_from_json_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__create_core_properties_from_json_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__create_csv_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__create_dbf_field_info_from_json_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__create_dbf_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__create_detect_response_from_json_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__create_detection_result_from_json_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__create_djot_content_from_json_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__create_djot_image_from_json_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__create_djot_link_from_json_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__create_document_extractor_dart_impl_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__create_document_node_from_json_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__create_document_relationship_from_json_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__create_document_structure_from_json_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__create_docx_app_properties_from_json_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__create_docx_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__create_element_from_json_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__create_element_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__create_email_attachment_from_json_impl(port, ptr, rust_vec_len, data_len),
        44 => wire__crate__create_email_config_from_json_impl(port, ptr, rust_vec_len, data_len),
        45 => wire__crate__create_email_extraction_result_from_json_impl(port, ptr, rust_vec_len, data_len),
        46 => wire__crate__create_email_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        47 => wire__crate__create_embedded_file_from_json_impl(port, ptr, rust_vec_len, data_len),
        48 => wire__crate__create_embedding_backend_dart_impl_impl(port, ptr, rust_vec_len, data_len),
        49 => wire__crate__create_embedding_config_from_json_impl(port, ptr, rust_vec_len, data_len),
        50 => wire__crate__create_embedding_preset_from_json_impl(port, ptr, rust_vec_len, data_len),
        51 => wire__crate__create_epub_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__create_error_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        53 => wire__crate__create_excel_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        54 => wire__crate__create_excel_sheet_from_json_impl(port, ptr, rust_vec_len, data_len),
        55 => wire__crate__create_excel_workbook_from_json_impl(port, ptr, rust_vec_len, data_len),
        56 => wire__crate__create_extracted_image_from_json_impl(port, ptr, rust_vec_len, data_len),
        ...
        140 => wire__crate__create_uri_from_json_impl(port, ptr, rust_vec_len, data_len),
        141 => wire__crate__create_validator_dart_impl_impl(port, ptr, rust_vec_len, data_len),
        142 => wire__crate__create_xlsx_app_properties_from_json_impl(port, ptr, rust_vec_len, data_len),
        143 => wire__crate__create_xml_extraction_result_from_json_impl(port, ptr, rust_vec_len, data_len),
        144 => wire__crate__create_xml_metadata_from_json_impl(port, ptr, rust_vec_len, data_len),
        145 => wire__crate__create_yake_params_from_json_impl(port, ptr, rust_vec_len, data_len),
        146 => wire__crate__create_year_range_from_json_impl(port, ptr, rust_vec_len, data_len),
        147 => wire__crate__detect_mime_type_impl(port, ptr, rust_vec_len, data_len),
        148 => wire__crate__detect_mime_type_from_bytes_impl(port, ptr, rust_vec_len, data_len),
        149 => wire__crate__embed_texts_impl(port, ptr, rust_vec_len, data_len),
        150 => wire__crate__embed_texts_async_impl(port, ptr, rust_vec_len, data_len),
        151 => wire__crate__extract_bytes_impl(port, ptr, rust_vec_len, data_len),
        152 => wire__crate__extract_bytes_sync_impl(port, ptr, rust_vec_len, data_len),
        153 => wire__crate__extract_file_impl(port, ptr, rust_vec_len, data_len),
        154 => wire__crate__extract_file_sync_impl(port, ptr, rust_vec_len, data_len),
        155 => wire__crate__get_embedding_preset_impl(port, ptr, rust_vec_len, data_len),
        156 => wire__crate__get_extensions_for_mime_impl(port, ptr, rust_vec_len, data_len),
        157 => wire__crate__list_document_extractors_impl(port, ptr, rust_vec_len, data_len),
        158 => wire__crate__list_embedding_backends_impl(port, ptr, rust_vec_len, data_len),
        159 => wire__crate__list_embedding_presets_impl(port, ptr, rust_vec_len, data_len),
        160 => wire__crate__list_ocr_backends_impl(port, ptr, rust_vec_len, data_len),
        161 => wire__crate__list_post_processors_impl(port, ptr, rust_vec_len, data_len),
        162 => wire__crate__list_renderers_impl(port, ptr, rust_vec_len, data_len),
        163 => wire__crate__list_validators_impl(port, ptr, rust_vec_len, data_len),
        164 => wire__crate__register_document_extractor_impl(port, ptr, rust_vec_len, data_len),
        165 => wire__crate__register_embedding_backend_impl(port, ptr, rust_vec_len, data_len),
        166 => wire__crate__register_ocr_backend_impl(port, ptr, rust_vec_len, data_len),
        167 => wire__crate__register_post_processor_impl(port, ptr, rust_vec_len, data_len),
        168 => wire__crate__register_renderer_impl(port, ptr, rust_vec_len, data_len),
        169 => wire__crate__register_validator_impl(port, ptr, rust_vec_len, data_len),
        170 => wire__crate__render_pdf_page_to_png_impl(port, ptr, rust_vec_len, data_len),
        171 => wire__crate__unregister_document_extractor_impl(port, ptr, rust_vec_len, data_len),
        172 => wire__crate__unregister_embedding_backend_impl(port, ptr, rust_vec_len, data_len),
        173 => wire__crate__unregister_ocr_backend_impl(port, ptr, rust_vec_len, data_len),
        174 => wire__crate__unregister_post_processor_impl(port, ptr, rust_vec_len, data_len),
        175 => wire__crate__unregister_renderer_impl(port, ptr, rust_vec_len, data_len),
        176 => wire__crate__unregister_validator_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
