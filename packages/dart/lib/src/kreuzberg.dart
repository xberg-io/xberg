...
class KreuzbergBridge {
  ...
  static Future<ChunkingResult> chunkForRag(String text, {ChunkingConfig? config}) async {
    return await rust_bridge.chunkForRag(text: text, config: config ?? ChunkingConfig(maxCharacters: 1000, overlap: 200, trim: true, chunkerType: ChunkerType.text, embedding: null, preset: null, sizing: ChunkSizing.characters(), prependHeadingContext: false, topicThreshold: null));
  }
