...
class XbergBridge {
  ...
  /// throws anyhow::Error on failure
  static Future<void> registerDocumentExtractor(DocumentExtractor extractor) async {
    return await rust_bridge.registerDocumentExtractor(extractor: extractor);
  }
  ...
  static Future<void> unregisterDocumentExtractor(String name) async {
    return await rust_bridge.unregisterDocumentExtractor(name: name);
  }
  ...
  /// throws anyhow::Error on failure
  static Future<void> registerRenderer(Renderer renderer) async {
    return await rust_bridge.registerRenderer(renderer: renderer);
  }
  ...
  static Future<void> unregisterRenderer(String name) async {
    return await rust_bridge.unregisterRenderer(name: name);
  }
