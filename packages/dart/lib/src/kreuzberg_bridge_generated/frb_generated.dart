...
abstract class RustLibApi extends BaseApi {
  ...
  Future<double> crateCalculateQualityScore({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_Map_String_String_None(metadata, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 5,
        ...
        constMeta: kCrateCalculateQualityScoreConstMeta,
        argValues: [text, metadata],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateCalculateQualityScoreConstMeta => const TaskConstMeta(
    debugName: "calculate_quality_score",
    argNames: ["text", "metadata"],
  );
