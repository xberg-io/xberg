...
go get github.com/kreuzberg-dev/kreuzberg/v5@v5.0.0-rc.33
```
...
curl -LO https://github.com/kreuzberg-dev/kreuzberg/releases/download/v5.0.0-rc.33/go-ffi-linux-x86_64.tar.gz
