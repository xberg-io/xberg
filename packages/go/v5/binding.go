...
func (ChunkingDecisionNoChunking) Type() string        { return "no_chunking" }
...
func (ChunkingDecisionUseOverrides) Type() string        { return "use_overrides" }
...
func (NoChunkingReasonSmallFile) Type() string        { return "small_file" }
...
func (NoChunkingReasonFewPages) Type() string        { return "few_pages" }
...
func (NoChunkingReasonTextLayerDetected) Type() string        { return "text_layer_detected" }
...
func (NoChunkingReasonFormatNotChunkable) Type() string        { return "format_not_chunkable" }
...
func (NoChunkingReasonChunkingDisabled) Type() string        { return "chunking_disabled" }
...
func (NoChunkingReasonFastTextExtraction) Type() string        { return "fast_text_extraction" }
...
func (ChunkingReasonLargeFile) Type() string      { return "large_file" }
...
func (ChunkingReasonManyPages) Type() string      { return "many_pages" }
...
func (ChunkingReasonOcrRequired) Type() string      { return "ocr_required" }
...
func (ChunkingReasonLargeAndManyPages) Type() string      { return "large_and_many_pages" }
...
const (
	...
	StructuredCallModeTextOnly StructuredCallMode = "TextOnly"
	// StructuredCallModeVisionOnly StructuredCallModeVisionOnly send page rasters only; no extracted text payload.
	StructuredCallModeVisionOnly StructuredCallMode = "VisionOnly"
	...
	StructuredCallModeTextPlusVision StructuredCallMode = "TextPlusVision"
	...
	StructuredCallModeTextOnlyWithVisionFallback StructuredCallMode = "TextOnlyWithVisionFallback"
)
...
func BoundariesFromExtractionResult(result ExtractionResult, thresholds MultidocThresholds) ([]DocumentBoundary, error) {
	jsonBytescResult, err := json.Marshal(result)
	if err != nil {
		return nil, fmt.Errorf("failed to marshal: %w", err)
	}
...
func ConfidenceSignalsFromExtractionResult(result ExtractionResult, schemaCompliance SchemaCompliance, textCoverage float32) (*ConfidenceSignals, error) {
	jsonBytescResult, err := json.Marshal(result)
	if err != nil {
		return nil, fmt.Errorf("failed to marshal: %w", err)
	}
...
// TestConfig create a configuration suitable for unit tests (smaller thresholds).
func HeuristicsConfigTestConfig() *HeuristicsConfig {
	ptr := C.kreuzberg_heuristics_config_test_config()
	defer C.kreuzberg_heuristics_config_free(ptr)
	return func() *HeuristicsConfig {
		jsonPtr := C.kreuzberg_heuristics_config_to_json(ptr)
		if jsonPtr == nil {
			return nil
		}
		defer C.kreuzberg_free_string(jsonPtr)
		var result HeuristicsConfig
		if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil {
			return nil
		}
		return &result
