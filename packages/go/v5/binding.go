...
// alef:hash:18b977f1e2bdfaab7fe16b4a36473cc03ce70c85477263f1e29595480b12f197
...
// CalculateQualityScore score an extracted text on the closed interval `[0.0, 1.0]`, where higher is better.
//
...
func CalculateQualityScore(text string, metadata map[string]json.RawMessage) (float64, error) {
	...
	cMetadata := C.CString(string(jsonBytescMetadata))
	defer C.free(unsafe.Pointer(cMetadata))

	ptr := C.kreuzberg_calculate_quality_score(cText, cMetadata)
