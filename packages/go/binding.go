...
func ExtractedDocumentFromOcr(ocr OcrExtractionResult) (*ExtractedDocument, error) {
	...
	ptr := C.xberg_extracted_document_from_ocr(cOcr)
	defer C.xberg_extracted_document_free(ptr)
	return func() *ExtractedDocument {
