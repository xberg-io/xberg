...
//
// Errors are returned when returns `XbergError::Validation` if MIME type is invalid.
...
func ExtractBytes(content []byte, mimeType string, config ExtractionConfig) (*ExtractionResult, error) {
	...
	ptr := C.xberg_extract_bytes(cContent, cContentLen, cMimeType, cConfig)
...
// Returns an `ExtractionResult` containing the extracted content and metadata.
//
// Errors are returned when returns `XbergError::Io` if the file doesn't exist (NotFound) or for other file I/O errors.
// Returns `XbergError::UnsupportedFormat` if MIME type is not supported.
//
// Example:
//
...
func ExtractFile(path string, mimeType *string, config ExtractionConfig) (*ExtractionResult, error) {
	...
	ptr := C.xberg_extract_file(cPath, cMimeType, cConfig)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.xberg_extraction_result_free(ptr)
		}
...
func ExtractFileSync(path string, mimeType *string, config ExtractionConfig) (*ExtractionResult, error) {
	...
	ptr := C.xberg_extract_file_sync(cPath, cMimeType, cConfig)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.xberg_extraction_result_free(ptr)
		}
...
func ExtractBytesSync(content []byte, mimeType string, config ExtractionConfig) (*ExtractionResult, error) {
	...
	ptr := C.xberg_extract_bytes_sync(cContent, cContentLen, cMimeType, cConfig)
	if err := lastError(); err != nil {
		if ptr != nil {
			C.xberg_extraction_result_free(ptr)
		}
...
func BatchExtractFilesSync(items []BatchFileItem, config ExtractionConfig) ([]ExtractionResult, error) {
	...
	ptr := C.xberg_batch_extract_files_sync(cItems, cConfig)
	if err := lastError(); err != nil {
		return nil, err
	}
	if ptr == nil {
...
func BatchExtractBytesSync(items []BatchBytesItem, config ExtractionConfig) ([]ExtractionResult, error) {
	...
	ptr := C.xberg_batch_extract_bytes_sync(cItems, cConfig)
	if err := lastError(); err != nil {
		return nil, err
	}
	if ptr == nil {
...
func BatchExtractFiles(items []BatchFileItem, config ExtractionConfig) ([]ExtractionResult, error) {
	...
	ptr := C.xberg_batch_extract_files(cItems, cConfig)
	if err := lastError(); err != nil {
		return nil, err
	}
	if ptr == nil {
...
func BatchExtractBytes(items []BatchBytesItem, config ExtractionConfig) ([]ExtractionResult, error) {
	...
	ptr := C.xberg_batch_extract_bytes(cItems, cConfig)
	if err := lastError(); err != nil {
		return nil, err
	}
	if ptr == nil {
