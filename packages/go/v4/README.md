...
go get github.com/kreuzberg-dev/kreuzberg/packages/go/v4@v4.7.0
```
...
curl -LO https://github.com/kreuzberg-dev/kreuzberg/releases/download/v4.7.0/go-ffi-linux-x86_64.tar.gz
