...
#define KREUZBERG_VERSION "4.9.6"
 ...
 * ```
 */
KREUZBERG_EXPORT struct CancellationToken *kreuzberg_cancel_token_new(void);
 ...
 */
KREUZBERG_EXPORT void kreuzberg_cancel_token_cancel(struct CancellationToken *token);
 ...
 * ```
 */
KREUZBERG_EXPORT int kreuzberg_cancel_token_is_cancelled(const struct CancellationToken *token);
 ...
 * ```
 */
KREUZBERG_EXPORT void kreuzberg_cancel_token_free(struct CancellationToken *token);
 ...
 * ```
 */
KREUZBERG_EXPORT uint32_t kreuzberg_error_code_cancelled(void);
