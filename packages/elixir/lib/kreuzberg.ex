...
# alef:hash:606bde194be53d52598476b1c7dba828612aa618654a9b9b68405198c0449a65
...
defmodule Kreuzberg do
  ...
  @doc "Score an extracted text on the closed interval `[0.0, 1.0]`, where higher is better."
  ...
  @doc "Score an extracted text on the closed interval `[0.0, 1.0]`, where higher is better."
  @spec calculate_quality_score(String.t(), map() | nil) :: float()
