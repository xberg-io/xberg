...
defmodule Kreuzberg.TranscriptionConfig do
  ...
  @type t :: %__MODULE__{
          enabled: boolean(),          model: String.t() | nil,          language: String.t() | nil,          timestamps: boolean(),          max_duration_ms: non_neg_integer() | nil,          max_bytes: non_neg_integer() | nil,          timeout_ms: non_neg_integer() | nil,          model_cache_dir: String.t() | nil,          allow_network: boolean(),          verify_hash: boolean()        }
