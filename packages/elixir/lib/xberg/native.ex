...
defmodule Xberg.Native do
  ...
  * `fused_confidence` - Confidence recorded on a successfully fused field
  ...
  """
  def fuse(_merged, _ocr_elements, _element_metadata, _emit_citations, _match_threshold, _fused_confidence),
  ...
  * `merge_mode` - Merging strategy
  ...
  """
  def validate_and_merge(_raw_responses, _schema, _merge_mode), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def custom_source_from_parts(_repo, _model_file, _tokenizer_file, _architecture),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def dedupe_overlaps(_matches), do: :erlang.nif_error(:nif_not_loaded)

  @doc "Encrypt `map` with `passphrase`. Returns `XPII\\x01` + salt(16) + nonce(12) + tag(16) + ciphertext."
  def encrypt_map(_map, _passphrase), do: :erlang.nif_error(:nif_not_loaded)

  @doc "Decrypt a blob from [`encrypt_map`]."
  def decrypt_map(_blob, _passphrase), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def find_subject(_map, _query), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def forget_subject(_map, _query), do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `origin` - The origin to check (e.g., "<https://example.com>")
  ...
  def noopcache_get_async(_obj, _key), do: :erlang.nif_error(:nif_not_loaded)
  def noopcache_put_async(_obj, _key, _value, _ttl), do: :erlang.nif_error(:nif_not_loaded)
  def noopprogresssink_emit(_obj, _event), do: :erlang.nif_error(:nif_not_loaded)
  def defaultmodelprovider_default, do: :erlang.nif_error(:nif_not_loaded)
  def defaultmodelprovider_ensure_model_async(_obj, _model), do: :erlang.nif_error(:nif_not_loaded)
  def chunkerconfig_default, do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def parseddocument_from_bytes(_source), do: :erlang.nif_error(:nif_not_loaded)

  @doc "The detected MIME type."
  def parseddocument_mime_type(_obj), do: :erlang.nif_error(:nif_not_loaded)

  @doc "The page count (1 for non-PDF inputs)."
  def parseddocument_page_count(_obj), do: :erlang.nif_error(:nif_not_loaded)

  @doc "The shared source bytes."
  def parseddocument_source(_obj), do: :erlang.nif_error(:nif_not_loaded)

  @doc "Start building an [`Engine`]."
  def engine_builder, do: :erlang.nif_error(:nif_not_loaded)

  @doc "Construct an [`Engine`] with default configuration."
  def engine_new_default, do: :erlang.nif_error(:nif_not_loaded)

  @doc "Extract content from a single bytes or URI input."
  def engine_extract_async(_obj, _input, _config), do: :erlang.nif_error(:nif_not_loaded)

  @doc "Extract content from multiple bytes or URI inputs."
  def engine_extract_batch_async(_obj, _inputs, _config), do: :erlang.nif_error(:nif_not_loaded)

  @doc """
  Finalize the builder into an [`Engine`], filling every unset seam with
  its in-core default.
  """
  def enginebuilder_build(_obj), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def candlebackend_from_local(_model_dir, _lora_adapter_dir), do: :erlang.nif_error(:nif_not_loaded)
  ...
  """
  def candlebackend_from_bytes(_safetensors, _tokenizer_json, _encoder_config_json),
    do: :erlang.nif_error(:nif_not_loaded)

  def candlebackend_detect_async(_obj, _text, _categories), do: :erlang.nif_error(:nif_not_loaded)

  @doc "Create a fresh counter with no previous state."
  def tokencounter_new, do: :erlang.nif_error(:nif_not_loaded)
  def ibanchecksumvalidator_label(_obj), do: :erlang.nif_error(:nif_not_loaded)
  def ibanchecksumvalidator_validate(_obj, _entity, _ctx), do: :erlang.nif_error(:nif_not_loaded)
  def luhnvalidator_label(_obj), do: :erlang.nif_error(:nif_not_loaded)
  def luhnvalidator_validate(_obj, _entity, _ctx), do: :erlang.nif_error(:nif_not_loaded)
  ...
  * `tier` - `"mobile"` (default, lightweight, faster) or `"server"` (high accuracy, GPU/complex documents)
  ...
  @doc false
  def subject_match_from_json(_json), do: :erlang.nif_error(:nif_not_loaded)
