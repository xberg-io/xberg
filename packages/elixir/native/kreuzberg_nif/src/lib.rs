...
// alef:hash:06942af8d4dca23148099c5afe97618b2755587bda24b3aa4d34dba40615ff2c
...
/// ```
#[rustler::nif(schedule = "DirtyCpu")]
pub fn embed_texts_async_async(texts: Vec<String>, config: Option<String>) -> Result<Vec<Vec<f32>>, String> {
