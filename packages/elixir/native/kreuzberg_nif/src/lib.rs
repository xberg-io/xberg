...
// alef:hash:15608d9c0d156aa43d2f95b94b3e6bd5a46665562ad8c047c0b658e98194724a
...
pub fn hwpxextractor_priority(resource: rustler::ResourceArc<HwpxExtractor>) -> i32 {
    resource.inner.as_ref().priority()
}
...
pub fn tessdatamanager_cache_dir(resource: rustler::ResourceArc<TessdataManager>) -> String {
    resource.inner.as_ref().cache_dir().to_string_lossy().to_string()
}
...
pub fn tessdatamanager_is_language_cached(resource: rustler::ResourceArc<TessdataManager>, lang: String) -> bool {
    resource.inner.as_ref().is_language_cached(&lang)
}
...
#[rustler::nif]
pub fn html_extraction_result_from_json(json: String) -> Result<HtmlExtractionResult, String> {
...
#[rustler::nif]
pub fn extracted_inline_image_from_json(json: String) -> Result<ExtractedInlineImage, String> {
...
#[rustler::nif]
pub fn drawing_from_json(json: String) -> Result<Drawing, String> {
...
#[rustler::nif]
pub fn anchor_properties_from_json(json: String) -> Result<AnchorProperties, String> {
...
#[rustler::nif]
pub fn table_properties_from_json(json: String) -> Result<TableProperties, String> {
...
#[rustler::nif]
pub fn info_response_from_json(json: String) -> Result<InfoResponse, String> {
...
#[rustler::nif]
pub fn embed_request_from_json(json: String) -> Result<EmbedRequest, String> {
...
#[rustler::nif]
pub fn embed_response_from_json(json: String) -> Result<EmbedResponse, String> {
...
#[rustler::nif]
pub fn chunk_request_from_json(json: String) -> Result<ChunkRequest, String> {
...
#[rustler::nif]
pub fn chunk_response_from_json(json: String) -> Result<ChunkResponse, String> {
...
#[rustler::nif]
pub fn manifest_entry_response_from_json(json: String) -> Result<ManifestEntryResponse, String> {
...
#[rustler::nif]
pub fn manifest_response_from_json(json: String) -> Result<ManifestResponse, String> {
...
#[rustler::nif]
pub fn warm_response_from_json(json: String) -> Result<WarmResponse, String> {
...
#[rustler::nif]
pub fn structured_extraction_response_from_json(json: String) -> Result<StructuredExtractionResponse, String> {
...
#[rustler::nif]
pub fn open_web_document_response_from_json(json: String) -> Result<OpenWebDocumentResponse, String> {
...
#[rustler::nif]
pub fn docling_compat_response_from_json(json: String) -> Result<DoclingCompatResponse, String> {
...
#[rustler::nif]
pub fn detect_mime_type_params_from_json(json: String) -> Result<DetectMimeTypeParams, String> {
...
#[rustler::nif]
pub fn cache_warm_params_from_json(json: String) -> Result<CacheWarmParams, String> {
...
#[rustler::nif]
pub fn embed_text_params_from_json(json: String) -> Result<EmbedTextParams, String> {
...
#[rustler::nif]
pub fn extract_structured_params_from_json(json: String) -> Result<ExtractStructuredParams, String> {
...
#[rustler::nif]
pub fn chunk_text_params_from_json(json: String) -> Result<ChunkTextParams, String> {
...
#[rustler::nif]
pub fn detected_boundary_from_json(json: String) -> Result<DetectedBoundary, String> {
...
fn on_load(env: rustler::Env, _info: rustler::Term) -> bool {
    ...
    env.register::<HwpxExtractor>()
        .expect("Failed to register resource type HwpxExtractor");
