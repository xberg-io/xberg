...
// alef:hash:e7e28105c89754b0cd59a25a7b4d0c4684ac9ea50f46c67f9063d7a039ea9a2b
...
pub fn extract_bytes_async(
    ...
    std::thread::Builder::new()
        ...
        .spawn(move || {
            ...
            let result = rt
                .block_on(async {
                    kreuzberg::extract_bytes(content, &mime_type, config_core.as_ref().unwrap_or(&Default::default()))
                        .await
                })
                .map_err(|e| e.to_string())?;
            Ok(result.into())
