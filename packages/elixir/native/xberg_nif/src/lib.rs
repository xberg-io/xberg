...
// alef:hash:014d7c3c576d977f9675e3064c26864356fc87b35b96b456440379091ce6734e
...
impl BedrockConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            region: opts.get("region").and_then(|t| t.decode().ok()),
            cross_region_prefix: opts.get("cross_region_prefix").and_then(|t| t.decode().ok()),
            access_key_id: opts.get("access_key_id").and_then(|t| t.decode().ok()),
            secret_access_key: opts.get("secret_access_key").and_then(|t| t.decode().ok()),
            session_token: opts.get("session_token").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for CaptioningConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::CaptioningConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for ChunkClassificationConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::ChunkClassificationConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for ChunkingConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::ChunkingConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl ChunkingConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            sparse_embedding: opts.get("sparse_embedding").and_then(|t| t.decode().ok()),
            late_interaction: opts.get("late_interaction").and_then(|t| t.decode().ok()),
...
impl ConcurrencyConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            max_threads: opts.get("max_threads").and_then(|t| t.decode().ok()),
            max_concurrent_ocr: opts.get("max_concurrent_ocr").and_then(|t| t.decode().ok()),
        }
    }
}
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            include_footers: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
            include_footnotes: opts
                .get("include_footnotes")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
...
impl CrawlConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            max_links_per_page: opts.get("max_links_per_page").and_then(|t| t.decode().ok()),
            ...
            bm25_query: opts.get("bm25_query").and_then(|t| t.decode().ok()),
            bm25_threshold: opts.get("bm25_threshold").and_then(|t| t.decode().ok()),
            ...
            document_mime_types: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            document_output_dir: opts.get("document_output_dir").and_then(|t| t.decode().ok()),
            document_content_encoding: opts.get("document_content_encoding").and_then(|t| t.decode().ok()),
            ...
            ssrf_deny_private_explicit: opts.get("ssrf_deny_private_explicit").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl DjotAttributeGroup {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            identifier: opts.get("identifier").and_then(|t| t.decode().ok()).unwrap_or_default(),
            attributes: opts.get("attributes").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for DjotContent {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::DjotContent as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl DoctorReport {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            checks: opts.get("checks").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for DocumentNode {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::DocumentNode as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for DocumentStructure {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::DocumentStructure as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for ExtractInput {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::ExtractInput as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl ExtractedDocument {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            detected_language_confidences: opts.get("detected_language_confidences").and_then(|t| t.decode().ok()),
...
impl<'de> serde::Deserialize<'de> for ExtractedImage {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::ExtractedImage as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl ExtractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            mime_detection_policy: opts
                .get("mime_detection_policy")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            ...
            ocr_near_empty_fallback: opts.get("ocr_near_empty_fallback").and_then(|t| t.decode().ok()),
            ocr_scanned_page_quality_gate: opts.get("ocr_scanned_page_quality_gate").and_then(|t| t.decode().ok()),
            ocr_embedded_images: opts.get("ocr_embedded_images").and_then(|t| t.decode().ok()),
            ...
            jupyter_cell_rendering: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
            apply_notebook_cell_tags: opts
                .get("apply_notebook_cell_tags")
                .and_then(|t| t.decode().ok())
                .unwrap_or(true),
            ...
            csv: opts.get("csv").and_then(|t| t.decode().ok()),
            geojson: opts.get("geojson").and_then(|t| t.decode().ok()),
            concurrency: opts.get("concurrency").and_then(|t| t.decode().ok()),
            url: opts.get("url").and_then(|t| t.decode().ok()).unwrap_or_default(),
            max_archive_depth: opts.get("max_archive_depth").and_then(|t| t.decode().ok()).unwrap_or(3),
...
impl<'de> serde::Deserialize<'de> for ExtractionResult {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::ExtractionResult as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl FileExtractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            mime_detection_policy: opts.get("mime_detection_policy").and_then(|t| t.decode().ok()),
...
impl GeoJsonExtractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            include_full_coordinates: opts
                .get("include_full_coordinates")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
        }
    }
...
impl HierarchicalBoundingBox {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            left: opts.get("left").and_then(|t| t.decode().ok()).unwrap_or_default(),
            top: opts.get("top").and_then(|t| t.decode().ok()).unwrap_or_default(),
            right: opts.get("right").and_then(|t| t.decode().ok()).unwrap_or_default(),
            bottom: opts.get("bottom").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl ImageDpi {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            horizontal: opts.get("horizontal").and_then(|t| t.decode().ok()).unwrap_or_default(),
            vertical: opts.get("vertical").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl KeyValueAttribute {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            key: opts.get("key").and_then(|t| t.decode().ok()).unwrap_or_default(),
...
#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Xberg.LanguageConfidence"]
...
impl LateInteractionConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            model: opts.get("model").and_then(|t| t.decode().ok()).unwrap_or_default(),
            batch_size: opts.get("batch_size").and_then(|t| t.decode().ok()).unwrap_or(16),
            max_length: opts.get("max_length").and_then(|t| t.decode().ok()).unwrap_or(512),
            query_max_length: opts.get("query_max_length").and_then(|t| t.decode().ok()).unwrap_or(32),
            show_download_progress: opts
                .get("show_download_progress")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
...
impl LlmBudgetConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            model_limits: opts.get("model_limits").and_then(|t| t.decode().ok()),
            enforcement: opts.get("enforcement").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl LlmCacheConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            max_entries: opts.get("max_entries").and_then(|t| t.decode().ok()),
            ttl_seconds: opts.get("ttl_seconds").and_then(|t| t.decode().ok()),
            backend: opts.get("backend").and_then(|t| t.decode().ok()),
            backend_config: opts.get("backend_config").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl LlmConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            providers: opts.get("providers").and_then(|t| t.decode().ok()),
            cache: opts.get("cache").and_then(|t| t.decode().ok()),
            budget: opts.get("budget").and_then(|t| t.decode().ok()),
            rate_limit: opts.get("rate_limit").and_then(|t| t.decode().ok()),
            cost_tracking: opts.get("cost_tracking").and_then(|t| t.decode().ok()),
            tracing: opts.get("tracing").and_then(|t| t.decode().ok()),
            cooldown_secs: opts.get("cooldown_secs").and_then(|t| t.decode().ok()),
            health_check_secs: opts.get("health_check_secs").and_then(|t| t.decode().ok()),
            bedrock: opts.get("bedrock").and_then(|t| t.decode().ok()),
            credential_provider: opts.get("credential_provider").and_then(|t| t.decode().ok()),
            max_concurrency: opts.get("max_concurrency").and_then(|t| t.decode().ok()),
            max_response_bytes: opts.get("max_response_bytes").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl LlmProviderConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            base_url: opts.get("base_url").and_then(|t| t.decode().ok()).unwrap_or_default(),
            auth_header: opts.get("auth_header").and_then(|t| t.decode().ok()),
            model_prefixes: opts
                .get("model_prefixes")
                .and_then(|t| t.decode().ok())
                .unwrap_or_default(),
...
impl LlmRateLimitConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            window_seconds: opts.get("window_seconds").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl MarkdownCodeBlock {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            code: opts.get("code").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for NerConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::NerConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl NgramRange {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            min: opts.get("min").and_then(|t| t.decode().ok()).unwrap_or(1),
            max: opts.get("max").and_then(|t| t.decode().ok()).unwrap_or(3),
        }
    }
}

#[derive(Debug, Clone, Default, serde::Serialize, serde::Deserialize, rustler::NifStruct)]
#[module = "Xberg.OcrBackendCapabilities"]
...
impl<'de> serde::Deserialize<'de> for OcrConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::OcrConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl OcrElement {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            page_number: opts.get("page_number").and_then(|t| t.decode().ok()).unwrap_or(1),
...
impl<'de> serde::Deserialize<'de> for OcrPipelineConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::OcrPipelineConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for OcrPipelineStage {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::OcrPipelineStage as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl OcrPoint {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            x: opts.get("x").and_then(|t| t.decode().ok()).unwrap_or_default(),
            y: opts.get("y").and_then(|t| t.decode().ok()).unwrap_or_default(),
        }
    }
}
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            critical_fragmented_word_ratio: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(0.8),
            max_ocr_output_fragmented_word_ratio: opts
                .get("max_ocr_output_fragmented_word_ratio")
                .and_then(|t| t.decode().ok())
                .unwrap_or(0.35),
            min_ocr_mean_confidence: opts
                .get("min_ocr_mean_confidence")
                .and_then(|t| t.decode().ok())
                .unwrap_or(75.0),
            min_words_for_ocr_output_check: opts
                .get("min_words_for_ocr_output_check")
                .and_then(|t| t.decode().ok())
                .unwrap_or(20),
            max_ocr_output_dict_invalid_word_ratio: opts
                .get("max_ocr_output_dict_invalid_word_ratio")
                .and_then(|t| t.decode().ok())
                .unwrap_or(1.01),
            discard_suspected_ocr_noise: opts
                .get("discard_suspected_ocr_noise")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
            ...
            min_provenance_fallback_ratio: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(0.5),
            enable_plausibility_ocr_routing: opts
                .get("enable_plausibility_ocr_routing")
                .and_then(|t| t.decode().ok())
                .unwrap_or(true),
            min_reliable_language_chunk_ratio: opts
                .get("min_reliable_language_chunk_ratio")
                .and_then(|t| t.decode().ok())
                .unwrap_or(0.1),
        }
    }
...
impl PaddleOcrConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            cache_dir: opts.get("cache_dir").and_then(|t| t.decode().ok()),
            use_angle_cls: opts.get("use_angle_cls").and_then(|t| t.decode().ok()).unwrap_or(false),
            enable_table_detection: opts
                .get("enable_table_detection")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
            det_db_thresh: opts.get("det_db_thresh").and_then(|t| t.decode().ok()).unwrap_or(0.3),
            ...
            det_limit_side_len: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(1024),
            rec_batch_num: opts.get("rec_batch_num").and_then(|t| t.decode().ok()).unwrap_or(6),
            padding: opts.get("padding").and_then(|t| t.decode().ok()).unwrap_or(10),
            drop_score: opts.get("drop_score").and_then(|t| t.decode().ok()).unwrap_or(0.5),
            model_tier: opts
                .get("model_tier")
                .and_then(|t| t.decode().ok())
                .unwrap_or("mobile".to_string()),
            model_version: opts
                .get("model_version")
                .and_then(|t| t.decode().ok())
                .unwrap_or("pp-ocrv6".to_string()),
...
impl<'de> serde::Deserialize<'de> for PageClassificationConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::PageClassificationConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl PageOcrConfidence {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            score: opts.get("score").and_then(|t| t.decode().ok()),
...
impl PdfMetadata {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            fabricated_text_pages: opts.get("fabricated_text_pages").and_then(|t| t.decode().ok()),
            implausible_text_pages: opts.get("implausible_text_pages").and_then(|t| t.decode().ok()),
            layout_gated_pages: opts.get("layout_gated_pages").and_then(|t| t.decode().ok()),
            layout_gate_reasons: opts.get("layout_gate_reasons").and_then(|t| t.decode().ok()),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for RedactionConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::RedactionConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl SparseEmbeddingConfig {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            model: opts.get("model").and_then(|t| t.decode().ok()).unwrap_or_default(),
            batch_size: opts.get("batch_size").and_then(|t| t.decode().ok()).unwrap_or(16),
            max_length: opts.get("max_length").and_then(|t| t.decode().ok()).unwrap_or(256),
            show_download_progress: opts
                .get("show_download_progress")
                .and_then(|t| t.decode().ok())
                .unwrap_or(false),
...
impl SsrfPolicy {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            ...
            allowlist: opts.get("allowlist").and_then(|t| t.decode().ok()).unwrap_or_default(),
            max_redirects: opts.get("max_redirects").and_then(|t| t.decode().ok()).unwrap_or(5),
            scheme_allowlist: opts
                .get("scheme_allowlist")
                .and_then(|t| t.decode().ok())
                .unwrap_or(vec!["http".to_string(), "https".to_string()]),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for StructuredExtractionConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::StructuredExtractionConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl<'de> serde::Deserialize<'de> for SummarizationConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::SummarizationConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
impl TableCellStyle {
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            row: opts.get("row").and_then(|t| t.decode().ok()).unwrap_or_default(),
            col: opts.get("col").and_then(|t| t.decode().ok()).unwrap_or_default(),
            heading_level: opts.get("heading_level").and_then(|t| t.decode().ok()),
            style_name: opts.get("style_name").and_then(|t| t.decode().ok()),
        }
    }
}
    ...
    pub fn new(opts: std::collections::HashMap<String, rustler::Term>) -> Self {
        Self {
            language: opts
                ...
                .and_then(|t| t.decode().ok())
                .unwrap_or(vec!["eng".to_string()]),
            psm: opts.get("psm").and_then(|t| t.decode().ok()),
            output_format: opts
                .get("output_format")
                .and_then(|t| t.decode().ok())
                .unwrap_or("markdown".to_string()),
...
impl<'de> serde::Deserialize<'de> for TranslationConfig {
    fn deserialize<D>(deserializer: D) -> ::core::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        <xberg::TranslationConfig as serde::Deserialize>::deserialize(deserializer).map(Into::into)
    }
}
...
#[allow(clippy::derivable_impls)]
impl Default for CandleTrocrVariant {
    fn default() -> Self {
        Self::BasePrinted
    }
}
...
pub enum ConfidenceSemantics {
    Legibility { scale_max: f64 },
    Uncalibrated,
    None,
}

#[allow(clippy::derivable_impls)]
impl Default for ConfidenceSemantics {
    fn default() -> Self {
        Self::Uncalibrated
    }
}
...
#[expect(
    ...
    reason = "this enum's data variants differ substantially in estimated size; boxing the largest field would change the generated public variant shape, so the size difference is accepted here instead"
)]
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize, rustler::NifTaggedEnum)]
#[serde(tag = "type", rename_all = "snake_case")]
...
#[allow(clippy::derivable_impls)]
impl Default for GlmOcrLayoutMode {
    fn default() -> Self {
        Self::WholePage
    }
}
...
#[allow(clippy::derivable_impls)]
impl Default for GlmOcrTaskKind {
    fn default() -> Self {
        Self::Ocr
    }
}
...
#[allow(clippy::derivable_impls)]
impl Default for HtmlToMarkdownRsOutputFormat {
    fn default() -> Self {
        Self::Markdown
    }
}
...
#[allow(clippy::derivable_impls)]
impl Default for MimeDetectionPolicy {
    fn default() -> Self {
        Self::PreferContent
    }
}
...
#[allow(clippy::derivable_impls)]
impl Default for PaddleOcrVlTaskKind {
    fn default() -> Self {
        Self::Ocr
    }
}
...
pub fn classify_chunks_owned_async(
    ...
    let result_core: Option<xberg::ExtractedDocument> = result
        ...
        .transpose()
        .map_err(|error| {
            format!("failed to deserialize parameter `result` for `classify_chunks_owned_async`: {error}")
        })?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
                // 16 MiB: the spawning thread's 32 MiB only covers `block_on`; tasks the
...
#[rustler::nif]
pub fn doctor(config: Option<String>) -> Result<DoctorReport, String> {
    let config_core: Option<xberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<xberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `config` for `doctor`: {error}"))?;
    Ok(xberg::doctor(config_core.as_ref().unwrap_or(&Default::default())).into())
}
...
pub fn extract_async(input: Option<String>, config: Option<String>) -> Result<ExtractionResult, String> {
    let input_core: Option<xberg::ExtractInput> = input
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `input` for `extract_async`: {error}"))?;
    let config_core: Option<xberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<xberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `config` for `extract_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
...
pub fn extract_batch_async(inputs: Option<String>, config: Option<String>) -> Result<ExtractionResult, String> {
    let inputs_core_option: Option<Vec<xberg::ExtractInput>> = inputs
        .map(|s| serde_json::from_str::<Vec<xberg::ExtractInput>>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `inputs` for `extract_batch_async`: {error}"))?;
    let inputs_core: Vec<xberg::ExtractInput> = inputs_core_option.unwrap_or_default();
    let config_core: Option<xberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<xberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `config` for `extract_batch_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
...
pub fn list_ocr_backend_capabilities() -> Result<Vec<OcrBackendCapabilities>, String> {
    let result = xberg::list_ocr_backend_capabilities().map_err(|e| e.to_string())?;
...
pub fn map_url_async(uri: String, config: Option<String>) -> Result<MapResult, String> {
    let config_core: Option<xberg::UrlExtractionConfig> = config
        ...
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `config` for `map_url_async`: {error}"))?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            .stack_size(32 * 1024 * 1024)
            .spawn(move || {
...
#[rustler::nif]
pub fn max_sim_rank(query: MultiVectorEmbedding, docs: Option<String>) -> Result<Vec<LateInteractionMatch>, String> {
    let docs_core_option: Option<Vec<xberg::MultiVectorEmbedding>> = docs
        .map(|s| serde_json::from_str::<Vec<xberg::MultiVectorEmbedding>>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `docs` for `max_sim_rank`: {error}"))?;
    let docs_core: Vec<xberg::MultiVectorEmbedding> = docs_core_option.unwrap_or_default();
    Ok(xberg::max_sim_rank(&query.clone().into(), &docs_core)
        .into_iter()
        .map(Into::into)
        .collect())
}
...
pub fn max_sim_score(query: MultiVectorEmbedding, doc: MultiVectorEmbedding) -> f64 {
    xberg::max_sim_score(&query.clone().into(), &doc.clone().into())
}
...
pub fn ocr_backend_supports_language(backend: String, language: String) -> Result<bool, String> {
    let result = xberg::ocr_backend_supports_language(&backend, &language).map_err(|e| e.to_string())?;
    Ok(result)
}
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::OcrBackend for RustlerOcrBackendBridge {
    ...
    fn supports_language(&self, lang: &str) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_language", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_language", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_language", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn backend_type(&self) -> xberg::OcrBackendType {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "backend_type", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "backend_type", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "backend_type", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn supported_languages(&self) -> Vec<String> {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supported_languages", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supported_languages", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supported_languages", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn supports_table_detection(&self) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_table_detection", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_table_detection", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_table_detection", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn supports_document_processing(&self) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_document_processing", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_document_processing", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "supports_document_processing", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn emits_structured_markdown(&self) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "emits_structured_markdown", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "emits_structured_markdown", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "emits_structured_markdown", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }

    fn confidence_semantics(&self) -> xberg::ConfidenceSemantics {
        if !(self.implemented_methods.contains("confidence_semantics")) {
            return RustlerOcrBackendBridgeDefaultConfidenceSemantics(self).confidence_semantics();
        }
        let reply_id = TRAIT_REPLY_COUNTER.fetch_add(1, std::sync::atomic::Ordering::Relaxed);
        let (tx, rx) = tokio::sync::oneshot::channel::<Result<String, String>>();
        TRAIT_REPLY_CHANNELS.lock().unwrap().insert(reply_id, tx);
        ...
        let pid = self.inner;
        let method = "confidence_semantics";
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "confidence_semantics", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "confidence_semantics", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "confidence_semantics", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }

    fn page_orientation_handling(&self) -> xberg::PageOrientationHandling {
        if !(self.implemented_methods.contains("page_orientation_handling")) {
            return RustlerOcrBackendBridgeDefaultPageOrientationHandling(self).page_orientation_handling();
        }
        let reply_id = TRAIT_REPLY_COUNTER.fetch_add(1, std::sync::atomic::Ordering::Relaxed);
        let (tx, rx) = tokio::sync::oneshot::channel::<Result<String, String>>();
        TRAIT_REPLY_CHANNELS.lock().unwrap().insert(reply_id, tx);
        ...
        let pid = self.inner;
        let method = "page_orientation_handling";
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "page_orientation_handling", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "page_orientation_handling", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerOcrBackendBridge", method = "page_orientation_handling", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::OcrBackend for RustlerOcrBackendBridgeDefaultProcessImageFile<'_> {
    ...
    fn confidence_semantics(&self) -> xberg::ConfidenceSemantics {
        xberg::OcrBackend::confidence_semantics(self.0)
    }
    fn page_orientation_handling(&self) -> xberg::PageOrientationHandling {
        xberg::OcrBackend::page_orientation_handling(self.0)
    }
    async fn process_document(
        &self,
        _path: &std::path::Path,
...
/// Runs `confidence_semantics`'s Rust default body for [`RustlerOcrBackendBridge`] while routing
/// every other trait method back through the bridge, so the default body's `self.*`
/// calls still reach host overrides.
#[derive(Debug)]
struct RustlerOcrBackendBridgeDefaultConfidenceSemantics<'a>(&'a RustlerOcrBackendBridge);
impl xberg::plugins::Plugin for RustlerOcrBackendBridgeDefaultConfidenceSemantics<'_> {
    fn name(&self) -> &str {
        xberg::plugins::Plugin::name(self.0)
    }
...
#[async_trait::async_trait]
impl xberg::OcrBackend for RustlerOcrBackendBridgeDefaultConfidenceSemantics<'_> {
    async fn process_image(
        &self,
        image_bytes: &[u8],
        config: &xberg::OcrConfig,
...
/// Runs `page_orientation_handling`'s Rust default body for [`RustlerOcrBackendBridge`] while routing
/// every other trait method back through the bridge, so the default body's `self.*`
/// calls still reach host overrides.
#[derive(Debug)]
struct RustlerOcrBackendBridgeDefaultPageOrientationHandling<'a>(&'a RustlerOcrBackendBridge);
impl xberg::plugins::Plugin for RustlerOcrBackendBridgeDefaultPageOrientationHandling<'_> {
    fn name(&self) -> &str {
        xberg::plugins::Plugin::name(self.0)
    }
...
#[async_trait::async_trait]
impl xberg::OcrBackend for RustlerOcrBackendBridgeDefaultPageOrientationHandling<'_> {
    async fn process_image(
        &self,
        image_bytes: &[u8],
        config: &xberg::OcrConfig,
...
impl xberg::plugins::Plugin for RustlerPostProcessorBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::PostProcessor for RustlerPostProcessorBridge {
    ...
    fn processing_stage(&self) -> xberg::ProcessingStage {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "processing_stage", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "processing_stage", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "processing_stage", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn should_process(&self, _result: &xberg::ExtractedDocument, _config: &xberg::ExtractionConfig) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "should_process", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "should_process", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "should_process", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn estimated_duration_ms(&self, _result: &xberg::ExtractedDocument) -> u64 {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "estimated_duration_ms", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "estimated_duration_ms", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "estimated_duration_ms", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn priority(&self) -> i32 {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "priority", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "priority", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerPostProcessorBridge", method = "priority", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
}
...
impl xberg::plugins::Plugin for RustlerValidatorBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::Validator for RustlerValidatorBridge {
    ...
    fn should_validate(&self, _result: &xberg::ExtractedDocument, _config: &xberg::ExtractionConfig) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "should_validate", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "should_validate", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "should_validate", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn priority(&self) -> i32 {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "priority", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "priority", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerValidatorBridge", method = "priority", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
}
...
impl xberg::plugins::Plugin for RustlerDocumentExtractorBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::DocumentExtractor for RustlerDocumentExtractorBridge {
    ...
    fn supported_mime_types(&self) -> &[&str] {
        let __types: Vec<String> = {
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "supported_mime_types", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "supported_mime_types", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "supported_mime_types", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
        };
    ...
    fn priority(&self) -> i32 {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "priority", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "priority", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "priority", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
    ...
    fn can_handle(&self, _path: &std::path::Path, _mime_type: &str) -> bool {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "can_handle", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "can_handle", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerDocumentExtractorBridge", method = "can_handle", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
}
...
impl xberg::plugins::Plugin for RustlerEmbeddingBackendBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerEmbeddingBackendBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerEmbeddingBackendBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerEmbeddingBackendBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::EmbeddingBackend for RustlerEmbeddingBackendBridge {
    fn dimensions(&self) -> usize {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerEmbeddingBackendBridge", method = "dimensions", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerEmbeddingBackendBridge", method = "dimensions", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerEmbeddingBackendBridge", method = "dimensions", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::plugins::Plugin for RustlerRendererBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerRendererBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerRendererBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerRendererBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::plugins::Plugin for RustlerRerankerBackendBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerRerankerBackendBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerRerankerBackendBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerRerankerBackendBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::plugins::Plugin for RustlerTokenizerBackendBridge {
    ...
    fn version(&self) -> String {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerTokenizerBackendBridge", method = "version", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerTokenizerBackendBridge", method = "version", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerTokenizerBackendBridge", method = "version", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
...
impl xberg::TokenizerBackend for RustlerTokenizerBackendBridge {
    fn count_tokens(&self, text: &str) -> usize {
        ...
        match rx.blocking_recv() {    // This method's Rust signature is infallible, so a host failure cannot
            ...
            // default is indistinguishable from a real result to the caller.
            Ok(Ok(json)) => serde_json::from_str(&json).unwrap_or_else(|e| {
                tracing::warn!(wrapper = "RustlerTokenizerBackendBridge", method = "count_tokens", error = %e, "host returned an unparseable value; returning default");
                Default::default()
            }),
            // The host side already logs its own raises in detail, so keep this brief.
            Ok(Err(_msg)) => {
                tracing::warn!(wrapper = "RustlerTokenizerBackendBridge", method = "count_tokens", "host callback raised (details in host log); returning default");
                Default::default()
            }
            Err(_) => {
                tracing::warn!(wrapper = "RustlerTokenizerBackendBridge", method = "count_tokens", "reply channel closed before a reply arrived (host process exited or dropped the call); returning default");
                Default::default()
            }}
    }
}
...
#[rustler::nif]
pub fn captioningconfig_default_min_image_area() -> u32 {
    xberg::CaptioningConfig::default_min_image_area()
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn chunkclassificationconfig_default_batch_size() -> usize {
    xberg::ChunkClassificationConfig::default_batch_size()
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn chunkclassificationconfig_default_max_concurrency() -> usize {
    xberg::ChunkClassificationConfig::default_max_concurrency()
}
...
#[rustler::nif]
pub fn doctorcheck_pass(name: String, message: String) -> DoctorCheck {
...
#[rustler::nif]
pub fn doctorcheck_warn(name: String, message: String) -> DoctorCheck {
...
#[rustler::nif]
pub fn doctorcheck_fail(name: String, message: String) -> DoctorCheck {
...
#[rustler::nif]
pub fn doctorcheck_skip(name: String, message: String) -> DoctorCheck {
...
#[rustler::nif]
pub fn doctorreport_is_ok(obj: DoctorReport) -> bool {
    xberg::DoctorReport::from(obj).is_ok()
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn extractionconfig_default_archive_depth() -> usize {
    xberg::ExtractionConfig::default_archive_depth()
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn extractionconfig_default_max_embedded_file_bytes() -> Option<u64> {
    xberg::ExtractionConfig::default_max_embedded_file_bytes()
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn extractionconfig_default_extraction_timeout() -> Option<u64> {
    xberg::ExtractionConfig::default_extraction_timeout()
}
...
#[rustler::nif]
pub fn extractionconfig_validate(obj: String) -> Result<(), String> {
    let obj: xberg::ExtractionConfig = serde_json::from_str::<xberg::ExtractionConfig>(&obj)
        .map_err(|error| format!("failed to deserialize parameter `obj` for `extractionconfig_validate`: {error}"))?;
    let result = obj.validate().map_err(|e| e.to_string())?;
    Ok(result)
}
...
/// result's `images` array; that is `wants_own_bytes_in_result`.
#[rustler::nif]
...
#[rustler::nif]
pub fn extractionconfig_runs_ocr_on_embedded_images(obj: ExtractionConfig) -> bool {
    xberg::ExtractionConfig::from(obj).runs_ocr_on_embedded_images()
}
...
///
/// Deliberately narrower than `needs_image_data`: a standalone
...
/// QR-code detection.
#[rustler::nif]
pub fn extractionconfig_wants_own_bytes_in_result(obj: ExtractionConfig) -> bool {
    xberg::ExtractionConfig::from(obj).wants_own_bytes_in_result()
}
...
#[rustler::nif]
pub fn extractionresult_single(result: Option<String>) -> Result<ExtractionResult, String> {
    let result_core: Option<xberg::ExtractedDocument> = result
        .map(|s| serde_json::from_str::<xberg::ExtractedDocument>(&s))
        .transpose()
        .map_err(|error| format!("failed to deserialize parameter `result` for `extractionresult_single`: {error}"))?;
    Ok(xberg::ExtractionResult::single(result_core.unwrap_or_default()).into())
}
...
#[rustler::nif]
pub fn heuristicsconfig_validate(obj: String) -> Result<(), String> {
    let obj: xberg::HeuristicsConfig = serde_json::from_str::<xberg::HeuristicsConfig>(&obj)
        .map_err(|error| format!("failed to deserialize parameter `obj` for `heuristicsconfig_validate`: {error}"))?;
    let result = obj.validate().map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn llmconfig_validate(obj: String) -> Result<(), String> {
    let obj: xberg::LlmConfig = serde_json::from_str::<xberg::LlmConfig>(&obj)
        .map_err(|error| format!("failed to deserialize parameter `obj` for `llmconfig_validate`: {error}"))?;
    let result = obj.validate().map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn ngramrange_default() -> NgramRange {
    xberg::NgramRange::default().into()
}
...
#[rustler::nif]
pub fn pdfconfig_validate(obj: String) -> Result<(), String> {
    let obj: xberg::PdfConfig = serde_json::from_str::<xberg::PdfConfig>(&obj)
        .map_err(|error| format!("failed to deserialize parameter `obj` for `pdfconfig_validate`: {error}"))?;
    let result = obj.validate().map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn redactionconfig_validate(obj: String) -> Result<(), String> {
    let obj: xberg::RedactionConfig = serde_json::from_str::<xberg::RedactionConfig>(&obj)
        .map_err(|error| format!("failed to deserialize parameter `obj` for `redactionconfig_validate`: {error}"))?;
    let result = obj.validate().map_err(|e| e.to_string())?;
    Ok(result)
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn structuredextractionconfig_default_schema_name() -> String {
    xberg::StructuredExtractionConfig::default_schema_name()
}
...
/// have to call it to reproduce the default, and a private one is out of their reach.
#[rustler::nif]
pub fn urlextractionconfig_default_xberg_crawl_config() -> CrawlConfig {
    xberg::UrlExtractionConfig::default_xberg_crawl_config().into()
}
...
impl From<Attributes> for xberg::Attributes {
    fn from(val: Attributes) -> Self {
        Self {
            id: val.id,
            classes: val.classes.into_iter().collect(),
            key_values: val.key_values.into_iter().map(Into::into).collect(),
            ..Default::default()
        }
    }
}
...
impl From<xberg::Attributes> for Attributes {
    fn from(val: xberg::Attributes) -> Self {
        Self {
...
impl From<ConcurrencyConfig> for xberg::ConcurrencyConfig {
    fn from(val: ConcurrencyConfig) -> Self {
        Self {
            ...
            max_concurrent_ocr: val.max_concurrent_ocr,
            ..Default::default()
        }
    }
}
...
impl From<xberg::ConcurrencyConfig> for ConcurrencyConfig {
    fn from(val: xberg::ConcurrencyConfig) -> Self {
        Self {
            max_threads: val.max_threads,
            max_concurrent_ocr: val.max_concurrent_ocr,
        }
...
impl From<DjotAttributeGroup> for xberg::DjotAttributeGroup {
    fn from(val: DjotAttributeGroup) -> Self {
        Self {
            identifier: val.identifier,
            attributes: val.attributes.into(),
            ..Default::default()
        }
    }
}
...
impl From<xberg::DjotAttributeGroup> for DjotAttributeGroup {
    fn from(val: xberg::DjotAttributeGroup) -> Self {
        Self {
            identifier: val.identifier.to_string(),
            attributes: val.attributes.into(),
        }
    }
}
...
impl From<xberg::Element> for Element {
    fn from(val: xberg::Element) -> Self {
        Self {
            element_id: val.element_id.to_string(),
            element_type: val.element_type.into(),
            text: val.text.to_string(),
            metadata: val.metadata.into(),
        }
...
impl From<ExtractionConfig> for xberg::ExtractionConfig {
    fn from(val: ExtractionConfig) -> Self {
        Self {
            mime_detection_policy: val.mime_detection_policy.into(),
            ...
            ocr_near_empty_fallback: val.ocr_near_empty_fallback,
            ocr_scanned_page_quality_gate: val.ocr_scanned_page_quality_gate,
            ocr_embedded_images: val.ocr_embedded_images,
            ...
            apply_notebook_cell_tags: val.apply_notebook_cell_tags,
            ...
            geojson: val.geojson.map(Into::into),
...
impl From<FileExtractionConfig> for xberg::FileExtractionConfig {
    fn from(val: FileExtractionConfig) -> Self {
        Self {
            mime_detection_policy: val.mime_detection_policy.map(Into::into),
            enable_quality_processing: val.enable_quality_processing,
            ocr: val.ocr.map(Into::into),
            force_ocr: val.force_ocr,
...
impl From<GeoJsonExtractionConfig> for xberg::GeoJsonExtractionConfig {
    fn from(val: GeoJsonExtractionConfig) -> Self {
        Self {
            include_full_coordinates: val.include_full_coordinates,
            ..Default::default()
        }
    }
}
...
impl From<xberg::GeoJsonExtractionConfig> for GeoJsonExtractionConfig {
    fn from(val: xberg::GeoJsonExtractionConfig) -> Self {
        Self {
            include_full_coordinates: val.include_full_coordinates,
        }
    }
...
impl From<HierarchicalBoundingBox> for xberg::HierarchicalBoundingBox {
    fn from(val: HierarchicalBoundingBox) -> Self {
        Self {
            left: val.left,
            top: val.top,
            right: val.right,
...
impl From<xberg::HierarchicalBoundingBox> for HierarchicalBoundingBox {
    fn from(val: xberg::HierarchicalBoundingBox) -> Self {
        Self {
            left: val.left,
            top: val.top,
            right: val.right,
...
impl From<xberg::ImageDimensions> for ImageDimensions {
    fn from(val: xberg::ImageDimensions) -> Self {
        Self {
            width: val.width,
            height: val.height,
        }
...
impl From<xberg::ImageDpi> for ImageDpi {
    fn from(val: xberg::ImageDpi) -> Self {
        Self {
            horizontal: val.horizontal,
            vertical: val.vertical,
        }
...
impl From<ImagePreprocessingMetadata> for xberg::ImagePreprocessingMetadata {
    fn from(val: ImagePreprocessingMetadata) -> Self {
        Self {
            original_dimensions: val.original_dimensions.into(),
            original_dpi: val.original_dpi.into(),
            target_dpi: val.target_dpi,
            scale_factor: val.scale_factor,
            auto_adjusted: val.auto_adjusted,
            final_dpi: val.final_dpi,
            new_dimensions: val.new_dimensions.map(Into::into),
...
impl From<KeyValueAttribute> for xberg::KeyValueAttribute {
    fn from(val: KeyValueAttribute) -> Self {
        Self {
            key: val.key,
            value: val.value,
            ..Default::default()
...
impl From<xberg::KeyValueAttribute> for KeyValueAttribute {
    fn from(val: xberg::KeyValueAttribute) -> Self {
        Self {
...
impl From<KeywordConfig> for xberg::KeywordConfig {
    fn from(val: KeywordConfig) -> Self {
        Self {
            ...
            ngram_range: val.ngram_range.into(),
            language: val.language,
            #[cfg(feature = "keywords-yake")]
...
impl From<xberg::LlmBudgetConfig> for LlmBudgetConfig {
    fn from(val: xberg::LlmBudgetConfig) -> Self {
        Self {
            global_limit: val.global_limit,
            model_limits: val.model_limits.map(|m| m.into_iter().collect()),
...
impl From<xberg::LlmCacheConfig> for LlmCacheConfig {
    fn from(val: xberg::LlmCacheConfig) -> Self {
        Self {
            max_entries: val.max_entries,
            ttl_seconds: val.ttl_seconds,
...
impl From<xberg::LlmProviderConfig> for LlmProviderConfig {
    fn from(val: xberg::LlmProviderConfig) -> Self {
        Self {
            name: val.name.to_string(),
...
impl From<xberg::LlmRateLimitConfig> for LlmRateLimitConfig {
    fn from(val: xberg::LlmRateLimitConfig) -> Self {
        Self {
            rpm: val.rpm,
            tpm: val.tpm,
            window_seconds: val.window_seconds,
...
impl From<MarkdownCodeBlock> for xberg::MarkdownCodeBlock {
    fn from(val: MarkdownCodeBlock) -> Self {
        Self {
            language: val.language,
            code: val.code,
            ..Default::default()
...
impl From<xberg::MarkdownCodeBlock> for MarkdownCodeBlock {
    fn from(val: xberg::MarkdownCodeBlock) -> Self {
        Self {
            language: val.language.to_string(),
...
impl From<xberg::MarkdownLink> for MarkdownLink {
    fn from(val: xberg::MarkdownLink) -> Self {
        Self {
            text: val.text.to_string(),
            url: val.url.to_string(),
        }
...
impl From<xberg::NgramRange> for NgramRange {
    fn from(val: xberg::NgramRange) -> Self {
        Self {
            min: val.min,
            max: val.max,
        }
...
impl From<OcrBackendCapabilities> for xberg::OcrBackendCapabilities {
    fn from(val: OcrBackendCapabilities) -> Self {
        Self {
            name: val.name,
            supported_languages: val.supported_languages.into_iter().collect(),
        }
    }
}

impl From<xberg::OcrBackendCapabilities> for OcrBackendCapabilities {
    fn from(val: xberg::OcrBackendCapabilities) -> Self {
        Self {
            name: val.name.to_string(),
            supported_languages: val.supported_languages.into_iter().collect(),
        }
...
impl From<xberg::OcrPoint> for OcrPoint {
    fn from(val: xberg::OcrPoint) -> Self {
...
impl From<OcrQualityThresholds> for xberg::OcrQualityThresholds {
    fn from(val: OcrQualityThresholds) -> Self {
        Self {
            ...
            max_ocr_output_fragmented_word_ratio: val.max_ocr_output_fragmented_word_ratio,
            min_ocr_mean_confidence: val.min_ocr_mean_confidence,
            min_words_for_ocr_output_check: val.min_words_for_ocr_output_check,
            max_ocr_output_dict_invalid_word_ratio: val.max_ocr_output_dict_invalid_word_ratio,
            discard_suspected_ocr_noise: val.discard_suspected_ocr_noise,
...
impl From<PageContent> for xberg::PageContent {
    fn from(val: PageContent) -> Self {
        Self {
            ...
            ocr_confidence: val.ocr_confidence.map(Into::into),
        }
    }
}
...
impl From<xberg::PageDimensions> for PageDimensions {
    fn from(val: xberg::PageDimensions) -> Self {
        Self {
            width: val.width,
            height: val.height,
        }
...
impl From<PageOcrConfidence> for xberg::PageOcrConfidence {
    fn from(val: PageOcrConfidence) -> Self {
        Self {
            score: val.score,
...
impl From<xberg::PageOcrConfidence> for PageOcrConfidence {
    fn from(val: xberg::PageOcrConfidence) -> Self {
        Self {
            score: val.score,
            word_count: val.word_count,
            backend: val.backend.to_string(),
...
impl From<PixelDimensions> for xberg::PixelDimensions {
    fn from(val: PixelDimensions) -> Self {
        Self {
            width: val.width,
            height: val.height,
            ..Default::default()
...
impl From<xberg::PixelDimensions> for PixelDimensions {
    fn from(val: xberg::PixelDimensions) -> Self {
        Self {
            width: val.width,
            height: val.height,
        }
...
impl From<xberg::TesseractConfig> for TesseractConfig {
    fn from(val: xberg::TesseractConfig) -> Self {
        Self {
            ...
            tessedit_use_primary_params_model: val.tessedit_use_primary_params_model,
            textord_space_size_is_variable: val.textord_space_size_is_variable,
            thresholding_method: val.thresholding_method.to_string(),
        }
    }
}
...
impl From<TextMetadata> for xberg::TextMetadata {
    fn from(val: TextMetadata) -> Self {
        Self {
            ...
            links: val.links.map(|v| v.into_iter().map(Into::into).collect()),
            code_blocks: val.code_blocks.map(|v| v.into_iter().map(Into::into).collect()),
            ..Default::default()
        }
    }
}
...
impl From<xberg::candle_ocr::CandleDevicePreference> for CandleDevicePreference {
    fn from(val: xberg::candle_ocr::CandleDevicePreference) -> Self {
        match val {
            xberg::candle_ocr::CandleDevicePreference::Auto => Self::Auto,
            xberg::candle_ocr::CandleDevicePreference::Cpu => Self::Cpu,
            xberg::candle_ocr::CandleDevicePreference::Cuda => Self::Cuda,
            xberg::candle_ocr::CandleDevicePreference::Metal => Self::Metal,
        }
    }
}

impl From<xberg::candle_ocr::CandleTrocrVariant> for CandleTrocrVariant {
    fn from(val: xberg::candle_ocr::CandleTrocrVariant) -> Self {
        match val {
            xberg::candle_ocr::CandleTrocrVariant::BasePrinted => Self::BasePrinted,
            xberg::candle_ocr::CandleTrocrVariant::LargePrinted => Self::LargePrinted,
            xberg::candle_ocr::CandleTrocrVariant::BaseHandwritten => Self::BaseHandwritten,
            xberg::candle_ocr::CandleTrocrVariant::LargeHandwritten => Self::LargeHandwritten,
        }
    }
}
...
impl From<xberg::ConfidenceSemantics> for ConfidenceSemantics {
    fn from(val: xberg::ConfidenceSemantics) -> Self {
        match val {
            xberg::ConfidenceSemantics::Legibility { scale_max } => Self::Legibility { scale_max },
            xberg::ConfidenceSemantics::Uncalibrated => Self::Uncalibrated,
            xberg::ConfidenceSemantics::None => Self::None,
        }
    }
}
...
impl From<CredentialProviderConfig> for xberg::CredentialProviderConfig {
    fn from(val: CredentialProviderConfig) -> Self {
        match val {
            ...
            CredentialProviderConfig::VertexAdc { scope } => Self::VertexAdc { scope },
...
impl From<xberg::CredentialProviderConfig> for CredentialProviderConfig {
    fn from(val: xberg::CredentialProviderConfig) -> Self {
        match val {
            ...
            xberg::CredentialProviderConfig::VertexAdc { scope } => Self::VertexAdc {
                scope: scope.map(|v| v.to_string()),
            },
            xberg::CredentialProviderConfig::BedrockWebIdentity {
                ...
                session_name: session_name.map(|v| v.to_string()),
...
impl From<xberg::candle_ocr::GlmOcrLayoutMode> for GlmOcrLayoutMode {
    fn from(val: xberg::candle_ocr::GlmOcrLayoutMode) -> Self {
        match val {
            xberg::candle_ocr::GlmOcrLayoutMode::WholePage => Self::WholePage,
            xberg::candle_ocr::GlmOcrLayoutMode::Paired => Self::Paired,
        }
    }
}

impl From<xberg::candle_ocr::GlmOcrTaskKind> for GlmOcrTaskKind {
    fn from(val: xberg::candle_ocr::GlmOcrTaskKind) -> Self {
        match val {
            xberg::candle_ocr::GlmOcrTaskKind::Ocr => Self::Ocr,
            xberg::candle_ocr::GlmOcrTaskKind::Table => Self::Table,
            xberg::candle_ocr::GlmOcrTaskKind::Formula => Self::Formula,
            xberg::candle_ocr::GlmOcrTaskKind::Chart => Self::Chart,
            xberg::candle_ocr::GlmOcrTaskKind::Caption => Self::Caption,
        }
    }
}
...
impl From<HtmlToMarkdownRsOutputFormat> for html_to_markdown_rs::OutputFormat {
    fn from(val: HtmlToMarkdownRsOutputFormat) -> Self {
        match val {
            HtmlToMarkdownRsOutputFormat::Markdown => Self::Markdown,
            HtmlToMarkdownRsOutputFormat::Djot => Self::Djot,
            HtmlToMarkdownRsOutputFormat::Plain => Self::Plain,
        }
    }
}
...
impl From<LateInteractionModelType> for xberg::LateInteractionModelType {
    fn from(val: LateInteractionModelType) -> Self {
        match val {
            LateInteractionModelType::Preset { name } => Self::Preset { name },
            ...
            LateInteractionModelType::Plugin { name } => Self::Plugin { name },
        }
    }
}
...
impl From<MimeDetectionPolicy> for xberg::MimeDetectionPolicy {
    fn from(val: MimeDetectionPolicy) -> Self {
        match val {
            MimeDetectionPolicy::PreferContent => Self::PreferContent,
            MimeDetectionPolicy::TrustExtension => Self::TrustExtension,
            MimeDetectionPolicy::ContentOnly => Self::ContentOnly,
        }
    }
}

impl From<xberg::MimeDetectionPolicy> for MimeDetectionPolicy {
    fn from(val: xberg::MimeDetectionPolicy) -> Self {
        match val {
            xberg::MimeDetectionPolicy::PreferContent => Self::PreferContent,
            xberg::MimeDetectionPolicy::TrustExtension => Self::TrustExtension,
            xberg::MimeDetectionPolicy::ContentOnly => Self::ContentOnly,
        }
    }
}
...
impl From<NodeContent> for xberg::NodeContent {
    fn from(val: NodeContent) -> Self {
        match val {
            ...
            NodeContent::Comment { text } => Self::Comment { text },
            NodeContent::Group {
                label,
                heading_level,
                heading_text,
...
impl From<xberg::NodeContent> for NodeContent {
    fn from(val: xberg::NodeContent) -> Self {
        match val {
            ...
            xberg::NodeContent::Comment { text } => Self::Comment { text: text.to_string() },
...
impl From<OcrStrategy> for xberg::OcrStrategy {
    fn from(val: OcrStrategy) -> Self {
        match val {
            ...
            OcrStrategy::ScannedPages { min_confidence } => Self::ScannedPages { min_confidence },
        }
    }
}
...
impl From<xberg::OcrStrategy> for OcrStrategy {
    fn from(val: xberg::OcrStrategy) -> Self {
        match val {
            ...
            xberg::OcrStrategy::ScannedPages { min_confidence } => Self::ScannedPages { min_confidence },
        }
    }
}
...
impl From<xberg::OutputFormat> for OutputFormat {
    fn from(val: xberg::OutputFormat) -> Self {
        match val {
            ...
            xberg::OutputFormat::DocTags => Self {
                r#type: "doctags".to_string(),
                ..Default::default()
            },
...
impl From<OutputFormat> for xberg::OutputFormat {
    fn from(val: OutputFormat) -> Self {
        match val.r#type.as_str() {
            ...
            "doctags" => xberg::OutputFormat::DocTags,
...
impl From<xberg::candle_ocr::PaddleOcrVlTaskKind> for PaddleOcrVlTaskKind {
    fn from(val: xberg::candle_ocr::PaddleOcrVlTaskKind) -> Self {
        match val {
            xberg::candle_ocr::PaddleOcrVlTaskKind::Ocr => Self::Ocr,
            xberg::candle_ocr::PaddleOcrVlTaskKind::Table => Self::Table,
            xberg::candle_ocr::PaddleOcrVlTaskKind::Formula => Self::Formula,
            xberg::candle_ocr::PaddleOcrVlTaskKind::Chart => Self::Chart,
        }
    }
}
...
impl From<xberg::PageOrientationHandling> for PageOrientationHandling {
    fn from(val: xberg::PageOrientationHandling) -> Self {
        match val {
            xberg::PageOrientationHandling::SelfCorrecting => Self::SelfCorrecting,
            xberg::PageOrientationHandling::RecognisesRotatedText => Self::RecognisesRotatedText,
            xberg::PageOrientationHandling::RequiresUpright => Self::RequiresUpright,
        }
    }
}
...
impl From<xberg::PdfBackend> for PdfBackend {
    fn from(val: xberg::PdfBackend) -> Self {
        match val {
            xberg::PdfBackend::Native => Self::Native,
            xberg::PdfBackend::Pdfium => Self::Pdfium,
        }
    }
}
    ...
    fn from(val: xberg::PiiCategory) -> Self {
        match val {
            ...
            xberg::PiiCategory::PostalCode => Self {
                r#type: "postal_code".to_string(),
                ..Default::default()
            },
            xberg::PiiCategory::IpAddress => Self {
                r#type: "ip_address".to_string(),
                ..Default::default()
            },
            ...
            xberg::PiiCategory::SwiftBic => Self {
                r#type: "swift_bic".to_string(),
                ..Default::default()
            },
            xberg::PiiCategory::DateOfBirth => Self {
                r#type: "date_of_birth".to_string(),
                ..Default::default()
            },
...
impl From<SparseEmbeddingModelType> for xberg::SparseEmbeddingModelType {
    fn from(val: SparseEmbeddingModelType) -> Self {
        match val {
            SparseEmbeddingModelType::Preset { name } => Self::Preset { name },
            ...
            SparseEmbeddingModelType::Plugin { name } => Self::Plugin { name },
        }
    }
}
...
#[rustler::nif]
pub fn attributes_from_json(json: String) -> Result<Attributes, String> {
...
#[rustler::nif]
pub fn bedrock_config_from_json(json: String) -> Result<BedrockConfig, String> {
    serde_json::from_str::<xberg::BedrockConfig>(&json)
        .map(BedrockConfig::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn concurrency_config_from_json(json: String) -> Result<ConcurrencyConfig, String> {
    serde_json::from_str::<xberg::ConcurrencyConfig>(&json)
        .map(ConcurrencyConfig::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn csv_config_from_json(json: String) -> Result<CsvConfig, String> {
...
#[rustler::nif]
pub fn djot_attribute_group_from_json(json: String) -> Result<DjotAttributeGroup, String> {
...
#[rustler::nif]
pub fn doctor_check_from_json(json: String) -> Result<DoctorCheck, String> {
...
#[rustler::nif]
pub fn doctor_report_from_json(json: String) -> Result<DoctorReport, String> {
...
#[rustler::nif]
pub fn geo_json_extraction_config_from_json(json: String) -> Result<GeoJsonExtractionConfig, String> {
    serde_json::from_str::<xberg::GeoJsonExtractionConfig>(&json)
        .map(GeoJsonExtractionConfig::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn hierarchical_bounding_box_from_json(json: String) -> Result<HierarchicalBoundingBox, String> {
    serde_json::from_str::<xberg::HierarchicalBoundingBox>(&json)
        .map(HierarchicalBoundingBox::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn image_dpi_from_json(json: String) -> Result<ImageDpi, String> {
...
#[rustler::nif]
pub fn key_value_attribute_from_json(json: String) -> Result<KeyValueAttribute, String> {
...
#[rustler::nif]
pub fn llm_budget_config_from_json(json: String) -> Result<LlmBudgetConfig, String> {
    serde_json::from_str::<xberg::LlmBudgetConfig>(&json)
        .map(LlmBudgetConfig::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn llm_cache_config_from_json(json: String) -> Result<LlmCacheConfig, String> {
    serde_json::from_str::<xberg::LlmCacheConfig>(&json)
        .map(LlmCacheConfig::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn llm_provider_config_from_json(json: String) -> Result<LlmProviderConfig, String> {
    serde_json::from_str::<xberg::LlmProviderConfig>(&json)
        .map(LlmProviderConfig::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn llm_rate_limit_config_from_json(json: String) -> Result<LlmRateLimitConfig, String> {
    serde_json::from_str::<xberg::LlmRateLimitConfig>(&json)
        .map(LlmRateLimitConfig::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn markdown_code_block_from_json(json: String) -> Result<MarkdownCodeBlock, String> {
    serde_json::from_str::<xberg::MarkdownCodeBlock>(&json)
        .map(MarkdownCodeBlock::from)
        .map_err(|e| e.to_string())
}

#[rustler::nif]
pub fn markdown_link_from_json(json: String) -> Result<MarkdownLink, String> {
    serde_json::from_str::<xberg::MarkdownLink>(&json)
        .map(MarkdownLink::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn ngram_range_from_json(json: String) -> Result<NgramRange, String> {
...
#[rustler::nif]
pub fn ocr_backend_capabilities_from_json(json: String) -> Result<OcrBackendCapabilities, String> {
    serde_json::from_str::<xberg::OcrBackendCapabilities>(&json)
        .map(OcrBackendCapabilities::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn ocr_point_from_json(json: String) -> Result<OcrPoint, String> {
...
#[rustler::nif]
pub fn page_ocr_confidence_from_json(json: String) -> Result<PageOcrConfidence, String> {
    serde_json::from_str::<xberg::PageOcrConfidence>(&json)
        .map(PageOcrConfidence::from)
        .map_err(|e| e.to_string())
}
...
#[rustler::nif]
pub fn pixel_dimensions_from_json(json: String) -> Result<PixelDimensions, String> {
...
#[rustler::nif]
pub fn table_cell_style_from_json(json: String) -> Result<TableCellStyle, String> {
    serde_json::from_str::<xberg::TableCellStyle>(&json)
        .map(TableCellStyle::from)
        .map_err(|e| e.to_string())
}
