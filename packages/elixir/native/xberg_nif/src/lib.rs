...
#[rustler::nif]
pub fn register_document_extractor(extractor: rustler::ResourceArc<DocumentExtractor>) -> Result<(), String> {
    let result = xberg::register_document_extractor(&extractor.inner).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn unregister_document_extractor(name: String) -> Result<(), String> {
    let result = xberg::unregister_document_extractor(&name).map_err(|e| e.to_string())?;
    Ok(result)
}
...
#[rustler::nif]
pub fn register_renderer(renderer: rustler::ResourceArc<Renderer>) -> Result<(), String> {
    let result = xberg::register_renderer(&renderer.inner).map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn unregister_renderer(name: String) -> Result<(), String> {
    let result = xberg::unregister_renderer(&name).map_err(|e| e.to_string())?;
    Ok(result)
}
