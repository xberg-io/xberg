...
pub fn extract_bytes_sync(
    ...
    let config_core: Option<xberg::ExtractionConfig> = config
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::extract_bytes_sync(
        content.as_slice(),
        &mime_type,
        config_core.as_ref().unwrap_or(&Default::default()),
    )
...
pub fn batch_extract_files_sync(
    ...
    let items_core: Vec<xberg::BatchFileItem> = items
        .map(|s| serde_json::from_str::<Vec<xberg::BatchFileItem>>(&s).map_err(|e| e.to_string()))
        .transpose()?
        .unwrap_or_default();
    let config_core: Option<xberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<xberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::batch_extract_files_sync(items_core, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
...
pub fn batch_extract_bytes_sync(
    ...
    let items_core: Vec<xberg::BatchBytesItem> = items
        .map(|s| serde_json::from_str::<Vec<xberg::BatchBytesItem>>(&s).map_err(|e| e.to_string()))
        .transpose()?
        .unwrap_or_default();
    let config_core: Option<xberg::ExtractionConfig> = config
        .map(|s| serde_json::from_str::<xberg::ExtractionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = xberg::batch_extract_bytes_sync(items_core, config_core.as_ref().unwrap_or(&Default::default()))
        .map_err(|e| e.to_string())?;
    Ok(result.into_iter().map(Into::into).collect())
}
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::batch_extract_files(items_core, config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into_iter().map(Into::into).collect())
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        xberg::batch_extract_bytes(items_core, config_core.as_ref().unwrap_or(&Default::default()))
                            .await
                    })
                    .map_err(|e| e.to_string())?;
                Ok(result.into_iter().map(Into::into).collect())
...
pub fn batch_bytes_item_from_json(json: String) -> Result<BatchBytesItem, String> {
    serde_json::from_str::<xberg::BatchBytesItem>(&json)
...
pub fn batch_file_item_from_json(json: String) -> Result<BatchFileItem, String> {
    serde_json::from_str::<xberg::BatchFileItem>(&json)
