...
class XbergApi
{
    public static function extractBytes(string $content, string $mime_type, \Xberg\ExtractionConfig $config): \Xberg\ExtractionResult { throw new \RuntimeException('Not implemented.'); }
    public static function extractFile(string $path, ?string $mime_type = null, ?\Xberg\ExtractionConfig $config = null): \Xberg\ExtractionResult { throw new \RuntimeException('Not implemented.'); }
    public static function extractFileSync(string $path, ?string $mime_type = null, ?\Xberg\ExtractionConfig $config = null): \Xberg\ExtractionResult { throw new \RuntimeException('Not implemented.'); }
    public static function extractBytesSync(string $content, string $mime_type, \Xberg\ExtractionConfig $config): \Xberg\ExtractionResult { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Xberg\BatchFileItem> $items
     * @param \Xberg\ExtractionConfig $config
     * @return array<\Xberg\ExtractionResult>
     */
    public static function batchExtractFilesSync(array $items, \Xberg\ExtractionConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Xberg\BatchBytesItem> $items
     * @param \Xberg\ExtractionConfig $config
     * @return array<\Xberg\ExtractionResult>
     */
    public static function batchExtractBytesSync(array $items, \Xberg\ExtractionConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Xberg\BatchFileItem> $items
     * @param \Xberg\ExtractionConfig $config
     * @return array<\Xberg\ExtractionResult>
     */
    public static function batchExtractFiles(array $items, \Xberg\ExtractionConfig $config): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Xberg\BatchBytesItem> $items
     * @param \Xberg\ExtractionConfig $config
     * @return array<\Xberg\ExtractionResult>
     */
    public static function batchExtractBytes(array $items, \Xberg\ExtractionConfig $config): array { throw new \RuntimeException('Not implemented.'); }
