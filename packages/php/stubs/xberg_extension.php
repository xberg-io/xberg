...
final class NerConfig
{
    public function __construct(
         ...
         * @var ?string
         */
        public readonly ?string $hfRepo = null,
        /**
         ...
         * @var ?string
         */
        public readonly ?string $hfModelFile = null,
        /**
         ...
         * @var ?string
         */
        public readonly ?string $hfTokenizerFile = null,
        /**
         ...
         *
         * @var ?GlinerArchitecture
         */
        public readonly ?GlinerArchitecture $hfArchitecture = null,
        /**
         ...
         * @var ?string
         */
        public readonly ?string $modelDir = null,
        /**
         ...
         * @var ?string
         */
        public readonly ?string $loraAdapterDir = null
    ) { }
}
...
final class RedactionConfig
{
    public function __construct(
         ...
         * @var array<RedactionTerm>
         */
        public readonly array $preserveTerms,
        /**
...
{
    public function __construct(
        /** @var string Short, stable identifier for the current stage (e.g. `"download"`). */
        public readonly string $stage,
        /** @var ?string Optional human-readable detail for this event. */
        public readonly ?string $message = null,
        /** @var ?float Optional completion fraction in `0.0..=1.0`, when known. */
...
{
    public function __construct(
        /** @var string Canonical model-type key. */
 ...
 */
final class CitedField
{
    public function __construct(
        /** @var string The field value. */
        public readonly string $value,
        /** @var CitationSource Provenance of the value. */
        public readonly CitationSource $source,
        /** @var ?int 1-based page number where the value appears, when known. */
        public readonly ?int $page = null,
        /** @var ?float Confidence in the citation, when known. */
 ...
 */
final class CitationOutput
{
    public function __construct(
        /** @var string Citation-wrapped envelope (or the original `merged` when citations are off). */
        public readonly string $structuredOutput,
        /** @var string Values only (`CitedField.value` extracted recursively). */
        public readonly string $structuredOutputFlat
    ) { }
}
...
{
    public function __construct(
        /** @var string System instruction primer. */
        public readonly string $system,
        /** @var ?string User content (text + images context). None for VisionOnly / Skip modes. */
        public readonly ?string $userText = null
    ) { }
}
 ...
 */
final class ChunkerConfig
{
    public function __construct(
        /** @var int Maximum input tokens per batch. */
        public readonly int $maxInputTokens,
        /** @var int Estimated tokens contributed by each image. */
        public readonly int $avgTokensPerImage,
        /** @var int Characters-per-token divisor used to estimate text/image byte token counts. */
        public readonly int $charsPerToken
    ) { }
    public static function default(): ChunkerConfig
    { throw new \RuntimeException('Not implemented — provided by the native extension.'); }
}
...
{
    public function __construct(
        /** @var array<PageImage> Page images in this batch. */
...
{
    public function __construct(
        /** @var int 1-based page number (matches the citation envelope convention). */
        public readonly int $pageNumber,
        /** @var string PNG-encoded page bytes. */
 ...
 */
final class MergedOutput
{
    public function __construct(
        /** @var string The merged JSON value. */
        public readonly string $merged,
        /** @var Outcome Aggregate outcome across all batches. */
        public readonly Outcome $outcome,
        /** @var array<string> Per-batch validation/parse errors, surfaced by the orchestrator event payload. */
        public readonly array $perBatchErrors,
        /** @var ?string Top-level error message, when the whole operation failed. */
         ...
         */
        public readonly ?ExtractionConfidence $confidence = null
    ) { }
}
 ...
 */
final class CustomGlinerSource
{
    public function __construct(
        /** @var string Hugging Face repo id, e.g. `"gliner-community/gliner_small-v2.5"`. */
        public readonly string $repo,
        /** @var string Path to the ONNX model file within `repo`. */
        public readonly string $modelFile,
        /** @var string Path to the tokenizer file within `repo`. */
        public readonly string $tokenizerFile,
        /** @var GlinerArchitecture Which GLiNER tensor I/O contract `model_file` uses. */
        public readonly GlinerArchitecture $architecture
    ) { }
}
 ...
 */
final class TextRedactionOutcome
{
    public function __construct(
        /** @var RehydrationMap Token → original PII text, populated for `TokenReplace` strategy hits. */
        public readonly RehydrationMap $map,
        /** @var RejectionCounts Post-detection validator rejection counts, keyed by reason. */
        public readonly RejectionCounts $rejectionCounts
    ) { }
}
...
final class RejectionCount
{
    public function __construct(
        ...
        /** @var int Number of candidates rejected for this reason. */
...
enum GlinerArchitecture: string
{
    case Gliner1 = 'gliner1';
...
class XbergApi
{
     ...
     * @return \Xberg\CitationOutput
     */
    public static function fuse(string $merged, array $ocr_elements, array $element_metadata, bool $emit_citations, float $match_threshold, float $fused_confidence): \Xberg\CitationOutput { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<string> $raw_responses
     * @param string $schema
     * @param \Xberg\MergeMode $merge_mode
     * @return \Xberg\MergedOutput
     */
    public static function validateAndMerge(array $raw_responses, string $schema, \Xberg\MergeMode $merge_mode): \Xberg\MergedOutput { throw new \RuntimeException('Not implemented.'); }
    ...
    public static function customSourceFromParts(?string $repo = null, ?string $model_file = null, ?string $tokenizer_file = null, ?\Xberg\GlinerArchitecture $architecture = null): ?\Xberg\CustomGlinerSource { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param array<\Xberg\PatternMatch> $matches
     * @return array<\Xberg\PatternMatch>
     */
    public static function dedupeOverlaps(array $matches): array { throw new \RuntimeException('Not implemented.'); }
    public static function encryptMap(\Xberg\RehydrationMap $map, string $passphrase): string { throw new \RuntimeException('Not implemented.'); }
    public static function decryptMap(string $blob, string $passphrase): \Xberg\RehydrationMap { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param \Xberg\RehydrationMap $map
     * @param string $query
     * @return array<\Xberg\SubjectMatch>
     */
    public static function findSubject(\Xberg\RehydrationMap $map, string $query): array { throw new \RuntimeException('Not implemented.'); }
    /**
     * @param \Xberg\RehydrationMap $map
     * @param string $query
     * @return array<\Xberg\SubjectMatch>
     */
    public static function forgetSubject(\Xberg\RehydrationMap $map, string $query): array { throw new \RuntimeException('Not implemented.'); }
    /**
