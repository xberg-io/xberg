...
enum ChunkingDecision: string
{
    case NoChunking = 'NoChunking';
    case Chunk = 'Chunk';
    case UseOverrides = 'UseOverrides';
}

enum NoChunkingReason: string
{
    case SmallFile = 'SmallFile';
    case FewPages = 'FewPages';
    case TextLayerDetected = 'TextLayerDetected';
    case FormatNotChunkable = 'FormatNotChunkable';
    case ChunkingDisabled = 'ChunkingDisabled';
    case FastTextExtraction = 'FastTextExtraction';
}

enum ChunkingReason: string
{
    case LargeFile = 'LargeFile';
    case ManyPages = 'ManyPages';
    case OcrRequired = 'OcrRequired';
    case LargeAndManyPages = 'LargeAndManyPages';
}
