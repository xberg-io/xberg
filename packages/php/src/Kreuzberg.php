...
RedactionStrategy $strategy, string $original, PiiCategory $category, TokenCounter $counter): string
    {
        return \Kreuzberg\KreuzbergApi::applyStrategy($strategy, $original, $category, $counter); // delegate to native extension class
    }
    /**
...
string $text): int
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function summarizeWithLlm(
string $text, LlmConfig $llm_config, ?int $max_tokens = null): string
    {
        return \Kreuzberg\KreuzbergApi::summarizeWithLlm($text, $llm_config, $max_tokens); // delegate to native extension class
    }
    /**
...
string $image_bytes, string $image_mime, RegionKind $region_kind, LlmConfig $llm_config, ?string $custom_prompt = null): string
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractRegionWithVlmUsage(
string $image_bytes, string $image_mime, RegionKind $region_kind, LlmConfig $llm_config, ?string $custom_prompt = null): string
    {
        return \Kreuzberg\KreuzbergApi::extractRegionWithVlmUsage($image_bytes, $image_mime, $region_kind, $llm_config, $custom_prompt); // delegate to native extension class
    }
    /**
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function completeWithJsonSchema(
LlmConfig $llm_config, string $prompt, string $schema_name, string $schema, string $source): string
    {
        return \Kreuzberg\KreuzbergApi::completeWithJsonSchema($llm_config, $prompt, $schema_name, $schema, $source); // delegate to native extension class
    }
    /**
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function completeText(
LlmConfig $llm_config, string $prompt, string $source): string
    {
        return \Kreuzberg\KreuzbergApi::completeText($llm_config, $prompt, $source); // delegate to native extension class
    }
    /**
