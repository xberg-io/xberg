...
// alef:hash:42be65c803c6eb7e78b5067427da127a06cedd45702d3cbe63eddb6d9e235201
...
final class Kreuzberg
{
     ...
     */
    public static function extractBytesAsync(
string $content, string $mime_type, ExtractionConfig $config): ExtractionResult
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function extractFileAsync(
...
array $items, ExtractionConfig $config): array
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function batchExtractFilesAsync(
array $items, ExtractionConfig $config): array
    {
     ...
     * @throws \Kreuzberg\KreuzbergException
     */
    public static function batchExtractBytesAsync(
array $items, ExtractionConfig $config): array
    {
