...
string $content, string $mime_type, ExtractionConfig $config): ExtractionResult
    {
        return \Xberg\XbergApi::extractBytes($content, $mime_type, $config); // delegate to native extension class
    }
    /**
...
string $path, ?string $mime_type, ExtractionConfig $config): ExtractionResult
    {
        return \Xberg\XbergApi::extractFile($path, $mime_type, $config); // delegate to native extension class
    }
    /**
...
string $path, ?string $mime_type, ExtractionConfig $config): ExtractionResult
    {
        return \Xberg\XbergApi::extractFileSync($path, $mime_type, $config); // delegate to native extension class
    }
    /**
...
string $content, string $mime_type, ExtractionConfig $config): ExtractionResult
    {
        return \Xberg\XbergApi::extractBytesSync($content, $mime_type, $config); // delegate to native extension class
    }
    /**
...
array $items, ExtractionConfig $config): array
    {
        return \Xberg\XbergApi::batchExtractFilesSync($items, $config); // delegate to native extension class
    }
    /**
...
array $items, ExtractionConfig $config): array
    {
        return \Xberg\XbergApi::batchExtractBytesSync($items, $config); // delegate to native extension class
    }
    /**
...
array $items, ExtractionConfig $config): array
    {
        return \Xberg\XbergApi::batchExtractFiles($items, $config); // delegate to native extension class
    }
    /**
...
array $items, ExtractionConfig $config): array
    {
        return \Xberg\XbergApi::batchExtractBytes($items, $config); // delegate to native extension class
    }
    /**
