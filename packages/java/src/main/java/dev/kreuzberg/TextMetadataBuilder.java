...
// alef:hash:f9e40560afa6caed0c32d0584416a3ade238875a914e064a7c5dc32e24f798e3
...
public class TextMetadataBuilder {
    ...
    @JsonProperty("line_count")
    public TextMetadataBuilder withLineCount(final int value) {
    ...
    @JsonProperty("word_count")
    public TextMetadataBuilder withWordCount(final int value) {
    ...
    @JsonProperty("character_count")
    public TextMetadataBuilder withCharacterCount(final int value) {
