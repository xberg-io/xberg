...
// alef:hash:462408330ec013d5380e611af1462ce5fffd705631b54354db6bc80d8916bf02
...
public class TextMetadataBuilder {
    ...
    public TextMetadata build() {
        return new TextMetadata(lineCount, wordCount, characterCount, headers.orElse(null), links.orElse(null), codeBlocks.orElse(null));
    }
}
