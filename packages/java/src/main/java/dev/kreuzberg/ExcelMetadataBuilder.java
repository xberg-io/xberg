...
// alef:hash:6814cdfa8dbdda1266567c8147703ac0faa4ce01129e9dae1bb76f4823332aa7
...
public class ExcelMetadataBuilder {
    ...
    @com.fasterxml.jackson.annotation.JsonAlias("sheet_count")
    private Optional<Long> sheetCount = Optional.empty();
    @JsonProperty("sheetNames")
    @com.fasterxml.jackson.annotation.JsonAlias("sheet_names")
