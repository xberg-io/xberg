...
// alef:hash:a37700a8449cee8443b6cb5ee38b85be4255ccb2c8f3e3a74ad5d9c6878b53b0
...
public final class KreuzbergRs {
    ...
    public static byte[] renderPdfPageToPng(final byte[] pdfBytes, final long pageIndex, final Integer dpi, final String password) throws KreuzbergRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            int rc = (int) NativeLib.KREUZBERG_RENDER_PDF_PAGE_TO_PNG.invoke(cpdfBytes, pageIndex, cdpi, cpassword, outPtrHolder, outLenHolder, outCapHolder);
            if (rc != 0) {
                checkLastError();                return null;            }
