...
// alef:hash:b9dfb9666faecb6aa804b71edd64a9dc3c38904225edc13ebe63a99ba82d7928
...
public sealed interface EmbeddingModelType {
  ...
  record Custom(
      @JsonProperty("model_id") String modelId, @JsonProperty("dimensions") long dimensions)
