...
// alef:hash:10a879306ac64e11ec1c5efaf7cb7d28c9271c50e35788ff6574db4cb2a936e8
...
public class EmailMetadataBuilder {
    ...
    public EmailMetadata build() {
        return new EmailMetadata(fromEmail.orElse(null), fromName.orElse(null), toEmails, ccEmails, bccEmails, messageId.orElse(null),
                attachments);
    }
}
