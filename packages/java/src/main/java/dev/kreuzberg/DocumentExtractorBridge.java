...
/**
 * Allocates Panama FFM upcall stubs for an IDocumentExtractor implementation, assembles the C vtable in native memory, and provides static
...
public final class DocumentExtractorBridge implements AutoCloseable {
    ...
    DocumentExtractorBridge(final IDocumentExtractor impl) {
        ...
        try {
            ...
            var stubExtractBytes = LINKER.upcallStub(
                    LOOKUP.bind(this, "handleExtractBytes",
            ...
            var stubExtractFile = LINKER.upcallStub(
                    LOOKUP.bind(this, "handleExtractFile",
                            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class, MemorySegment.class,
                                    MemorySegment.class, MemorySegment.class, MemorySegment.class)),
                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                            ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS),
            ...
            var stubSupportedMimeTypes = LINKER.upcallStub(
                    LOOKUP.bind(this, "handleSupportedMimeTypes",
                            MethodType.methodType(int.class, MemorySegment.class, MemorySegment.class, MemorySegment.class)),
                    FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS), arena);
    ...
    private int handleExtractBytes(MemorySegment userData, MemorySegment content_in, MemorySegment mime_type_in, MemorySegment config_in,
    ...
    private int handleExtractFile(MemorySegment userData, MemorySegment path_in, MemorySegment mime_type_in, MemorySegment config_in,
            MemorySegment outResult, MemorySegment outError) {
        try {
    ...
    private int handleCanHandle(MemorySegment userData, MemorySegment _path_in, MemorySegment _mime_type_in, MemorySegment outResult,
    ...
    public static void registerDocumentExtractor(final IDocumentExtractor impl) throws Exception {
        ...
        try {
            try (var nameArena = Arena.ofConfined()) {
                ...
                int rc = (int) NativeLib.KREUZBERG_REGISTER_DOCUMENT_EXTRACTOR.invoke(nameCs, bridge.vtableSegment(), MemorySegment.NULL,
                        outErr);
                if (rc != 0) {
