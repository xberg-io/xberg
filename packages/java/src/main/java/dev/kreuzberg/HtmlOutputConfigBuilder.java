...
// alef:hash:8bf8c7aa115a5bfdb8a14996d9d130cb65732ce25b6279f6fad75ef1feddb758
...
public class HtmlOutputConfigBuilder {
    ...
    @com.fasterxml.jackson.annotation.JsonAlias("css_file")
    private Optional<java.nio.file.Path> cssFile = Optional.empty();
    private HtmlTheme theme = null;
    @JsonProperty("classPrefix")
    @com.fasterxml.jackson.annotation.JsonAlias("class_prefix")
    private String classPrefix = "";
    @JsonProperty("embedCss")
    @com.fasterxml.jackson.annotation.JsonAlias("embed_css")
