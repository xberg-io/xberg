...
// alef:hash:81b7e3c76c4410f65278569609d8eef8d90c8e53450ee7ec046b83f73242241f
...
class FormatMetadataDeserializer extends StdDeserializer<FormatMetadata> {
    ...
    public FormatMetadata deserialize(JsonParser parser, DeserializationContext ctx) throws java.io.IOException {
        ...
        if (tagNode == null || tagNode.isNull()) {
            throw new com.fasterxml.jackson.databind.JsonMappingException(parser, "Missing discriminator field: format_type");
        }
        ...
        return switch (tagValue) {
            ...
            default ->
                throw new com.fasterxml.jackson.databind.JsonMappingException(parser, "Unknown FormatMetadata discriminator: " + tagValue);
        };
    }
}
...
class FormatMetadataSerializer extends StdSerializer<FormatMetadata> {
    ...
    @Override
    public void serialize(FormatMetadata value, JsonGenerator gen, SerializerProvider provider) throws java.io.IOException {
        String tag;
        Object inner;
        ...
        if (inner != null) {
            ...
            if (tree.isObject()) {
                java.util.Iterator<java.util.Map.Entry<String, com.fasterxml.jackson.databind.JsonNode>> it = tree.fields();
                while (it.hasNext()) {
