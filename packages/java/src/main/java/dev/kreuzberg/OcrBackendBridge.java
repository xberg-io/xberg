...
/**
 * Allocates Panama FFM upcall stubs for an IOcrBackend implementation, assembles the C vtable in native memory, and provides static
...
public final class OcrBackendBridge implements AutoCloseable {
    ...
    private int handleProcessImage(MemorySegment userData, MemorySegment image_bytes_in, MemorySegment config_in, MemorySegment outResult,
    ...
    private int handleProcessImageFile(MemorySegment userData, MemorySegment path_in, MemorySegment config_in, MemorySegment outResult,
            MemorySegment outError) {
        try {
    ...
    private int handleProcessDocument(MemorySegment userData, MemorySegment _path_in, MemorySegment _config_in, MemorySegment outResult,
            MemorySegment outError) {
        try {
