...
// alef:hash:570858ff7088e4c89e2d0a21f123b821d28ed7629938c30e4c9083cfc70606ff
 ...
 *
 * <p>Uses {@code #[serde(tag = "node_type")]} to avoid "type" keyword collision in
...
public sealed interface NodeContent {
  ...
  record Slide(@JsonProperty("number") int number, @JsonProperty("title") Optional<String> title)
      implements NodeContent {}
  ...
  record Citation(@JsonProperty("key") String key, @JsonProperty("text") String text)
      implements NodeContent {}

  /** Admonition / callout container (note, warning, tip, etc.). */
  record Admonition(
      @JsonProperty("kind") String kind, @JsonProperty("title") Optional<String> title)
      implements NodeContent {}
