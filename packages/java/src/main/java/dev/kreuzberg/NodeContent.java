...
// alef:hash:dc4f167deb98169f5e3d1cbe59d0faef96445fe0835a8febca62dcf33a5affe8
...
public sealed interface NodeContent {
    ...
    /** Image reference. */
    record Image(@JsonProperty("description") Optional<String> description, @JsonProperty("image_index") Optional<Integer> imageIndex,
            @JsonProperty("src") Optional<String> src) implements NodeContent {
    }

    /** Code block. */
    record Code(@JsonProperty("text") String text, @JsonProperty("language") Optional<String> language) implements NodeContent {
    }
    ...
    record Group(@JsonProperty("label") Optional<String> label, @JsonProperty("heading_level") Optional<Byte> headingLevel,
    ...
    record Slide(@JsonProperty("number") int number, @JsonProperty("title") Optional<String> title) implements NodeContent {
    }
    ...
    record DefinitionItem(@JsonProperty("term") String term, @JsonProperty("definition") String definition) implements NodeContent {
    }
    ...
    record Admonition(@JsonProperty("kind") String kind, @JsonProperty("title") Optional<String> title) implements NodeContent {
    }

    /** Raw block preserved verbatim from the source format. */
    record RawBlock(@JsonProperty("format") String format, @JsonProperty("content") String content) implements NodeContent {
    }
