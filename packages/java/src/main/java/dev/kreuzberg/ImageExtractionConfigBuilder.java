...
// alef:hash:e930366312562863bd9ffdda546355edd0675e2670c3cc21739180de21301e09
...
public class ImageExtractionConfigBuilder {
    ...
    public ImageExtractionConfig build() {
        return new ImageExtractionConfig(extractImages, targetDpi, maxImageDimension, injectPlaceholders, autoAdjustDpi, minDpi, maxDpi,
                maxImagesPerPage.orElse(null), classify);
    }
}
