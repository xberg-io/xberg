...
// alef:hash:b5118dd9014877d664ce86f6e00796162c2964fc1de1668c1eeaba7dcc120cf6
 ...
 *
 * Defaults to {@code Characters} (Unicode character count). When using token-based sizing, chunks are sized by token count according to the
 * specified tokenizer.
 *
 * Token-based sizing uses HuggingFace tokenizers loaded at runtime. Any tokenizer available on HuggingFace Hub can be used, including
 * OpenAI-compatible tokenizers (e.g., {@code Xenova/gpt-4o}, {@code Xenova/cl100k_base}).
 */
