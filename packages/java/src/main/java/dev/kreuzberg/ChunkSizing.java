...
// alef:hash:a1d53be90aa60dfc5029eca7561d2d4b89aea96d3dc2ba453937e855ddc39932
 ...
 *
 * <p>Defaults to {@code Characters} (Unicode character count). When using token-based sizing,
 * chunks are sized by token count according to the specified tokenizer.
 *
 * <p>Token-based sizing uses HuggingFace tokenizers loaded at runtime. Any tokenizer available on
 * HuggingFace Hub can be used, including OpenAI-compatible tokenizers (e.g., {@code Xenova/gpt-4o},
