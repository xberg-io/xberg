...
// alef:hash:9c7d6de03d08df43d3f3822cf5d4c5bd4801ead1534ed9a1065a428d20b36c39
...
public class PdfConfigBuilder {
    ...
    @com.fasterxml.jackson.annotation.JsonAlias("extract_tables")
    private boolean extractTables = true;
    private Optional<List<String>> passwords = Optional.empty();
    @JsonProperty("extractMetadata")
    @com.fasterxml.jackson.annotation.JsonAlias("extract_metadata")
    private boolean extractMetadata = true;
    private Optional<HierarchyConfig> hierarchy = Optional.empty();
    @JsonProperty("extractAnnotations")
    @com.fasterxml.jackson.annotation.JsonAlias("extract_annotations")
    private boolean extractAnnotations = false;
    @JsonProperty("topMarginFraction")
    @com.fasterxml.jackson.annotation.JsonAlias("top_margin_fraction")
    private Optional<Float> topMarginFraction = Optional.empty();
    @JsonProperty("bottomMarginFraction")
    @com.fasterxml.jackson.annotation.JsonAlias("bottom_margin_fraction")
    private Optional<Float> bottomMarginFraction = Optional.empty();
    @JsonProperty("allowSingleColumnTables")
    @com.fasterxml.jackson.annotation.JsonAlias("allow_single_column_tables")
