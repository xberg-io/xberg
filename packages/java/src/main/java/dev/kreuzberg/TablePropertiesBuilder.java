...
// alef:hash:95d3e5f2c1951117291c4a3d9d2a25adc16df053708f14d8bf2ac806747d5c7e
...
public class TablePropertiesBuilder {
    ...
    public TableProperties build() {
        return new TableProperties(styleId.orElse(null), width.orElse(null), alignment.orElse(null), layout.orElse(null), look.orElse(null),
                borders.orElse(null), cellMargins.orElse(null), indent.orElse(null), caption.orElse(null));
    }
}
