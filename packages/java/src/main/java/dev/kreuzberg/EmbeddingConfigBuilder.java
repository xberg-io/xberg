...
// alef:hash:eaeb14d741f6fe747bcafaebaa53e26f02f07f6d553cdf4d8ea0f75282dc36d3
...
public class EmbeddingConfigBuilder {
    ...
    public EmbeddingConfig build() {
        return new EmbeddingConfig(model, normalize, batchSize, showDownloadProgress, cacheDir.orElse(null), acceleration.orElse(null),
