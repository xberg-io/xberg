...
// alef:hash:7d6b1973c99fb00d3e56b52e0c4dd1b93cd461147d626c9f5307c2bfbd47b890
...
public sealed interface AnnotationKind {
    ...
    record Link(@JsonProperty("url") String url, @JsonProperty("title") Optional<String> title) implements AnnotationKind {
    }
    ...
    record Custom(@JsonProperty("name") String name, @JsonProperty("value") Optional<String> value) implements AnnotationKind {
    }
}
