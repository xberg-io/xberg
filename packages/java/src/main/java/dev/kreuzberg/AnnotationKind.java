...
// alef:hash:718b90627aff47296296b819e4458c0d06fa74f4a0e44b741ea7f769a209275b
...
public sealed interface AnnotationKind {
  ...
  record Custom(@JsonProperty("name") String name, @JsonProperty("value") Optional<String> value)
      implements AnnotationKind {}
}
