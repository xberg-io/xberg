...
public record ServerConfig(
    ...
    public static final class Builder {
        ...
        private String host = serde(default = "default_host");
        private short port = serde(default = "default_port");
        @JsonProperty("cors_origins")
        @Nullable private List<String> corsOrigins;
        @JsonProperty("max_request_body_bytes")
        private long maxRequestBodyBytes = serde(default = "default_max_request_body_bytes");
        @JsonProperty("max_multipart_field_bytes")
        private long maxMultipartFieldBytes = serde(default = "default_max_multipart_field_bytes");
