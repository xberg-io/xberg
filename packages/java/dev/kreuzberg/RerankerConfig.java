...
public record RerankerConfig(
    @JsonProperty("model") RerankerModelType model,
    ...
    public static final class Builder {
        ...
        private RerankerModelType model = serde(default = "default_reranker_model");
        @JsonProperty("top_k")
        ...
        @JsonProperty("model")
        public Builder withModel(final RerankerModelType value) {
            this.model = value;
            return this;
        }
