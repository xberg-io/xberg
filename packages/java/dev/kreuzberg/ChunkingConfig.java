...
public record ChunkingConfig(
    ...
    public static final class Builder {
        ...
        private long maxCharacters = serde(default = "default_chunk_size");
        @JsonProperty("max_overlap")
        private long overlap = serde(default = "default_chunk_overlap");
        private boolean trim = serde(default = "default_trim");
        @JsonProperty("chunker_type")
        private ChunkerType chunkerType = serde(default = "default_chunker_type");
