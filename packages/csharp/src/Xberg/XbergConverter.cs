...
public static class XbergConverter
{
    ...
    ///
    /// <exception cref="XbergException">Returns `XbergError.Validation` if MIME type is invalid.
    /// Returns `XbergError.UnsupportedFormat` if MIME type is not supported.</exception>
    ...
    /// <returns>An `ExtractionResult` containing the extracted content and metadata.</returns>
    ///
    /// <exception cref="XbergException">Returns `XbergError.Io` if the file doesn't exist (NotFound) or for other file I/O errors.
    /// Returns `XbergError.UnsupportedFormat` if MIME type is not supported.</exception>
    ...
    ///
    /// <exception cref="XbergException">Individual file errors are captured in the result metadata. System errors
