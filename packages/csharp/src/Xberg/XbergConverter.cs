...
public static class XbergConverter
{
    ...
    public static ExtractedDocument ExtractedDocumentFromOcr(OcrExtractionResult ocr)
    {
        ...
        var nativeResult = NativeMethods.ExtractedDocumentFromOcr(
            ocrHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
        ...
        var returnValue = JsonSerializer.Deserialize<ExtractedDocument>(json ?? "null", JsonOptions)!;
