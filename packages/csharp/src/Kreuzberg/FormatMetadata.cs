...
// alef:hash:94f6722d70bae1d81544be36dcb70822e5e9230787f4021686a1f29544bd0ffe
...
public sealed class FormatMetadataJsonConverter : JsonConverter<FormatMetadata>
{
    public override FormatMetadata Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return tagValue switch
        {
            ...
            "excel" => JsonSerializer.Deserialize<FormatMetadata.Excel>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "email" => JsonSerializer.Deserialize<FormatMetadata.Email>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            ...
            "xml" => JsonSerializer.Deserialize<FormatMetadata.Xml>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            ...
            "ocr" => JsonSerializer.Deserialize<FormatMetadata.Ocr>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "csv" => JsonSerializer.Deserialize<FormatMetadata.Csv>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "bibtex" => JsonSerializer.Deserialize<FormatMetadata.Bibtex>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "citation" => JsonSerializer.Deserialize<FormatMetadata.Citation>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
            "fiction_book" => JsonSerializer.Deserialize<FormatMetadata.FictionBook>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),
    ...
    {
        throw new NotSupportedException("FormatMetadata serialization is not supported");
    }
}
