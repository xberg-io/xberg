...
// alef:hash:c90fa484b96c39e09f0bc27859f9057098f2c62cc7f342b6c437722897534a78
...
public sealed class AnnotationKindJsonConverter : JsonConverter<AnnotationKind>
{
    public override AnnotationKind Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {            "bold" => new AnnotationKind.Bold(),            "italic" => new AnnotationKind.Italic(),            "underline" => new AnnotationKind.Underline(),            "strikethrough" => new AnnotationKind.Strikethrough(),            "code" => new AnnotationKind.Code(),            "subscript" => new AnnotationKind.Subscript(),            "superscript" => new AnnotationKind.Superscript(),            "link" => JsonSerializer.Deserialize<AnnotationKind.Link>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),            "highlight" => new AnnotationKind.Highlight(),            "color" => JsonSerializer.Deserialize<AnnotationKind.Color>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),            "font_size" => JsonSerializer.Deserialize<AnnotationKind.FontSize>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),            "custom" => JsonSerializer.Deserialize<AnnotationKind.Custom>(variantJson, options) ?? throw new JsonException("Failed to deserialize variant"),            _ => throw new JsonException($"Unknown AnnotationKind discriminator: {tagValue}")
        };
    }
