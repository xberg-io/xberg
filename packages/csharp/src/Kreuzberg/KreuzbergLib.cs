...
// alef:hash:b4ae8966b6fe021a3aa5cd49cfccacc7016e161c8bde4e7f41ebbb78c596885d
#nullable enable
...
public static class KreuzbergLib
{
    ...
    public static double CalculateQualityScore(string text, Dictionary<string, object>? metadata)
    {
        ArgumentNullException.ThrowIfNull(text);
        var metadataJson = JsonSerializer.Serialize(metadata, JsonSerializationOptions);
        var metadataHandle = global::System.Runtime.InteropServices.Marshal.StringToHGlobalAnsi(metadataJson);
        var nativeResult = NativeMethods.CalculateQualityScore(
            text,
            metadataHandle
        );
        var returnValue = nativeResult;
        global::System.Runtime.InteropServices.Marshal.FreeHGlobal(metadataHandle);
        return returnValue;
    }
