...
public static class KreuzbergLib
{
    ...
    public static string Blake3HashBytes(byte[] data)
    {
        ...
        var nativeResult = NativeMethods.Blake3HashBytes(
    ...
    {
        var nativeResult = NativeMethods.Blake3HashFile(
            path
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static ulong FastHash(byte[] data)
    {
        ArgumentNullException.ThrowIfNull(data);
        var dataHandle = GCHandle.Alloc(data, GCHandleType.Pinned);
        var nativeResult = NativeMethods.FastHash(
            dataHandle.AddrOfPinnedObject()
        );
    ...
    public static bool ValidateCacheKey(string key)
    {
        ...
        var nativeResult = NativeMethods.ValidateCacheKey(
            key
        );
    ...
    public static bool IsValidFormatField(string field)
    {
        ...
        var nativeResult = NativeMethods.IsValidFormatField(
            field
        );
        var returnValue = nativeResult != 0;
        return returnValue;
    ...
    {
        ArgumentNullException.ThrowIfNull(mimeType);
        var nativeResult = NativeMethods.ValidateMimeType(
            mimeType
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        var nativeResult = NativeMethods.DetectOrValidate(
            path!,
            mimeType!
        );
        if (nativeResult == IntPtr.Zero)
    ...
    public static List<Element> TransformExtractionResultToElements(ExtractionResult result)
    {
        ...
        var nativeResult = NativeMethods.TransformExtractionResultToElements(
            resultHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static EmailExtractionResult ExtractEmailContent(byte[] data, string mimeType, uint? fallbackCodepage)
    {
        ...
        ArgumentNullException.ThrowIfNull(mimeType);
        var dataHandle = GCHandle.Alloc(data, GCHandleType.Pinned);
        var nativeResult = NativeMethods.ExtractEmailContent(
            dataHandle.AddrOfPinnedObject(),
            mimeType,
            fallbackCodepage.GetValueOrDefault()
        );
        if (nativeResult == IntPtr.Zero)
        {
            var err = GetLastError();
        ...
        var jsonPtr = NativeMethods.EmailExtractionResultToJson(nativeResult);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        NativeMethods.FreeString(jsonPtr);
        NativeMethods.EmailExtractionResultFree(nativeResult);
    ...
    public static string CellsToText(List<List<string>> cells)
    {
        ...
        var nativeResult = NativeMethods.CellsToText(
            cellsHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string CellsToMarkdown(List<List<string>> cells)
    {
        var cellsJson = JsonSerializer.Serialize(cells, JsonOptions);
        var cellsHandle = Marshal.StringToHGlobalAnsi(cellsJson);
        var nativeResult = NativeMethods.CellsToMarkdown(
            cellsHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string DjotToHtml(string djotSource)
    {
        ...
        var nativeResult = NativeMethods.DjotToHtml(
            djotSource
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static List<string> DedupText(List<string> texts)
    {
        ...
        var nativeResult = NativeMethods.DedupText(
            textsHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string NormalizeWhitespace(string s)
    {
        ...
        var nativeResult = NativeMethods.NormalizeWhitespace(
            s
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        var nativeResult = NativeMethods.SanitizeFilename(
            path
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        var nativeResult = NativeMethods.SanitizePath(
            path
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static bool IsValidUtf8(byte[] bytes)
    {
        ...
        var nativeResult = NativeMethods.IsValidUtf8(
    ...
    public static string CleanExtractedText(string text)
    {
        ...
        var nativeResult = NativeMethods.CleanExtractedText(
            text
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string ReduceTokens(string text, TokenReductionConfig config, string? languageHint)
    {
        ...
        var nativeResult = NativeMethods.ReduceTokens(
            text,
            configHandle,
            languageHint!
        );
    ...
    public static List<string> BatchReduceTokens(List<string> texts, TokenReductionConfig config, string? languageHint)
    {
        ...
        var configJson = JsonSerializer.Serialize(config, JsonOptions);
        var configHandle = NativeMethods.TokenReductionConfigFromJson(configJson);
        var nativeResult = NativeMethods.BatchReduceTokens(
            textsHandle,
            configHandle,
            languageHint!
        );
    ...
    {
        var nativeResult = NativeMethods.Bold(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
        ...
        var jsonPtr = NativeMethods.TextAnnotationToJson(nativeResult);
        var json = Marshal.PtrToStringUTF8(jsonPtr);
        NativeMethods.FreeString(jsonPtr);
        NativeMethods.TextAnnotationFree(nativeResult);
    ...
    {
        var nativeResult = NativeMethods.Italic(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    {
        var nativeResult = NativeMethods.Underline(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    public static TextAnnotation Link(uint start, uint end, string url, string? title)
    {
        ...
        var nativeResult = NativeMethods.Link(
            start,
            end,
            url,
            title!
    ...
    {
        var nativeResult = NativeMethods.Code(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    {
        var nativeResult = NativeMethods.Strikethrough(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    {
        var nativeResult = NativeMethods.Subscript(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    {
        var nativeResult = NativeMethods.Superscript(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    public static TextAnnotation FontSize(uint start, uint end, string value)
    {
        ...
        var nativeResult = NativeMethods.FontSize(
            start,
            end,
            value
        );
    ...
    {
        ArgumentNullException.ThrowIfNull(value);
        var nativeResult = NativeMethods.Color(
            start,
            end,
            value
        );
    ...
    {
        var nativeResult = NativeMethods.Highlight(
            start,
            end
        );
        if (nativeResult == IntPtr.Zero)
    ...
    {
        ArgumentNullException.ThrowIfNull(url);
        var nativeResult = NativeMethods.ClassifyUri(
            url
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string SafeDecode(byte[] byteData, string? encoding)
    {
        ...
        var nativeResult = NativeMethods.SafeDecode(
    ...
    {
        ArgumentNullException.ThrowIfNull(text);
        var nativeResult = NativeMethods.CalculateTextConfidence(
            text
        );
        var returnValue = nativeResult;
        return returnValue;
    ...
    {
        var nativeResult = NativeMethods.CreateStringBufferPool(
            poolSize,
            bufferCapacity
        );
        if (nativeResult == IntPtr.Zero)
        ...
        var returnValue = new StringBufferPool(nativeResult);
        return returnValue;
    }
    ...
    {
        var nativeResult = NativeMethods.CreateByteBufferPool(
            poolSize,
            bufferCapacity
        );
        if (nativeResult == IntPtr.Zero)
        ...
        var returnValue = new ByteBufferPool(nativeResult);
        return returnValue;
    }
    ...
    {
        var nativeResult = NativeMethods.OpenapiJson();
        if (nativeResult == IntPtr.Zero)
        {
            var err = GetLastError();
            if (err.Code != 0)
    ...
    public static ChunkingResult ChunkText(string text, ChunkingConfig config, List<PageBoundary>? pageBoundaries)
    {
        ...
        var nativeResult = NativeMethods.ChunkText(
            text,
            configHandle,
    ...
    public static ChunkingResult ChunkTextWithHeadingSource(string text, ChunkingConfig config, List<PageBoundary>? pageBoundaries, string? headingSource)
    {
        ...
        var pageBoundariesJson = JsonSerializer.Serialize(pageBoundaries, JsonOptions);
        var pageBoundariesHandle = Marshal.StringToHGlobalAnsi(pageBoundariesJson);
        var nativeResult = NativeMethods.ChunkTextWithHeadingSource(
            text,
            configHandle,
            pageBoundariesHandle,
            headingSource!
    ...
    public static List<ChunkingResult> ChunkTextsBatch(List<string> texts, ChunkingConfig config)
    {
        ...
        var configJson = JsonSerializer.Serialize(config, JsonOptions);
        var configHandle = NativeMethods.ChunkingConfigFromJson(configJson);
        var nativeResult = NativeMethods.ChunkTextsBatch(
            textsHandle,
            configHandle
        );
        if (nativeResult == IntPtr.Zero)
    ...
    public static ChunkingResult ChunkSemantic(string text, ChunkingConfig config, List<PageBoundary>? pageBoundaries)
    {
        ...
        var pageBoundariesJson = JsonSerializer.Serialize(pageBoundaries, JsonOptions);
        var pageBoundariesHandle = Marshal.StringToHGlobalAnsi(pageBoundariesJson);
        var nativeResult = NativeMethods.ChunkSemantic(
            text,
            configHandle,
            pageBoundariesHandle
        );
    ...
    public static List<float> Normalize(List<float> v)
    {
        ...
        var nativeResult = NativeMethods.Normalize(
            vHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        ArgumentNullException.ThrowIfNull(name);
        var nativeResult = NativeMethods.GetPreset(
            name
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    {
        var nativeResult = NativeMethods.ListPresets();
        if (nativeResult == IntPtr.Zero)
        {
            var err = GetLastError();
            if (err.Code != 0)
    ...
    {
        var nativeResult = NativeMethods.CalculateOptimalDpi(
            pageWidth,
            pageHeight,
            targetDpi,
            maxDimension,
    ...
    public static List<string>? DetectLanguages(string text, LanguageDetectionConfig config)
    {
        ...
        var nativeResult = NativeMethods.DetectLanguages(
            text,
            configHandle
        );
        if (nativeResult == IntPtr.Zero)
    ...
    {
        ArgumentNullException.ThrowIfNull(data);
        var nativeResult = NativeMethods.ComputeHash(
            data
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static byte[] RenderPdfPageToPng(byte[] pdfBytes, ulong pageIndex, int? dpi, string? password)
    {
        ...
        var nativeResult = NativeMethods.RenderPdfPageToPng(
    ...
    public static string ExtractTextFromPdf(byte[] pdfBytes)
    {
        ArgumentNullException.ThrowIfNull(pdfBytes);
        var pdfBytesHandle = GCHandle.Alloc(pdfBytes, GCHandleType.Pinned);
        var nativeResult = NativeMethods.ExtractTextFromPdf(
            pdfBytesHandle.AddrOfPinnedObject()
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string SerializeToToon(ExtractionResult result)
    {
        ...
        var resultJson = JsonSerializer.Serialize(result, JsonOptions);
        var resultHandle = NativeMethods.ExtractionResultFromJson(resultJson);
        var nativeResult = NativeMethods.SerializeToToon(
            resultHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
    ...
    public static string SerializeToJson(ExtractionResult result)
    {
        ...
        var resultJson = JsonSerializer.Serialize(result, JsonOptions);
        var resultHandle = NativeMethods.ExtractionResultFromJson(resultJson);
        var nativeResult = NativeMethods.SerializeToJson(
            resultHandle
        );
        if (nativeResult == IntPtr.Zero)
        {
