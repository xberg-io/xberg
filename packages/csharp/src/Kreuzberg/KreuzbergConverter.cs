...
public static class KreuzbergConverter
{
    ...
    /// </summary>
    public static HeuristicsConfig HeuristicsConfigTestConfig()
    {
        var nativeResult = NativeMethods.HeuristicsConfigTestConfig();
        if (nativeResult == IntPtr.Zero)
        {
            throw GetLastError();
        }
        ...
        var returnValue = JsonSerializer.Deserialize<HeuristicsConfig>(json ?? "null", JsonOptions)!;
        return returnValue;
    }
