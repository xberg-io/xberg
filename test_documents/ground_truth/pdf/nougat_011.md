...
Kingston: Is there a precedent on ten-year vesting up front when it's more than 330% more than what's stipulated in the code? That's an exceptionally-large jump from three years to ten years. Given that
...
Bessey: As a condition of both the PUD and the preliminary plat, the applicants are going to be developing a soft-surface trail that will connect the two river access points at the terminus of 3rd Street and 4th Street. That infrastructure and the landscaping in the riparian buffer area will all be completed separate from this application.
