...
-  **Java**
  ...
  ***
  ...
  ```gradle
  implementation 'io.xberg:xberg:1.0.0-rc.13'
  ```
...
-  **Kotlin Android**
  ...
  ***
  ...
  ```kotlin
  implementation("io.xberg:xberg-android:1.0.0-rc.13")
  ```
...
-  **Swift**
  ...
  ***
  ...
  ```swift
  .package(url: "https://github.com/xberg-io/xberg.git", from: "1.0.0-rc.13")
  ```
...
-  **Zig**
  ...
  ***
  ...
  ```bash
  zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.0.0-rc.13.tar.gz
  ```
