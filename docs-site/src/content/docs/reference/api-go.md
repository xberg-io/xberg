...
<!-- alef:hash:63d08cb74b19891aecb4e0f93986b5c9642460681b4f107bc2f2148f615e8797 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Go API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `PdfVersion`: `string`, `Producer`: `string`, `IsEncrypted`: `bool`, `Width`: `int64`, `Height`: `int64`, `PageCount`: `uint32`, `ScannedConfidence`: `float32`, `ScannedPages`: `[]uint32`, `LayoutGatedPages`: `[]uint32`, `LayoutGateReasons`: `[]string` |
