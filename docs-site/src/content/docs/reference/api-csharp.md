...
<!-- alef:hash:400c736243a3a5a28865fe561a1c1e8fe7962e6c6a5014bc65396bb594d0385f -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## C# API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `PdfVersion`: `string`, `Producer`: `string`, `IsEncrypted`: `bool`, `Width`: `long`, `Height`: `long`, `PageCount`: `uint`, `ScannedConfidence`: `float`, `ScannedPages`: `List<uint>`, `LayoutGatedPages`: `List<uint>`, `LayoutGateReasons`: `List<string>` |
