...
<!-- alef:hash:ef918c64d847f4669e56bbbb619029daa61ad2a3e630b5945e99ed4d9568eb78 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## TypeScript API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `string`, `producer`: `string`, `isEncrypted`: `boolean`, `width`: `number`, `height`: `number`, `pageCount`: `number`, `scannedConfidence`: `number`, `scannedPages`: `Array<number>`, `layoutGatedPages`: `Array<number>`, `layoutGateReasons`: `Array<string>` |
