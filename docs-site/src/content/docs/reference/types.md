...
<!-- alef:hash:5d4b57bc7ed350718ea2ce629930fefffc1d94a68dca5ebb47f3b524855badd7 -->
...
| Variant | Wire value | Description |
|---------|------------|-------------|
| `Pdf` | `pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdf_version`: `String`, `producer`: `String`, `is_encrypted`: `bool`, `width`: `i64`, `height`: `i64`, `page_count`: `u32`, `scanned_confidence`: `f32`, `scanned_pages`: `Vec<u32>`, `layout_gated_pages`: `Vec<u32>`, `layout_gate_reasons`: `Vec<String>` |
