...
<!-- alef:hash:6e0e44e806beb52d0fd5efd6615af7f24f9be4c9c5c3f66e661006376b309001 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Swift API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `Bool`, `width`: `Int64`, `height`: `Int64`, `pageCount`: `UInt32`, `scannedConfidence`: `Float`, `scannedPages`: `[UInt32]`, `layoutGatedPages`: `[UInt32]`, `layoutGateReasons`: `[String]` |
