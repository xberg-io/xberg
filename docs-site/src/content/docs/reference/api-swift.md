...
<!-- alef:hash:fff1f524e8306eab4b753c5ef513ba536a8fcef4371702060c8f37786ea9db76 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Swift API Reference <span class="version-badge">v1.2.6</span>
...
```swift
public static func listOcrBackendCapabilities() throws -> [OcrBackendCapabilities]
```

**Example:**

```swift
let result = try listOcrBackendCapabilities()
```

**Returns:** `[OcrBackendCapabilities]`
...
```swift
public static func ocrBackendSupportsLanguage(backend: String, language: String) throws -> Bool
```

**Example:**

```swift
let result = try ocrBackendSupportsLanguage("value", "value")
```
...
| `maxContentSize` | `UInt` | `104857600` | Maximum string growth and decoded image allocation per operation (100 MB). Per-page passes such as layout detection charge each batch against this limit, not the whole document; only `max_pages` bounds the rasters retained across a document (GH#1721). |
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `Bool`, `width`: `Int64`, `height`: `Int64`, `pageCount`: `UInt32`, `scannedConfidence`: `Float`, `scannedPages`: `[UInt32]`, `fabricatedTextPages`: `[UInt32]`, `implausibleTextPages`: `[UInt32]`, `layoutGatedPages`: `[UInt32]`, `layoutGateReasons`: `[String]` |
| `Docx` | Metadata extracted from a DOCX Word document. — Fields (flattened into the tagged object): `coreProperties`: `CoreProperties`, `appProperties`: `DocxAppProperties`, `customProperties`: `[String: String]` |
| `Excel` | Metadata extracted from an Excel spreadsheet. — Fields (flattened into the tagged object): `sheetCount`: `UInt32`, `sheetNames`: `[String]` |
| `Email` | Metadata extracted from an email message (EML/MSG). — Fields (flattened into the tagged object): `fromEmail`: `String`, `fromName`: `String`, `toEmails`: `[String]`, `ccEmails`: `[String]`, `bccEmails`: `[String]`, `messageId`: `String`, `attachments`: `[String]` |
| `Pptx` | Metadata extracted from a PowerPoint presentation. — Fields (flattened into the tagged object): `slideCount`: `UInt32`, `slideNames`: `[String]`, `imageCount`: `UInt32`, `tableCount`: `UInt32` |
| `Archive` | Metadata extracted from an archive (ZIP, TAR, 7Z, etc.). — Fields (flattened into the tagged object): `format`: `String`, `fileCount`: `UInt32`, `fileList`: `[String]`, `totalSize`: `UInt64`, `compressedSize`: `UInt64` |
| `Image` | Metadata extracted from a raster or vector image. — Fields (flattened into the tagged object): `width`: `UInt32`, `height`: `UInt32`, `format`: `String`, `exif`: `[String: String]` |
| `Xml` | Metadata extracted from an XML document. — Fields (flattened into the tagged object): `elementCount`: `UInt32`, `uniqueElements`: `[String]` |
| `Text` | Metadata extracted from a plain-text file. — Fields (flattened into the tagged object): `lineCount`: `UInt32`, `wordCount`: `UInt32`, `characterCount`: `UInt32`, `headers`: `[String]`, `links`: `[MarkdownLink]`, `codeBlocks`: `[MarkdownCodeBlock]` |
| `Html` | Metadata extracted from an HTML document. — Fields (flattened into the tagged object): `title`: `String`, `description`: `String`, `keywords`: `[String]`, `author`: `String`, `canonicalUrl`: `String`, `baseHref`: `String`, `language`: `String`, `textDirection`: `TextDirection`, `openGraph`: `[String: String]`, `twitterCard`: `[String: String]`, `metaTags`: `[String: String]`, `headers`: `[HeaderMetadata]`, `links`: `[LinkMetadata]`, `images`: `[ImageMetadataType]`, `structuredData`: `[StructuredData]` |
| `Ocr` | Metadata produced by an OCR pipeline. — Fields (flattened into the tagged object): `language`: `String`, `psm`: `Int32`, `outputFormat`: `String`, `tableCount`: `UInt32`, `tableRows`: `UInt32`, `tableCols`: `UInt32` |
| `Csv` | Metadata extracted from a CSV or TSV file. — Fields (flattened into the tagged object): `rowCount`: `UInt32`, `columnCount`: `UInt32`, `delimiter`: `String`, `hasHeader`: `Bool`, `columnTypes`: `[String]` |
| `Bibtex` | Metadata extracted from a BibTeX bibliography file. — Fields (flattened into the tagged object): `entryCount`: `UInt`, `citationKeys`: `[String]`, `authors`: `[String]`, `yearRange`: `YearRange`, `entryTypes`: `[String: UInt]` |
| `Citation` | Metadata extracted from a citation file (RIS, PubMed, EndNote). — Fields (flattened into the tagged object): `citationCount`: `UInt`, `format`: `String`, `authors`: `[String]`, `yearRange`: `YearRange`, `dois`: `[String]`, `keywords`: `[String]` |
| `FictionBook` | Metadata extracted from a FictionBook (FB2) e-book. — Fields (flattened into the tagged object): `genres`: `[String]`, `sequences`: `[String]`, `annotation`: `String` |
| `Dbf` | Metadata extracted from a dBASE (DBF) database file. — Fields (flattened into the tagged object): `recordCount`: `UInt`, `fieldCount`: `UInt`, `fields`: `[DbfFieldInfo]` |
| `Jats` | Metadata extracted from a JATS (Journal Article Tag Suite) XML file. — Fields (flattened into the tagged object): `copyright`: `String`, `license`: `String`, `historyDates`: `[String: String]`, `contributorRoles`: `[ContributorRole]` |
...
| `Pst` | Metadata extracted from an Outlook PST archive. — Fields (flattened into the tagged object): `messageCount`: `UInt` |
| `Audio` | Metadata extracted from an audio or video file. — Fields (flattened into the tagged object): `durationMs`: `UInt64`, `codec`: `String`, `container`: `String`, `sampleRateHz`: `UInt32`, `channels`: `UInt16`, `bitrate`: `UInt32` |
| `Code` | Code (tree-sitter analyzable source). Carries the structural chunks (function, class, and module boundaries) produced by the tree-sitter extractor, consumed by the chunking pipeline to emit structure-aware `Chunk`s instead of falling back to text-based splitting. Wraps `CodeMetadata` (a named struct) rather than `[CodeChunkInfo]` directly: `FormatMetadata` is internally tagged (`#[serde(tag = "format_type")]`), and serde cannot serialize a tagged newtype variant that wraps a sequence — the tag has no map to live in. Wrapping a struct gives serde a map to hold the tag, and keeps this variant shape consistent with every sibling (`Variant(XMetadata)`) so the derived OpenAPI discriminator can reference a named component schema. — Fields (flattened into the tagged object): `chunks`: `[CodeChunkInfo]`, `data`: `CodeDataNode` |
