...
<!-- alef:hash:5208868865017e69ed4624c14b34ba9fe799e348e7bb588df55e29549e86bdb2 -->
...
| `max_concurrent_ocr` | `--max-concurrent-ocr` | `Option<usize>` |  | Set concurrent Tesseract recognition sessions directly. The value is applied as given and is not capped by the thread budget. |
