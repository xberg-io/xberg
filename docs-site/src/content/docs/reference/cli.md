...
<!-- alef:hash:9c26dc92bd8e6fb4fb403dcaa7bdcab96d37b356391f9157c62f3695bf8a76ce -->
...
| `max_concurrent_ocr` | `--max-concurrent-ocr` | `Option<usize>` |  | Set concurrent Tesseract recognition sessions directly. The value is applied as given and is not capped by the thread budget. The first extraction in a process fixes it for that process. |
