...
<!-- alef:hash:20c099911bfc8750fd0e5057ce6f75714e391e357665e29ad042f77a03f398d7 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Java API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `PDF` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `boolean`, `width`: `long`, `height`: `long`, `pageCount`: `int`, `scannedConfidence`: `float`, `scannedPages`: `List<Integer>`, `layoutGatedPages`: `List<Integer>`, `layoutGateReasons`: `List<String>` |
