...
<!-- alef:hash:8d1d40373ac17f9b03ff42363a18c11b218d40a518aa54898f732dbdd725dc2d -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Kotlin (Android) API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `Boolean`, `width`: `Long`, `height`: `Long`, `pageCount`: `Int`, `scannedConfidence`: `Float`, `scannedPages`: `List<Int>`, `layoutGatedPages`: `List<Int>`, `layoutGateReasons`: `List<String>` |
