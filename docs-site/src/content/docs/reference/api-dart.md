...
<!-- alef:hash:66f7a591bcad5f016d4001ff9e20d430c27ab5175a8cc0dbc6d873d59b1ce3b4 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Dart API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `String`, `producer`: `String`, `isEncrypted`: `bool`, `width`: `int`, `height`: `int`, `pageCount`: `int`, `scannedConfidence`: `double`, `scannedPages`: `List<int>`, `layoutGatedPages`: `List<int>`, `layoutGateReasons`: `List<String>` |
