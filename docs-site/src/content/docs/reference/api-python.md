...
<!-- alef:hash:3e13cd22500e3f32e8de0f9422ce8958266a9e756d0352212b37f6f4f825bf77 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Python API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `PDF` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdf_version`: `str`, `producer`: `str`, `is_encrypted`: `bool`, `width`: `int`, `height`: `int`, `page_count`: `int`, `scanned_confidence`: `float`, `scanned_pages`: `list[int]`, `layout_gated_pages`: `list[int]`, `layout_gate_reasons`: `list[str]` |
