...
<!-- alef:hash:a4386c3708b1f88dbb12221af0f57b9d601a6cf68aaf0bb5a76e7b8f88f7df88 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## PHP API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdfVersion`: `string`, `producer`: `string`, `isEncrypted`: `bool`, `width`: `int`, `height`: `int`, `pageCount`: `int`, `scannedConfidence`: `float`, `scannedPages`: `array<int>`, `layoutGatedPages`: `array<int>`, `layoutGateReasons`: `array<string>` |
