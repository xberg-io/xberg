...
<!-- alef:hash:c6242c9cef3ba80fd888873d1eb3e3ac1b8d3b41777afd24816d008e3f8d2602 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Zig API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdf_version`: `[]const u8`, `producer`: `[]const u8`, `is_encrypted`: `bool`, `width`: `i64`, `height`: `i64`, `page_count`: `u32`, `scanned_confidence`: `f32`, `scanned_pages`: `[]const u32`, `layout_gated_pages`: `[]const u32`, `layout_gate_reasons`: `[]const []const u8` |
