...
<!-- alef:hash:58d91a6cdfe225ff56757590b3eac7370dfcf6a9d07644811556c4e83ef8a802 -->
<!-- To regenerate: alef docs -->
<!-- To verify freshness: alef verify -->

## Rust API Reference <span class="version-badge">v1.2.3</span>
...
| Value | Description |
|-------|-------------|
| `Pdf` | Metadata extracted from a PDF document. — Fields (flattened into the tagged object): `pdf_version`: `String`, `producer`: `String`, `is_encrypted`: `bool`, `width`: `i64`, `height`: `i64`, `page_count`: `u32`, `scanned_confidence`: `f32`, `scanned_pages`: `Vec<u32>`, `layout_gated_pages`: `Vec<u32>`, `layout_gate_reasons`: `Vec<String>` |
