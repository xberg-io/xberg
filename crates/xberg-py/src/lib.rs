...
impl LlmBackend {
    ...
    pub fn new(config: LlmConfig) -> LlmBackend {
        ...
        Self {
            inner: Arc::new(xberg::LlmBackend::new(config_core)),
        }
    }
}
...
impl EmbeddingModelType {
    ...
    pub fn _factory_llm(llm: LlmConfig) -> Self {
        Self {
            inner: xberg::EmbeddingModelType::Llm { llm: llm.into() },
        }
    }
...
impl RerankerModelType {
    ...
    pub fn _factory_llm(llm: LlmConfig) -> Self {
        Self {
            inner: xberg::RerankerModelType::Llm { llm: llm.into() },
        }
    }
...
impl NodeContent {
    ...
    pub fn _factory_table(grid: TableGrid) -> Self {
        Self {
            inner: xberg::NodeContent::Table { grid: grid.into() },
        }
    }
...
impl EnrichStatus {
    ...
    pub fn _factory_completed(result: EnrichResult) -> Self {
        Self {
            inner: xberg::enrichment::EnrichStatus::Completed { result: result.into() },
        }
    }
    ...
    pub fn _factory_failed(error: String) -> Self {
        Self {
            inner: xberg::enrichment::EnrichStatus::Failed { error },
        }
    }
}
...
impl ChunkingDecision {
    ...
    #[pyo3(name = "no_chunking")]
    #[staticmethod]
    pub fn _factory_no_chunking(reason: NoChunkingReason) -> Self {
        Self {
            inner: xberg::ChunkingDecision::NoChunking { reason: reason.into() },
        }
    }

    #[pyo3(name = "use_overrides")]
    #[staticmethod]
    pub fn _factory_use_overrides(user_chunks: Vec<PageRange>) -> Self {
        Self {
            inner: xberg::ChunkingDecision::UseOverrides {
...
pub fn extract_file_sync(
    ...
    py.detach(|| xberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core))
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn extract_bytes_sync(
    ...
    py.detach(|| xberg::extract_bytes_sync(&content, &mime_type, &config_core))
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn batch_extract_files_sync(
    ...
    py.detach(|| xberg::batch_extract_files_sync(items_core, &config_core))
...
pub fn batch_extract_bytes_sync(
    ...
    py.detach(|| xberg::batch_extract_bytes_sync(items_core, &config_core))
        .map(|val| val.into_iter().map(Into::into).collect())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn detect_mime_type_from_bytes(py: Python<'_>, content: Vec<u8>) -> PyResult<String> {
    py.detach(|| xberg::detect_mime_type_from_bytes(&content))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn get_extensions_for_mime(py: Python<'_>, mime_type: String) -> PyResult<Vec<String>> {
    py.detach(|| xberg::get_extensions_for_mime(&mime_type))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn detect_qr_codes(py: Python<'_>, image_bytes: Vec<u8>, _format_hint: Option<String>) -> Vec<QrCode> {
    py.detach(|| xberg::extractors::qr::detect_qr_codes(&image_bytes, _format_hint.as_deref()))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn register_builtin(py: Python<'_>) -> PyResult<()> {
    py.detach(|| xberg::plugins::processor::builtin::register_builtin())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn download_model(py: Python<'_>, name: String, cache_dir: Option<String>) -> PyResult<String> {
    py.detach(|| xberg::text::ner::download_model(&name, cache_dir.map(std::path::PathBuf::from)))
...
pub fn known_models(py: Python<'_>) -> Vec<String> {
    py.detach(|| xberg::text::ner::known_models())
        .iter()
        .map(|s| s.to_string())
        .collect()
}
...
pub fn find_all(py: Python<'_>, text: String) -> Vec<PatternMatch> {
    py.detach(|| xberg::text::redaction::patterns::ssn::find_all(&text))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn scan_text(py: Python<'_>, text: String, categories: Vec<PiiCategory>) -> Vec<PatternMatch> {
    ...
    py.detach(|| xberg::text::redaction::patterns::scan_text(&text, &categories_core))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn find_footnote_anchors(py: Python<'_>, markdown: String) -> Vec<FootnoteAnchor> {
    py.detach(|| xberg::find_footnote_anchors(&markdown))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn parse_footnote_definitions(py: Python<'_>, markdown: String) -> Vec<FootnoteDefinition> {
    py.detach(|| xberg::parse_footnote_definitions(&markdown))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn parse_citations(py: Python<'_>, markdown: String) -> Vec<Citation> {
    py.detach(|| xberg::parse_citations(&markdown))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn chunk_for_rag(py: Python<'_>, text: String, config: ChunkingConfig) -> PyResult<ChunkingResult> {
    ...
    py.detach(|| xberg::chunking::chunk_for_rag(&text, &config_core))
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn extract_keywords(py: Python<'_>, text: String, config: KeywordConfig) -> PyResult<Vec<Keyword>> {
    ...
    py.detach(|| xberg::keywords::extract_keywords(&text, &config_core))
        .map(|val| val.into_iter().map(Into::into).collect())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn analyze_document(
    ...
    py.detach(|| xberg::analyze_document(&metadata_core, &config_core, document_bytes.as_deref()))
        .map(Into::into)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn analyze_with_user_chunks(
    ...
    py.detach(|| xberg::analyze_with_user_chunks(&user_ranges_core, total_pages, size_bytes, &config_core))
        .into()
}
...
pub fn boundaries_from_extraction_result(
    ...
    py.detach(|| xberg::boundaries_from_extraction_result(&result_core, &thresholds_core))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn detect_boundaries(
    ...
    py.detach(|| xberg::detect_boundaries(&input_core, &thresholds_core))
        .into_iter()
        .map(Into::into)
        .collect()
}
...
pub fn calculate_chunk_plan(
    ...
    py.detach(|| xberg::calculate_chunk_plan(page_count, size_bytes, needs_ocr, &config_core))
        .into()
}
...
pub fn calculate_plan_from_overrides(
    ...
    py.detach(|| xberg::calculate_plan_from_overrides(&user_chunks_core, total_pages, size_bytes, &config_core))
        .into()
}
...
pub fn extract_structured_json(
    ...
    py.detach(|| xberg::extract_structured_json(&bytes, &mime, &preset_spec_json, &options_json))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn split_and_extract_json(
    ...
    py.detach(|| xberg::split_and_extract_json(&bytes, &mime, &preset_spec_json, &options_json))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn render_pdf_page_to_png(
    ...
    py.detach(|| xberg::render_pdf_page_to_png(&pdf_bytes, page_index, dpi, password.as_deref()))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn pdf_page_count(py: Python<'_>, pdf_bytes: Vec<u8>, password: Option<String>) -> PyResult<usize> {
    py.detach(|| xberg::pdf_page_count(&pdf_bytes, password.as_deref()))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn detect_mime_type(py: Python<'_>, path: String, check_exists: bool) -> PyResult<String> {
    py.detach(|| xberg::detect_mime_type(path, check_exists))
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
...
pub fn rerank(
    ...
    py.detach(|| xberg::rerank(query, documents, &config_core))
        .map(|val| val.into_iter().map(Into::into).collect())
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
}
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                let py_result = ctx.call_method1("run", (bound_method, pyo3::types::PyBytes::new(py, &image_bytes), OcrConfig::from(config_owned.clone())))
                    .map_err(|e| xberg::XbergError::Other(format!("Plugin '{}' method 'process_image' failed: {}", cached_name, e)))?;
        ...
        tokio::task::spawn_blocking(move || {
            Python::attach(|py| {
                ...
                let py_result = ctx.call_method1("run", (bound_method, pyo3::types::PyBytes::new(py, &content), mime_type, ExtractionConfig::from(config_owned.clone())))
                    .map_err(|e| xberg::XbergError::Other(format!("Plugin '{}' method 'extract_bytes' failed: {}", cached_name, e)))?;
                let json_val: String = py
                    .import("json")
                    .and_then(|m| m.call_method1("dumps", (py_result,)))
                    .and_then(|v| v.extract())
    ...
    fn render(&self, doc: &xberg::InternalDocument) -> std::result::Result<String, xberg::XbergError> {
        Python::attach(|py| {
            ...
            py.import("contextvars")
                ...
                .and_then(|v| v.extract::<String>())
                .map_err(|e| {
                    xberg::XbergError::Other(format!("Plugin '{}' method 'render' failed: {}", self.cached_name, e))
                })
        })
    }
}
