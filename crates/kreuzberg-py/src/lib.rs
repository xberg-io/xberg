...
// alef:hash:9a059ed918af405ff7050dc3e2c7f99d64459415695f4d165432ff8c576277d5
...
#[pyfunction]
#[pyo3(signature = (texts, config=None))]
pub fn embed_texts(texts: Vec<String>, config: Option<EmbeddingConfig>) -> PyResult<Vec<Vec<f32>>> {
