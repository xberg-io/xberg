...
impl ConfidenceSignals {
    ...
    pub fn from_extraction_result(
        ...
        let _ = (result, schema_compliance, text_coverage);
        compile_error!(
            "alef cannot auto-delegate `ConfidenceSignals::from_extraction_result`; configure an adapter body or exclude this item from the backend"
        )
    }
...
impl ChunkPlan {
    #[allow(clippy::too_many_arguments)]
    #[must_use]
    #[pyo3(signature = (total_chunks, chunks, total_estimated_time_ms, use_disk_processing, reason))]
    #[new]
    pub fn new(
        total_chunks: u32,
