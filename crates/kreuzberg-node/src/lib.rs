...
pub fn list_ocr_backends() -> Result<Vec<String>> {
    kreuzberg::plugins::list_ocr_backends().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn list_validators() -> Result<Vec<String>> {
    kreuzberg::plugins::list_validators().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
