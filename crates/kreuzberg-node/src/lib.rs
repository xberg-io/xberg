...
pub fn confidence_signals_from_extraction_result(
    ...
    kreuzberg::ConfidenceSignals::from_extraction_result(result.into(), schema_compliance.into(), text_coverage as f32)
        .into()
}
...
#[napi(js_name = "heuristicsConfigTestConfig")]
pub fn heuristics_config_test_config() -> JsHeuristicsConfig {
...
pub fn analyze_document(
    ...
    let document_bytes: Vec<u8> = document_bytes.to_vec();
...
pub fn resolve(
    ...
    kreuzberg::resolve(&preset_core, custom_schema, context)
        .map(|val| val.into())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
impl From<JsSchemaCompliance> for kreuzberg::heuristics::SchemaCompliance {
...
impl From<kreuzberg::heuristics::SchemaCompliance> for JsSchemaCompliance {
    fn from(val: kreuzberg::heuristics::SchemaCompliance) -> Self {
        match val {
            kreuzberg::heuristics::SchemaCompliance::AllValid => Self::AllValid,
            kreuzberg::heuristics::SchemaCompliance::PartialValid => Self::PartialValid,
            kreuzberg::heuristics::SchemaCompliance::AllInvalid => Self::AllInvalid,
        }
    }
}
