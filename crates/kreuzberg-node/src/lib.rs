...
#[napi(string_enum, js_name = "ChunkingDecision")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub enum JsChunkingDecision {
...
#[napi(string_enum, js_name = "NoChunkingReason")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub enum JsNoChunkingReason {
...
#[napi(string_enum, js_name = "ChunkingReason")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub enum JsChunkingReason {
...
impl From<JsChunkingDecision> for kreuzberg::ChunkingDecision {
    fn from(val: JsChunkingDecision) -> Self {
        match val {
            JsChunkingDecision::NoChunking => Self::NoChunking {
                reason: Default::default(),
            },
            JsChunkingDecision::Chunk => Self::Chunk(Default::default()),
            JsChunkingDecision::UseOverrides => Self::UseOverrides {
                user_chunks: Default::default(),
            },
        }
    }
}
...
impl From<kreuzberg::ChunkingDecision> for JsChunkingDecision {
    fn from(val: kreuzberg::ChunkingDecision) -> Self {
        match val {
            kreuzberg::ChunkingDecision::NoChunking { .. } => Self::NoChunking,
            kreuzberg::ChunkingDecision::Chunk(..) => Self::Chunk,
            kreuzberg::ChunkingDecision::UseOverrides { .. } => Self::UseOverrides,
        }
    }
}
...
impl From<JsNoChunkingReason> for kreuzberg::NoChunkingReason {
    fn from(val: JsNoChunkingReason) -> Self {
        match val {
            JsNoChunkingReason::SmallFile => Self::SmallFile {
                size_bytes: Default::default(),
                threshold_bytes: Default::default(),
            },
            JsNoChunkingReason::FewPages => Self::FewPages {
                page_count: Default::default(),
                threshold: Default::default(),
            },
            JsNoChunkingReason::TextLayerDetected => Self::TextLayerDetected {
                text_coverage: Default::default(),
                avg_chars_per_page: Default::default(),
            },
            JsNoChunkingReason::FormatNotChunkable => Self::FormatNotChunkable {
                mime_type: Default::default(),
            },
            JsNoChunkingReason::ChunkingDisabled => Self::ChunkingDisabled,
            JsNoChunkingReason::FastTextExtraction => Self::FastTextExtraction,
        }
    }
}
...
impl From<kreuzberg::NoChunkingReason> for JsNoChunkingReason {
    fn from(val: kreuzberg::NoChunkingReason) -> Self {
        match val {
            kreuzberg::NoChunkingReason::SmallFile { .. } => Self::SmallFile,
            kreuzberg::NoChunkingReason::FewPages { .. } => Self::FewPages,
            kreuzberg::NoChunkingReason::TextLayerDetected { .. } => Self::TextLayerDetected,
            kreuzberg::NoChunkingReason::FormatNotChunkable { .. } => Self::FormatNotChunkable,
...
impl From<JsChunkingReason> for kreuzberg::ChunkingReason {
    fn from(val: JsChunkingReason) -> Self {
        match val {
            JsChunkingReason::LargeFile => Self::LargeFile {
                size_bytes: Default::default(),
                threshold_bytes: Default::default(),
            },
            JsChunkingReason::ManyPages => Self::ManyPages {
                page_count: Default::default(),
                threshold: Default::default(),
            },
            JsChunkingReason::OcrRequired => Self::OcrRequired {
                page_count: Default::default(),
                force_ocr: Default::default(),
            },
            JsChunkingReason::LargeAndManyPages => Self::LargeAndManyPages {
                size_bytes: Default::default(),
                page_count: Default::default(),
            },
        }
...
impl From<kreuzberg::ChunkingReason> for JsChunkingReason {
    fn from(val: kreuzberg::ChunkingReason) -> Self {
        match val {
            kreuzberg::ChunkingReason::LargeFile { .. } => Self::LargeFile,
            kreuzberg::ChunkingReason::ManyPages { .. } => Self::ManyPages,
            kreuzberg::ChunkingReason::OcrRequired { .. } => Self::OcrRequired,
            kreuzberg::ChunkingReason::LargeAndManyPages { .. } => Self::LargeAndManyPages,
        }
    }
}
