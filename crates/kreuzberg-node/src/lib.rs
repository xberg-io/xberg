...
// alef:hash:89691743522879ef7995c221e6db9c66a882e010f13f2348c2213fa755c55168
...
pub struct JsCustomProperties {
    inner: Arc<kreuzberg::CustomProperties>,
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<kreuzberg::OdtProperties> for JsOdtProperties {
    fn from(val: kreuzberg::OdtProperties) -> Self {
        Self {
            title: val.title,
            subject: val.subject,
            creator: val.creator,
