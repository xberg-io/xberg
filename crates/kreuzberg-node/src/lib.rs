...
// alef:hash:14edffb221475281e397329675232a5a2ccf851dcc937f314ad34214f4b4420f
...
pub fn calculate_quality_score(text: String, metadata: Option<HashMap<String, serde_json::Value>>) -> f64 {
    kreuzberg::text::quality::calculate_quality_score(&text, metadata.as_ref())
}
    ...
    fn from(val: kreuzberg::TextExtractionResult) -> Self {
        Self {
            ...
            links: val
                .links
                .as_ref()
                .map(|v| v.iter().map(|(a, b)| vec![a.to_string(), b.to_string()]).collect()),
            code_blocks: val
                .code_blocks
                .as_ref()
                .map(|v| v.iter().map(|(a, b)| vec![a.to_string(), b.to_string()]).collect()),
