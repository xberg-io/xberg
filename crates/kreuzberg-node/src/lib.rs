...
// alef:hash:db07917972802dc5ebea1e42a6f21684b2159dd77cdcd4594cc82b0cd1db42a2
...
pub fn validate_port(port: u16) -> Result<()> {
    kreuzberg::validate_port(port).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "validateHost")]
pub fn validate_host(host: String) -> Result<()> {
    kreuzberg::validate_host(&host).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn validate_ocr_backend(backend: String) -> Result<()> {
    kreuzberg::validate_ocr_backend(&backend).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "validateLanguageCode")]
pub fn validate_language_code(code: String) -> Result<()> {
    kreuzberg::validate_language_code(&code).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "validateTesseractPsm")]
pub fn validate_tesseract_psm(psm: i32) -> Result<()> {
    kreuzberg::validate_tesseract_psm(psm).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "validateTesseractOem")]
pub fn validate_tesseract_oem(oem: i32) -> Result<()> {
    kreuzberg::validate_tesseract_oem(oem).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn djot_to_html(djot_source: String) -> Result<String> {
    kreuzberg::djot_to_html(&djot_source).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "unregisterExtractor")]
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "listExtractors")]
pub fn list_extractors() -> Result<Vec<String>> {
    kreuzberg::plugins::list_extractors().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "clearExtractors")]
pub fn clear_extractors() -> Result<()> {
    kreuzberg::plugins::clear_extractors().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn clear_ocr_backends() -> Result<()> {
    kreuzberg::plugins::clear_ocr_backends().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn list_renderers() -> Result<Vec<String>> {
    kreuzberg::plugins::list_renderers().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "clearRenderers")]
pub fn clear_renderers() -> Result<()> {
    kreuzberg::plugins::clear_renderers().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn clear_validators() -> Result<()> {
    kreuzberg::plugins::clear_validators().map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn reduce_tokens(text: String, config: JsTokenReductionConfig, language_hint: Option<String>) -> Result<String> {
    ...
    let config_core: kreuzberg::TokenReductionConfig = serde_json::from_str(&config_json)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    kreuzberg::reduce_tokens(&text, &config_core, language_hint.as_deref())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
#[napi(js_name = "openapiJson")]
pub fn openapi_json() -> String {
    kreuzberg::api::openapi::openapi_json()
}

#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "serveDefault")]
...
pub fn normalize(v: Vec<f64>) -> Vec<f64> {
    ...
    kreuzberg::normalize(&v_f32).into_iter().map(|v| v as f64).collect()
}
...
pub fn register_post_processor(obj: napi::bindgen_prelude::Object) -> napi::Result<()> {
    ...
    let mut registry = registry.write();
    registry.register(arc, 50).map_err(|e| {
        napi::Error::new(
            napi::Status::GenericFailure,
            format!("Failed to register backend: {}", e),
        )
