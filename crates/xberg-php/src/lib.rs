...
impl XbergApi {
    ...
    pub fn register_document_extractor(extractor: &DocumentExtractor) -> PhpResult<()> {
        let result = xberg::register_document_extractor(&extractor.inner)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn unregister_document_extractor(name: String) -> PhpResult<()> {
        let result = xberg::unregister_document_extractor(&name)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn register_renderer(renderer: &Renderer) -> PhpResult<()> {
        let result = xberg::register_renderer(&renderer.inner)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
    ...
    pub fn unregister_renderer(name: String) -> PhpResult<()> {
        let result = xberg::unregister_renderer(&name)
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result)
    }
