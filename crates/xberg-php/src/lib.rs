...
impl XbergApi {
    ...
    pub fn extract_bytes(
        ...
        WORKER_RUNTIME.block_on(async {
            let result = xberg::extract_bytes(&content.0[..], &mimeType, &config_core.unwrap_or_default())
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into())
        })
    ...
    pub fn extract_file_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::extract_file_sync(
            std::path::PathBuf::from(path),
            mimeType.as_deref(),
            &config_core.unwrap_or_default(),
        )
    ...
    pub fn extract_bytes_sync(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::extract_bytes_sync(&content.0[..], &mimeType, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into())
    }
    ...
    pub fn batch_extract_files_sync(
        ...
        let mut items_core_result: Vec<xberg::BatchFileItem> = Vec::new();
        ...
        let items_core: Vec<xberg::BatchFileItem> = items_core_result;
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::batch_extract_files_sync(items_core, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
    ...
    pub fn batch_extract_bytes_sync(
        ...
        let mut items_core_result: Vec<xberg::BatchBytesItem> = Vec::new();
        for (_, item) in items.iter() {
        ...
        let items_core: Vec<xberg::BatchBytesItem> = items_core_result;
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        let result = xberg::batch_extract_bytes_sync(items_core, &config_core.unwrap_or_default())
            .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
        Ok(result.into_iter().map(Into::into).collect())
    }
    ...
    pub fn batch_extract_files(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = xberg::batch_extract_files(items_core, &config_core.unwrap_or_default())
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into_iter().map(Into::into).collect())
        })
    ...
    pub fn batch_extract_bytes(
        ...
        let config_core: Option<xberg::ExtractionConfig> = config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = xberg::batch_extract_bytes(items_core, &config_core.unwrap_or_default())
                .await
                .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result.into_iter().map(Into::into).collect())
        })
...
#[allow(clippy::useless_conversion)]
impl From<BatchBytesItem> for xberg::BatchBytesItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::BatchBytesItem> for BatchBytesItem {
...
#[allow(clippy::useless_conversion)]
impl From<BatchFileItem> for xberg::BatchFileItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::BatchFileItem> for BatchFileItem {
