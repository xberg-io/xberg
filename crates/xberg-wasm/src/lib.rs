...
pub fn extract_bytes_sync(
    ...
    let config_core: xberg::ExtractionConfig = config_input.into();
    let result =
        xberg::extract_bytes_sync(&content, &mime_type, &config_core).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
pub fn batch_extract_bytes_sync(items: Vec<String>, config: JsValue) -> Result<Vec<WasmExtractionResult>, JsValue> {
    let items_core: Vec<xberg::BatchBytesItem> = items
        .into_iter()
        .map(|s| serde_json::from_str::<xberg::BatchBytesItem>(&s).map_err(|e| JsValue::from_str(&e.to_string())))
    ...
    let config_core: xberg::ExtractionConfig = config_input.into();
    let result =
        xberg::batch_extract_bytes_sync(items_core, &config_core).map_err(|e| JsValue::from_str(&e.to_string()))?;
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmBatchBytesItem> for xberg::BatchBytesItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::BatchBytesItem> for WasmBatchBytesItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmBatchFileItem> for xberg::BatchFileItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::BatchFileItem> for WasmBatchFileItem {
