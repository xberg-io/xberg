...
impl WasmExtractedDocument {
    ...
    pub fn from_ocr(ocr: WasmOcrExtractionResult) -> WasmExtractedDocument {
...
pub fn register_document_extractor(extractor: WasmDocumentExtractor) -> Result<(), JsValue> {
    let result = xberg::register_document_extractor(&extractor.inner).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn unregister_document_extractor(name: String) -> Result<(), JsValue> {
    let result = xberg::unregister_document_extractor(&name).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn register_renderer(renderer: WasmRenderer) -> Result<(), JsValue> {
    let result = xberg::register_renderer(&renderer.inner).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn unregister_renderer(name: String) -> Result<(), JsValue> {
    let result = xberg::unregister_renderer(&name).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
mod __alef_wasm_bridge_documentextractor {
    ...
    pub fn register_document_extractor(backend: wasm_bindgen::JsValue) -> Result<(), wasm_bindgen::JsValue> {
        let required_methods = vec!["supportedMimeTypes"];
