 ...
 */
export declare function customSourceFromParts(repo?: string | undefined | null, modelFile?: string | undefined | null, tokenizerFile?: string | undefined | null, architecture?: GlinerArchitecture | undefined | null): CustomGlinerSource | null;

/** Decrypt a blob from [`encrypt_map`]. */
export declare function decryptMap(blob: Uint8Array, passphrase: string): RehydrationMap;
 ...
 */
export declare function dedupeOverlaps(matches: Array<PatternMatch>): Array<PatternMatch>;

/** Encrypt `map` with `passphrase`. Returns `XPII\x01` + salt(16) + nonce(12) + tag(16) + ciphertext. */
export declare function encryptMap(map: RehydrationMap, passphrase: string): Uint8Array;
 ...
 */
export declare function findSubject(map: RehydrationMap, query: string): Array<SubjectMatch>;
 ...
 */
export declare function forgetSubject(map: RehydrationMap, query: string): Array<SubjectMatch>;
 ...
 */
export declare function fuse(merged: JsonValue, ocrElements: Array<JsonValue>, elementMetadata: Array<JsonValue>, emitCitations: boolean, matchThreshold: number, fusedConfidence: number): CitationOutput;
...
export interface Batch {
  ...
  readonly pages: Array<PageImage>
  /**
...
export interface CacheBackend {
  ...
  put(key: string, value: Uint8Array, ttl?: number | undefined | null): Promise<void>
}
 ...
 */
export declare class CandleBackend {
  /**
   ...
   */
  static fromLocal(modelDir: string, loraAdapterDir?: string | undefined | null): CandleBackend
  /**
   ...
   */
  static fromBytes(safetensors: Uint8Array, tokenizerJson: Uint8Array, encoderConfigJson: Uint8Array): CandleBackend
...
export interface ChunkerConfig {
  ...
  readonly avgTokensPerImage?: number
...
export interface CitationOutput {
  ...
  readonly structuredOutputFlat: JsonValue
}

/** Provenance of a cited field value. */
export declare enum CitationSource {
 ...
 */
export interface CustomGlinerSource {
  ...
  readonly architecture: GlinerArchitecture
}
 ...
 */
export declare class DefaultModelProvider {
  static default(): DefaultModelProvider
  ensureModel(model: ModelId): Promise<string>
}
...
export interface DocumentExtractor {
   ...
   */
  extract(input?: ExtractInput | undefined | null, config?: ExtractionConfig | undefined | null): Promise<ExtractedDocument>
  /**
...
export declare class Engine {
  ...
  static newDefault(): Engine
  /** Extract content from a single bytes or URI input. */
  extract(input?: ExtractInput | undefined | null, config?: ExtractionConfig | undefined | null): Promise<ExtractionResult>
  /** Extract content from multiple bytes or URI inputs. */
  extractBatch(inputs: Array<ExtractInput>, config?: ExtractionConfig | undefined | null): Promise<ExtractionResult>
}
...
export interface EntityValidator {
   ...
   * found in.
   */
  validate(entity: PatternMatch, ctx: string): ValidationResult
}
...
export declare class IbanChecksumValidator {
  label(): string
  validate(entity: PatternMatch, ctx: string): ValidationResult
}
...
export interface MergedOutput {
  ...
  readonly perBatchErrors: Array<string>
  /**
...
export interface ModelProvider {
   ...
   * @throws Returns an error if the model type is unknown or the download/verify
   * step fails.
   */
  ensureModel(model: ModelId): Promise<string>
}
...
export interface NerConfig {
   ...
   */
  readonly hfArchitecture?: GlinerArchitecture
  /**
   ...
   */
  readonly loraAdapterDir?: string
  /**
 ...
 */
export declare class NoopCache {
  get(key: string): Promise<Uint8Array | null>
  put(key: string, value: Uint8Array, ttl?: number | undefined | null): Promise<void>
}
 ...
 */
export declare class NoopProgressSink {
...
export declare class ParsedDocument {
   ...
   * @throws Propagates MIME-detection and PDF page-count failures.
   */
  static fromBytes(source: Uint8Array): ParsedDocument
...
export interface RedactionConfig {
   ...
   */
  readonly preserveTerms?: Array<RedactionTerm>
}
...
export declare class RehydrationMap {
}
...
export declare class RejectionCounts {
}
 ...
 */
export interface TextRedactionOutcome {
  /** Token → original PII text, populated for `TokenReplace` strategy hits. */
  readonly map?: RehydrationMap
 ...
 */
export declare function validateAndMerge(rawResponses: Array<JsonValue>, schema: JsonValue, mergeMode: MergeMode): MergedOutput;
