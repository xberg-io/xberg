...
// alef:hash:67460c1d38ed338c3835a9d70ac9c238f4dfda1864175757892ab7a41e920061
 ...
 */
export declare enum CandleDeepseekOcrDtype {
  Auto = "auto",
  F32 = "f32",
  F16 = "f16",
  Bf16 = "bf16",
...
export interface DeepseekOcrBackendOptions {
  ...
  readonly dtype?: CandleDeepseekOcrDtype;
}
...
export interface ExtractionConfig {
   ...
   */
  readonly ocrNearEmptyFallback?: boolean;
  /**
   ...
   */
  readonly ocrScannedPageQualityGate?: boolean;
  /**
   ...
   */
  readonly ocrEmbeddedImages?: boolean;
...
export type FormatMetadata =
  | ({ formatType: "pdf" } & PdfMetadata)
  | ({ formatType: "docx" } & DocxMetadata)
  | ({ formatType: "excel" } & ExcelMetadata)
  | ({ formatType: "email" } & EmailMetadata)
  | ({ formatType: "pptx" } & PptxMetadata)
  | ({ formatType: "archive" } & ArchiveMetadata)
  | ({ formatType: "image" } & ImageMetadata)
  | ({ formatType: "xml" } & XmlMetadata)
  | ({ formatType: "text" } & TextMetadata)
  | ({ formatType: "html" } & HtmlMetadata)
  | ({ formatType: "ocr" } & OcrMetadata)
  | ({ formatType: "csv" } & CsvMetadata)
  | ({ formatType: "bibtex" } & BibtexMetadata)
  | ({ formatType: "citation" } & CitationMetadata)
  | ({ formatType: "fiction_book" } & FictionBookMetadata)
  | ({ formatType: "dbf" } & DbfMetadata)
  | ({ formatType: "jats" } & JatsMetadata)
  | ({ formatType: "epub" } & EpubMetadata)
  | ({ formatType: "pst" } & PstMetadata)
  | ({ formatType: "audio" } & AudioMetadata)
  | ({ formatType: "code" } & CodeMetadata);
 ...
 * means.
 */
export interface OcrBackendCapabilities {
...
export interface OcrQualityThresholds {
   ...
   */
  readonly enablePlausibilityOcrRouting?: boolean;
  /**
   ...
   */
  readonly minReliableLanguageChunkRatio?: number;
}
...
export interface PdfMetadata {
   ...
   */
  readonly fabricatedTextPages?: Array<number>;
  /**
   ...
   * when no page qualifies.
   */
  readonly implausibleTextPages?: Array<number>;
  /**
...
export interface TesseractConfig {
   ...
   */
  readonly thresholdingMethod?: string
}
 ...
 * cache.
 * @throws Returns an error only if the registry lock cannot be acquired in the current environment.
 */
export declare function listOcrBackendCapabilities(): Array<OcrBackendCapabilities>;
 ...
 * @param backend - Name of a registered OCR backend, as returned by `list_ocr_backends`. Lookup is case-insensitive and resolves the same `paddleocr` alias as backend dispatch.
 *
 * @param language - Language code to check (e.g. `"eng"`, `"deu"`).
 *
 * @throws Returns an error if no backend with that name (or alias) is registered.
 */
export declare function ocrBackendSupportsLanguage(backend: string, language: string): boolean;
