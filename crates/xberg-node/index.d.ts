 ...
 *
 * @throws Returns `XbergError::Validation` if MIME type is invalid.
 ...
 * @returns An `ExtractionResult` containing the extracted content and metadata.
 *
 * @throws Returns `XbergError::Io` if the file doesn't exist (NotFound) or for other file I/O errors.
 * Returns `XbergError::UnsupportedFormat` if MIME type is not supported.
 */
