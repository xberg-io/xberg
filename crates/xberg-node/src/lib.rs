...
#[napi(js_name = "extractedDocumentFromOcr")]
pub fn extracted_document_from_ocr(ocr: JsOcrExtractionResult) -> JsExtractedDocument {
...
pub fn register_document_extractor(extractor: JsVisitorRef) -> Result<()> {
    let extractor_core: xberg::DocumentExtractor = extractor.into();

    xberg::register_document_extractor(extractor_core)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn unregister_document_extractor(name: String) -> Result<()> {
    xberg::unregister_document_extractor(&name)
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn register_renderer(renderer: JsVisitorRef) -> Result<()> {
    let renderer_core: xberg::Renderer = renderer.into();

    xberg::register_renderer(renderer_core).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn unregister_renderer(name: String) -> Result<()> {
    xberg::unregister_renderer(&name).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
