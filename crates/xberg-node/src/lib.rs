...
pub async fn extract_bytes(
    ...
    let result = xberg::extract_bytes(&content, &mime_type, &config_core)
        .await
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    Ok(result.into())
}
...
pub async fn extract_file(
    ...
    let result = xberg::extract_file(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core)
        .await
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    Ok(result.into())
}
...
pub fn extract_file_sync(
    ...
    xberg::extract_file_sync(std::path::PathBuf::from(path), mime_type.as_deref(), &config_core)
        .map(|val| val.into())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn extract_bytes_sync(
    ...
    let content: Vec<u8> = content.to_vec();
    xberg::extract_bytes_sync(&content, &mime_type, &config_core)
        .map(|val| val.into())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub fn batch_extract_files_sync(
    ...
    xberg::batch_extract_files_sync(items_core, &config_core)
...
pub fn batch_extract_bytes_sync(
    ...
    xberg::batch_extract_bytes_sync(items_core, &config_core)
        .map(|val| val.into_iter().map(Into::into).collect())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
pub async fn batch_extract_files(
    ...
    let result = xberg::batch_extract_files(items_core, &config_core)
        .await
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
pub async fn batch_extract_bytes(
    ...
    let result = xberg::batch_extract_bytes(items_core, &config_core)
        .await
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    Ok(result.into_iter().map(Into::into).collect())
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsBatchBytesItem> for xberg::BatchBytesItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::BatchBytesItem> for JsBatchBytesItem {
    fn from(val: xberg::BatchBytesItem) -> Self {
        Self {
            content: val.content.to_vec().into(),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsBatchFileItem> for xberg::BatchFileItem {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::BatchFileItem> for JsBatchFileItem {
    fn from(val: xberg::BatchFileItem) -> Self {
        Self {
