...
pub struct JsNerConfig {
    ...
    #[napi(js_name = "loraAdapterDir")]
    #[serde(rename = "loraAdapterDir")]
    pub lora_adapter_dir: Option<String>,
...
/// and `put` is inert.
#[derive(Clone)]
#[napi(js_name = "NoopCache")]
pub struct JsNoopCache {
    inner: Arc<xberg::engine::seams::NoopCache>,
}

#[napi]
impl JsNoopCache {
    #[napi]
    pub async fn get(&self, _key: String) -> Option<napi::bindgen_prelude::Buffer> {
        let inner = self.inner.clone();
        let result = inner.get(&_key).await;
        result
    }

    #[napi]
    pub async fn put(&self, _key: String, _value: napi::bindgen_prelude::Buffer, _ttl: Option<i64>) -> () {
        let inner = self.inner.clone();
        inner
            .put(
                &_key,
                _value,
                _ttl.map(|v| std::time::Duration::from_millis(v.max(0) as u64)),
            )
            .await;
        Ok(())
    }
...
#[derive(Clone)]
#[napi(js_name = "NoopProgressSink")]
pub struct JsNoopProgressSink {
    inner: Arc<xberg::engine::seams::NoopProgressSink>,
}

#[napi]
impl JsNoopProgressSink {
    #[napi]
    pub fn emit(&self, _event: JsProgressEvent) -> () {
        let _event_core: xberg::ProgressEvent = _event.into();

        self.inner.emit(_event_core)
    }
}
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "ModelId")]
pub struct JsModelId {
...
#[derive(Clone)]
#[napi(js_name = "DefaultModelProvider")]
pub struct JsDefaultModelProvider {
    inner: Arc<xberg::engine::seams::DefaultModelProvider>,
}

#[napi]
impl JsDefaultModelProvider {
    #[allow(clippy::missing_errors_doc)]
    #[napi(js_name = "ensureModel")]
    pub async fn ensure_model(&self, model: JsModelId) -> Result<String> {
        let model_json =
            serde_json::to_string(&model).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let model_core: xberg::ModelId = serde_json::from_str(&model_json)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let result = self
            .inner
            .ensure_model(&model_core)
            .await
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    ...
    #[napi]
    pub fn default() -> JsDefaultModelProvider {
        Self {
            inner: Arc::new(xberg::engine::seams::DefaultModelProvider::default()),
        }
    }
}
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "CitedField")]
pub struct JsCitedField {
    /// The field value.
    ...
    pub source: JsCitationSource,
}

/// Both views of the fused output: citation-wrapped and flattened.
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "CitationOutput")]
pub struct JsCitationOutput {
    ...
    #[napi(js_name = "structuredOutputFlat")]
    #[serde(rename = "structuredOutputFlat")]
    pub structured_output_flat: serde_json::Value,
}

/// Built prompt components ready to send to the vision model.
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "BuiltPrompt")]
pub struct JsBuiltPrompt {
    /// System instruction primer.
    pub system: String,
    /// User content (text + images context). undefined for VisionOnly / Skip modes.
    #[napi(js_name = "userText")]
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "ChunkerConfig")]
pub struct JsChunkerConfig {
    ...
    #[napi(js_name = "avgTokensPerImage")]
    #[serde(rename = "avgTokensPerImage")]
    pub avg_tokens_per_image: Option<u32>,
    /// Characters-per-token divisor used to estimate text/image byte token counts.
    #[napi(js_name = "charsPerToken")]
    #[serde(rename = "charsPerToken")]
    pub chars_per_token: Option<i64>,
}

#[napi(js_name = "chunkerConfigDefault")]
pub fn chunker_config_default() -> JsChunkerConfig {
    xberg::engine::structured::chunk::ChunkerConfig::default().into()
}

/// A batch of pages ready for a single vision-LLM call.
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "Batch")]
pub struct JsBatch {
    /// Page images in this batch.
    pub pages: Vec<JsPageImage>,
    /// User text (context + excerpt). Only set for the first batch;
    /// subsequent batches have undefined to avoid duplication.
    #[napi(js_name = "userText")]
    #[serde(rename = "userText")]
    pub user_text: Option<String>,
}
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "PageImage")]
pub struct JsPageImage {
    /// 1-based page number (matches the citation envelope convention).
    #[napi(js_name = "pageNumber")]
    #[serde(rename = "pageNumber")]
    pub page_number: u32,
    /// PNG-encoded page bytes.
    #[napi(js_name = "pngBytes", ts_type = "Uint8Array | Buffer | Array<number>")]
    #[serde(rename = "pngBytes")]
    pub png_bytes: JsBytes,
}

/// Merged structured output plus validation bookkeeping.
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "MergedOutput")]
pub struct JsMergedOutput {
    ...
    #[napi(js_name = "perBatchErrors")]
    #[serde(rename = "perBatchErrors")]
    ...
    pub confidence: Option<JsExtractionConfidence>,
}
...
/// can take `&self`.
#[derive(Clone)]
#[napi(js_name = "ParsedDocument")]
pub struct JsParsedDocument {
    inner: Arc<xberg::engine::parsed::ParsedDocument>,
}

#[napi]
impl JsParsedDocument {
    /// The detected MIME type.
    #[napi(js_name = "mimeType")]
    pub fn mime_type(&self) -> String {
        self.inner.mime_type().into()
    }
    ...
    #[napi]
    pub fn source(&self) -> napi::bindgen_prelude::Buffer {
        self.inner.source().to_vec()
    }
    ...
    pub fn from_bytes(source: napi::bindgen_prelude::Buffer) -> Result<JsParsedDocument> {
        xberg::engine::parsed::ParsedDocument::from_bytes(source)
...
impl JsEngine {
    ...
    #[allow(clippy::missing_errors_doc)]
    #[napi]
    pub async fn extract(&self, input: JsExtractInput, config: JsExtractionConfig) -> Result<JsExtractionResult> {
        let input_json =
            serde_json::to_string(&input).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let input_core: xberg::ExtractInput = serde_json::from_str(&input_json)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let config_json = serde_json::to_string(&config)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let config_core: xberg::ExtractionConfig = serde_json::from_str(&config_json)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let result = self
            .inner
            .extract(input_core, &config_core)
            .await
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        Ok(result.into())
    }
    ...
    pub async fn extract_batch(
        ...
        let inputs_json = serde_json::to_string(&inputs)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let inputs_core: Vec<xberg::ExtractInput> = serde_json::from_str(&inputs_json)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let config_json = serde_json::to_string(&config)
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        let config_core: xberg::ExtractionConfig = serde_json::from_str(&config_json)
        ...
        let result = self
            .inner
            .extract_batch(inputs_core, &config_core)
            .await
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
        Ok(result.into())
    }
    ...
    #[napi(js_name = "newDefault")]
    pub fn new_default() -> JsEngine {
        Self {
            inner: Arc::new(xberg::engine::Engine::new_default()),
        }
    }
}
...
#[derive(Clone)]
#[napi(js_name = "EngineBuilder")]
pub struct JsEngineBuilder {
    inner: Arc<xberg::engine::EngineBuilder>,
}
...
impl JsEngineBuilder {
    ...
    pub fn build(&self) -> JsEngine {
        compile_error!(
            "alef cannot auto-delegate `EngineBuilder.build`; configure an adapter body or add this item to the backend exclude list"
        )
    }
}
...
#[derive(Clone)]
#[napi(js_name = "CandleBackend")]
pub struct JsCandleBackend {
    inner: Arc<xberg::text::ner::candle::CandleBackend>,
}

#[napi]
impl JsCandleBackend {
    #[allow(clippy::missing_errors_doc)]
    #[napi]
    ...
    #[allow(clippy::missing_errors_doc)]
    #[napi(js_name = "fromLocal")]
    pub fn from_local(model_dir: String, lora_adapter_dir: Option<String>) -> Result<JsCandleBackend> {
        xberg::text::ner::candle::CandleBackend::from_local(
            std::path::Path::new(&model_dir),
            lora_adapter_dir.as_deref().map(std::path::Path::new),
        )
        .map(|val| Self { inner: Arc::new(val) })
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
    }
    ...
    #[napi(js_name = "fromBytes")]
    pub fn from_bytes(
        safetensors: napi::bindgen_prelude::Buffer,
        tokenizer_json: napi::bindgen_prelude::Buffer,
        encoder_config_json: napi::bindgen_prelude::Buffer,
    ) -> Result<JsCandleBackend> {
        xberg::text::ner::candle::CandleBackend::from_bytes(&safetensors, &tokenizer_json, &encoder_config_json)
            .map(|val| Self { inner: Arc::new(val) })
            .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
    }
}
...
#[derive(Clone, Default, serde::Serialize, serde::Deserialize)]
#[napi(object, js_name = "CustomGlinerSource")]
pub struct JsCustomGlinerSource {
    ...
    #[napi(js_name = "tokenizerFile")]
    #[serde(rename = "tokenizerFile")]
...
pub struct JsRehydrationMap {
    inner: Arc<xberg::text::redaction::RehydrationMap>,
}
...
#[napi(string_enum = "snake_case", js_name = "CitationSource")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub enum JsCitationSource {
...
#[allow(clippy::derivable_impls)]
impl Default for JsCitationSource {
    fn default() -> Self {
        Self::Llm
    }
}
...
#[napi(string_enum = "snake_case", js_name = "Outcome")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub enum JsOutcome {
...
pub fn fuse(
    ...
    ocr_elements: Vec<serde_json::Value>,
    element_metadata: Vec<serde_json::Value>,
    emit_citations: bool,
    match_threshold: f64,
    fused_confidence: f64,
) -> JsCitationOutput {
    xberg::engine::structured::citations::fuse(
        merged,
        &ocr_elements,
        &element_metadata,
        emit_citations,
...
#[napi(js_name = "validateAndMerge")]
pub fn validate_and_merge(
    raw_responses: Vec<serde_json::Value>,
    schema: serde_json::Value,
    merge_mode: JsMergeMode,
) -> JsMergedOutput {
    let merge_mode_core: xberg::MergeMode = merge_mode.into();

    xberg::engine::structured::schema::validate_and_merge(raw_responses, &schema, merge_mode_core).into()
}
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "customSourceFromParts")]
pub fn custom_source_from_parts(
    repo: Option<String>,
    model_file: Option<String>,
    tokenizer_file: Option<String>,
    architecture: Option<JsGlinerArchitecture>,
) -> Result<Option<JsCustomGlinerSource>> {
    let architecture_core: Option<xberg::GlinerArchitecture> = architecture.map(Into::into);

    xberg::text::ner::gline::custom_source_from_parts(
        repo.as_deref(),
        model_file.as_deref(),
...
#[napi(js_name = "dedupeOverlaps")]
pub fn dedupe_overlaps(matches: Vec<JsPatternMatch>) -> Vec<JsPatternMatch> {
    let matches_core: Vec<_> = matches.into_iter().map(Into::into).collect();

    xberg::text::redaction::dedupe_overlaps(matches_core)
        .into_iter()
        .map(Into::into)
        .collect()
}
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "encryptMap")]
pub fn encrypt_map(map: &JsRehydrationMap, passphrase: String) -> Result<napi::bindgen_prelude::Buffer> {
    xberg::text::redaction::encrypt_map(map.inner.as_ref(), &passphrase)
        .map(|val| val.into())
        .map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))
}
...
#[allow(clippy::missing_errors_doc)]
#[napi(js_name = "decryptMap")]
pub fn decrypt_map(blob: napi::bindgen_prelude::Buffer, passphrase: String) -> Result<JsRehydrationMap> {
...
impl From<JsNerConfig> for xberg::NerConfig {
    fn from(val: JsNerConfig) -> Self {
        ...
        __result.model_dir = val.model_dir.map(Into::into);
        __result.lora_adapter_dir = val.lora_adapter_dir.map(Into::into);
...
impl From<xberg::NerConfig> for JsNerConfig {
    fn from(val: xberg::NerConfig) -> Self {
        Self {
            ...
            model_dir: val.model_dir.map(|p| p.to_string_lossy().to_string()),
            lora_adapter_dir: val.lora_adapter_dir.map(|p| p.to_string_lossy().to_string()),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsProgressEvent> for xberg::engine::seams::ProgressEvent {
    fn from(val: JsProgressEvent) -> Self {
        Self {
            stage: val.stage,
            message: val.message,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::seams::ProgressEvent> for JsProgressEvent {
    fn from(val: xberg::engine::seams::ProgressEvent) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsModelId> for xberg::engine::seams::ModelId {
    fn from(val: JsModelId) -> Self {
        Self { kind: val.kind }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::seams::ModelId> for JsModelId {
    fn from(val: xberg::engine::seams::ModelId) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::citations::CitedField> for JsCitedField {
    fn from(val: xberg::engine::structured::citations::CitedField) -> Self {
        Self {
            value: val.value,
            page: val.page,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCitationOutput> for xberg::engine::structured::citations::CitationOutput {
    fn from(val: JsCitationOutput) -> Self {
        Self {
            structured_output: val.structured_output,
            structured_output_flat: val.structured_output_flat,
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::citations::CitationOutput> for JsCitationOutput {
    fn from(val: xberg::engine::structured::citations::CitationOutput) -> Self {
        Self {
            structured_output: val.structured_output,
            structured_output_flat: val.structured_output_flat,
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::prompts::BuiltPrompt> for JsBuiltPrompt {
    fn from(val: xberg::engine::structured::prompts::BuiltPrompt) -> Self {
        Self {
            system: val.system.to_string(),
            user_text: val.user_text.map(|v| v.to_string()),
        }
    }
}
...
#[allow(clippy::field_reassign_with_default, clippy::let_and_return)]
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsChunkerConfig> for xberg::engine::structured::chunk::ChunkerConfig {
    fn from(val: JsChunkerConfig) -> Self {
        let mut __result = xberg::engine::structured::chunk::ChunkerConfig::default();
        if let Some(__v) = val.max_input_tokens {
            __result.max_input_tokens = __v;
        }
        if let Some(__v) = val.avg_tokens_per_image {
            __result.avg_tokens_per_image = __v;
        }
        if let Some(__v) = val.chars_per_token {
            __result.chars_per_token = __v as usize;
        }
        __result
    }
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::chunk::ChunkerConfig> for JsChunkerConfig {
    fn from(val: xberg::engine::structured::chunk::ChunkerConfig) -> Self {
        Self {
            max_input_tokens: Some(val.max_input_tokens),
            avg_tokens_per_image: Some(val.avg_tokens_per_image),
            chars_per_token: Some(val.chars_per_token as i64),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::chunk::Batch> for JsBatch {
    fn from(val: xberg::engine::structured::chunk::Batch) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::rasterize::PageImage> for JsPageImage {
    fn from(val: xberg::engine::structured::rasterize::PageImage) -> Self {
        Self {
            page_number: val.page_number,
            png_bytes: val.png_bytes.to_vec().into(),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsMergedOutput> for xberg::engine::structured::schema::MergedOutput {
    fn from(val: JsMergedOutput) -> Self {
        Self {
            merged: val.merged,
            outcome: val.outcome.into(),
            error_message: val.error_message,
            per_batch_errors: val.per_batch_errors.into_iter().collect(),
            confidence: val.confidence.map(Into::into),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::engine::structured::schema::MergedOutput> for JsMergedOutput {
    fn from(val: xberg::engine::structured::schema::MergedOutput) -> Self {
        Self {
            merged: val.merged,
            outcome: val.outcome.into(),
            error_message: val.error_message.map(|v| v.to_string()),
            per_batch_errors: val.per_batch_errors.into_iter().collect(),
            confidence: val.confidence.map(Into::into),
        }
    }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCustomGlinerSource> for xberg::text::ner::gline::CustomGlinerSource {
    fn from(val: JsCustomGlinerSource) -> Self {
        Self {
            repo: val.repo,
            model_file: val.model_file,
            tokenizer_file: val.tokenizer_file,
            architecture: val.architecture.into(),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<xberg::text::ner::gline::CustomGlinerSource> for JsCustomGlinerSource {
    fn from(val: xberg::text::ner::gline::CustomGlinerSource) -> Self {
        Self {
            repo: val.repo.to_string(),
            model_file: val.model_file.to_string(),
            tokenizer_file: val.tokenizer_file.to_string(),
            architecture: val.architecture.into(),
        }
    }
}
...
impl From<JsNerBackendKind> for xberg::NerBackendKind {
    fn from(val: JsNerBackendKind) -> Self {
        match val {
            ...
            JsNerBackendKind::Candle => Self::Candle,
        }
    }
}
...
impl From<xberg::NerBackendKind> for JsNerBackendKind {
    fn from(val: xberg::NerBackendKind) -> Self {
        match val {
            ...
            xberg::NerBackendKind::Candle => Self::Candle,
        }
    }
}
...
impl From<xberg::engine::structured::citations::CitationSource> for JsCitationSource {
    fn from(val: xberg::engine::structured::citations::CitationSource) -> Self {
        match val {
            xberg::engine::structured::citations::CitationSource::Llm => Self::Llm,
            xberg::engine::structured::citations::CitationSource::Extracted => Self::Extracted,
            xberg::engine::structured::citations::CitationSource::Fused => Self::Fused,
            xberg::engine::structured::citations::CitationSource::None => Self::None,
        }
    }
}

impl From<JsOutcome> for xberg::engine::structured::schema::Outcome {
    fn from(val: JsOutcome) -> Self {
        match val {
            JsOutcome::Success => Self::Success,
            JsOutcome::PartialSuccess => Self::PartialSuccess,
            JsOutcome::SchemaInvalid => Self::SchemaInvalid,
            JsOutcome::Error => Self::Error,
        }
    }
}

impl From<xberg::engine::structured::schema::Outcome> for JsOutcome {
    fn from(val: xberg::engine::structured::schema::Outcome) -> Self {
        match val {
            xberg::engine::structured::schema::Outcome::Success => Self::Success,
            xberg::engine::structured::schema::Outcome::PartialSuccess => Self::PartialSuccess,
            xberg::engine::structured::schema::Outcome::SchemaInvalid => Self::SchemaInvalid,
            xberg::engine::structured::schema::Outcome::Error => Self::Error,
        }
    }
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsCitedField> for xberg::engine::structured::citations::CitedField {
    fn from(val: JsCitedField) -> Self {
        Self {
            value: val.value,
            page: val.page,
            bbox: Default::default(),
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsBuiltPrompt> for xberg::engine::structured::prompts::BuiltPrompt {
    fn from(val: JsBuiltPrompt) -> Self {
        Self {
            system: val.system,
            user_text: val.user_text,
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsBatch> for xberg::engine::structured::chunk::Batch {
    fn from(val: JsBatch) -> Self {
        Self {
            pages: val.pages.into_iter().map(Into::into).collect(),
            user_text: val.user_text,
        }
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsPageImage> for xberg::engine::structured::rasterize::PageImage {
    fn from(val: JsPageImage) -> Self {
        Self {
            page_number: val.page_number,
            png_bytes: val.png_bytes.to_vec().into(),
        }
...
impl From<JsCitationSource> for xberg::engine::structured::citations::CitationSource {
    fn from(val: JsCitationSource) -> Self {
        match val {
            JsCitationSource::Llm => Self::Llm,
            JsCitationSource::Extracted => Self::Extracted,
            JsCitationSource::Fused => Self::Fused,
            JsCitationSource::None => Self::None,
        }
    }
}
...
pub const RASTERIZE_ERROR_ERROR_PDF: &str = "Pdf";
pub const RASTERIZE_ERROR_ERROR_IMAGE: &str = "Image";
pub const RASTERIZE_ERROR_ERROR_UNSUPPORTED_MIME: &str = "UnsupportedMime";

/// Convert a `xberg::engine::structured::rasterize::RasterizeError` error to a NAPI error.
#[allow(dead_code)]
fn rasterize_error_to_napi_err(e: xberg::engine::structured::rasterize::RasterizeError) -> napi::Error {
    let msg = e.to_string();
    #[allow(unreachable_patterns)]
    match &e {
        xberg::engine::structured::rasterize::RasterizeError::Pdf(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[Pdf] {}", msg))
        }
        xberg::engine::structured::rasterize::RasterizeError::Image(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[Image] {}", msg))
        }
        xberg::engine::structured::rasterize::RasterizeError::UnsupportedMime(..) => {
            napi::Error::new(napi::Status::GenericFailure, format!("[UnsupportedMime] {}", msg))
        }
