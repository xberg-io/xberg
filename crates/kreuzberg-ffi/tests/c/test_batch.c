...
int main(void) {
    ...
    {
        struct CBatchResult *batch =
            kreuzberg_batch_extract_files_sync(NULL, 0, NULL);
    ...
    /* Test 3: Batch extract bytes with a small text/plain sample */
    {
        ...
        struct CBatchResult *batch =
            kreuzberg_batch_extract_bytes_sync(&item, 1, NULL);
    ...
    /* Test 4: Batch extract bytes with multiple items */
    {
        ...
        struct CBatchResult *batch =
            kreuzberg_batch_extract_bytes_sync(items, 2, NULL);
    ...
    /* Test 5: Batch extract files with nonexistent paths */
    {
        ...
        struct CBatchResult *batch =
            kreuzberg_batch_extract_files_sync(paths, 2, NULL);
    ...
    /* Test 8: Batch extract with explicit JSON config */
    {
        ...
        struct CBatchResult *batch =
            kreuzberg_batch_extract_bytes_sync(&item, 1, config);
