...
// alef:hash:02d8047a83352790b5cb50b2b096193178e6517bf2342e09daedb9e238b8b808
...
impl BatchBytesItem {
    ...
    #[php(constructor)]
    pub fn new(content: Vec<u8>, mimeType: String) -> Self {
        Self {
            content,
            mime_type: mimeType,
...
impl OcrPipelineConfig {
    ...
    #[php(constructor)]
    pub fn new(stages: Vec<OcrPipelineStage>) -> Self {
        Self {
            stages,
...
impl ImageOcrResult {
    ...
    #[php(constructor)]
    pub fn new(content: String, boundaries: Option<Vec<PageBoundary>>, pageContents: Option<Vec<PageContent>>) -> Self {
        Self {
            content,
            boundaries,
...
impl FormattedBlock {
    ...
    pub fn new(
        blockType: String,
        level: Option<i64>,
        inlineContent: Vec<InlineElement>,
...
impl ExtractionResult {
    ...
    pub fn new(
        ...
        ocrElements: Option<Vec<OcrElement>>,
        extractedKeywords: Option<Vec<Keyword>>,
        qualityScore: Option<f64>,
        processingWarnings: Vec<ProcessingWarning>,
        annotations: Option<Vec<PdfAnnotation>>,
        children: Option<Vec<ArchiveEntry>>,
        uris: Option<Vec<Uri>>,
        codeIntelligence: Option<String>,
        llmUsage: Option<Vec<LlmUsage>>,
...
impl ExcelWorkbook {
    ...
    #[php(constructor)]
    pub fn new(sheets: Vec<ExcelSheet>) -> Self {
        Self {
            sheets,
            metadata: Default::default(),
        }
...
impl XmlExtractionResult {
    #[php(constructor)]
    pub fn new(content: String, element_count: i64, unique_elements: Vec<String>) -> Self {
        Self {
            content,
            element_count,
            unique_elements,
...
impl PptxExtractionResult {
    ...
    pub fn new(
        ...
        pageContents: Option<Vec<PageContent>>,
...
impl HeaderMetadata {
    #[php(constructor)]
    pub fn new(level: u8, text: String, id: Option<String>, depth: i64, html_offset: i64) -> Self {
        Self {
            level,
            text,
            id,
...
impl StructuredData {
    #[php(constructor)]
    pub fn new(data_type: String, raw_json: String, schema_type: Option<String>) -> Self {
        Self {
            data_type,
            raw_json,
            schema_type,
...
impl HtmlMetadata {
    ...
    pub fn new(
        ...
        structuredData: Vec<StructuredData>,
    ) -> Self {
        Self {
            title,
            description,
...
impl DbfMetadata {
    ...
    #[php(constructor)]
    pub fn new(recordCount: i64, fieldCount: i64, fields: Vec<DbfFieldInfo>) -> Self {
        Self {
...
impl JatsMetadata {
    ...
    #[php(constructor)]
    pub fn new(copyright: Option<String>, license: Option<String>, contributorRoles: Vec<ContributorRole>) -> Self {
        Self {
            copyright,
            license,
...
impl PageBoundary {
    #[php(constructor)]
    pub fn new(byte_start: i64, byte_end: i64, page_number: i64) -> Self {
        Self {
            byte_start,
            byte_end,
            page_number,
...
impl PageContent {
    ...
    pub fn new(
        ...
        images: Vec<ExtractedImage>,
        isBlank: Option<bool>,
        layoutRegions: Option<Vec<LayoutRegion>>,
    ) -> Self {
        Self {
            page_number: pageNumber,
            content,
...
impl PageHierarchy {
    ...
    #[php(constructor)]
    pub fn new(blockCount: i64, blocks: Vec<HierarchicalBlock>) -> Self {
        Self {
...
impl ChunkRequest {
    #[php(constructor)]
    pub fn new(text: String, config: Option<String>, chunker_type: String) -> Self {
        Self {
            text,
            config,
            chunker_type,
...
impl ManifestEntryResponse {
    #[php(constructor)]
    pub fn new(relative_path: String, sha256: String, size_bytes: i64, source_url: String) -> Self {
        Self {
            relative_path,
            sha256,
            size_bytes,
...
impl DetectedBoundary {
    #[php(constructor)]
    pub fn new(byte_offset: i64, is_header: bool) -> Self {
...
impl ChunkingResult {
    ...
    #[php(constructor)]
    pub fn new(chunks: Vec<Chunk>, chunkCount: i64) -> Self {
        Self {
            chunks,
...
impl MergedChunk {
    #[php(constructor)]
    pub fn new(text: String, byte_start: i64, byte_end: i64) -> Self {
        Self {
            text,
            byte_start,
            byte_end,
...
impl DetectionResult {
    ...
    #[php(constructor)]
    pub fn new(pageWidth: u32, pageHeight: u32, detections: Vec<LayoutDetection>) -> Self {
        Self {
...
impl EmbeddedFile {
    ...
    #[php(constructor)]
    pub fn new(name: String, data: Vec<u8>, mimeType: Option<String>) -> Self {
        Self {
            name,
            data,
            mime_type: mimeType,
