...
// alef:hash:f2cf57506a8727e03b60cf79749f1bfad8db4105d08048c5eaf8d3645235e3f8
...
impl kreuzberg::plugins::PostProcessor for PhpPostProcessorBridge {
    ...
    fn should_process(&self, _result: &kreuzberg::ExtractionResult, _config: &kreuzberg::ExtractionConfig) -> bool {
        ...
        let mut args: Vec<ext_php_rs::types::Zval> = Vec::new();
        args.push(
            ext_php_rs::types::Zval::try_from(serde_json::to_string(&_result).unwrap_or_default()).unwrap_or_default(),
        );
        args.push(
            ext_php_rs::types::Zval::try_from(serde_json::to_string(&_config).unwrap_or_default()).unwrap_or_default(),
        );
        let result = unsafe {
            (*self.inner).try_call_method(
                "should_process",
