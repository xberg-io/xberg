...
impl Default for NerConfig {
    fn default() -> Self {
        <kreuzberg::core::config::NerConfig as Default>::default().into()
    }
}
...
impl Default for RedactionConfig {
    fn default() -> Self {
        <kreuzberg::core::config::RedactionConfig as Default>::default().into()
    }
}
...
impl RedactionConfig {
    ...
    pub fn validate(&self) -> PhpResult<()> {
        let core_self = kreuzberg::core::config::RedactionConfig {
            categories: self
                .categories
                .clone()
                .into_iter()
    ...
    pub fn default() -> RedactionConfig {
        kreuzberg::core::config::RedactionConfig::default().into()
    }
}
...
impl RedactionTerm {
    ...
    pub fn literal(value: String) -> RedactionTerm {
        kreuzberg::core::config::redaction::RedactionTerm::literal(value).into()
    }
    ...
    pub fn labeled(label: String, value: String) -> RedactionTerm {
        kreuzberg::core::config::redaction::RedactionTerm::labeled(label, value).into()
    }
}
...
impl RedactionPattern {
    ...
    pub fn labeled(label: String, pattern: String) -> RedactionPattern {
        kreuzberg::core::config::redaction::RedactionPattern::labeled(label, pattern).into()
    }
}
...
impl Default for SummarizationConfig {
    fn default() -> Self {
        <kreuzberg::core::config::SummarizationConfig as Default>::default().into()
    }
}
...
impl GlineBackend {
    ...
    pub fn new(repoId: Option<String>) -> PhpResult<GlineBackend> {
        kreuzberg::text::ner::gline::GlineBackend::new(repoId.as_deref())
            .map(|val| val.into())
...
pub struct LlmBackend {
    inner: Arc<kreuzberg::text::ner::llm::LlmBackend>,
}
...
pub struct TokenCounter {
    inner: Arc<std::sync::Mutex<kreuzberg::text::redaction::strategy::TokenCounter>>,
}
    ...
    pub fn new() -> TokenCounter {
        Self {
            inner: Arc::new(std::sync::Mutex::new(
                kreuzberg::text::redaction::strategy::TokenCounter::new(),
            )),
        }
    }
}
...
impl KreuzbergApi {
     ...
     * @throws KreuzbergException Propagates any LLM client / request error returned by
     * `complete_text`.
     */
    #[php(name = "summarizeWithLlm")]
    pub fn summarize_with_llm(
        ...
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::text::summarization::llm::summarize_with_llm(
                &text,
     ...
     * @throws KreuzbergException Same as `extract_region_with_vlm`.
     */
    #[php(name = "extractRegionWithVlmUsage")]
    pub fn extract_region_with_vlm_usage(
        imageBytes: PhpBytes,
        imageMime: String,
        regionKind: String,
        llmConfig: Option<&LlmConfig>,
        ...
        let llm_config_core: Option<kreuzberg::LlmConfig> = llm_config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::llm::region_extractor::extract_region_with_vlm_usage(
                &imageBytes.0[..],
                &imageMime,
                regionKind_core,
                &llm_config_core.unwrap_or_default(),
    ...
    /**
     * a free-form prompt to the configured LLM with a JSON-schema response
     ...
     * @param mixed $llm_config — provider/model configuration.
     *
     * @param mixed $prompt — fully-rendered user prompt (no Jinja substitution performed).
     *
     * @param mixed $schema_name — name for the JSON schema (passed to providers that distinguish multiple structured outputs).
     *
     * @param mixed $schema — the JSON schema the LLM is required to obey.
     *
     * @param mixed $source — label used for the returned `LlmUsage` entry.
     *
     * @throws KreuzbergException Returns an error if the LLM client cannot be constructed, the request fails,
     * the response contains no content, or the response is not parseable JSON.
     */
    #[php(name = "completeWithJsonSchema")]
    pub fn complete_with_json_schema(
        ...
        let llm_config_core: Option<kreuzberg::LlmConfig> = llm_config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result = kreuzberg::llm::structured::complete_with_json_schema(
                &llm_config_core.unwrap_or_default(),
                &prompt,
                &schemaName,
                schema,
    ...
    /**
     * a single user prompt to the configured LLM and return the response text
     ...
     */
    #[php(name = "completeText")]
    pub fn complete_text(llmConfig: Option<&LlmConfig>, prompt: String, source: String) -> PhpResult<String> {
        let llm_config_core: Option<kreuzberg::LlmConfig> = llm_config.map(|v| v.clone().into());
        WORKER_RUNTIME.block_on(async {
            let result =
                kreuzberg::llm::text_completion::complete_text(&llm_config_core.unwrap_or_default(), &prompt, &source)
                    .await
                    .map_err(|e| ext_php_rs::exception::PhpException::default(e.to_string()))?;
            Ok(result)
        })
...
impl From<kreuzberg::core::config::CaptioningConfig> for CaptioningConfig {
    fn from(val: kreuzberg::core::config::CaptioningConfig) -> Self {
        Self {
            llm: val.llm.into(),
            prompt: val.prompt,
            min_image_area: val.min_image_area,
...
impl From<kreuzberg::core::config::PageClassificationConfig> for PageClassificationConfig {
    fn from(val: kreuzberg::core::config::PageClassificationConfig) -> Self {
        Self {
            prompt_template: val.prompt_template,
            labels: val.labels.into_iter().collect(),
            multi_label: val.multi_label,
    ...
    fn from(val: NerConfig) -> Self {
        Self {
            backend: match val.backend.as_str() {
                "onnx" => kreuzberg::core::config::NerBackendKind::Onnx,
                "llm" => kreuzberg::core::config::NerBackendKind::Llm,
                _ => Default::default(),
            },
            categories: val
                .categories
...
impl From<kreuzberg::core::config::NerConfig> for NerConfig {
    fn from(val: kreuzberg::core::config::NerConfig) -> Self {
        Self {
...
impl From<kreuzberg::core::config::RedactionConfig> for RedactionConfig {
    fn from(val: kreuzberg::core::config::RedactionConfig) -> Self {
        Self {
            categories: val
                .categories
                .iter()
...
impl From<kreuzberg::core::config::redaction::RedactionTerm> for RedactionTerm {
    fn from(val: kreuzberg::core::config::redaction::RedactionTerm) -> Self {
        Self {
            label: val.label,
            value: val.value,
            case_sensitive: val.case_sensitive,
...
impl From<kreuzberg::core::config::redaction::RedactionPattern> for RedactionPattern {
    fn from(val: kreuzberg::core::config::redaction::RedactionPattern) -> Self {
        Self {
            label: val.label,
            pattern: val.pattern,
            case_sensitive: val.case_sensitive,
...
impl From<kreuzberg::core::config::SummarizationConfig> for SummarizationConfig {
    fn from(val: kreuzberg::core::config::SummarizationConfig) -> Self {
        Self {
            strategy: serde_json::to_value(val.strategy)
                .ok()
                .and_then(|s| s.as_str().map(String::from))
...
impl From<kreuzberg::core::config::TranslationConfig> for TranslationConfig {
    fn from(val: kreuzberg::core::config::TranslationConfig) -> Self {
        Self {
            target_lang: val.target_lang,
            source_lang: val.source_lang,
            preserve_markup: val.preserve_markup,
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<GlineBackend> for kreuzberg::text::ner::gline::GlineBackend {
...
impl From<kreuzberg::text::ner::gline::GlineBackend> for GlineBackend {
    fn from(val: kreuzberg::text::ner::gline::GlineBackend) -> Self {
        Self {
            repo_id: val.repo_id,
