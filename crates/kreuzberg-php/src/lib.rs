...
impl ChunkPlan {
    ...
    #[php(constructor)]
    pub fn new(totalChunks: u32, totalEstimatedTimeMs: i64, useDiskProcessing: bool, reason: String) -> Self {
        Self {
            total_chunks: totalChunks,
            chunks: Default::default(),
    ...
    pub fn total_pages(&self) -> u32 {
        let core_self = kreuzberg::ChunkPlan {
            ...
            reason: match self.reason.as_str() {
                "LargeFile" | "largefile" => kreuzberg::ChunkingReason::LargeFile {
                    size_bytes: Default::default(),
                    threshold_bytes: Default::default(),
                },
                "ManyPages" | "manypages" => kreuzberg::ChunkingReason::ManyPages {
                    page_count: Default::default(),
                    threshold: Default::default(),
                },
                "OcrRequired" | "ocrrequired" => kreuzberg::ChunkingReason::OcrRequired {
                    page_count: Default::default(),
                    force_ocr: Default::default(),
                },
                "LargeAndManyPages" | "largeandmanypages" => kreuzberg::ChunkingReason::LargeAndManyPages {
                    size_bytes: Default::default(),
                    page_count: Default::default(),
                },
                _ => kreuzberg::ChunkingReason::LargeFile {
                    size_bytes: Default::default(),
                    threshold_bytes: Default::default(),
                },
            },
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("kreuzberg", "5.0.0-rc.25")
