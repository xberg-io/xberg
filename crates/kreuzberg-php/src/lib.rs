...
// alef:hash:7505a2c17e861f2fa46a7ccad07727e6b6cf44e55636a651ecce52b7c3368a31
...
impl PdfAnnotation {
    #[php(constructor)]
    pub fn new(annotationType: String, content: Option<String>, pageNumber: u32, boundingBox: Option<String>) -> Self {
        Self {
...
impl ElementMetadata {
    ...
    pub fn get_coordinates(&self) -> Option<String> {
...
impl TextExtractionResult {
    ...
    pub fn get_code_blocks(&self) -> Option<Vec<String>> {
...
impl LayoutRegion {
    ...
    pub fn get_bounding_box(&self) -> String {
        self.bounding_box.clone()
    }
...
impl Table {
    ...
    #[php(constructor)]
    pub fn new(cells: Vec<Vec<String>>, markdown: String, pageNumber: u32, boundingBox: Option<String>) -> Self {
        Self {
            cells,
            markdown,
            page_number: pageNumber,
