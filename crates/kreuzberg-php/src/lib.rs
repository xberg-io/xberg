...
// alef:hash:a571935988093a226e26c065482c389b1c34a5cda49167b87f77510edca9cc20
...
impl PageContent {
    ...
    #[php(constructor)]
    pub fn new(pageNumber: u32, content: String, imageIndices: Vec<u32>, isBlank: Option<bool>) -> Self {
        Self {
            page_number: pageNumber,
            content,
            tables: Default::default(),
...
impl KreuzbergApi {
     ...
     */
    #[php(name = "calculateQualityScore")]
