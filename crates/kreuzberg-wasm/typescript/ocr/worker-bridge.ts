...
async function createNodeWorker(wasmGluePath: string, wasmBinary: Uint8Array | undefined): Promise<void> {
	const { Worker } = await import(/* @vite-ignore */ /* webpackIgnore: true */ "node:worker_threads");
	const nodePath = await import(/* @vite-ignore */ /* webpackIgnore: true */ "node:path");
	const nodeUrl = await import(/* @vite-ignore */ /* webpackIgnore: true */ "node:url");
