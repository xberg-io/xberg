...
// alef:hash:2b9c1e406c0879e297ca2dcb94a409dd2774f9b768dceb59c171b36701ecfc43
...
pub fn blake3_hash_file(path: String) -> Result<String, JsValue> {
    let result =
        kreuzberg::blake3_hash_file(std::path::Path::new(&path)).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_port(port: u16) -> Result<(), JsValue> {
    let result = kreuzberg::validate_port(port).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_host(host: String) -> Result<(), JsValue> {
    let result = kreuzberg::validate_host(&host).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_binarization_method(method: String) -> Result<(), JsValue> {
    let result = kreuzberg::validate_binarization_method(&method).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_token_reduction_level(level: String) -> Result<(), JsValue> {
    let result = kreuzberg::validate_token_reduction_level(&level).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_ocr_backend(backend: String) -> Result<(), JsValue> {
    let result = kreuzberg::validate_ocr_backend(&backend).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_language_code(code: String) -> Result<(), JsValue> {
    let result = kreuzberg::validate_language_code(&code).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_tesseract_psm(psm: i32) -> Result<(), JsValue> {
    let result = kreuzberg::validate_tesseract_psm(psm).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_tesseract_oem(oem: i32) -> Result<(), JsValue> {
    let result = kreuzberg::validate_tesseract_oem(oem).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_output_format(format: String) -> Result<(), JsValue> {
    let result = kreuzberg::validate_output_format(&format).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_confidence(confidence: f64) -> Result<(), JsValue> {
    let result = kreuzberg::validate_confidence(confidence).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn validate_chunking_params(max_chars: usize, max_overlap: usize) -> Result<(), JsValue> {
    let result =
        kreuzberg::validate_chunking_params(max_chars, max_overlap).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn extract_email_content(
    ...
    let result = kreuzberg::extract_email_content(&data, &mime_type, fallback_codepage)
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result.into())
}
...
pub fn djot_to_html(djot_source: String) -> Result<String, JsValue> {
    let result = kreuzberg::djot_to_html(&djot_source).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn list_renderers() -> Result<Vec<String>, JsValue> {
    let result = kreuzberg::plugins::list_renderers().map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn reduce_tokens(text: String, config: JsValue, language_hint: Option<String>) -> Result<String, JsValue> {
    let config_core: kreuzberg::TokenReductionConfig =
        serde_wasm_bindgen::from_value::<kreuzberg::TokenReductionConfig>(config)
            .map_err(|e| JsValue::from_str(&e.to_string()))?;
    let result = kreuzberg::reduce_tokens(&text, &config_core, language_hint.as_deref())
        .map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
...
pub fn extract_text_from_pdf(pdf_bytes: Vec<u8>) -> Result<String, JsValue> {
    let result = kreuzberg::extract_text_from_pdf(&pdf_bytes).map_err(|e| JsValue::from_str(&e.to_string()))?;
    Ok(result)
}
