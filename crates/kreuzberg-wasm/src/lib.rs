...
// alef:hash:9cf8bebc314686a5eeeaf4bf488d9b66379133da7341586d82075b03e8ca0c42
...
impl WasmMetadata {
    ...
    pub fn format(&self) -> Option<String> {
        self.format.map(|v| v.to_api_str().to_owned())
    }
...
impl WasmExcelMetadata {
    #[wasm_bindgen(constructor)]
    pub fn new(sheet_count: Option<u32>, sheet_names: Option<Vec<String>>) -> WasmExcelMetadata {
        WasmExcelMetadata {
            sheet_count,
            sheet_names,
        }
...
impl WasmXmlMetadata {
    #[wasm_bindgen(constructor)]
    pub fn new(element_count: Option<u32>, unique_elements: Option<Vec<String>>) -> WasmXmlMetadata {
        WasmXmlMetadata {
...
impl WasmHeaderMetadata {
    #[wasm_bindgen(constructor)]
    pub fn new(level: u8, text: String, depth: u32, html_offset: u32, id: Option<String>) -> WasmHeaderMetadata {
        WasmHeaderMetadata {
            level,
            text,
            id,
...
impl WasmOcrElement {
    ...
    pub fn geometry(&self) -> String {
        self.geometry.to_api_str().to_owned()
    }
...
impl WasmPageBoundary {
    #[wasm_bindgen(constructor)]
    pub fn new(byte_start: usize, byte_end: usize, page_number: u32) -> WasmPageBoundary {
        WasmPageBoundary {
            byte_start,
            byte_end,
            page_number,
...
impl WasmPageHierarchy {
    #[wasm_bindgen(constructor)]
    pub fn new(block_count: u32, blocks: Vec<WasmHierarchicalBlock>) -> WasmPageHierarchy {
