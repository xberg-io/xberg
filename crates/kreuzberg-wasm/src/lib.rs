...
// alef:hash:c774c3e84a244d149413ed59054f583b4c1ea8441f372348398b73b8d47c59ea
...
impl WasmEmbedTextParams {
    ...
    #[wasm_bindgen(getter, js_name = "embeddingPlugin")]
    pub fn embedding_plugin(&self) -> Option<String> {
        self.embedding_plugin.clone()
    }

    #[wasm_bindgen(setter, js_name = "embeddingPlugin")]
    pub fn set_embedding_plugin(&mut self, value: Option<String>) {
        self.embedding_plugin = value;
    }
}
