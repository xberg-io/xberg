...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.24/Xberg-rs.artifactbundle.zip",
      checksum: "03428fcc80c7b1d6bfa71eea839827e577631a153a57fd898ba4f39fd7616bd2"
    ),
