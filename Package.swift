...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.16/Xberg-rs.artifactbundle.zip",
      checksum: "70489b5d851f7d8b3f013abd29169f4a2d234a672b3e1d380a78366730bd609f"
    ),
