...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.28/Xberg-rs.artifactbundle.zip",
      checksum: "fdd8fcaa45b4790088eeee0818f1383c1119aa9921c1ec9b6f3fc30c279fadf4"
    ),
