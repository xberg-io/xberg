...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.1.1/Xberg-rs.artifactbundle.zip",
      checksum: "84799a1e187cc0818ebb8bd168c24b7cd995b5cd6bc021703318fbf8f2f9d1f6"
    ),
