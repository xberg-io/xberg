...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.34/Xberg-rs.artifactbundle.zip",
      checksum: "b6b04e4c1e7e6e53f7effad878af68c6bd26b842f1d53e058c9ae4558e2f15d7"
    ),
