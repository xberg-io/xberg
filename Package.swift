...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.1.2/Xberg-rs.artifactbundle.zip",
      checksum: "7714ee9148b7ca6babdf7b52f60478a4add81eed319db9e4950e5796576650ac"
    ),
