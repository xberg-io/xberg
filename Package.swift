...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.3/Xberg-rs.artifactbundle.zip",
      checksum: "00f5daa47b54893af4930a44b845b3506ddf9d2e371c2001cc71d7e1d938dbbc"
    ),
