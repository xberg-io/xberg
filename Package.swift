...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/kreuzberg-dev/kreuzberg/releases/download/v5.0.0-rc.34/Kreuzberg-rs.artifactbundle.zip",
      checksum: "0f3585a60ee78b795b47c51a994159377210e17499df256a736ff40b893478b8"
    ),
