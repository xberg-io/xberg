...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.10/Xberg-rs.artifactbundle.zip",
      checksum: "d2a004b242e01718b62119e010ccf4b0023a3ea3337facb854338288e9dd4cc8"
    ),
