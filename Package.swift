...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.5/Xberg-rs.artifactbundle.zip",
      checksum: "995d26574238812b37fdf83457baba3c1d1a4b7ec62b00f6280e9e8f068703d7"
    ),
