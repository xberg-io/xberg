...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.11/Xberg-rs.artifactbundle.zip",
      checksum: "e869a7dc26421cf27639ff86840257493db0c564f98dd71d12687be591c4a7ad"
    ),
