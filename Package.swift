...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.2.9/Xberg-rs.artifactbundle.zip",
      checksum: "faea70c5cba9448307234e6a3d18cfbe44dfaef623d050df3917414b1706c530"
    ),
