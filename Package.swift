...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.20/Xberg-rs.artifactbundle.zip",
      checksum: "4127f07af9da4171be3992e5c0179674b37cc120838ccd4f46d432ce1c742df8"
    ),
