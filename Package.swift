...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/xberg/releases/download/v1.0.0-rc.35/Xberg-rs.artifactbundle.zip",
      checksum: "2cf1a438ca14c11d4945a6cb58ae6b2fd9ec19228debac7858abd69a7d94e891"
    ),
