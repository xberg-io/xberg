...
## WebAssembly API Reference <span class="version-badge">v5.0.0-rc.23</span>
...
| `totalEstimatedTimeMs` | `number` | — | Estimated total processing time in milliseconds. |
...
```typescript
static testConfig(): HeuristicsConfig
```

**Example:**

```typescript
const result = HeuristicsConfig.testConfig();
```
