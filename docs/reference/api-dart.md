...
## Dart API Reference <span class="version-badge">v4.10.0-rc.8</span>
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bytes` | `Uint8List` | Yes | The byte slice to validate |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `byteData` | `Uint8List` | Yes | The byte data |
...
| `fileConfigs` | `List<String?>?` | `null` | Per-file extraction configuration overrides (parallel array to paths). Each entry is either null (use default) or a FileExtractionConfig JSON object. |
