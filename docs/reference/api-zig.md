...
## Zig API Reference <span class="version-badge">v5.0.0-rc.23</span>
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `totalChunks` | `u32` | — | Total number of chunks. |
| `chunks` | `\[\]const ChunkInfo` | — | Individual chunk information. |
| `totalEstimatedTimeMs` | `u64` | — | Estimated total processing time in milliseconds. |
...
```zig
pub fn testConfig() HeuristicsConfig
```
