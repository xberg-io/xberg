...
## Swift API Reference <span class="version-badge">v4.10.0-rc.8</span>
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `size` | `UInt64` | Yes | The maximum upload size in bytes to validate |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `maxChars` | `UInt64` | Yes | The maximum characters per chunk |
| `maxOverlap` | `UInt64` | Yes | The maximum overlap between chunks |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bytes` | `Data` | Yes | The byte slice to validate |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `byteData` | `Data` | Yes | The byte data |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `poolSize` | `UInt64` | Yes | Maximum number of buffers to keep in the pool |
| `bufferCapacity` | `UInt64` | Yes | Initial capacity for each buffer in bytes |
...
| `fileConfigs` | `[String?]?` | `null` | Per-file extraction configuration overrides (parallel array to paths). Each entry is either null (use default) or a FileExtractionConfig JSON object. |
...
| `removedFiles` | `UInt64` | — | Number of files removed |
...
|-------|------|---------|-------------|
| `directory` | `String` | — | Cache directory path |
| `totalFiles` | `UInt64` | — | Total number of cache files |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `sheetCount` | `UInt64` | — | Total number of sheets in the workbook |
