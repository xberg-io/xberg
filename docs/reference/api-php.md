...
## PHP API Reference <span class="version-badge">v5.0.0-rc.23</span>
...
| `totalEstimatedTimeMs` | `int` | — | Estimated total processing time in milliseconds. |
...
```php
public static function testConfig(): HeuristicsConfig
```

**Example:**

```php
$result = HeuristicsConfig::testConfig();
```
