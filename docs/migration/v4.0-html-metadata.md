...
- **`headers`**: List of page headers/headings
- **`links`**: List of links as `Vec<(String, String)>` (URL, text pairs)
- **`images`**: List of image URLs
- **`structured_data`**: Parsed JSON-LD and schema.org data
...
| Field | v3.x | v4.0 |
|-------|------|------|
| `keywords` | `Option<String>` | `Vec<String>` |
| `canonical` | `Option<String>` | Renamed to `canonical_url` |
| `og_*` fields (7 fields) | Individual `Option<String>` fields | `open_graph: Map<String, String>` |
| `twitter_*` fields (6 fields) | Individual `Option<String>` fields | `twitter_card: Map<String, String>` |
| `link_author`, `link_license`, `link_alternate` | Individual fields | Removed (use `links` field) |
| New: `language` | N/A | `Option<String>` |
| New: `text_direction` | N/A | `Option<String>` |
| New: `headers` | N/A | `Option<Vec<String>>` |
| New: `links` | N/A | `Option<Vec<(String, String)>>` |
| New: `images` | N/A | `Option<Vec<String>>` |
| New: `structured_data` | N/A | `Option<Vec<Value>>` |
| New: `meta_tags` | N/A | `Option<Map<String, String>>` |
