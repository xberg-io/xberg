...
For the exhaustive field-by-field reference, see [`docs/reference/api-rust.md`](../reference/api-rust.md) and [`docs/reference/configuration.md`](../reference/configuration.md).
...
See [`docs/reference/configuration.md`](../reference/configuration.md) for all fields and defaults.
